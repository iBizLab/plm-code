...
var J = (e, r, a) => (ce(e, typeof r != "symbol" ? r + "" : r, a), a);
...
import { defineComponent as se, ref as $, watch as ie, createVNode as I, resolveComponent as V, nextTick as ee, computed as he } from "vue";
...
(function(e) {
   ...
   */
  var a = function(i) {
    var u = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, S = 0, w = {}, l = {
      /**
      ...
      util: {
        ...
        clone: function t(n, s) {
          ...
          switch (l.util.type(n)) {
            case "Object":
              if (c = l.util.objId(n), s[c])
                return s[c];
              o = /** @type {Record<string, any>} */
              {}, s[c] = o;
              for (var E in n)
                n.hasOwnProperty(E) && (o[E] = t(n[E], s));
              return (
                /** @type {any} */
                o
              );
            case "Array":
              return c = l.util.objId(n), s[c] ? s[c] : (o = [], s[c] = o, /** @type {Array} */
              /** @type {any} */
        ...
        setLanguage: function(t, n) {
          t.className = t.className.replace(RegExp(u, "gi"), ""), t.classList.add("language-" + n);
        },
        /**
      ...
      languages: {
         ...
         */
        extend: function(t, n) {
          var s = l.util.clone(l.languages[t]);
          for (var o in n)
            s[o] = n[o];
          return s;
        },
        ...
        insertBefore: function(t, n, s, o) {
          ...
          for (var _ in c)
            if (c.hasOwnProperty(_)) {
              ...
              s.hasOwnProperty(_) || (E[_] = c[_]);
            }
          var D = o[t];
          return o[t] = E, l.languages.DFS(l.languages, function(N, U) {
            U === D && N != t && (this[N] = E);
          }), E;
        },
        // Traverse a language definition with Depth First Search
        DFS: function t(n, s, o, c) {
          c = c || {};
          var E = l.util.objId;
          for (var _ in n)
            if (n.hasOwnProperty(_)) {
              s.call(n, _, n[_], o || _);
              var y = n[_], D = l.util.type(y);
              D === "Object" && !c[E(y)] ? (c[E(y)] = !0, t(y, s, null, c)) : D === "Array" && !c[E(y)] && (c[E(y)] = !0, t(y, s, _, c));
            }
        }
      },
      plugins: {},
      ...
      highlightAll: function(t, n) {
        l.highlightAllUnder(document, t, n);
      },
      /**
      ...
      highlightAllUnder: function(t, n, s) {
        ...
        for (var c = 0, E; E = o.elements[c++]; )
          l.highlightElement(E, n === !0, o.callback);
      },
      /**
      ...
      highlightElement: function(t, n, s) {
        var o = l.util.getLanguage(t), c = l.languages[o];
        l.util.setLanguage(t, o);
        var E = t.parentElement;
        E && E.nodeName.toLowerCase() === "pre" && l.util.setLanguage(E, o);
        ...
        function D(U) {
          y.highlightedCode = U, l.hooks.run("before-insert", y), y.element.innerHTML = y.highlightedCode, l.hooks.run("after-highlight", y), l.hooks.run("complete", y), s && s.call(y.element);
        }
        if (l.hooks.run("before-sanity-check", y), E = y.element.parentElement, E && E.nodeName.toLowerCase() === "pre" && !E.hasAttribute("tabindex") && E.setAttribute("tabindex", "0"), !y.code) {
          l.hooks.run("complete", y), s && s.call(y.element);
          return;
        }
        if (l.hooks.run("before-highlight", y), !y.grammar) {
          D(l.util.encode(y.code));
          return;
        }
        if (n && i.Worker) {
          ...
          D(l.highlight(y.code, y.grammar, y.language));
      },
      /**
      ...
      highlight: function(t, n, s) {
        ...
        return o.tokens = l.tokenize(o.code, o.grammar), l.hooks.run("after-tokenize", o), g.stringify(l.util.encode(o.tokens), o.language);
      },
      /**
      ...
      tokenize: function(t, n) {
        ...
        var c = new f();
        return b(c, c.head, t), h(t, c, n, c.head, 0), k(c);
      },
      /**
       * @namespace
       * @memberof Prism
    ...
    i.Prism = l;
    function g(t, n, s, o) {
      this.type = t, this.content = n, this.alias = s, this.length = (o || "").length | 0;
    }
    g.stringify = function t(n, s) {
      ...
      var _ = "";
      for (var y in c.attributes)
        _ += " " + y + '="' + (c.attributes[y] || "").replace(/"/g, "&quot;") + '"';
      ...
      for (var _ in s)
        if (!(!s.hasOwnProperty(_) || !s[_])) {
          ...
          for (var D = 0; D < y.length; ++D) {
            if (E && E.cause == _ + "," + D)
              return;
            var N = y[D], U = N.inside, G = !!N.lookbehind, W = !!N.greedy, Y = N.alias;
            if (W && !N.pattern.global) {
              var K = N.pattern.toString().match(/[imsuy]*$/)[0];
              N.pattern = RegExp(N.pattern.source, K + "g");
            }
            for (var X = N.pattern || N, C = o.next, R = c; C !== n.tail && !(E && R >= E.reach); R += C.value.length, C = C.next) {
              var P = C.value;
              ...
              if (!(P instanceof g)) {
                var z = 1, M;
                if (W) {
                  if (M = m(X, R, t, G), !M || M.index >= t.length)
                    break;
                  ...
                  if (H -= C.value.length, R = H, C.value instanceof g)
                    continue;
                  for (var p = C; p !== n.tail && (H < Q || typeof p.value == "string"); p = p.next)
                    z++, H += p.value.length;
                  z--, P = t.slice(R, H), M.index -= R;
                } else if (M = m(X, 0, P, G), !M)
                  continue;
                var d = M.index, v = M[0], L = P.slice(0, d), B = P.slice(d + v.length), F = R + P.length;
                E && F > E.reach && (E.reach = F);
                var j = C.prev;
                L && (j = b(n, j, L), R += L.length), A(n, j, z);
                var Z = new g(_, U ? l.tokenize(v, U) : v, Y, v);
    ...
    function b(t, n, s) {
      var o = n.next, c = { value: s, prev: n, next: o };
      return n.next = c, o.prev = c, t.length++, c;
    }
    function A(t, n, s) {
      for (var o = n.next, c = 0; c < s && o !== t.tail; c++)
        o = o.next;
      n.next = o, o.prev = n, t.length -= c;
    }
    function k(t) {
    ...
    if (!i.document)
      return i.addEventListener && (l.disableWorkerMessageHandler || i.addEventListener("message", function(t) {
        var n = JSON.parse(t.data), s = n.language, o = n.code, c = n.immediateClose;
        i.postMessage(l.highlight(o, l.languages[s], s)), c && i.close();
      }, !1)), l;
...
(function(e) {
  ...
  e.languages.markdown = e.languages.extend("markup", {}), e.languages.insertBefore("markdown", "prolog", {
    ...
    table: {
      pattern: RegExp("^" + u + S + "(?:" + u + ")*", "m"),
      inside: {
        "table-data-rows": {
          pattern: RegExp("^(" + u + S + ")(?:" + u + ")*$"),
          lookbehind: !0,
          inside: {
            "table-data": {
              pattern: RegExp(i),
  ...
  var w = RegExp(e.languages.markup.tag.pattern.source, "gi"), l = {
    amp: "&",
    lt: "<",
    gt: ">",
    quot: '"'
...
(function(e) {
  ...
  Object.defineProperties(e.languages["markup-templating"] = {}, {
    buildPlaceholders: {
       ...
       */
      value: function(a, i, u, S) {
        if (a.language === i) {
          var w = a.tokenStack = [];
          a.code = a.code.replace(u, function(l) {
            if (typeof S == "function" && !S(l))
              return l;
            for (var g = w.length, m; a.code.indexOf(m = r(i, g)) !== -1; )
              ++g;
            return w[g] = l, m;
    ...
    tokenizePlaceholders: {
      ...
      value: function(a, i) {
        ...
        var u = 0, S = Object.keys(a.tokenStack);
        function w(l) {
          for (var g = 0; g < l.length && !(u >= S.length); g++) {
            var m = l[g];
            if (typeof m == "string" || m.content && typeof m.content == "string") {
              var h = S[u], f = a.tokenStack[h], b = typeof m == "string" ? m : m.content, A = r(i, h), k = b.indexOf(A);
              if (k > -1) {
                ++u;
                var T = b.substring(0, k), O = new e.Token(i, e.tokenize(f, a.grammar), "language-" + i, f), x = b.substring(k + A.length), t = [];
                T && t.push.apply(t, w([T])), t.push(O), x && t.push.apply(t, w([x])), typeof m == "string" ? l.splice.apply(l, [g, 1].concat(t)) : m.content = t;
              }
            } else
...
(function(e) {
  var r = /\/\*[\s\S]*?\*\/|\/\/.*|#(?!\[).*/, a = [
    ...
    /\b(?:null)\b/i,
    /\b[A-Z_][A-Z0-9_]*\b(?!\s*\()/
  ], i = /\b0b[01]+(?:_[01]+)*\b|\b0o[0-7]+(?:_[0-7]+)*\b|\b0x[\da-f]+(?:_[\da-f]+)*\b|(?:\b\d+(?:_\d+)*\.?(?:\d+(?:_\d+)*)?|\B\.\d+)(?:e[+-]?\d+)?/i, u = /<?=>|\?\?=?|\.{3}|\??->|[!=]=?=?|::|\*\*=?|--|\+\+|&&|\|\||<<|>>|[?~]|[/^|%*&<>.+-]=?/, S = /[{}\[\](),:;]/;
  e.languages.php = {
    delimiter: {
      pattern: /\?>$|^<\?(?:php(?=\s)|=)?/i,
      alias: "important"
...
(function(e) {
  var r = e.util.clone(e.languages.javascript), a = /(?:\s|\/\/.*(?!.)|\/\*(?:[^*]|\*(?!\/))\*\/)/.source, i = /(?:\{(?:\{(?:\{[^{}]*\}|[^{}])*\}|[^{}])*\})/.source, u = /(?:\{<S>*\.{3}(?:[^{}]|<BRACES>)*\})/.source;
  function S(g, m) {
  ...
  u = S(u).source, e.languages.jsx = e.languages.extend("markup", r), e.languages.jsx.tag.pattern = S(
  ...
  var w = function(g) {
    ...
    for (var m = [], h = 0; h < g.length; h++) {
      ...
      f.content && typeof f.content != "string" && l(f.content);
    }
  };
  e.hooks.add("after-tokenize", function(g) {
    g.language !== "jsx" && g.language !== "tsx" || l(g.tokens);
  });
})(Prism);
...
(function(e) {
  ...
  var w = S(u.typeDeclaration), l = RegExp(S(u.type + " " + u.typeDeclaration + " " + u.contextual + " " + u.other)), g = S(u.typeDeclaration + " " + u.contextual + " " + u.other), m = S(u.type + " " + u.typeDeclaration + " " + u.other), h = i(/<(?:[^<>;=+\-*/%&|^]|<<self>>)*>/.source, 2), f = i(/\((?:[^()]|<<self>>)*\)/.source, 2), b = /@?\b[A-Za-z_]\w*\b/.source, A = r(/<<0>>(?:\s*<<1>>)?/.source, [b, h]), k = r(/(?!<<0>>)<<1>>(?:\s*\.\s*<<1>>)*/.source, [g, A]), T = /\[\s*(?:,\s*)*\]/.source, O = r(/<<0>>(?:\s*(?:\?\s*)?<<1>>)*(?:\s*\?)?/.source, [k, T]), x = r(/[^,()<>[\];=+\-*/%&|^]|<<0>>|<<1>>|<<2>>/.source, [h, f, T]), t = r(/\(<<0>>+(?:,<<0>>+)+\)/.source, [x]), n = r(/(?:<<0>>|<<1>>)(?:\s*(?:\?\s*)?<<2>>)*(?:\s*\?)?/.source, [t, k, T]), s = {
    keyword: l,
    punctuation: /[<>()?,.:[\]]/
  ...
  e.languages.csharp = e.languages.extend("clike", {
    ...
    "type-list": {
      ...
      pattern: a(
        ...
        [w, A, b, n, l.source, f, /\bnew\s*\(\s*\)/.source]
      ),
      lookbehind: !0,
      inside: {
        "record-arguments": {
  ...
  var _ = c + "|" + o, y = r(/\/(?![*/])|\/\/[^\r\n]*[\r\n]|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>/.source, [_]), D = i(r(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [y]), 2), N = /\b(?:assembly|event|field|method|module|param|property|return|type)\b/.source, U = r(/<<0>>(?:\s*\(<<1>>*\))?/.source, [k, D]);
  e.languages.insertBefore("csharp", "class-name", {
    attribute: {
      // Attributes
  ...
  var G = /:[^}\r\n]+/.source, W = i(r(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [y]), 2), Y = r(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [W, G]), K = i(r(/[^"'/()]|\/(?!\*)|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>|\(<<self>>*\)/.source, [_]), 2), X = r(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [K, G]);
  function C(R, P) {
    return {
      interpolation: {
...
(function(e) {
  ...
  for (var u = [
    ...
    "punctuation",
    "number"
  ], S = i.variable[1].inside, w = 0; w < u.length; w++)
    S[u[w]] = e.languages.bash[u[w]];
...
const te = /* @__PURE__ */ se({
  ...
  setup(e, {
    ...
    let i = null, u = "";
    e.rawItem && (i = e.rawItem.rawItem, u = i.contentType);
    const S = $(e.type || u || ""), w = $("");
    let l = null;
    u === "IMAGE" && (l = i.sysImage), u === "RAW" || u === "HTML" ? u === "RAW" ? (S.value = "TEXT", w.value = i.caption) : w.value = i.content : ["VIDEO", "DIVIDER", "INFO", "WARNING", "ERROR"].includes(u) || u === "IMAGE" && l && (w.value = l);
    ...
    let n = [], s = [];
    const o = $(!1), c = (p) => e.parseScript ? de.execScriptFn({
      value: p
    }, e.parseScript, {
      singleRowReturn: !0,
      isAsync: !1
      ...
      if (S.value === "IMAGE" && typeof e.content == "string" && (g(e.content) ? w.value = {
        ...
        const p = b.value;
        b.value = p.replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&amp;nbsp;/g, " ").replace(/&nbsp;/g, " "), b.value = E(b.value), b.value = _(b.value), b.value = c(b.value);
      }
      ...
      var p;
      if (n = [], s = [], o.value = !1, k.value = [], O.value = [], S.value === "HTML" && b.value && typeof b.value == "string") {
      ...
      A.value = !A.value;
    }, K = (p) => p.map((d) => [d.title ? I("p", {
      id: d.id,
      innerHTML: d.title
    }, null) : null, d.children && d.children.length > 0 ? K(d.children) : I("p", {
      innerHTML: d,
      onClick: P
    }, null)]), X = (p) => {
      const d = />(.*?)</g;
      ...
      await ee(), Se.highlightAll();
    };
    return y(), G(), ie(() => e.content, (p, d) => {
      p !== d && (w.value = p, y(), G(), Q(), H());
    }, {
      immediate: !0
    }), {
      ns: a,
  ...
  setup(e, {
    ...
    var b, A, k, T, O, x;
    const a = oe("raw"), i = e.controller, u = i.model, S = $(""), w = $(""), l = $("");
    let g = "TEXT", m = "";
    u.contentType && (g = u.contentType), (b = u.editorParams) != null && b.contenttype && (g = (A = u.editorParams) == null ? void 0 : A.contenttype), (k = u.editorParams) != null && k.template && (m = u.editorParams.template.replaceAll("//n", "\n")), (T = u.editorParams) != null && T.TEMPLATE && (m = u.editorParams.TEMPLATE.replaceAll("//n", "\n")), (O = u.editorParams) != null && O.TITLE && (w.value = e.data[u.editorParams.TITLE]), (x = u.editorParams) != null && x.PARSESCRIPT && (l.value = u.editorParams.PARSESCRIPT);
    const h = he(() => !!(e.controlParams && e.controlParams.editmode === "hover"));
    return ie(() => e.value, async (t, n) => {
      ...
      onClick: (t, n) => {
        t.stopPropagation(), t.preventDefault(), i.handleClick(t, n), r("click", t, {
          data: n
        });
      }
    };
...
class ve extends pe {
  constructor() {
     ...
     */
    J(this, "linkViewId", "plmweb.recent_redirect_view");
  }
  async onInit() {
    await super.onInit();
    const {
  ...
  handleClick(a, i) {
    ...
    u.srfkey = i.id, i.owner_subtype === "page" ? u.article_page = i.owner_id : u[i.owner_subtype] = i.owner_id, u[i.owner_type] = i.recent_parent, delete i.script, delete i.icon, delete i.id, Object.assign(u, i), i && this.linkViewId && ibiz.commands.execute(ge.TAG, this.linkViewId, u, this.params);
  }
}
class Ae {
  constructor() {
...
const Ie = new fe(import.meta.url);
class _e {
  /**
  ...
  static loadScript(r) {
    return new Promise((a, i) => {
      ...
      u.src = r, u.onload = a, u.onerror = i, document.head.appendChild(u);
    });
  }
  /**
   * 配置全局 MathJax
  ...
  static loadMathJax() {
    return new Promise((r, a) => {
      if (this.getMathJax())
        ...
        this.initMathJax();
        const u = [this.loadScript(
          // 插件中使用 resource.dir
          Ie.dir("assets/mathjax/plugins/js/tex-svg.js")
          // 模板中使用
