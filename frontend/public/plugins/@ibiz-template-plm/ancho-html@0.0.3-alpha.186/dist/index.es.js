...
var ge = (e, r, n) => r in e ? pe(e, r, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[r] = n;
var Y = (e, r, n) => (ge(e, typeof r != "symbol" ? r + "" : r, n), n);
import { ScriptFactory as fe, EditorController as he, OpenAppViewCommand as me, PluginStaticResource as be, registerEditorProvider as ye } from "@ibiz-template/runtime";
import { defineComponent as le, ref as B, watch as ue, createVNode as A, resolveComponent as J, nextTick as ne, computed as Ee } from "vue";
import { useNamespace as ce, getRawProps as we, getEditorEmits as Se } from "@ibiz-template/vue3-util";
import { createUUID as se } from "qx-util";
import { clone as ve } from "ramda";
...
(function(e) {
    ...
    var o = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, f = 0, y = {}, u = {
      ...
      languages: {
        ...
        insertBefore: function(t, a, i, l) {
          ...
          var F = l[t];
          return l[t] = S, u.languages.DFS(u.languages, function(L, z) {
            z === F && L != t && (this[L] = S);
          }), S;
        },
        ...
        DFS: function t(a, i, l, c) {
          ...
          for (var _ in a)
            if (a.hasOwnProperty(_)) {
              i.call(a, _, a[_], l || _);
              var w = a[_], F = u.util.type(w);
              F === "Object" && !c[S(w)] ? (c[S(w)] = !0, t(w, i, null, c)) : F === "Array" && !c[S(w)] && (c[S(w)] = !0, t(w, i, _, c));
            }
        }
      },
      plugins: {},
      ...
      highlightElement: function(t, a, i) {
        ...
        function F(z) {
          w.highlightedCode = z, u.hooks.run("before-insert", w), w.element.innerHTML = w.highlightedCode, u.hooks.run("after-highlight", w), u.hooks.run("complete", w), i && i.call(w.element);
        }
        ...
        if (u.hooks.run("before-highlight", w), !w.grammar) {
          F(u.util.encode(w.code));
          return;
        }
        if (a && s.Worker) {
          var L = new Worker(u.filename);
          ...
          F(u.highlight(w.code, w.grammar, w.language));
      },
      /**
      ...
      tokenize: function(t, a) {
        ...
        var c = new h();
        return m(c, c.head, t), b(t, c, a, c.head, 0), k(c);
      },
      /**
       * @namespace
       * @memberof Prism
      ...
      for (var _ in i)
        if (!(!i.hasOwnProperty(_) || !i[_])) {
          ...
          for (var F = 0; F < w.length; ++F) {
            if (S && S.cause == _ + "," + F)
              return;
            var L = w[F], z = L.inside, Z = !!L.lookbehind, q = !!L.greedy, X = L.alias;
            if (q && !L.pattern.global) {
              var K = L.pattern.toString().match(/[imsuy]*$/)[0];
              L.pattern = RegExp(L.pattern.source, K + "g");
            }
            for (var V = L.pattern || L, D = l.next, O = c; D !== a.tail && !(S && O >= S.reach); O += D.value.length, D = D.next) {
              var M = D.value;
              ...
              if (!(M instanceof g)) {
                var H = 1, U;
                if (q) {
                  if (U = E(V, O, t, Z), !U || U.index >= t.length)
                    break;
                  var p = U.index, Q = U.index + U[0].length, W = O;
                  for (W += D.value.length; p >= W; )
                    D = D.next, W += D.value.length;
                  if (W -= D.value.length, O = W, D.value instanceof g)
                    continue;
                  for (var d = D; d !== a.tail && (W < Q || typeof d.value == "string"); d = d.next)
                    H++, W += d.value.length;
                  H--, M = t.slice(O, W), U.index -= O;
                } else if (U = E(V, 0, M, Z), !U)
                  continue;
                var p = U.index, v = U[0], x = M.slice(0, p), P = M.slice(p + v.length), C = O + M.length;
                S && C > S.reach && (S.reach = C);
                var G = D.prev;
                x && (G = m(a, G, x), O += x.length), I(a, G, H);
                var $ = new g(_, z ? u.tokenize(v, z) : v, X, v);
                if (D = m(a, G, $), P && m(a, D, P), H > 1) {
                  var j = {
                    cause: _ + "," + F,
                    reach: C
                  };
                  b(t, a, i, D.prev, O, j), S && j.reach > S.reach && (S.reach = j.reach);
                }
              }
            }
          }
  ...
  e.exports && (e.exports = n), typeof ie < "u" && (ie.Prism = n);
})(de);
var Ae = de.exports;
const _e = /* @__PURE__ */ Ie(Ae);
...
(function(e) {
  ...
  e.languages.markdown = e.languages.extend("markup", {}), e.languages.insertBefore("markdown", "prolog", {
    ...
    ["url", "bold", "italic", "strike", "code-snippet"].forEach(function(h) {
      b !== h && (e.languages.markdown[b].inside.content.inside[h] = e.languages.markdown[h]);
    });
      ...
      if (!(!m || typeof m == "string"))
        for (var I = 0, k = m.length; I < k; I++) {
          ...
          if (N && R && N.type === "code-language" && R.type === "code-block" && typeof N.content == "string") {
            var t = N.content.replace(/\b#/g, "sharp").replace(/\b\+\+/g, "pp");
            t = (/[a-z][\w-]*/i.exec(t) || [""])[0].toLowerCase();
            var a = "language-" + t;
            R.alias ? typeof R.alias == "string" ? R.alias = [R.alias, a] : R.alias.push(a) : R.alias = [a];
          }
        }
    }
    h(b.tokens);
    ...
    if (b.type === "code-block") {
      for (var h = "", m = 0, I = b.classes.length; m < I; m++) {
        var k = b.classes[m], T = /language-(.+)/.exec(k);
        if (T) {
          h = T[1];
          break;
        }
      ...
      var N = e.languages[h];
      if (N)
        b.content = e.highlight(E(b.content), N, h);
      else if (h && h !== "none" && e.plugins.autoloader) {
        var R = "md-" + (/* @__PURE__ */ new Date()).valueOf() + "-" + Math.floor(Math.random() * 1e16);
        b.attributes.id = R, e.plugins.autoloader.loadLanguages(h, function() {
          var t = document.getElementById(R);
          t && (t.innerHTML = e.highlight(t.textContent, e.languages[h], h));
        });
      }
    }
  });
  ...
  function E(b) {
    var h = b.replace(y, "");
    return h = h.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function(m, I) {
        ...
        function y(u) {
          for (var g = 0; g < u.length && !(o >= f.length); g++) {
            ...
            if (typeof E == "string" || E.content && typeof E.content == "string") {
              var b = f[o], h = n.tokenStack[b], m = typeof E == "string" ? E : E.content, I = r(s, b), k = m.indexOf(I);
              if (k > -1) {
                ++o;
                var T = m.substring(0, k), N = new e.Token(s, e.tokenize(h, n.grammar), "language-" + s, h), R = m.substring(k + I.length), t = [];
                T && t.push.apply(t, y([T])), t.push(N), R && t.push.apply(t, y([R])), typeof E == "string" ? u.splice.apply(u, [g, 1].concat(t)) : E.content = t;
              }
            } else
...
(function(e) {
  ...
  var y = function(g) {
    ...
    for (var E = [], b = 0; b < g.length; b++) {
      var h = g[b], m = !1;
      if (typeof h != "string" && (h.type === "tag" && h.content[0] && h.content[0].type === "tag" ? h.content[0].content[0].content === "</" ? E.length > 0 && E[E.length - 1].tagName === y(h.content[0].content[1]) && E.pop() : h.content[h.content.length - 1].content === "/>" || E.push({
        tagName: y(h.content[0].content[1]),
        openedBraces: 0
      }) : E.length > 0 && h.type === "punctuation" && h.content === "{" ? E[E.length - 1].openedBraces++ : E.length > 0 && E[E.length - 1].openedBraces > 0 && h.type === "punctuation" && h.content === "}" ? E[E.length - 1].openedBraces-- : m = !0), (m || typeof h == "string") && E.length > 0 && E[E.length - 1].openedBraces === 0) {
        var I = y(h);
        b < g.length - 1 && (typeof g[b + 1] == "string" || g[b + 1].type === "plain-text") && (I += y(g[b + 1]), g.splice(b + 1, 1)), b > 0 && (typeof g[b - 1] == "string" || g[b - 1].type === "plain-text") && (I = y(g[b - 1]) + I, g.splice(b - 1, 1), b--), g[b] = new e.Token("plain-text", I, null, I);
      }
      h.content && typeof h.content != "string" && u(h.content);
    }
  };
  e.hooks.add("after-tokenize", function(g) {
...
(function(e) {
  function r(O, M) {
    return O.replace(/<<(\d+)>>/g, function(H, U) {
      return "(?:" + M[+U] + ")";
    });
  }
  function n(O, M, H) {
    return RegExp(r(O, M), H || "");
  }
  function s(O, M) {
    for (var H = 0; H < M; H++)
  ...
  var y = f(o.typeDeclaration), u = RegExp(f(o.type + " " + o.typeDeclaration + " " + o.contextual + " " + o.other)), g = f(o.typeDeclaration + " " + o.contextual + " " + o.other), E = f(o.type + " " + o.typeDeclaration + " " + o.other), b = s(/<(?:[^<>;=+\-*/%&|^]|<<self>>)*>/.source, 2), h = s(/\((?:[^()]|<<self>>)*\)/.source, 2), m = /@?\b[A-Za-z_]\w*\b/.source, I = r(/<<0>>(?:\s*<<1>>)?/.source, [m, b]), k = r(/(?!<<0>>)<<1>>(?:\s*\.\s*<<1>>)*/.source, [g, I]), T = /\[\s*(?:,\s*)*\]/.source, N = r(/<<0>>(?:\s*(?:\?\s*)?<<1>>)*(?:\s*\?)?/.source, [k, T]), R = r(/[^,()<>[\];=+\-*/%&|^]|<<0>>|<<1>>|<<2>>/.source, [b, h, T]), t = r(/\(<<0>>+(?:,<<0>>+)+\)/.source, [R]), a = r(/(?:<<0>>|<<1>>)(?:\s*(?:\?\s*)?<<2>>)*(?:\s*\?)?/.source, [t, k, T]), i = {
    keyword: u,
    punctuation: /[<>()?,.:[\]]/
  ...
  e.languages.csharp = e.languages.extend("clike", {
    ...
    "class-name": [
      ...
      },
      {
        ...
        pattern: n(/(\busing\s+<<0>>\s*=\s*)<<1>>(?=\s*;)/.source, [m, a]),
        lookbehind: !0,
        inside: i
      },
      {
      ...
      },
      {
        ...
        pattern: n(/(\b(?:is(?:\s+not)?|as)\s+)<<0>>/.source, [N]),
        lookbehind: !0,
        inside: i
      },
      {
        ...
        pattern: n(/\b<<0>>(?=\s+(?!<<1>>|with\s*\{)<<2>>(?:\s*[=,;:{)\]]|\s+(?:in|when)\b))/.source, [a, E, m]),
        inside: i
      }
    ],
    keyword: u,
    ...
    namespace: {
      // namespace Foo.Bar {}
      // using Foo.Bar;
      pattern: n(/(\b(?:namespace|using)\s+)<<0>>(?:\s*\.\s*<<0>>)*(?=\s*[;{])/.source, [m]),
      lookbehind: !0,
      inside: {
        punctuation: /\./
      }
    ...
    "type-expression": {
      ...
      pattern: n(/(\b(?:default|sizeof|typeof)\s*\(\s*(?!\s))(?:[^()\s]|\s(?!\s)|<<0>>)*(?=\s*\))/.source, [h]),
      lookbehind: !0,
      alias: "class-name",
      inside: i
    },
    ...
    "type-list": {
      ...
      pattern: n(
        ...
        [y, I, m, a, u.source, h, /\bnew\s*\(\s*\)/.source]
      ),
      lookbehind: !0,
      inside: {
        "record-arguments": {
          pattern: n(/(^(?!new\s*\()<<0>>\s*)<<1>>/.source, [I, h]),
          lookbehind: !0,
          greedy: !0,
  ...
  var _ = c + "|" + l, w = r(/\/(?![*/])|\/\/[^\r\n]*[\r\n]|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>/.source, [_]), F = s(r(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [w]), 2), L = /\b(?:assembly|event|field|method|module|param|property|return|type)\b/.source, z = r(/<<0>>(?:\s*\(<<1>>*\))?/.source, [k, F]);
  e.languages.insertBefore("csharp", "class-name", {
    attribute: {
      // Attributes
      // [Foo], [Foo(1), Bar(2, Prop = "foo")], [return: Foo(1), Bar(2)], [assembly: Foo(Bar)]
      pattern: n(/((?:^|[^\s\w>)?])\s*\[\s*)(?:<<0>>\s*:\s*)?<<1>>(?:\s*,\s*<<1>>)*(?=\s*\])/.source, [L, z]),
      lookbehind: !0,
      greedy: !0,
      inside: {
        target: {
          pattern: n(/^<<0>>(?=\s*:)/.source, [L]),
          alias: "keyword"
        },
        "attribute-arguments": {
  ...
  var Z = /:[^}\r\n]+/.source, q = s(r(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [w]), 2), X = r(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [q, Z]), K = s(r(/[^"'/()]|\/(?!\*)|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>|\(<<self>>*\)/.source, [_]), 2), V = r(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [K, Z]);
  function D(O, M) {
    return {
      interpolation: {
...
const ae = /* @__PURE__ */ le({
  ...
  setup(e, {
    ...
    const n = ce("ancho-html-nav-bar");
    let s = null, o = "";
    e.rawItem && (s = e.rawItem.rawItem, o = s.contentType);
    const f = B(e.type || o || ""), y = B("");
    let u = null;
    ...
    const g = (d) => /^https?:|^http?:|(\.png|\.svg|\.jpg|\.png|\.gif|\.psd|\.tif|\.bmp|\.jpeg)/.test(d), E = B({
      id: se(),
      path: "",
      mute: !0,
      autoplay: !0,
      ...
      closeabled: !0,
      showIcon: !1
    }), m = B(""), I = B(!1), k = B([]), T = B(""), N = B([]), R = B(0), t = B(!1);
    let a = [], i = [];
    const l = B(!1), c = (d) => e.parseScript ? fe.execScriptFn({
      value: d,
      controller: e.controller
    }, e.parseScript, {
      singleRowReturn: !0,
      isAsync: !1
    }) : d.replace(/@{[^,]*,"name":"(.*?)"}/g, "<span class='comment-tag'>@$1</span>").replace(/@{[^,]*,name=(.*?)}/g, "<span class='comment-tag'>@$1</span>").replace(/#{"id":"(.+?)","name":"(.+?)","identifier":"(.+?)","type":"(.+?)","icon":"((.|[\t\r\f\n\s])+?)"}/g, (p, v, x, P, C, G) => {
      const $ = G.trim(), j = JSON.stringify({
        id: v,
        name: x,
        identifier: P,
        type: C
      });
      return "<span markerClick='marker' params='".concat(j, "' class='comment-tag is-click'>").concat($, " ").concat(P, " ").concat(x, "</span>");
    }).replace(/#{"id":"(.+?)","name":"(.+?)","identifier":"(.+?)","icon":"((.|[\t\r\f\n\s])+?)"}/g, "<span class='comment-tag'>$4 $3 $2</span>").replace(/#{id=(.+?),name=(.+?),identifier=(.+?),icon=((.|[\t\r\f\n\s])+?)}/g, "<span class='comment-tag'>$4 $3 $2</span>"), S = (d) => d.replaceAll(/{"emoji":"(.+?)"}/g, (p, v) => {
      const x = decodeURIComponent(atob(v));
      return '<span class="emoji-tag">'.concat(x, "</span>");
    }).replaceAll(/<span\sdata-w-e-type="emoji"\sclass=['"]emoji['"]>(.+?)<\/span>/g, (p, v) => {
      const x = decodeURIComponent(atob(v));
      return "<span data-w-e-type=\"emoji\" class='emoji'>".concat(x, "</span>");
    }), _ = (d) => d.replaceAll(/<span\sdata-w-e-type="insert"\sclass=['"]insert['"]>(.+?)<\/span>/g, (p, v) => {
      if (v) {
        ...
        switch (x.type) {
          case "date":
            C = '<span data-slate-inline="true"><date-elem data-value=\''.concat(P, "'></date-elem></span>");
            break;
          case "label":
            C = '<span data-slate-inline="true"><label-elem data-value=\''.concat(P, "'></label-elem></span>");
            break;
          case "prompt-box":
            C = "<p><prompt-box-elem data-value='".concat(P, "'></prompt-box-elem></p>");
            break;
          case "mind-map":
            C = "<p><mind-map-elem data-value='".concat(P, "'></mind-map-elem></p>");
            break;
          case "audio":
            C = "<p><audio-elem data-value='".concat(P, "'></audio-elem></p>");
            break;
          case "formula":
            C = '<span data-slate-inline="true"><formula-elem data-value=\''.concat(P, "'></formula-elem></span>");
            break;
          case "files":
            C = '<span data-slate-inline="true"><files-elem data-value=\''.concat(P, "'></files-elem></span>");
            break;
          default:
            C = "";
            break;
      ...
      return "";
    }).replaceAll(/<layout-elem data-w-e-type="layout" class='layout'>(.+?)<\/layout-elem>/g, (p, v) => {
      if (v) {
        ...
        return "<layout-elem class='layout' data-value='".concat(x, "'>").concat(v, "</layout-elem>");
      }
      return "";
    }).replaceAll(/<layout-column-elem data-w-e-type="layout-column" class='layout-column'>(.+?)<\/layout-column-elem>/g, (p, v) => v ? "<layout-column-elem class='layout-column'>".concat(v, "</layout-column-elem>") : ""), w = () => {
      if (f.value === "IMAGE" && typeof e.content == "string" && (g(e.content) ? y.value = {
        imagePath: e.content
      } : y.value = {
        cssClass: e.content
      }), ["TEXT", "HEADING1", "HEADING2", "HEADING3", "HEADING4", "HEADING5", "HEADING6", "PARAGRAPH", "HTML", "RAW"].includes(f.value) && (m.value = y.value, typeof m.value == "string")) {
        const d = m.value;
        m.value = d.replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&amp;nbsp;/g, " ").replace(/&nbsp;/g, " "), m.value = S(m.value), m.value = _(m.value), m.value = c(m.value);
      }
      if (["VIDEO", "DIVIDER", "INFO", "WARNING", "ERROR"].includes(f.value) && y.value) {
        let d = {};
        try {
          if (typeof y.value == "string")
            switch (d = new Function("return (".concat(y.value, ");"))(), f.value) {
              case "VIDEO":
                Object.assign(E.value, d);
                break;
              case "DIVIDER":
                Object.assign(b.value, d);
                break;
              case "INFO":
              case "WARNING":
              case "ERROR":
                h.value.type = f.value.toLocaleLowerCase(), Object.assign(h.value, d);
                break;
              default:
                break;
            }
      ...
      d.forEach((p) => {
        if (p.isIntersecting)
          p.target && p.target.id && i.push(p.target.id);
        else if (p.target && p.target.id) {
          const v = i.indexOf(p.target.id);
          v >= 0 && i.splice(v, 1);
        }
      }), F();
    }), z = (d, p = 1) => {
      if (p > 6)
        return [d];
      const v = [], x = new RegExp("<h".concat(p, "[\\s\\S]*?>[\\s\\S]*?<\\/h").concat(p, ">"), "g"), P = new RegExp("<h".concat(p, "[\\s\\S]*?>([\\s\\S]*?)<\\/h").concat(p, ">"), "g"), C = d.split(x), G = d.match(P) || [];
      G.length > 0 && (l.value = !0);
      for (let $ = 0; $ < C.length; $++) {
        const j = "title_".concat(se());
        a.push(j), v.push({
          id: j,
          title: G[$ - 1],
          level: p,
      ...
      var d;
      if (a = [], i = [], l.value = !1, k.value = [], N.value = [], f.value === "HTML" && m.value && typeof m.value == "string") {
        const p = ((d = m.value.match(/src="([^"]+)"/g)) == null ? void 0 : d.map((v) => v.slice(5, -1))) || [];
        N.value = p, k.value = z(m.value, 1);
      }
    }, q = (d) => {
      ...
      I.value = !I.value;
    }, K = (d) => d.map((p) => [p.title ? A("p", {
      id: p.id,
      innerHTML: p.title
    }, null) : null, p.children && p.children.length > 0 ? K(p.children) : A("p", {
      innerHTML: p,
      onClick: M
    }, null)]), V = (d) => {
      const p = />(.*?)</g;
      return (d.match(p) || []).map((x) => x.slice(1, -1)).join("");
    }, D = (d) => d.map((p) => A("div", {
      class: [n.bem("ancho", "title-item", "text")]
    }, [p.title ? A("p", {
      class: [n.bem("ancho", "title-item", "text-title"), n.bem("ancho", "title-item", "text-".concat(p.level)), n.is("ancho-select", T.value === p.id)],
      title: V(p.title),
      innerHTML: p.title,
      onClick: () => q(p.id)
    }, null) : null, p.children && p.children.length > 0 ? D(p.children) : null])), O = (d) => {
      (d.key === "Escape" || d.keyCode === 27) && (t.value = !1, d.stopPropagation(), d.preventDefault());
    }, M = async (d) => {
      var p, v;
      if (d && d.target instanceof HTMLElement && (d.target.tagName === "IMG" || d.target.tagName === "A"))
        if (d.target.tagName === "A") {
          const x = d.target.getAttribute("href") || "";
          if (x.startsWith("redirect://tree#")) {
            d.stopPropagation(), d.preventDefault();
            const P = x.indexOf("#");
            if (P > -1) {
              const C = x.slice(P + 1);
              if (C) {
                const G = (v = ((p = e.controller) == null ? void 0 : p.parent).form) == null ? void 0 : v.view.parentView;
                if (G) {
                  const $ = G.getController("treeexpbar"), j = $.navStack[0] || ($ == null ? void 0 : $.xDataController.state.selectedData[0]);
                  if (j) {
                    const {
                      _id: te
                    } = j;
                    await ($ == null ? void 0 : $.xDataController).expandNodeByKey([te]);
                  }
                  const ee = $ == null ? void 0 : $.xDataController.state.items.find((te) => {
                    var re;
                    return ((re = te._deData) == null ? void 0 : re.srfkey) === C;
                  });
                  ee && ($.xDataController.setActive(ee), $.xDataController.setSelection([ee]));
                }
              }
            }
          }
          ...
          d.stopPropagation(), d.preventDefault();
          const x = d.target.getAttribute("src") || "";
          if (x) {
            const C = N.value.indexOf(x);
            R.value = C;
          }
          t.value = !0, await ne();
          const P = document.querySelector(".el-image-viewer__wrapper");
          P && P.addEventListener("keydown", O);
        }
    }, H = () => {
      t.value = !1;
    }, U = async (d) => {
      const p = d.target.getAttribute("markerClick"), v = d.target.getAttribute("params");
      if (!p || !v) {
        d.stopPropagation();
        return;
      }
      r("itemClick", d, JSON.parse(v));
    }, Q = async () => {
      L.disconnect(), await ne(), a.forEach((d) => {
        const p = document.querySelector("#".concat(d));
        p && L.observe(p);
      });
    }, W = async () => {
      await ne(), _e.highlightAll();
    };
    return w(), Z(), ue(() => e.content, (d, p) => {
      d !== p && (y.value = d, w(), Z(), Q(), W());
    }, {
      immediate: !0
    }), {
      ns: n,
  ...
  setup(e, {
    ...
    var m, I, k, T, N, R;
    const n = ce("raw"), s = e.controller, o = s.model, f = B(""), y = B(""), u = B("");
    let g = "TEXT", E = "";
    o.contentType && (g = o.contentType), (m = o.editorParams) != null && m.contenttype && (g = (I = o.editorParams) == null ? void 0 : I.contenttype), (k = o.editorParams) != null && k.template && (E = o.editorParams.template.replaceAll("//n", "\n")), (T = o.editorParams) != null && T.TEMPLATE && (E = o.editorParams.TEMPLATE.replaceAll("//n", "\n")), (N = o.editorParams) != null && N.TITLE && (y.value = e.data[o.editorParams.TITLE]), (R = o.editorParams) != null && R.PARSESCRIPT && (u.value = o.editorParams.PARSESCRIPT);
    const b = Ee(() => !!(e.controlParams && e.controlParams.editmode === "hover"));
    return ue(() => e.value, async (t, a) => {
...
class Te extends he {
  constructor() {
     ...
     */
    Y(this, "linkViewId", "plmweb.recent_redirect_view");
    /**
     * @description 图标代码表标识
     * @type {string}
     * @memberof CommentItemRawItemEditorController
     */
    Y(this, "iconCodeListId", "plmweb.base__recent_visite");
    /**
     * @description 代码表数据
     * @type {readonly}
     * @memberof CommentItemRawItemEditorController
     */
    Y(this, "codeListItems", []);
  }
  async onInit() {
    await super.onInit();
    const {
  ...
  handleClick(n, s) {
    if (!s.owner_type)
      return;
    const o = this.context.clone(), f = ve(this.params);
    o.srfkey = s.id, s.owner_subtype === "page" ? f.article_page = s.owner_id : f[s.owner_subtype] = s.owner_id, f[s.owner_type] = s.recent_parent, delete s.script, delete s.icon, delete s.id, Object.assign(f, s), s && this.linkViewId && ibiz.commands.execute(me.TAG, this.linkViewId, o, f);
  }
}
class ke {
  constructor() {
    Y(this, "formEditor", "AnchoHtml");
    Y(this, "gridEditor", "AnchoHtml");
  }
...
const xe = new be(import.meta.url);
class Re {
  /**
    ...
    return new Promise((r, n) => {
      if (this.getMathJax())
        ...
        const o = [this.loadScript(
          // 插件中使用 resource.dir
          xe.dir("assets/mathjax/plugins/js/tex-svg.js")
          // 模板中使用
...
const Pe = {
  install(e) {
    e.component(ae.name, ae), e.component(oe.name, oe), ye("EDITOR_CUSTOMSTYLE_ANCHO_HTML", () => new ke());
  }
};
export {
  Pe as default
