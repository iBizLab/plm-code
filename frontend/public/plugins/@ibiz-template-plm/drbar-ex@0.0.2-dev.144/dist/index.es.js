...
import { ControlController as w, Srfuf as B, calcNavParams as N, hasSubRoute as D, registerControlProvider as x, ControlType as S } from "@ibiz-template/runtime";
import { route2routePath as c, useControlController as y, useNamespace as E, getNestedRoutePath as V, onRouteChange as G, withInstall as j } from "@ibiz-template/vue3-util";
import { defineComponent as O, watch as A, createVNode as v, resolveComponent as I, isVNode as T } from "vue";
import { useRouter as z, useRoute as C } from "vue-router";
class L extends w {
  constructor() {
    super(...arguments);
    /**
  ...
  handleSelectChange(t, e = !1) {
    ...
    i ? (this.setVisible("navPos"), this.openNavPosView(i, e)) : (this.setVisible("form"), this.routeDepth && this.router.push(this.state.drBarItems[0].fullPath)), this.state.selectedItem = t;
  }
  /**
   * 设置显示状态
   *
...
const g = /* @__PURE__ */ O({
  ...
  setup(o) {
    const s = y((...r) => new L(...r)), t = E("control-".concat(s.model.controlType.toLowerCase(), "-ex")), e = z();
    s.setRouter(e);
    const a = C();
    return q(s), A(() => e.currentRoute.value, (r, n) => {
      var u, h;
      if (s.routeDepth && s.navPos) {
        const {
          ...
          pathNodes: p
        } = c(n), l = V(a, s.routeDepth + 1), f = ((u = d[s.routeDepth + 1]) == null ? void 0 : u.viewName) === "route-modal" || ((h = p[s.routeDepth + 1]) == null ? void 0 : h.viewName) === "route-modal";
...
const _ = j(
  g,
  function(o) {
    o.component(g.name, g), x(S.DRBAR, () => new M());
  }
), H = {
...
export {
  L as DRBarExController,
  _ as IBizDRBarExControl,
  H as default
};
