...
import { useClickOutside as X, useNamespace as B, withInstall as ne } from "@ibiz-template/vue3-util";
import { Srfuf as _, GridFieldEditColumnController as Fe, GridRowState as Oe, UIActionUtil as Be, SysUIActionTag as q, TreeGridExNodeColumnController as _e, TreeGridExRowState as le, TreeGridExFieldColumnController as re, registerGridColumnProvider as Ue, registerTreeGridExColumnProvider as $e } from "@ibiz-template/runtime";
import { computed as i, ref as b, reactive as R, defineComponent as W, onMounted as se, onUnmounted as He, createVNode as s, resolveComponent as v, h as Y, isVNode as qe } from "vue";
...
const j = /* @__PURE__ */ W({
  ...
  setup(e) {
    ...
    se(() => {
      e.row.data.srfuf === _.CREATE && Q(!0), r.value && (k = X(r, async () => {
        y || (n.hasDropdown = !1, J.onBlur());
      }));
    }), He(() => {
      k && k.stop && k.stop();
    });
    const ue = (t) => {
    ...
    }, fe = i(() => n.getCustomHtml(e.row)), F = i(() => e.row.uiActionGroupStates[n.model.codeName]), O = i(() => e.row.data[e.controller.model.codeName.toLowerCase()]), Z = i(() => n.formatValue(O.value)), U = b(void 0), ve = (t) => {
      U.value = t;
    }, he = i(() => {
      if (e.controller.grid.overflowMode === "ellipsis" && ae(O.value) && O.value !== "")
        return U.value ? U.value : Z.value + (e.controller.model.unitName || "");
    }), we = (t, d) => {
      const c = {
        ...d
      };
      ...
      if (g.cancel || (a.value = !1), I.value = !1, g.closeView)
        ...
        switch (g.refreshMode) {
          case 1:
            c.view.callUIAction(q.REFRESH);
            break;
          case 2:
            (S = c.view.parentView) == null || S.callUIAction(q.REFRESH);
            break;
          case 3:
            (A = c.view.getTopView()) == null || A.callUIAction(q.REFRESH);
            break;
        }
    }, Ce = async (t, d, c) => {
      ...
      ["TEXTBOX", "PASSWORD", "TEXTAREA", "TEXTAREA_10", "NUMBER", "SOLIDER", "STEPPER"].includes(S) || (H(), a.value = !1);
    }, ge = () => {
      H(), a.value = !1, n.grid.saveAll();
    }, be = (t) => {
      var A, oe;
      ...
      return t.editorProvider && Y(v(t.editorProvider.gridEditor), {
        class: l.e("editor"),
  ...
  render() {
    ...
    const o = s(v("iBizGridEditItem"), {
      ...
      default: () => [e.editorProvider && Y(v(e.editorProvider.gridEditor), {
...
const tt = /* @__PURE__ */ W({
  ...
  render() {
    return s(v("iBizGridEditItem"), {
      ...
      default: () => [this.controller.editorProvider && Y(v(this.controller.editorProvider.gridEditor), {
        class: this.ns.e("editor"),
        value: this.fieldValue,
        data: this.row.data,
