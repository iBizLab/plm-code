...
import { ref as k, defineComponent as we, computed as Z, reactive as Ee, watch as ee, nextTick as xe, resolveComponent as v, onMounted as be, onUnmounted as Ce, withDirectives as Te, createVNode as h, resolveDirective as Me, isVNode as Re, createTextVNode as te } from "vue";
...
class Oe extends Ne {
  ...
  updateTreeNode({
    ...
    if (!n || n === this.state.editingNodeKey || d)
      return;
    const a = w(n, this), s = this.getNodeModel(a._nodeId);
      ...
      await ye(
        a.map(async (m) => {
          if (m.srfuf !== _e.CREATE) {
            const D = o.clone();
            D[l] = m.srfkey, await await ibiz.hub.getApp(s.appId).deService.exec(
              s.appDataEntityId,
              "remove",
              D,
              a,
...
const j = /* @__PURE__ */ we({
  ...
  setup() {
    const e = ve((...t) => new Oe(...t)), N = Z(() => e.context.srfreadonly === !0 || e.context.srfreadonly === "true"), n = Ee({});
    e.evt.on("onCreated", () => {
    ...
    const m = async () => {
      if (e.state.editingNodeKey)
        if (e.state.editingNodeText) {
          const t = w(e.state.editingNodeKey, e);
    ...
    const se = v("IBizRawItem"), O = v("IBizIcon"), U = (t, i, r, u) => {
      ...
      return r.clickTBUIActionItem && r.onlyOneActionItem ? null : h(v("iBizContextMenuControl"), {
        ...
        nodeData: i,
        context: e.context,
        onActionClick: (c, E) => e.doUIAction(c.uiactionId, i, E, c.appId)
      }, null);
    }, P = (t, i) => {
      const r = w(t._uuid, e);
      if (!r)
      ...
      const u = w(t.data._uuid, e), p = w(i.data._uuid, e);
      return e.calcAllowDrop(u, p, r);
    }, H = (t) => {
      const i = w(t.data._uuid, e);
      return e.calcAllowDrag(i);
    }, q = (t, i, r) => {
      const u = Ae(r), p = w(t.data._uuid, e), c = w(i.data._uuid, e);
      e.onNodeDrop(p, c, u);
    }, z = (t) => {
      ...
      renderTree: () => h("div", {
        ...
        default: ({
          ...
          return u ? p = h(v("iBizControlShell"), {
            ...
            class: [o.b("node"), o.is("hidden", Object.is(e.hiddenNodeId, i._nodeId) && !e.isFilter.value), i._leaf ? o.be("node", "item") : o.be("node", "group"), (E = r.sysCss) == null ? void 0 : E.cssName]
          }, [p, W(r), $(r, i)]), J(i)];
        }
      }), J()])])
    };
