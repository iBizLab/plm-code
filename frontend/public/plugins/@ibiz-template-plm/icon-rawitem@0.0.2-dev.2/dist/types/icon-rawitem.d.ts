...
export declare const IconRawItem: import("vue").DefineComponent<{
    value: (ArrayConstructor | StringConstructor | NumberConstructor)[];
    controller: import("@ibiz-template/vue3-util").RequiredProp<import("vue").PropType<IconRawItemEditorController>, undefined, undefined>;
