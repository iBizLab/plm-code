...
var n = (i, t, s) => (v(i, typeof t != "symbol" ? t + "" : t, s), s);
...
import { defineComponent as I, ref as d, createVNode as e, resolveComponent as b } from "vue";
class p extends f {
  constructor() {
    super(...arguments);
    /**
     * 标题
     */
    n(this, "caption", this.panel.view.state.caption);
    /**
     * 编号
     */
    n(this, "titleNumnber", "");
  ...
  async onInit() {
    super.onInit(), this.panel.view.evt.on(
      ...
      ({ caption: s, dataInfo: l }) => {
        ...
        this.titleNumnber = "";
        const r = this.panel.view.ctx.controllersMap.get("form");
        r && (this.titleNumnber = r.state.data[o]), this.caption = "".concat(this.panel.view.state.caption).concat(this.titleNumnber ? "-".concat(this.titleNumnber) : ""), ibiz.util.setBrowserTitle(this.caption);
      }
    );
  }
}
class T {
  constructor() {
    n(this, "component", "IdentifierTitle");
  }
...
const c = /* @__PURE__ */ I({
  ...
  setup() {
    const i = g("identifier-title"), t = d(!1), s = d(!1);
    let l, o;
    return {
      ns: i,
      copyIdSuccess: t,
      copyUrlSuccess: s,
      copy: (u, a) => {
        const h = ibiz.util.text.copy(u);
        clearTimeout(a === "id" ? l : o), h ? (ibiz.message.success("拷贝成功!"), a === "id" ? (t.value = !0, l = setTimeout(() => {
          t.value = !1;
