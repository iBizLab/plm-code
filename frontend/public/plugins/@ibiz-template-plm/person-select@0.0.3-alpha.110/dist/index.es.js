...
import { defineComponent as pe, ref as S, onMounted as he, watch as w, createVNode as n, computed as J, onBeforeUnmount as rt, resolveComponent as C, mergeProps as nt, withDirectives as ot, resolveDirective as ut, createTextVNode as O, nextTick as ct, isVNode as dt } from "vue";
import { isArray as pt } from "lodash-es";
class ht extends et {
  constructor() {
    super(...arguments);
    /**
...
function gt(r) {
  return typeof r == "function" || Object.prototype.toString.call(r) === "[object Object]" && !dt(r);
}
const W = /* @__PURE__ */ pe({
  name: "PersonelSelect",
  props: Xe(),
  ...
  setup(r, {
    ...
    const me = J(() => !!(r.controlParams && r.controlParams.editmode === "hover")), Y = (t) => {
      ...
      j = vt.calcSelItemRenderNum(t, G.value), h.value = "", Y(f.value);
    };
    w(() => r.value, (t) => {
    ...
    const te = async (t) => {
    ...
    }, [ie(o.value)])]), _e = () => ot(n("div", {
      class: s.b("select-modal"),
      onPointerdown: k,
      onPointerup: k,
      onClick: k
    }, [Te(), De(), v.value === "user" ? ie(u.value) : Be()]), [[ut("loading"), M.value]]), re = () => n("div", {
      ...
      (i !== e.copyUserUrl || l !== e.copyDeptUrl || r.data && r.data.srfkey !== Z.value) && (Z.value = ((c = r.data) == null ? void 0 : c.srfkey) || "", u.value = [], o.value = [], e.resetState(), T(!0)), await ct(), (y = K.value) == null || y.focus();
    }, Je = () => A.value ? ne() : re(), We = () => {
      x.value = !1;
    };
    w(() => r.readonly, (t) => {
