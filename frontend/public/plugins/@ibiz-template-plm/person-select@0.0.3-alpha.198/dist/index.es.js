...
var Ye = (n, h, a) => h in n ? Xe(n, h, { enumerable: !0, configurable: !0, writable: !0, value: a }) : n[h] = a;
var p = (n, h, a) => (Ye(n, typeof h != "symbol" ? h + "" : h, a), a);
import { useNamespace as K, getDataPickerProps as qe, getEditorEmits as Qe, renderString as et, withInstall as tt } from "@ibiz-template/vue3-util";
import { EditorController as st, getDeACMode as at, UIActionUtil as it, OpenAppViewCommand as de, PluginStaticResource as lt, registerEditorProvider as rt } from "@ibiz-template/runtime";
import { RuntimeModelError as J } from "@ibiz-template/core";
import { mergeDeepLeft as nt, clone as pe } from "ramda";
import { notNilEmpty as R } from "qx-util";
import { defineComponent as he, ref as S, onMounted as me, watch as O, createVNode as o, computed as W, onBeforeUnmount as ot, resolveComponent as C, mergeProps as ut, withDirectives as ct, resolveDirective as dt, createTextVNode as N, nextTick as pt, isVNode as ht } from "vue";
...
class ft extends st {
  ...
  async onInit() {
    var u, e, c, r;
    if (super.onInit(), this.initDefaultAttribute(), this.valueItem = ((u = this.model.valueItemName) == null ? void 0 : u.toLowerCase()) || "", this.initParams(), await this.getOperatorUserList(), this.model.appDataEntityId && (this.model.appDEDataSetId && (this.interfaceName = this.model.appDEDataSetId), this.model.appDEACModeId && (this.deACMode = await at(
  ...
  async onActionClick(a, u, e) {
    ...
    let r = {};
    this.parent.form ? r = this.parent.form.ctx.view : this.parent.grid && (r = this.parent.grid.ctx.view), await it.execAndResolved(
      c,
      {
  ...
  async getServiceData(a, u, e, c) {
    ...
    const y = this.fill(this.userUrl, r, m, u).replaceAll(
      "//",
      "/"
    ), F = this.fill(this.deptUrl, r, m, u).replaceAll(
      "//",
      "/"
    );
    this.copyUserUrl = y, this.copyDeptUrl = F;
    let f = "post";
    const g = {};
    if (a === "user" ? (P = y, f = this.userMethod.toLowerCase(), f === "get" ? Object.assign(g, { method: f, params: b }) : Object.assign(g, { method: f, data: b })) : (P = F, f = this.deptMethod.toLowerCase(), f === "get" ? Object.assign(g, { method: f, params: b }) : Object.assign(g, { method: f, data: b })), P)
...
const gt = /* @__PURE__ */ he({
  ...
  setup(n, {
    ...
    const a = K("virtual-list"), u = S(36), e = S(), c = S([]), r = S(0), m = S(0), v = S(0), b = S(0), P = () => {
      ...
      b.value = e.value.scrollTop, P(), F(u.value, b.value);
    }, F = (f, g) => {
      h("scrollEvent", f, g);
    };
    return me(() => {
...
class bt {
  ...
  static calcSelItemRenderNum(h, a) {
    ...
    if (a && (h == null ? void 0 : h.length) > 0) {
      const e = (a == null ? void 0 : a.offsetWidth) || 0, c = window.getComputedStyle(a), r = parseInt(c.marginLeft, 10), m = parseInt(c.marginRight, 10), v = parseInt(c.paddingLeft, 10), b = parseInt(c.paddingRight, 10), P = r + m + v + b, y = 30, F = 28, f = 8, g = (F + f) * h.length;
...
function St(n) {
  return typeof n == "function" || Object.prototype.toString.call(n) === "[object Object]" && !ht(n);
}
const Z = /* @__PURE__ */ he({
  name: "PersonelSelect",
  props: qe(),
  ...
  setup(n, {
    ...
    const a = K("picker-dropdown"), u = K("personel-select"), e = n.controller, c = S(""), r = S([]), m = S([]), v = S(""), b = S(!1), P = S(!1), y = S(""), F = S([]), f = S("user"), g = S([]), A = S(!1), $ = S(!1), D = S(!1), G = S(""), X = S(), j = S(), Y = S();
    let x;
    const z = S(), q = S([]);
    let U = 0;
    const fe = W(() => !!(n.controlParams && n.controlParams.editmode === "hover")), ve = (t) => /^https?:|^http?:|^data:image|(\.png$|\.svg|\.jpg|\.png|\.gif|\.psd|\.tif|\.bmp|\.jpeg)$/.test(t), Q = (t) => {
      const s = [], i = [];
      g.value = [], t.forEach((l) => {
        var E, M;
        const d = pe(l);
      ...
      x != null && x.value && x.value.hide(), j.value && j.value.hide();
    }, Se = (t) => {
      ...
      U = bt.calcSelItemRenderNum(t, Y.value), v.value = "", Q(g.value);
    };
    O(() => n.value, (t) => {
    ...
    const Ee = W(() => n.data && n.data[e.valueItem] || void 0);
    O(Ee, (t, s) => {
    ...
    const te = (t) => {
      ...
      if (e.multiple) {
        ...
        }), e.valueItem && (f.value === "user" ? h("change", s[e.userFilterMap.id], e.valueItem) : h("change", s[e.deptFilterMap.id], e.valueItem)), e.model.valueType === "OBJECT" ? h("change", e.handleObjectParams(s)) : e.valueType === "OBJECTS" ? (g.value = [ge(s)], L()) : f.value === "user" ? h("change", t[e.userFilterMap.name]) : h("change", t[e.deptFilterMap.name]), D.value = !1;
      }
      ...
      try {
        ...
        i && (f.value === "user" ? r.value.length === 0 ? r.value = i.data : Pe(i.data, e.userFilterMap.id) : m.value.length === 0 ? m.value = i.data : m.value.push(...i.data));
      } catch (i) {
        A.value = !1;
      }
      A.value = !1;
    ...
    const ae = async (t) => {
    ...
    }, Fe = (t) => /[\u4E00-\u9FA5]/.test(t), we = (t) => /[\u4e00-\u9fa5]+.*[a-zA-Z]+|[a-zA-Z]+.*[\u4e00-\u9fa5]+/.test(t), B = (t) => {
      if (!t)
        return "";
      let s = 0;
      ...
      if (ve(t))
        ...
        try {
          ...
          console.error("解析头像数据失败", d);
        }
        if (i.length === 0)
          return null;
        const {
          downloadUrl: l
        } = ibiz.util.file.calcFileUpDownUrl(e.context, e.params, n.data, e.editorParams);
        s = l.replace("%fileId%", i[0].id);
      }
      return o("img", {
      ...
      const i = e.getUserPictureUrl(t, s), l = Ve(i);
      return i && !q.value.includes(i) && l ? l : ke(s);
    }, le = (t) => {
    ...
    }, _e = (t) => y.value ? F.value : t, k = (t) => {
      t.preventDefault(), t.stopPropagation();
    }, Be = (t, s) => {
      $.value && (f.value === "user" ? t - s < 305 && (A.value || T()) : t - s < 250 && (A.value || T()));
    }, re = (t) => {
      var d, E;
      const s = ((d = e.model.uiactionGroup) == null ? void 0 : d.uiactionGroupDetails) || [], i = _e(t), l = (E = e.deACMode) == null ? void 0 : E.itemLayoutPanel;
      return o(gt, {
        items: i,
        itemHeight: 36,
        ...
        onScrollEvent: (M, w) => Be(M, w)
      }, {
        default: (M) => l ? ze(M, l) : le(M)
      });
    }, ne = (t) => {
      b.value = t;
    }, He = () => o("div", {
    ...
    }, [re(m.value)])]), Je = () => ct(o("div", {
      class: a.b("select-modal"),
      onPointerdown: k,
      onPointerup: k,
      onClick: k
    }, [Ce(), Ue(), f.value === "user" ? re(r.value) : He()]), [[dt("loading"), A.value]]), oe = () => o("div", {
      ...
      if (e.multiple) {
        ...
        const l = [];
        if (v.value) {
          let d = v.value.split(e.separator), E = I.value.split(e.separator);
        ...
        return e.defaultAttentionValue && e.valueType === "OBJECTS" && U > 0 && (i = U < ((s = g.value) == null ? void 0 : s.length), l == null || l.splice(U, l == null ? void 0 : l.length)), o("div", {
      ...
      return o("div", {
        ...
        style: "background-color:".concat(B(I.value))
      }, [H(v.value, I.value)]), o("div", {
        class: a.be("select-value", "text")
      }, [o("div", {
        class: a.bem("select-value", "text", "label")
      }, [I.value])]), n.readonly || n.disabled ? null : o("i", {
      ...
      (i !== e.copyUserUrl || l !== e.copyDeptUrl || n.data && n.data.srfkey !== G.value) && (G.value = ((d = n.data) == null ? void 0 : d.srfkey) || "", r.value = [], m.value = [], e.resetState(), T(!0)), await pt(), (E = X.value) == null || E.focus();
    }, Ze = () => I.value ? ue() : oe(), Ke = () => {
      $.value = !1;
    };
    O(() => n.readonly, (t) => {
    ...
    return me(() => {
      be(), window == null || window.addEventListener("resize", ce), _();
    }), ot(() => {
