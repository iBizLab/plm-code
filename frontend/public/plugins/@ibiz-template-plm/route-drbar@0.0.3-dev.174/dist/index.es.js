...
var H = (a, l, t) => l in a ? Y(a, l, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[l] = t;
var I = (a, l, t) => (H(a, typeof l != "symbol" ? l + "" : l, t), t);
import { ControlController as x, Srfuf as V, calcItemVisibleByCounter as N, calcItemVisible as E, OpenAppViewCommand as T, calcNavParams as k, hasSubRoute as D, CounterService as A, registerControlProvider as O } from "@ibiz-template/runtime";
import { getNestedRoutePath as P, route2routePath as C, routePath2string as _, useControlController as z, useNamespace as j, withInstall as M } from "@ibiz-template/vue3-util";
import { createVNode as f, defineComponent as L, reactive as q, onUnmounted as F, watch as y, resolveComponent as b, createTextVNode as Q, isVNode as U } from "vue";
import { useRouter as K, useRoute as G } from "vue-router";
import { isNil as W } from "ramda";
class X extends x {
  constructor() {
    super(...arguments);
    /**
  ...
  calcItemStateByCounter(t, s = !0) {
    if (this.state.drBarItems.forEach((e) => {
      ...
      const { visible: e, defaultVisibleItem: n } = this.getItemVisibleState(
        this.state.selectedItem
      );
      !e && n && this.handleSelectChange(n.tag);
    }
  }
  /**
   * 获取对应项的显示状态
  ...
  getItemVisibleState(t) {
    let s = !0, e;
    return this.state.drBarItems.forEach((n) => {
      if (n.children) {
        e || (e = n.children.find((o) => o.visible));
        const i = n.children.find((o) => o.tag === t);
        i && (s = !!i.visible);
      } else
        !e && n.visible && (e = n), n.tag === t && (s = !!n.visible);
    }), {
      visible: s,
  ...
  async calcPermitted(t) {
    var i;
    let s = !0;
    const e = (i = this.getData()) != null && i.length ? this.getData()[0] : void 0, n = await E(
      t,
      this.context,
      this.params,
  ...
  async onMounted() {
    ...
    await super.onMounted(), this.form ? (this.form.evt.on("onLoadSuccess", async (s) => {
      var n;
      const e = (n = s.data) == null ? void 0 : n[0];
  ...
  initDRBarItems() {
    ...
    const n = (i) => {
      let o = i.caption;
      i.capLanguageRes && (o = ibiz.i18n.t(i.capLanguageRes.lanResTag, i.caption));
      const { enableMode: h, testAppDELogicId: c, testScriptCode: u } = i;
      return {
        tag: i.id,
        caption: o,
        sysImage: i.sysImage,
    ...
    s && t && (s.length === 1 ? t.forEach((i) => {
      ...
      if (o.length > 1 || ((h = this.controlParams) == null ? void 0 : h.singleitemgroup) === "true" && o.length === 1) {
        let c = i.caption;
        i.capLanguageRes && (c = ibiz.i18n.t(
          ...
          visible: !1,
          // 默认不显示
          children: o.map((u) => n(u))
        });
      } else
        o.length === 1 && e.push(n(o[0]));
  ...
  handleSelectChange(t = this.state.defaultItem, s = !1) {
    ...
    if (this.state.selectedItem === t)
      return;
    const e = (n = this.model.dedrctrlItems) == null ? void 0 : n.find((i) => i.id === t);
    if (e && this.routeItems.includes(t)) {
      const { context: i, params: o } = this.prepareParams(e);
      Object.assign(i, {
   ...
   */
  prepareParams(t) {
    const { navigateContexts: s, navigateParams: e } = t, n = {
      navContexts: s,
      navParams: e
    }, i = {
      ...
      params: this.params,
      data: this.getData()[0]
    }, { resultContext: o, resultParams: h } = k(n, i), c = Object.assign(this.context.clone(), o), u = { ...this.params, ...h };
  ...
  async openNavPosView(t, s = !1) {
    var i;
    const { context: e, params: n } = this.prepareParams(t);
  ...
  doDefaultSelect() {
    ...
    if (this.routeDepth && this.state.srfnav && (e = this.state.srfnav), e) {
      const o = !!this.routeDepth && D(this.routeDepth), { visible: h, defaultVisibleItem: c } = this.getItemVisibleState(e);
      !h && c ? (e = c.tag, this.handleSelectChange(e)) : this.handleSelectChange(e, o);
    }
  }
  /**
   * 初始化计数器
  ...
  async initCounter() {
    ...
    if (s) {
      ...
      this.counter = await A.getCounterByRef(
        s,
        this.context,
        n ? { srfcustomtag: n, ...this.params } : { ...this.params }
...
const R = /* @__PURE__ */ L({
  ...
  setup(a) {
    const l = z((...r) => new X(...r)), t = j("route-drbar-control"), s = K(), e = q({}), n = (r) => {
      Object.assign(e, r);
    };
    l.evt.on("onCreated", () => {
      l.counter && l.counter.onChange(n, !0);
    }), F(() => {
      var r;
      (r = l.counter) == null || r.offChange(n);
    }), l.setRouter(s);
    const i = (r) => {
    ...
    }), l.routeDepth && (h = P(o, l.routeDepth)), y(() => o.fullPath, (r, g) => {
      if (r !== g) {
        const m = l.routeDepth;
        if (m && P(o, l.routeDepth) === h) {
          const d = C(o), {
            srfnav: v
          } = d.pathNodes[m - 1];
      ...
      if (r.visible) {
        ...
        return f(b("el-menu-item"), {
          ...
          default: () => [f(b("iBizIcon"), {
            class: t.e("icon"),
            icon: r.sysImage
          }, null), f("span", null, [r.caption]), r.counterId && e[r.counterId] && f(b("iBizBadge"), {
            class: t.e("counter"),
            value: e[r.counterId]
          }, null)]
        });
  ...
  render() {
    ...
    return f(b("iBizControlBase"), {
      ...
      default: () => {
        var i, o;
        return [l && n && [this.c.enableBack && this.c.viewId && f("div", {
          ...
          class: [this.ns.e("menu"), !((o = (i = t[0]) == null ? void 0 : i.children) != null && o.length) && this.ns.em("menu", "signal")],
          mode: this.showMode,
          "default-active": s || e,
          onSelect: this.handleSelect,
          "default-openeds": this.opens
        }, tt(a = t.map((h) => this.renderMenuItems(h))) ? a : {
          default: () => [a]
        })]];
      }
    });
...
const st = M(R, function(a) {
  a.component(R.name, R), O("CUSTOM_ROUTE_DRBAR", () => new et());
});
class at extends x {
  constructor() {
    super(...arguments);
  ...
  getItemVisibleState(t) {
    let s = !0, e;
    return this.state.drTabPages.forEach((n) => {
      !e && !n.hidden && (e = n), n.tag === t && (s = !n.hidden);
    }), {
      visible: s,
      defaultVisibleItem: e
    };
  ...
  initDRTabPages() {
    ...
    let c = t;
    s && (c = ibiz.i18n.t(s.lanResTag, t)), e ? this.state.defaultName = (o == null ? void 0 : o[0].id) || "" : (h.push({
      tag: i,
      caption: c,
      hidden: !!e,
      disabled: !1,
    ...
    }), this.state.defaultName = ""), o == null || o.forEach((d) => {
      let v = d.caption;
      d.capLanguageRes && (v = ibiz.i18n.t(d.capLanguageRes.lanResTag, d.caption));
      const { enableMode: w, dataAccessAction: S, testAppDELogicId: J, testScriptCode: $ } = d;
      h.push({
        tag: d.id,
        caption: v,
        sysImage: d.sysImage,
  ...
  handleTabChange(t = !1, s) {
    var i;
    const { activeName: e } = this.state, n = (i = this.model.dedrtabPages) == null ? void 0 : i.find(
      (o) => o.id === e
    );
    n ? (this.setVisible("navPos"), this.openNavPosView(n, t, s)) : (this.setVisible("form"), this.routeDepth && this.state.drTabPages[0] && this.router.push(this.state.drTabPages[0].fullPath));
  }
  /**
   * 设置显示状态
   *
  ...
  prepareParams(t) {
    const { navigateContexts: s, navigateParams: e } = t, n = {
      ...
      params: this.params,
      data: this.getData()[0]
    }, { resultContext: o, resultParams: h } = k(n, i), c = Object.assign(this.context.clone(), o, {
      currentSrfNav: t.id
    }), u = { ...this.params, ...h };
    return { context: c, params: u };
  }
...
const B = /* @__PURE__ */ L({
  ...
  setup() {
    const a = z((...c) => new at(...c)), l = j("route-drtab-control"), t = K(), s = q({}), e = (c) => {
      Object.assign(s, c);
    };
    a.evt.on("onCreated", () => {
    ...
    const n = () => {
      ...
      if (u) {
        const d = (g = C(o).pathNodes[a.routeDepth]) == null ? void 0 : g.viewName, v = (m = u.appViewId) == null ? void 0 : m.split(".")[1];
        if (v && d && v === d)
          return;
      }
    ...
    let h = "";
    return a.routeDepth && (h = P(o, a.routeDepth)), y(() => t.currentRoute.value, (c, u) => {
      var r, g;
      if (a.routeDepth && a.navPos) {
        const {
          ...
          pathNodes: p
        } = C(u), d = P(u, a.routeDepth + 1), v = P(o, a.routeDepth + 1);
        if (d === v)
          return;
  ...
  render() {
    ...
    return f(b("iBizControlBase"), {
      ...
      default: () => [l && s && f(b("el-tabs"), {
        ...
        const n = e.counterId ? this.counterData[e.counterId] : void 0;
...
const ot = M(B, function(a) {
  a.component(B.name, B), O("CUSTOM_ROUTE_DRTAB", () => new nt());
}), ft = {
  install(a) {
    a.use(st), a.use(ot);
  }
