...
var G = (r, e, l) => e in r ? j(r, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : r[e] = l;
var k = (r, e, l) => (G(r, typeof e != "symbol" ? e + "" : e, l), l);
...
class ae extends O {
   ...
   */
  async getDENodeDatas(e, l, c, i) {
    const { appDEDataSetId: C, appDataEntityId: g, appId: h } = e, { context: v, params: p, navContext: E, navParams: L } = l ? this.getNodeRSFilterParams(l, c, i) : {
      context: i.context,
      params: i.params,
      navContext: {},
      navParams: {}
    ...
    if (e.userTag === "CUSTOM" && e.treeNodeType === "DE") {
      ...
      m && (o = c && c._deData ? c._deData["".concat(e.id)].content || [] : [], o = o.map((f) => new P(m, f)));
    } else
      o = (await this.app.deService.exec(
        g,
        C,
        v,
        p
      )).data;
    return o && o.length > 0 ? o.map((f, b) => {
...
class re extends V {
   ...
   */
  async initService() {
    this.service = new ae(this.model), await this.service.init(this.context);
  }
}
function S(r) {
...
const _ = /* @__PURE__ */ W({
  ...
  setup() {
    var B;
    const r = q((...t) => new re(...t)), e = K("track-tree-grid"), l = A(!1), c = D(() => r.state.isLoaded ? r.state.rootNodes.reduce((t, a) => a._children ? t.concat(a._children) : t, []) : []), i = A([]);
    r.model.detreeNodes && (i.value = (B = r.model.detreeNodes) == null ? void 0 : B.filter((t) => t.treeNodeType === "STATIC" && !t.rootNode).map((t) => {
      let a = !1;
      if (t.userTag) {
        const [s, d] = t.userTag.split("=");
        s === "ENABLESETTING" && (a = d === "true");
      }
      return {
        ...t,
        enableSetting: a,
    ...
    const C = D(() => (c.value[0] || {})._children || []), g = (t, a) => {
      a.stopPropagation(), !t._disableSelect && r.onTreeNodeClick(t, a);
    }, h = (t, a) => {
      a.stopPropagation(), !t._disableSelect && r.onDbTreeNodeClick(t);
    }, v = (t) => {
      var a;
      Object.assign(t, {
        _expanded: !t._expanded
      }), (a = t._children) == null || a.forEach((s) => {
        v(s);
      });
    }, p = (t) => {
      var a;
      ...
      const a = r.getNodeModel(t._nodeId) || {}, s = Y(a);
      ...
      const s = a._children || [];
      return n("div", {
        class: [e.e("row"), e.is("expand", a._expanded)]
      }, [n("div", {
        ...
        const w = s.find((x) => x._nodeId === d.id) || {};
        return d.visible && d.enableSetting && b(w);
      })])]);
    }, I = (t, a) => n("div", {
    ...
    }, [a.map((s) => y(t, s))])]), F = (t) => n("div", {
      class: e.e("header"),
      style: {
        minWidth: "".concat(t.length * 20, "rem")
      }
    }, [t.map((a, s) => a.visible && n("div", {
      ...
      class: e.e("table")
    }, [F(i.value), I(i.value, C.value)]), z = () => n(u("el-dropdown"), {
      trigger: "click",
  ...
  render() {
    ...
    return r[e] = () => {
      ...
      default: () => [H(n(u("iBizControlBase"), {
        ...
        default: () => [r]
      }), [[J("loading"), !this.c.view.state.isLoading && this.c.state.isLoading]])]
    });
  }
});
class se {
