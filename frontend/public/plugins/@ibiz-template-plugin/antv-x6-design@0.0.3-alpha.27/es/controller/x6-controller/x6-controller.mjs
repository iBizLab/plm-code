...
class X6Controller {
  ...
  init() {
    if (this.opt.minimap === true) {
      const mapContainer = this.dom.parentElement.getElementsByClassName(
        this.ns.b("minimap")
      );
      if (mapContainer.length > 0) {
        this.g.use(
          new MiniMap({
            container: mapContainer.item(0)
          })
        );
      } else {
    ...
    this.g.use(new Snapline({ enabled: true }));
