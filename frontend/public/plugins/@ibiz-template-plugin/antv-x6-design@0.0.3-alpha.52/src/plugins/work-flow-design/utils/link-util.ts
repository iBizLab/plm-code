...
export class LinkUtil {
   ...
   * @return {*}
   */
  async getLinkType(context: IContext, service: IAppDEService) {
   ...
   * @return {*}
   */
  async getLinkName(context: IContext, type: string, service: IAppDEService) {
    if (!type) {
      return '';
    }
