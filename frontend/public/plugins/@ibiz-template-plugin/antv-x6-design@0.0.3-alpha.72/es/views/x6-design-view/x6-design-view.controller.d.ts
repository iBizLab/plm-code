...
export declare class X6DesignViewController extends ViewController<IAppDECustomView, X6DesignViewState, X6DesignViewEvent> {
    /**
     * 视图中的选中数据
     *
     * @author chitanda
     ...
     */
    readonly select: SelectState<X6CellDataProvider<IData>>;
