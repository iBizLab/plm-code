...
export const boundary = (): Cell.ToolItem => {
  return {
    name: 'boundary',
    args: {
...
export const sourceArrowhead = (): Cell.ToolItem => {
  return {
...
export const targetArrowhead = (): Cell.ToolItem => {
  return {
...
export const vertices = (): Cell.ToolItem => {
  return {
    name: 'vertices',
    args: {
      attrs: { fill: '#666' },
...
export const loopIcon = (): Cell.ToolItem => {
  return {
