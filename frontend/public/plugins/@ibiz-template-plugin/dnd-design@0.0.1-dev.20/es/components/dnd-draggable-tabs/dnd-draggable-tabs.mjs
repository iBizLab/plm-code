  ...
  render() {
    return createVNode("div", {
      ...
      item: (args) => {
        ...
        return createVNode("div", {
          "class": [this.ns.b("item"), this.ns.is("active", isActive)],
          "onClick": (e) => {
            e.stopPropagation();
        ...
        }, [element.srftext || ""]), createVNode("div", {
          ...
          "width": "auto",
          "placement": "left",
          "popper-class": this.ns.be("item", "pop-confirm"),
      ...
      return createVNode("div", {
        "class": [this.ns.b("item-content"), this.ns.is("hidden", isHidden), this.ns.is("select", this.select && item.srfkey === this.select.srfkey)],
        "onClick": (e) => {
          e.stopPropagation();
          this.onItemClick(item);
        }
      }, [(_b = (_a = this.$slots).default) == null ? void 0 : _b.call(_a, item)]);
    })])]);
  }
});
