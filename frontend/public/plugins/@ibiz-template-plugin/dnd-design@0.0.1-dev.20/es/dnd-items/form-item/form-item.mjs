...
var Component = /* @__PURE__ */ defineComponent({
  ...
  setup(props) {
    ...
    const renderDefaultField = () => {
      const data = props.controller.data;
      const text = "".concat(data.logicname || "", "(").concat(data.srftext, ")");
      ...
      if (data) {
        switch (data.editortype) {
          ...
          case "DATEPICKEREX_NODAY":
            return createVNode(resolveComponent("el-date-picker"), {
              "model-value": dayjs(curDate).format("HH:mm:ss"),
              "format": "HH:mm:ss",
              "disabled": true
            }, null);
          case "DATEPICKEREX_NODAY_NOSECOND":
            return createVNode(resolveComponent("el-date-picker"), {
              "model-value": dayjs(curDate).format("HH:mm"),
              "format": "HH:mm",
              "disabled": true
            }, null);
    ...
    const getFormCtrlStyle = (tag, labelPos) => {
      ...
      if (Object.is(labelPos, "none") || Object.is(labelPos, "top") || Object.is(labelPos, "bottom") || tag.showcaption === "0") {
        ...
        style += "width: calc(100% - ".concat(tag.labelwidth || 130, "px);");
      }
      if (tag.ctrlheight) {
    ...
    const renderContent = () => {
      ...
      const labelStyle = Object.is(labelPos, "top") || Object.is(labelPos, "bottom") ? "" : "width: ".concat(tag.labelwidth || 130, "px;");
      ...
      return createVNode("div", {
        ...
        "class": ns.e("label")
      }, [Object.is(labelPos, "right") ? "\uFF1A" : "", tag.caption || "", !Object.is(labelPos, "right") ? "\uFF1A" : ""])]), createVNode("div", {
        "class": ns.e("container-content"),
        "style": ctrlStyle
      }, [renderDesignItem()])]);
    };
