...
require('./editor-pulgin/editor-params/index.cjs');
var index$2 = require('./components/index.cjs');
var index$3 = require('./editor-pulgin/index.cjs');
...
var editorParamsProvider = require('./editor-pulgin/editor-params/editor-params-provider.cjs');
