...
var MODEL_STATE = /* @__PURE__ */ ((MODEL_STATE2) => {
  ...
  MODEL_STATE2[MODEL_STATE2["Placeholder"] = 524288] = "Placeholder";
  return MODEL_STATE2;
})(MODEL_STATE || {});
class ModelStateUtil {
   ...
   *
   * @author zhanghengfeng
   * @date 2024-06-21 19:06:24
   * @param {number} state
   * @return {*}  {boolean}
   */
  isEnablePlaceholder(state) {
    if (!state) {
      return false;
    }
    return (state & 524288 /* Placeholder */) === 524288 /* Placeholder */;
  }
}
