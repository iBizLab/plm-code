    ...
    const renderIcon = (icon) => {
      if (icon) {
        ...
        if (icon.endsWith("</svg>")) {
          const svg = URL.createObjectURL(new Blob([icon], {
            ...
            item: (data) => {
              ...
              return createVNode("div", {
                ...
                "onDblclick": (e) => {
                  var _a;
                  e.stopPropagation();
                  (_a = props.controller.view) == null ? void 0 : _a.evt.emit("onStencilAdd", {
                    stencil: clone(item)
                  });
                }
              }, [createVNode("svg", {
              ...
              }, [item.iconPath ? renderIcon(item.iconPath) : null]), createVNode("div", {
