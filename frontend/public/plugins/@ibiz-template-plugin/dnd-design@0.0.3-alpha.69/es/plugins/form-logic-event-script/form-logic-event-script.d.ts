...
export declare const FormLogicEventScript: import("vue").DefineComponent<{
    ...
    controller: import("@ibiz-template/vue3-util").RequiredProp<import("vue").PropType<FormLogicEventScriptEditorController>, undefined, undefined>;
