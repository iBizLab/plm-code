import { isVNode, ref, resolveComponent, h, createVNode, provide, Transition, vShow, withDirectives, defineComponent } from 'vue';
...
var DndDesign = /* @__PURE__ */ defineComponent({
  ...
  render() {
    ...
    return createVNode("div", {
      ...
      "name": "dnd-design-fade"
    }, {
      default: () => [withDirectives(createVNode("div", {
        "class": this.ns.b("preview-container")
      }, [isPreview && previewData ? createVNode(resolveComponent("iBizFormShell"), {
        "key": previewKey,
        "data": previewData,
        "items": previewData.psdeformdetails,
        "context": this.controller.panel.context
      }, null) : null]), [[vShow, isPreview]])]
    }), createVNode(Transition, {
      "name": "dnd-design-fade"
    }, {
      default: () => [withDirectives(createVNode("div", {
        "class": this.ns.b("container")
      }, [this.renderFormPage()]), [[vShow, !isPreview]])]
    })]);
  }
});
