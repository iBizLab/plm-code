export declare const IBizLogicTreeDesignTree: import("@ibiz-template/vue3-util").TypeWithInstall<import("vue").DefineComponent<{
    modelData: {
    ...
    c: import("./tree.controller").LogicTreeDesignTreeController;
    ...
    renderDeNode: (nodeData: import("@ibiz-template/runtime").ITreeNodeData) => any[];
