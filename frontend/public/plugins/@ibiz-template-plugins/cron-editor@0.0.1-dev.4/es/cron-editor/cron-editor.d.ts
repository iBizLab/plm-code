...
declare const _default: import("vue").DefineComponent<{
    ...
    controller: import("@ibiz-template/vue3-util").RequiredProp<import("vue").PropType<CronEditorController>, undefined, undefined>;
    ...
    c: CronEditorController;
    ns: import("@ibiz-template/core").Namespace;
    changeCron: (val: string) => false | undefined;
    closeCron: () => void;
    changeButton: () => void;
    cronPopover: Ref<Boolean>;
