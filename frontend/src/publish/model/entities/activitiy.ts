export default {
  ...
  appDEMethodDTOs: [
    ...
    },
    {
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      name: 'ActivitiyFilterDTO',
      id: 'activitiyfilterdto',
    },
  ],
  appDEMethods: [
    {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'activitiyfilterdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
