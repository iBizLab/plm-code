export default {
  ...
  appDEMethodDTOs: [
    {
      codeName: 'addon_role_member_dto',
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      id: 'addon_role_member_dto',
    },
    {
      codeName: 'addon_role_member_filter_dto',
      appDEMethodDTOFields: [
        {
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      id: 'addon_role_member_filter_dto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'addon_role_member_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'addon_role_member_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  codeName: 'addon_role_member',
  deapicodeName: 'addon_role_member',
  deapicodeName2: 'addon_role_members',
  deapitag: 'ADDON_ROLE_MEMBER',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  keyAppDEFieldId: 'id',
  lnlanguageRes: {
    lanResTag: 'DE.LNAME.ADDON_ROLE_MEMBER',
  },
  logicName: '组件权限成员',
  ...
  minorAppDERSs: [
    {
      ...
      majorAppDataEntityId: 'plmweb.addon',
      parentAppDEFieldId: 'addon_id',
      rsmode: 2,
      name: '组件-权限成员',
