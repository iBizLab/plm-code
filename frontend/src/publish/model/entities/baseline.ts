  ...
  appDEUIActions: [
    {
      ...
      frontAppViewId: 'plmweb.baseline_update_view',
      frontProcessType: 'WIZARD',
      fullCodeName: 'baseline_open_edit_view',
      sysImage: {
        cssClass: 'fa fa-edit',
    ...
    },
    {
      ...
      codeName: 'set_complete',
      confirmMsg: '确认设立基线吗？',
      fullCodeName: 'baseline_set_complete',
      appDEMethodId: 'set_complete',
      sysImage: {
    ...
    },
    {
      ...
      frontProcessType: 'OTHER',
      fullCodeName:
        'baseline_toolbar_tree_exp_view_treeexpbar_toolbar_deuiaction1_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      appDataEntityId: 'plmweb.baseline',
      name: '新建分组',
      id: 'toolbar_tree_exp_view_treeexpbar_toolbar_deuiaction1_click@baseline',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
      ...
      frontProcessType: 'OTHER',
      fullCodeName:
        'baseline_toolbar_tree_exp_view_treeexpbar_toolbar_deuiaction2_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      appDataEntityId: 'plmweb.baseline',
      name: '新建类别',
      id: 'toolbar_tree_exp_view_treeexpbar_toolbar_deuiaction2_click@baseline',
    },
  ],
  appDEUILogics: [
    {
