export default {
      ...
      delogicParams: [
        {
          ...
          default: true,
          entityParam: true,
          paramAppDataEntityId: 'plmweb.board',
          name: '传入变量',
          id: 'default',
        },
      ],
  ...
  appDEMethods: [
    {
      codeName: 'check_board_is_deleted',
      methodType: 'DEACTION',
      appDEMethodInput: {
      ...
      requestPath: '/check_board_is_deleted',
      needResourceKey: true,
      actionMode: 'CUSTOM',
      actionType: 'REMOTE',
      dataSetType: 'REMOTE',
      id: 'check_board_is_deleted',
    },
    {
      codeName: 'check_key',
      methodType: 'DEACTION',
    ...
    {
      codeName: 'fetch_cur_board_upload',
      methodType: 'FETCH',
      appDEMethodInput: {
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetch_cur_board_upload',
      actionType: 'REMOTE',
      addedqconditions: [
        {
          condOp: 'EQ',
          ...
          condType: 'SINGLE',
          name: '(PROJECT_ID) 等于(=) 数据上下文',
          id: '(project_id) 等于(=) 数据上下文',
        },
      ],
      dataSetName: 'cur_board_upload',
      dataSetTag: 'cur_board_upload',
      dataSetType: 'REMOTE',
      id: 'fetch_cur_board_upload',
    },
    {
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      caption: '打开默认看板',
      codeName: 'open_default_board',
      frontAppViewId: 'plmweb.work_item_kanban_view',
      frontProcessType: 'WIZARD',
      fullCodeName: 'board_open_default_board',
      navigateContexts: [
        {
          key: 'BOARD',
          value: 'project',
      ...
      uiactionMode: 'FRONT',
      uiactionTag: 'open_default_board',
      uiactionType: 'DEUIACTION',
      showBusyIndicator: true,
      noPrivDisplayMode: 2,
      appDataEntityId: 'plmweb.board',
      name: '打开默认看板',
      id: 'open_default_board@board',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
  ...
  appDEUILogics: [
    {
      ...
      deuilogicNodes: [
        ...
        {
          dstAppDEUIActionId: 'open_default_board@board',
          dstAppDataEntityId: 'plmweb.board',
          codeName: 'DEUIACTION1',
          dstDEUILogicParamId: 'data',
          leftPos: -197,
