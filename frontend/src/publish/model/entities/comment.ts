export default {
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      actionTarget: 'SINGLEKEY',
      caption: '删除评论',
      codeName: 'delete_comment_space',
      confirmMsg: '确认删除该评论？',
      fullCodeName: 'comment_delete_comment_space',
      nextId: 'refresh_comment_list@comment',
      appDEMethodId: 'delete',
      successMsg: '删除成功！',
      timeout: 60000,
      uiactionMode: 'BACKEND',
      uiactionTag: 'delete_comment_space',
      uiactionType: 'DEUIACTION',
      enableConfirm: true,
      showBusyIndicator: true,
      noPrivDisplayMode: 2,
      appDataEntityId: 'plmweb.comment',
      name: '删除评论（知识库）',
      id: 'delete_comment_space@comment',
    },
    {
      actionLevel: 100,
    ...
    },
    {
      ...
      actionTarget: 'NONE',
      caption: '刷新评论列表',
      codeName: 'refresh_comment_list',
      frontProcessType: 'OTHER',
      fullCodeName: 'comment_refresh_comment_list',
      uiactionMode: 'FRONT',
      uiactionTag: 'refresh_comment_list',
      uiactionType: 'DEUIACTION',
      uilogicAttachMode: 'REPLACE',
      showBusyIndicator: true,
      noPrivDisplayMode: 2,
      appDEUILogicId: 'refresh_comment_list',
      appDataEntityId: 'plmweb.comment',
      name: '刷新评论列表',
      id: 'refresh_comment_list@comment',
    },
    {
      actionLevel: 100,
      actionTarget: 'NONE',
  ...
  deopprivs: [
    ...
    {
      logicName: '建立',
      mapDEName: 'DISCUSS_REPLY',
      mapDEOPPrivName: 'READ',
      name: 'CREATE',
      id: 'discuss_reply__create',
    },
    {
      logicName: '删除',
      name: 'DELETE',
