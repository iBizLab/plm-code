export default {
  ...
  appDEUILogics: [
    ...
    {
      codeName: 'customer_get_only_read',
      defaultParamName: 'Default',
      logicName: '客户只读用户判断',
      deuilogicNodes: [
        {
        ...
        {
          dstAppDEActionId: 'customer_readonly_recognize',
    ...
    },
    {
      ...
      deuilogicNodes: [
        ...
        {
          code: 'uiLogic.view.ctx.parent.controllersMap.get("form").details.grouppanel8.state.visible=true;\r\nuiLogic.view.ctx.parent.controllersMap.get("form").details.grouppanel11.state.visible=false;',
          codeName: 'RAWJSCODE2',
          leftPos: 793,
          logicNodeType: 'RAWJSCODE',
          topPos: 208,
    ...
    {
      codeName: 'refresh_customer_grid',
      defaultParamName: 'Default',
      logicName: '刷新客户表格',
      deuilogicNodes: [
        {
        ...
        {
          code: "ibiz.mc.command.update.send({ srfdecodename: 'customer', srfkey: context.customer})",
          codeName: 'RAWJSCODE1',
          leftPos: 376,
          logicNodeType: 'RAWJSCODE',
          deuilogicLinks: [
