export default {
  ...
  appDEMethods: [
    ...
    },
    {
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetch_dept_filter',
      actionType: 'REMOTE',
      dataSetName: 'dept_filter',
      dataSetTag: 'dept_filter',
      dataSetType: 'REMOTE',
      id: 'fetch_dept_filter',
    },
    {
      codeName: 'fetch_root',
      methodType: 'FETCH',
  ...
  appDEUIActions: [
    {
      ...
      codeName: 'delete',
      confirmMsg: '确认删除该部门吗？',
      fullCodeName: 'department_delete',
    ...
    },
    {
      ...
      caption: '编辑部门',
      codeName: 'edit_dept',
      frontAppViewId: 'plmweb.department_dept_option_view',
      frontProcessType: 'WIZARD',
      fullCodeName: 'department_edit_dept',
      refreshMode: 1,
      uiactionMode: 'FRONT',
      uiactionTag: 'edit_dept',
      uiactionType: 'DEUIACTION',
      reloadData: true,
      showBusyIndicator: true,
      noPrivDisplayMode: 2,
    ...
    },
    {
      ...
      caption: '新建部门',
      codeName: 'new_dept',
      frontAppViewId: 'plmweb.department_dept_option_new_view',
      frontProcessType: 'WIZARD',
      fullCodeName: 'department_new_dept',
      navigateContexts: [
        {
          key: 'DEPARTMENT',
          rawValue: true,
    ...
    },
    {
      ...
      frontAppViewId: 'plmweb.department_dept_option_new_view',
      frontProcessType: 'WIZARD',
      fullCodeName: 'department_new_root_dept',
      navigateContexts: [
        {
          key: 'DEPARTMENT',
          rawValue: true,
