export default {
  ...
  appDEMethods: [
    ...
    },
    {
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/mob_change_admin_role',
      needResourceKey: true,
      actionMode: 'CUSTOM',
      actionType: 'REMOTE',
      dataSetType: 'REMOTE',
      id: 'mob_change_admin_role',
    },
    {
      ...
      dedqgroupConditions: [
        ...
        },
        {
          ...
          dedqconditions: [
            {
              condOp: 'EQ',
              condValue: 'discuss_topic',
              fieldName: 'ID',
              vartypeId: 'WEBCONTEXT',
              condType: 'SINGLE',
              name: '(ID) 等于(=) 网页请求上下文 discuss_topic',
              id: '(id) 等于(=) 网页请求上下文 discuss_topic',
            },
          ],
          condType: 'GROUP',
          id: '连接条件',
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      nextId: 'open_topic_exp_page@discuss_topic',
