export default {
  ...
  appDEMethods: [
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'entry_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  minorAppDERSs: [
    {
      actionRSMode: 1,
      codeName: 'entries',
      majorAppDataEntityId: 'plmweb.board',
      parentAppDEFieldId: 'board_id',
      rsmode: 2,
      name: 'DER1N_ENTRY_BOARD_BOARD_ID',
      id: 'entries',
    },
    {
      actionRSMode: 1,
