export default {
  ...
  appDEMethods: [
    ...
    {
      codeName: 'fetch_comment_work_item_executor',
      methodType: 'FETCH',
      appDEMethodInput: {
      ...
      appDEMethodReturn: {
        appDEMethodDTOId: 'executor_user_id_dto',
        type: 'PAGE',
        id: '返回对象',
      },
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetch_comment_work_item_executor',
      actionType: 'REMOTE',
      dataSetName: 'comment_work_item_executor',
      dataSetTag: 'comment_work_item_executor',
      dataSetType: 'REMOTE',
      id: 'fetch_comment_work_item_executor',
    },
    {
    ...
    {
      codeName: 'fetch_executor_by_ownerid',
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'executor_filter_dto',
        type: 'DTO',
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetch_executor_by_ownerid',
      actionType: 'REMOTE',
      dataSetName: 'executor_by_ownerid',
      dataSetTag: 'executor_by_ownerid',
      dataSetType: 'REMOTE',
      id: 'fetch_executor_by_ownerid',
    },
    {
