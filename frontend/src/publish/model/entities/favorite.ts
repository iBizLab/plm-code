export default {
  ...
  appDEMethodDTOs: [
    ...
    },
    {
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      name: 'FavoriteFilterDTO',
      id: 'favoritefilterdto',
    },
  ],
  appDEMethods: [
    {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'favoritefilterdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
