export default {
  ...
  appDEMethodDTOs: [
    ...
    {
      codeName: 'Ideaadvanced_searchDTO',
      appDEMethodDTOFields: [
        {
          codeName: 'Title',
          logicName: '标题',
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      name: 'Ideaadvanced_searchDTO',
      id: 'ideaadvanced_searchdto',
    },
    {
  ...
  appDEMethods: [
    ...
    },
    {
      ...
      appDEMethodReturn: {
        appDEMethodDTOId: 'ideaadvanced_searchdto',
        type: 'PAGE',
        id: '返回对象',
      },
      requestMethod: 'POST',
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      frontProcessType: 'OTHER',
      fullCodeName: 'Idea_show_dorpdown_data',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      showBusyIndicator: true,
      noPrivDisplayMode: 2,
      appDEUILogicId: 'show_dorpdown_data',
      appDataEntityId: 'plmweb.idea',
      name: '显示下拉并展开数据（嵌入视图）',
      id: 'show_dorpdown_data@idea',
    },
    {
      actionLevel: 100,
