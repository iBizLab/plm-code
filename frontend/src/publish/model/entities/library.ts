export default {
  appDEACModes: [
    ...
    },
    {
      ...
      itemLayoutPanel: {
        ...
        modelId: '0ABDAA98-EE83-4D65-AB0B-62128A3C2322',
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      frontAppViewId: 'plmweb.librarytree_exp_view_details_setting',
      ...
      scriptCode:
        "const srfkey = context.library ? context.library : data[0].id;\r\nwindow.location.hash=`/-/index/library=${srfkey}/libraryindex_view/srfnav=usrdrgroup1227882118/librarytree_exp_view_details_setting/srfnav=${encodeURIComponent('root:normal:recycle')}/test_caserecycle_grid_view/-`",
      timeout: 60000,
      uiactionMode: 'FRONT',
    ...
    },
    {
      ...
      scriptCode:
        "const srfkey = context.library ? context.library : data[0].id;\r\nwindow.location.hash=`/-/index/library=${srfkey}/libraryindex_view/srfnav=usrdrgroup1227882118/librarytree_exp_view_details_setting/srfnav=${encodeURIComponent('root:normal:member')}/library_membergrid_view_config/-`",
      timeout: 60000,
      uiactionMode: 'FRONT',
    ...
    },
    {
      ...
      scriptCode:
        "const srfkey = context.library ? context.library : data[0].id;\r\nwindow.location.hash=`/-/index/library=${srfkey}/libraryindex_view/srfnav=usrdrgroup1227882118/librarytree_exp_view_details_setting/srfnav=${encodeURIComponent('root:setting:info')}/libraryedit_view_base_info/-`",
      timeout: 60000,
      uiactionMode: 'FRONT',
