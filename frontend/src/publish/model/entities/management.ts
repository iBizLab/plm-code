export default {
  ...
  appDEMethodDTOs: [
    ...
    {
      codeName: 'management_filter_dto',
      appDEMethodDTOFields: [
        {
          codeName: 'n_id_eq',
          logicName: '标识',
  ...
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'management_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'management_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  codeName: 'management',
  deapicodeName: 'management',
  deapicodeName2: 'managements',
  deapitag: 'MANAGEMENT',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  ...
  major: true,
  name: 'MANAGEMENT',
  id: 'plmweb.management',
  codeName2: 'managements',
  requestPaths: [],
};
