  ...
  appDEMethodDTOs: [
    {
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      name: 'Page_versionDTO',
      id: 'page_versiondto',
    },
    {
      codeName: 'Page_versionFilterDTO',
      appDEMethodDTOFields: [
        {
          codeName: 'N_ID_EQ',
          logicName: '标识',
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      name: 'Page_versionFilterDTO',
      id: 'page_versionfilterdto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'page_versiondto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'page_versionfilterdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
