export default {
      ...
      delogicParams: [
        {
          ...
          default: true,
          entityParam: true,
          paramAppDataEntityId: 'plmweb.portfolio_member',
          name: '传入变量',
          id: 'default',
        },
      ],
  ...
  appDEMethodDTOs: [
    {
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      id: 'portfolio_member_dto',
    },
    {
      codeName: 'portfolio_member_filter_dto',
      appDEMethodDTOFields: [
        {
          codeName: 'n_id_eq',
          logicName: '标识',
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      id: 'portfolio_member_filter_dto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'portfolio_member_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    {
      codeName: 'fetch_cur_project_set',
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'portfolio_member_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetch_cur_project_set',
      actionType: 'REMOTE',
      addedqconditions: [
        {
          condOp: 'EQ',
          ...
          condType: 'SINGLE',
          name: '(PORTFOLIO_ID) 等于(=) 数据上下文 id',
          id: '(portfolio_id) 等于(=) 数据上下文 id',
        },
      ],
      dataSetName: 'cur_project_set',
      dataSetTag: 'cur_project_set',
      dataSetType: 'REMOTE',
      id: 'fetch_cur_project_set',
    },
    {
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      frontAppViewId: 'plmweb.portfolio_member_role_edit_view',
      frontProcessType: 'WIZARD',
      fullCodeName: 'portfolio_member_setting_role',
      ...
      appDataEntityId: 'plmweb.portfolio_member',
      name: '设置角色',
      id: 'setting_role@portfolio_member',
    },
  ],
  appDEUILogics: [
    {
