export default {
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      scriptCode:
        'const srfkey = context.portfolio ? context.portfolio : data[0].id;\r\nwindow.location.hash=`/-/index/portfolio=${srfkey}/portfolioproject_index_view/srfnav=drgroup/portfolio_setting_view/srfnav=base/portfolioproject_edit_view/-`',
      timeout: 60000,
      uiactionMode: 'FRONT',
    ...
    },
    {
      ...
      scriptCode:
        'const srfkey = context.portfolio ? context.portfolio : data[0].id;\r\nwindow.location.hash=`/-/index/portfolio=${srfkey}/portfolioproject_index_view/srfnav=drgroup/portfolio_setting_view/srfnav=member/portfolio_memberproject_member_grid_view/-`',
      timeout: 60000,
      uiactionMode: 'FRONT',
