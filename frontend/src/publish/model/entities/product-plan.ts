export default {
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      actionTarget: 'NONE',
      caption: '切换模式',
      codeName: 'swtich_show_mode',
      frontProcessType: 'OTHER',
      fullCodeName: 'product_plan_swtich_show_mode',
      timeout: 60000,
      uiactionMode: 'FRONT',
      uiactionTag: 'swtich_show_mode',
      uiactionType: 'DEUIACTION',
      ...
      appDataEntityId: 'plmweb.product_plan',
      name: '切换显示模式',
      id: 'swtich_show_mode@product_plan',
    },
    {
      actionLevel: 100,
    ...
    },
    {
      ...
      deuilogicNodes: [
        ...
        },
        {
          ...
          dstAppDataEntityId: 'plmweb.product_plan',
          codeName: 'DEACTION1',
