export default {
  ...
  appDEMethodDTOs: [
    ...
    },
    {
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      name: 'Product_tagFilterDTO',
      id: 'product_tagfilterdto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'product_tagdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'product_tagfilterdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      caption: '编辑标签',
      codeName: 'edit_tag',
      frontAppViewId: 'plmweb.product_tagoption_view_edit',
      frontProcessType: 'WIZARD',
