export default {
  ...
  appDEMethodDTOs: [
    {
      codeName: 'Product_ticket_typeDTO',
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      name: 'Product_ticket_typeDTO',
      id: 'product_ticket_typedto',
    },
    {
      codeName: 'Product_ticket_typeFilterDTO',
      appDEMethodDTOFields: [
        {
          codeName: 'N_ID_EQ',
          logicName: '标识',
        ...
        },
        {
          ...
          type: 'SIMPLE',
          allowEmpty: true,
          name: 'N_TICKET_TYPE_ID_EQ',
          id: 'n_ticket_type_id_eq',
        },
      ],
      sourceType: 'DE',
      type: 'DEFILTER',
      name: 'Product_ticket_typeFilterDTO',
      id: 'product_ticket_typefilterdto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'product_ticket_typedto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'product_ticket_typefilterdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
