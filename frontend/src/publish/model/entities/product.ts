export default {
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      actionTarget: 'NONE',
      caption: '新建项目',
      codeName: 'new_project_re_product',
      dataAccessAction: 'SRFUR__PROJECT_M',
      frontAppViewId: 'plmweb.project_create_wizard_view',
      frontProcessType: 'WIZARD',
      fullCodeName: 'product_new_project_re_product',
      deopprivId: 'srfur__project_m',
      refreshMode: 1,
      uiactionMode: 'FRONT',
      uiactionTag: 'new_project_re_product',
      uiactionType: 'DEUIACTION',
      uilogicAttachMode: 'AFTER',
      reloadData: true,
      showBusyIndicator: true,
      noPrivDisplayMode: 2,
      appDEUILogicId: 'after_new_product_re_project',
      appDataEntityId: 'plmweb.product',
      name: '新建项目（关联产品）',
      id: 'new_project_re_product@product',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEKEY',
    ...
    },
    {
      ...
      appDataEntityId: 'plmweb.product',
      name: '配置',
      id: 'panel_usr1021297820_button_calluilogic_click@product',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEKEY',
    ...
    },
    {
      ...
      dataAccessAction: 'UPDATE',
      frontAppViewId: 'plmweb.project_choose_project_option_view',
      frontProcessType: 'WIZARD',
      ...
      showBusyIndicator: true,
      noPrivDisplayMode: 2,
      appDEUILogicId: 'project_re_product',
      appDataEntityId: 'plmweb.product',
      name: '产品关联项目',
  ...
  appDEUILogics: [
    {
      codeName: 'after_new_product_re_project',
      defaultParamName: 'Default',
      logicName: '新建后项目关联产品',
      deuilogicNodes: [
        {
          ...
          deuilogicNodeParams: [
            {
              ...
              name: 'Default[id] ==> relation_obj[target_id]',
              id: 'default[id] ==> relation_obj[target_id]',
            },
            {
              ...
              srcValueType: 'SRCDLPARAM',
              id: 'ctx[target_type] ==> relation_obj[target_type]',
            },
            {
              ...
              srcDEUILogicParamId: 'ctx',
              srcValueType: 'SRCDLPARAM',
              id: 'ctx[principal_id] ==> relation_obj[principal_id]',
            },
            {
              ...
              srcDEUILogicParamId: 'ctx',
              srcValueType: 'SRCDLPARAM',
              id: 'ctx[principal_type] ==> relation_obj[principal_type]',
            },
          ],
          topPos: 208,
          name: '准备参数',
      ...
      name: '新建后项目关联产品',
      id: 'after_new_product_re_project',
    },
    {
