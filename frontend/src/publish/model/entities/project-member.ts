export default {
  ...
  appDEMethods: [
    ...
    },
    {
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/mob_create_project_member',
      actionMode: 'GETDRAFT',
      actionType: 'REMOTE',
      dataSetType: 'REMOTE',
      id: 'mob_create_project_member',
    },
    {
      codeName: 'nothing',
      methodType: 'DEACTION',
  ...
  appDEUIActions: [
    {
      ...
      frontAppViewId: 'plmweb.project_member_choose_position_option_view',
      fullCodeName: 'project_member_choose_position',
      ...
      appDataEntityId: 'plmweb.project_member',
      name: '职位变更',
      id: 'choose_position@project_member',
    },
    {
      actionLevel: 100,
      actionTarget: 'NONE',
