export default {
  ...
  appDEMethodDTOs: [
    ...
    },
    {
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      name: 'Project_tagFilterDTO',
      id: 'project_tagfilterdto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'project_tagdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'project_tagfilterdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      caption: '编辑标签',
      codeName: 'edit_tag',
      frontAppViewId: 'plmweb.project_tagoption_view',
      frontProcessType: 'WIZARD',
