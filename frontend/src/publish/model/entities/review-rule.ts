export default {
  ...
  appDEMethodDTOs: [
    ...
    {
      codeName: 'review_rule_filter_dto',
      appDEMethodDTOFields: [
        {
  ...
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'review_rule_dto',
        type: 'DTO',
        name: 'CheckKeyInput',
        id: 'checkkeyinput',
      },
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'review_rule_filter_dto',
        type: 'DTO',
        name: 'DefaultInput',
        id: 'defaultinput',
      },
  ...
  keyAppDEFieldId: 'id',
  lnlanguageRes: {
    lanResTag: 'DE.LNAME.REVIEW_RULE',
  },
  logicName: '评审规则',
  ...
  minorAppDERSs: [
    {
      ...
      rsmode: 1,
      rstype: 'DER1N',
      name: 'DER1N_REVIEW_RULE_GUIDELINE_GUIDELINE_ID',
      id: 'guideline',
    },
  ],
