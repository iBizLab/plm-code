export default {
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      actionTarget: 'SINGLEDATA',
      caption: '撤回评审',
      codeName: 'toolbar_main_view_toolbar_deuiaction2_click',
      frontProcessType: 'OTHER',
      fullCodeName: 'review_toolbar_main_view_toolbar_deuiaction2_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      uiactionTag: 'toolbar_main_view_toolbar_deuiaction2_click',
      uiactionType: 'DEUIACTION',
      uilogicAttachMode: 'REPLACE',
      uilogicType: 'DELOGIC',
      showBusyIndicator: true,
      noPrivDisplayMode: 2,
      appDEUILogicId: 'repeal_review',
      appDataEntityId: 'plmweb.review',
      name: '撤回评审',
      id: 'toolbar_main_view_toolbar_deuiaction2_click@review',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
