export default {
  ...
  appDEMethods: [
    ...
    },
    {
      ...
      needResourceKey: true,
      actionMode: 'UPDATE',
      actionName: 'other_relation_run',
      actionType: 'REMOTE',
      dataSetType: 'REMOTE',
      name: 'Other_relation_run',
    ...
    },
    {
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetchcaseperson',
      actionType: 'REMOTE',
      dataSetName: 'casePerson',
      dataSetTag: 'CasePerson',
      dataSetType: 'REMOTE',
      name: 'FetchCasePerson',
      id: 'fetchcaseperson',
    },
    {
    ...
    {
      codeName: 'FetchComparativeAnalysis',
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'runfilterdto',
        type: 'DTO',
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetchcomparativeanalysis',
      actionType: 'REMOTE',
      dataSetName: 'comparativeAnalysis',
      dataSetTag: 'ComparativeAnalysis',
      dataSetType: 'REMOTE',
      name: 'FetchComparativeAnalysis',
      id: 'fetchcomparativeanalysis',
    },
    {
      codeName: 'FetchDailyTendencies',
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'runfilterdto',
        type: 'DTO',
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetchdailytendencies',
      actionType: 'REMOTE',
      dataSetName: 'dailyTendencies',
      dataSetTag: 'DailyTendencies',
      dataSetType: 'REMOTE',
      name: 'FetchDailyTendencies',
      id: 'fetchdailytendencies',
    },
    {
    ...
    },
    {
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetcheverydaytest',
      actionType: 'REMOTE',
      dataSetName: 'everydayTest',
      dataSetTag: 'EverydayTest',
      dataSetType: 'REMOTE',
      name: 'FetchEverydayTest',
      id: 'fetcheverydaytest',
    },
    {
      codeName: 'FetchImplementationResults',
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'runfilterdto',
        type: 'DTO',
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetchimplementationresults',
      actionType: 'REMOTE',
      dataSetName: 'ImplementationResults',
      dataSetTag: 'ImplementationResults',
      dataSetType: 'REMOTE',
      name: 'FetchImplementationResults',
      id: 'fetchimplementationresults',
    },
    {
    ...
    {
      codeName: 'FetchPriorityDistributions',
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'runfilterdto',
        type: 'DTO',
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetchprioritydistributions',
      actionType: 'REMOTE',
      dataSetName: 'priorityDistributions',
      dataSetTag: 'PriorityDistributions',
      dataSetType: 'REMOTE',
      name: 'FetchPriorityDistributions',
      id: 'fetchprioritydistributions',
    },
    {
