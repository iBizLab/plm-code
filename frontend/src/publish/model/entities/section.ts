export default {
  ...
  appDEMethods: [
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'sectionfilterdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    {
      codeName: 'FetchThis_product_section',
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'sectionfilterdto',
        type: 'DTO',
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetchthis_product_section',
      actionType: 'REMOTE',
      dataSetName: 'This_product_section',
      dataSetTag: 'This_product_section',
      dataSetType: 'REMOTE',
      name: 'FetchThis_product_section',
      id: 'fetchthis_product_section',
    },
    {
