export default {
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      showBusyIndicator: true,
      noPrivDisplayMode: 2,
      appDEUILogicId: 'product__re_space',
      appDataEntityId: 'plmweb.space',
      name: '产品关联空间',
    ...
    },
    {
      ...
      frontAppViewId: 'plmweb.spacedetails_setting_view',
      frontProcessType: 'OTHER',
      ...
      scriptCode:
        "const srfkey = context.space? context.space: data[0].id;\r\nwindow.location.hash=`/-/index/space=${srfkey}/spaceindex_view/srfnav=drgroup/spacedetails_setting_view/srfnav=${encodeURIComponent('root:normal:member')}/spaceedit_view_base_info/-`",
      timeout: 60000,
      uiactionMode: 'FRONT',
    ...
    },
    {
      ...
      scriptCode:
        "const srfkey = context.space? context.space: data[0].id;\r\nwindow.location.hash=`/-/index/space=${srfkey}/spaceindex_view/srfnav=drgroup/spacedetails_setting_view/srfnav=${encodeURIComponent('root:normal:member')}/article_pagerecycle_grid_view/-`",
      timeout: 60000,
      uiactionMode: 'FRONT',
    ...
    },
    {
      ...
      scriptCode:
        "const srfkey = context.space? context.space: data[0].id;\r\nwindow.location.hash=`/-/index/space=${srfkey}/spaceindex_view/srfnav=drgroup/spacedetails_setting_view/srfnav=${encodeURIComponent('root:normal:member')}/space_membergrid_view_config/-`",
      timeout: 60000,
      uiactionMode: 'FRONT',
