export default {
  ...
  appDEMethodDTOs: [
    {
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      name: 'Sprint_sectionDTO',
      id: 'sprint_sectiondto',
    },
    {
      codeName: 'Sprint_sectionFilterDTO',
      appDEMethodDTOFields: [
        {
          codeName: 'N_ID_EQ',
          logicName: '标识',
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      name: 'Sprint_sectionFilterDTO',
      id: 'sprint_sectionfilterdto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'sprint_sectiondto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'sprint_sectionfilterdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  codeName: 'Sprint_section',
  deapicodeName: 'sprint_section',
  deapicodeName2: 'sprint_sections',
  deapitag: 'SPRINT_SECTION',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  keyAppDEFieldId: 'id',
  lnlanguageRes: {
    lanResTag: 'DE.LNAME.SPRINT_SECTION',
  },
  logicName: '迭代分组',
  ...
  major: true,
  name: 'SPRINT_SECTION',
  id: 'plmweb.sprint_section',
  codeName2: 'Sprint_sections',
  requestPaths: [],
};
