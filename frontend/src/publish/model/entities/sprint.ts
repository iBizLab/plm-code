export default {
  ...
  appDEFields: [
    ...
    {
      codeName: 'Sprint_category_name',
      logicName: '类别名称',
      stdDataType: 25,
      stringLength: 200,
      name: 'SPRINT_CATEGORY_NAME',
      id: 'sprint_category_name',
    },
    {
      codeName: 'Categories',
      logicName: '类别',
  ...
  appDEMethodDTOs: [
    {
      ...
      appDEMethodDTOFields: [
        ...
        },
        {
          codeName: 'Sprint_category_name',
          logicName: '类别名称',
          appDEFieldId: 'sprint_category_name',
          sourceType: 'DEFIELD',
          stdDataType: 25,
          type: 'SIMPLE',
          allowEmpty: true,
    ...
    },
    {
      ...
      appDEMethodDTOFields: [
        ...
        {
          codeName: 'N_SPRINT_CATEGORY_ID_EQ',
          logicName: '迭代类别标识',
          appDEFieldId: 'sprint_category_id',
          sourceType: 'DEFSEARCHMODE',
          stdDataType: 25,
          type: 'SIMPLE',
          allowEmpty: true,
          name: 'N_SPRINT_CATEGORY_ID_EQ',
          id: 'n_sprint_category_id_eq',
        },
        {
          codeName: 'N_SPRINT_CATEGORY_NAME_EQ',
          logicName: '类别名称',
          appDEFieldId: 'sprint_category_name',
          sourceType: 'DEFSEARCHMODE',
          stdDataType: 25,
          type: 'SIMPLE',
          allowEmpty: true,
          name: 'N_SPRINT_CATEGORY_NAME_EQ',
          id: 'n_sprint_category_name_eq',
        },
        {
          codeName: 'N_SPRINT_CATEGORY_NAME_LIKE',
          logicName: '类别名称',
          appDEFieldId: 'sprint_category_name',
          sourceType: 'DEFSEARCHMODE',
          stdDataType: 25,
          type: 'SIMPLE',
          allowEmpty: true,
          name: 'N_SPRINT_CATEGORY_NAME_LIKE',
          id: 'n_sprint_category_name_like',
        },
        {
