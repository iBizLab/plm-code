export default {
  ...
  appDEMethodDTOs: [
    {
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      name: 'Template_flowDTO',
      id: 'template_flowdto',
    },
    {
      codeName: 'Template_flowFilterDTO',
      appDEMethodDTOFields: [
        {
          codeName: 'N_ID_EQ',
          logicName: '标识',
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      name: 'Template_flowFilterDTO',
      id: 'template_flowfilterdto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'template_flowdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'template_flowfilterdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  major: true,
  name: 'TEMPLATE_FLOW',
  id: 'plmweb.template_flow',
  codeName2: 'Template_flows',
  requestPaths: [],
};
