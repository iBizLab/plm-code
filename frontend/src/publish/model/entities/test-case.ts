export default {
  ...
  appDEMethods: [
    ...
    },
    {
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fill_library_member',
      needResourceKey: true,
      actionMode: 'CUSTOM',
      actionType: 'REMOTE',
      dataSetType: 'REMOTE',
      id: 'fill_library_member',
    },
    {
      codeName: 'get',
      methodType: 'DEACTION',
    ...
    {
      codeName: 'fetch_case_latest_result',
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'test_case_filter_dto',
        type: 'DTO',
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetch_case_latest_result',
      actionType: 'REMOTE',
      dataSetName: 'case_latest_result',
      dataSetTag: 'case_latest_result',
      dataSetType: 'REMOTE',
      id: 'fetch_case_latest_result',
    },
    {
  ...
  appDEUILogics: [
    ...
    },
    {
      ...
      deuilogicNodes: [
        ...
        {
          dstAppDEActionId: 'fill_library_member',
          dstAppDataEntityId: 'plmweb.test_case',
