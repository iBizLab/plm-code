export default {
  ...
  appDEUILogics: [
    ...
    },
    {
      ...
      deuilogicNodes: [
        ...
        },
        {
          ...
          deuilogicNodeParams: [
            {
              dstDEUILogicParamId: 'rows',
              paramAction: 'BINDPARAM',
              srcFieldName: 'state.rows',
              srcDEUILogicParamId: 'grid',
              srcValueType: 'SRCDLPARAM',
              id: 'grid[state.rows] ==> rows',
            },
          ],
          topPos: 208,
          name: '准备参数',
    ...
    {
      codeName: 'refresh_test_case_grid',
      defaultParamName: 'Default',
      logicName: '刷新测试用例表格',
      deuilogicNodes: [
        {
        ...
        {
          code: "ibiz.mc.command.update.send({ srfdecodename: 'test_case', srfkey: context.test_case})",
          codeName: 'RAWJSCODE1',
          leftPos: 376,
          logicNodeType: 'RAWJSCODE',
          deuilogicLinks: [
