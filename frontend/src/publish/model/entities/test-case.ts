export default {
  ...
  appDEMethods: [
    ...
    {
      codeName: 'FetchAssessmentResult',
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'test_casefilterdto',
        type: 'DTO',
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetchassessmentresult',
      actionType: 'REMOTE',
      dataSetName: 'assessmentResult',
      dataSetTag: 'AssessmentResult',
      dataSetType: 'REMOTE',
      name: 'FetchAssessmentResult',
      id: 'fetchassessmentresult',
    },
    {
    ...
    {
      codeName: 'FetchDegreeImportance',
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'test_casefilterdto',
        type: 'DTO',
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetchdegreeimportance',
      actionType: 'REMOTE',
      dataSetName: 'degreeImportance',
      dataSetTag: 'DegreeImportance',
      dataSetType: 'REMOTE',
      name: 'FetchDegreeImportance',
      id: 'fetchdegreeimportance',
    },
    {
    ...
    {
      codeName: 'FetchPersonDistributions',
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'test_casefilterdto',
        type: 'DTO',
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetchpersondistributions',
      actionType: 'REMOTE',
      dataSetName: 'PersonDistributions',
      dataSetTag: 'PersonDistributions',
      dataSetType: 'REMOTE',
      name: 'FetchPersonDistributions',
      id: 'fetchpersondistributions',
    },
    {
    ...
    },
    {
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetchprogram_analyze',
      actionType: 'REMOTE',
      dataSetName: 'program_analyze',
      dataSetTag: 'Program_analyze',
      dataSetType: 'REMOTE',
      name: 'FetchProgram_analyze',
      id: 'fetchprogram_analyze',
    },
    {
    ...
    {
      codeName: 'FetchTest_case_maneuver_context',
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'test_casefilterdto',
        type: 'DTO',
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetchtest_case_maneuver_context',
      actionType: 'REMOTE',
      dataSetName: 'test_case_maneuver_context',
      dataSetTag: 'Test_case_maneuver_context',
      dataSetType: 'REMOTE',
      name: 'FetchTest_case_maneuver_context',
      id: 'fetchtest_case_maneuver_context',
    },
    {
