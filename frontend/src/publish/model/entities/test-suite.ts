  ...
  appDEUIActions: [
    {
      ...
      fullCodeName:
        'test_suite_toolbar_tree_exp_view_node1_cm_deuiaction1_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      name: '编辑',
      id: 'toolbar_tree_exp_view_node1_cm_deuiaction1_click@test_suite',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
      ...
      frontProcessType: 'OTHER',
      fullCodeName:
        'test_suite_toolbar_tree_exp_view_node1_cm_deuiaction2_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      appDataEntityId: 'plmweb.test_suite',
      name: '删除',
      id: 'toolbar_tree_exp_view_node1_cm_deuiaction2_click@test_suite',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
