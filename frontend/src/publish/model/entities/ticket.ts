export default {
  ...
  appDEMethodDTOs: [
    ...
    {
      codeName: 'Ticketadvanced_searchDTO',
      appDEMethodDTOFields: [
        {
          codeName: 'Product_id',
          logicName: '产品标识',
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      name: 'Ticketadvanced_searchDTO',
      id: 'ticketadvanced_searchdto',
    },
    {
  ...
  appDEMethods: [
    ...
    },
    {
      ...
      needResourceKey: true,
      actionMode: 'READ',
      actionName: 'get_product_member',
      actionType: 'REMOTE',
      dataSetType: 'REMOTE',
      name: 'Get_product_member',
    ...
    },
    {
      ...
      needResourceKey: true,
      actionMode: 'READ',
      actionName: 'test_get_archived_info',
      actionType: 'REMOTE',
      dataSetType: 'REMOTE',
      name: 'Test_get_archived_info',
    ...
    },
    {
      ...
      appDEMethodReturn: {
        appDEMethodDTOId: 'ticketadvanced_searchdto',
        type: 'PAGE',
        id: '返回对象',
      },
      requestMethod: 'POST',
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      actionTarget: 'NONE',
      caption: '关联产品需求',
      codeName: 'link_product',
      frontProcessType: 'OTHER',
      fullCodeName: 'Ticket_link_product',
      timeout: 60000,
      uiactionMode: 'FRONT',
      uiactionTag: 'link_product',
      uiactionType: 'DEUIACTION',
      uilogicAttachMode: 'REPLACE',
      showBusyIndicator: true,
      noPrivDisplayMode: 2,
      appDEUILogicId: 'link_product',
      appDataEntityId: 'plmweb.ticket',
      name: '关联产品需求',
      id: 'link_product@ticket',
    },
    {
      actionLevel: 100,
      actionTarget: 'NONE',
  ...
  appDEUILogics: [
    ...
    },
    {
      ...
      deuilogicNodes: [
        ...
        {
          dstAppDEUIActionId: 'show_dorpdown_data@idea',
          dstAppDataEntityId: 'plmweb.idea',
          codeName: 'DEUIACTION1',
