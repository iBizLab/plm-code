export default {
  ...
  appDEMethodDTOs: [
    {
      codeName: 'transition_history_dto',
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      id: 'transition_history_dto',
    },
    {
      codeName: 'transition_history_filter_dto',
      appDEMethodDTOFields: [
        {
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      id: 'transition_history_filter_dto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'transition_history_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'transition_history_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
