export default {
  ...
  appDEFields: [
    ...
    {
      codeName: 'Version_category_id',
      logicName: '发布类别标识',
      stdDataType: 25,
      stringLength: 100,
      name: 'VERSION_CATEGORY_ID',
      id: 'version_category_id',
    },
    {
  ...
  appDEMethodDTOs: [
    {
      ...
      appDEMethodDTOFields: [
        ...
        },
        {
          codeName: 'Version_category_id',
          logicName: '发布类别标识',
          appDEFieldId: 'version_category_id',
          sourceType: 'DEFIELD',
          stdDataType: 25,
          type: 'SIMPLE',
          allowEmpty: true,
    ...
    },
    {
      ...
      appDEMethodDTOFields: [
        ...
        {
          codeName: 'N_VERSION_CATEGORY_ID_EQ',
          logicName: '发布类别标识',
          appDEFieldId: 'version_category_id',
          sourceType: 'DEFSEARCHMODE',
          stdDataType: 25,
          type: 'SIMPLE',
          allowEmpty: true,
          name: 'N_VERSION_CATEGORY_ID_EQ',
          id: 'n_version_category_id_eq',
        },
      ],
      sourceType: 'DE',
      type: 'DEFILTER',
  ...
  appDEUIActions: [
    {
      ...
      frontAppViewId: 'plmweb.versionupdate_view',
      frontProcessType: 'WIZARD',
      fullCodeName: 'Version_open_update_view',
      sysImage: {
        cssClass: 'fa fa-edit',
    ...
    },
    {
      ...
      fullCodeName: 'Version_toolbar_tree_exp_viewnode_1_cm_deuiaction1_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      appDataEntityId: 'plmweb.version',
      name: '编辑',
      id: 'toolbar_tree_exp_viewnode_1_cm_deuiaction1_click@version',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
      ...
      frontProcessType: 'OTHER',
      fullCodeName: 'Version_toolbar_tree_exp_viewnode_1_cm_deuiaction2_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      appDataEntityId: 'plmweb.version',
      name: '删除',
      id: 'toolbar_tree_exp_viewnode_1_cm_deuiaction2_click@version',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
      ...
      frontProcessType: 'OTHER',
      fullCodeName: 'Version_toolbar_tree_exp_viewnode_2_cm_deuiaction1_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      appDataEntityId: 'plmweb.version',
      name: '编辑',
      id: 'toolbar_tree_exp_viewnode_2_cm_deuiaction1_click@version',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
      ...
      frontProcessType: 'OTHER',
      fullCodeName: 'Version_toolbar_tree_exp_viewnode_2_cm_deuiaction2_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      appDataEntityId: 'plmweb.version',
      name: '删除',
      id: 'toolbar_tree_exp_viewnode_2_cm_deuiaction2_click@version',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
      ...
      frontProcessType: 'OTHER',
      fullCodeName: 'Version_toolbar_tree_exp_viewnode_3_cm_deuiaction1_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      appDataEntityId: 'plmweb.version',
      name: '编辑',
      id: 'toolbar_tree_exp_viewnode_3_cm_deuiaction1_click@version',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
      ...
      frontProcessType: 'OTHER',
      fullCodeName: 'Version_toolbar_tree_exp_viewnode_3_cm_deuiaction2_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      appDataEntityId: 'plmweb.version',
      name: '删除',
      id: 'toolbar_tree_exp_viewnode_3_cm_deuiaction2_click@version',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
      ...
      frontProcessType: 'OTHER',
      fullCodeName:
        'Version_toolbar_tree_exp_viewtreeexpbar_toolbar_deuiaction1_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      appDataEntityId: 'plmweb.version',
      name: '新建分组',
      id: 'toolbar_tree_exp_viewtreeexpbar_toolbar_deuiaction1_click@version',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
      ...
      frontProcessType: 'OTHER',
      fullCodeName:
        'Version_toolbar_tree_exp_viewtreeexpbar_toolbar_deuiaction2_click',
      timeout: 60000,
      uiactionMode: 'FRONT',
      ...
      appDataEntityId: 'plmweb.version',
      name: '新建类别',
      id: 'toolbar_tree_exp_viewtreeexpbar_toolbar_deuiaction2_click@version',
    },
  ],
  appDEUILogics: [
    {
        ...
        },
        {
          ...
          deuilogicNodeParams: [
            ...
            },
            {
              ...
              srcValue: 'version',
              srcValueType: 'SRCVALUE',
              name: '直接值[version] ==> defaultValue[owner_subtype]',
              id: '直接值[version] ==> defaultvalue[owner_subtype]',
            },
            {
  ...
  id: 'plmweb.version',
  codeName2: 'Versions',
  requestPaths: ['projects/${project}/versions/${version}'],
};
