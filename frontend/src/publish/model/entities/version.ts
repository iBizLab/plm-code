export default {
  ...
  appDEMethods: [
    ...
    },
    {
      ...
      requestMethod: 'POST',
      requestParamType: 'ENTITY',
      requestPath: '/fetch_name_version',
      actionType: 'REMOTE',
      dataSetName: 'name_version',
      dataSetTag: 'name_version',
      dataSetType: 'REMOTE',
      id: 'fetch_name_version',
    },
    {
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      frontProcessType: 'WIZARD',
      fullCodeName: 'version_open_work_item_main_view',
      navigateContexts: [
        {
          key: 'SRFDATATYPE',
      ...
      appDataEntityId: 'plmweb.version',
      name: '打开工作项主视图',
      id: 'open_work_item_main_view@version',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
    ...
    },
    {
      ...
      frontProcessType: 'WIZARD',
      fullCodeName: 'version_review_content_version_comparison',
      navigateParams: [
        {
          key: 'base_version',
          value: 'base_version',
      ...
      appDataEntityId: 'plmweb.version',
      name: '评审内容版本对比',
      id: 'review_content_version_comparison@version',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
  ...
  appDEUILogics: [
    ...
    },
    {
      ...
      deuilogicNodes: [
        ...
        {
          dstAppDEUIActionId: 'open_work_item_main_view@version',
