  ...
  appDEMethodDTOs: [
    {
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      name: 'Workload_typeDTO',
      id: 'workload_typedto',
    },
    {
      codeName: 'Workload_typeFilterDTO',
      appDEMethodDTOFields: [
        {
          codeName: 'N_ID_EQ',
          logicName: '标识',
      ...
      sourceType: 'DE',
      type: 'DEFILTER',
      name: 'Workload_typeFilterDTO',
      id: 'workload_typefilterdto',
    },
  ],
  appDEMethods: [
    {
      ...
      methodType: 'DEACTION',
      appDEMethodInput: {
        appDEMethodDTOId: 'workload_typedto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'workload_typefilterdto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
