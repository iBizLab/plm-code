export default {
      ...
      delogicParams: [
        {
          ...
          default: true,
          entityParam: true,
          paramAppDataEntityId: 'plmweb.workload_type',
          name: '传入变量',
          id: 'default',
        },
      ],
  ...
  appDEMethodDTOs: [
    {
      ...
      sourceType: 'DE',
      type: 'DEFAULT',
      id: 'workload_type_dto',
    },
    {
      codeName: 'workload_type_filter_dto',
      appDEMethodDTOFields: [
        {
          codeName: 'n_id_eq',
          logicName: '标识',
  ...
  appDEMethods: [
    ...
    },
    {
      ...
      methodType: 'FETCH',
      appDEMethodInput: {
        appDEMethodDTOId: 'workload_type_filter_dto',
        type: 'DTO',
        id: '输入对象',
      },
      appDEMethodReturn: {
  ...
  appDEUIActions: [
    {
      ...
      dialogResult: 'OK',
      frontAppViewId: 'plmweb.workload_type_quick_create_view',
    ...
    },
    {
      ...
      frontAppViewId: 'plmweb.workload_type_confirm_remove_view',
  ...
  codeName: 'workload_type',
  deapicodeName: 'workload_type',
  deapicodeName2: 'workload_types',
  deapitag: 'WORKLOAD_TYPE',
  dataAccCtrlArch: 1,
  dataAccCtrlMode: 1,
  enableUIActions: 15,
  keyAppDEFieldId: 'id',
  ...
  major: true,
  name: 'WORKLOAD_TYPE',
  id: 'plmweb.workload_type',
  codeName2: 'workload_types',
  requestPaths: [],
};
