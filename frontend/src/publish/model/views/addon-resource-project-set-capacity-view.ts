export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'project_set_capacity_view',
  deviewId: '81bcb5aad007dc160d8f14123402d353',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    ...
    {
      codeName: 'project_set_capacity_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'project_set_capacity_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.ADDON_RESOURCE',
      ...
      caption: '容量设置',
      codeName: 'project_set_capacity_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.addon_resource',
      controlParam: {},
      name: 'captionbar',
      id: 'project_set_capacity_view_captionbar',
    },
  ],
  sysCss: {
  ...
  title: '项目集资源组件容量设置选项操作视图',
  viewStyle: 'DEFAULT',
  viewType: 'DEOPTVIEW',
  width: 1000,
  enableDP: true,
  showCaptionBar: true,
  modelId: 'ebf931d823e5d83af47ecd64b243da4a',
  modelType: 'PSAPPDEVIEW',
  name: 'addon_resourceproject_set_capacity_view',
