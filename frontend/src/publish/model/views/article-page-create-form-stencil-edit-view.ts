export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'create_form_stencil_edit_view',
  deviewId: 'e881bce58caf9721bdf68241b48a1c3d',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.PAGE',
  },
  caption: '新建页面',
  codeName: 'article_page_create_form_stencil_edit_view',
  height: 90,
  ...
  controls: [
    {
      ...
      toolbarStyle: 'USER2',
      xdataControlName: 'form',
      codeName: 'create_form_stencil_edit_view_toolbar',
      controlType: 'TOOLBAR',
      ...
      name: 'toolbar',
      id: 'create_form_stencil_edit_view_toolbar',
    },
    {
      autoSaveMode: 1,
      createControlAction: {
      ...
      autoLoad: true,
      showBusyIndicator: true,
      codeName: 'new_view_form_stencil_form',
      controlType: 'FORM',
      logicName: '从模板新建页面编辑视图_表单',
      appDataEntityId: 'plmweb.article_page',
      controlParam: {
        id: 'form',
      },
      modelId: 'f5ac64ae994caa6377d6766e51ff808b',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'plmweb.article_page.new_view_form_stencil_form',
    },
    {
      codeName: 'create_form_stencil_edit_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'create_form_stencil_edit_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.PAGE',
      ...
      caption: '新建页面',
      codeName: 'create_form_stencil_edit_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.article_page',
      controlParam: {},
      name: 'captionbar',
      id: 'create_form_stencil_edit_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'cb090df10c9e68c7763b9902314bbabd',
  modelType: 'PSAPPDEVIEW',
  name: 'article_pagecreate_form_stencil_edit_view',
  id: 'plmweb.article_page_create_form_stencil_edit_view',
};
