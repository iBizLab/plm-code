export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'document_edit_view',
  deviewId: 'bce027eb545c93e69dee1c3a68f2e452',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      toolbarStyle: 'USER2',
      xdataControlName: 'form',
      codeName: 'document_edit_view_toolbar',
      controlType: 'TOOLBAR',
    ...
    },
    {
      ...
      autoLoad: true,
      showBusyIndicator: true,
      codeName: 'edit_view_document_form',
      controlType: 'FORM',
      logicName: '页面编辑视图（文档）_表单',
      appDataEntityId: 'plmweb.article_page',
      controlParam: {
        id: 'form',
      },
    ...
    {
      codeName: 'document_edit_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'document_edit_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.PAGE',
      ...
      caption: '页面',
      codeName: 'document_edit_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.article_page',
      controlParam: {},
      name: 'captionbar',
      id: 'document_edit_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'cb43f32dcea82f187604c346581d80d2',
  modelType: 'PSAPPDEVIEW',
  name: 'article_pagedocument_edit_view',
