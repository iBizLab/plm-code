export default {
  ...
  loadDefault: true,
  deviewCodeName: 'draft_show_edit_view',
  deviewId: 'd45cb54f4457c25cbcc47e83fe19b526',
  accUserMode: 2,
  capLanguageRes: {
    ...
    controls: [
      {
          ...
          },
          {
            ...
            detoolbarItems: [
              ...
              },
              {
                actionLevel: 100,
                noPrivDisplayMode: 2,
                uiactionId: 'remove_this_page@article_page',
                uiactionTarget: 'SINGLEDATA',
                valid: true,
                caption: '删除',
                itemType: 'DEUIACTION',
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'form',
        codeName: 'draft_show_edit_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '草稿展示编辑视图_工具栏',
        appDataEntityId: 'plmweb.article_page',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '8bcc1ed8da1e92186a1129263323c3f9',
        modelType: 'PSDETOOLBAR',
        name: 'toolbar',
        id: 'draft_show_edit_view_toolbar',
      },
      {
        createControlAction: {
        ...
        autoLoad: true,
        showBusyIndicator: true,
        codeName: 'draft_show_edit_view_form',
        controlType: 'FORM',
        logicName: '草稿展示编辑视图_表单',
        appDataEntityId: 'plmweb.article_page',
        controlParam: {
          id: 'form',
        },
        modelId: 'c796a417968d856570fa312d36c9ed8e',
        modelType: 'PSDEFORM_EDITFORM',
        name: 'form',
        id: 'plmweb.article_page.draft_show_edit_view_form',
      },
      {
        codeName: 'draft_show_edit_view_datainfobar',
        ...
        name: 'datainfobar',
        id: 'draft_show_edit_view_datainfobar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.PAGE',
        ...
        caption: '草稿',
        codeName: 'draft_show_edit_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.article_page',
        controlParam: {},
        name: 'captionbar',
        id: 'draft_show_edit_view_captionbar',
      },
    ],
    codeName: 'usr0208420804',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'draft_show_edit_view编辑视图布局面板',
    appDataEntityId: 'plmweb.article_page',
    controlParam: {},
    modelId: '39160CA2-51C0-4E2C-A375-97D091D4B071',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '1691a5e0a04a1b8805a04a5e00905123',
  modelType: 'PSAPPDEVIEW',
  name: 'article_pagedraft_show_edit_view',
