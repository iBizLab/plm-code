export default {
  ...
  deviewCodeName: 'model_show_view_noupdown',
  deviewId: 'b97bcc6869b973155b5f0d3361ec5210',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.PAGE',
  },
  caption: '页面',
  codeName: 'article_page_model_show_view_noupdown',
  height: 90,
    ...
    controls: [
      {
        detoolbarItems: [
          ...
          },
          {
            ...
            noPrivDisplayMode: 2,
            uiactionId:
              'toolbar_model_show_view_noupdown_toolbar_deuiaction2_click@article_page',
            uiactionTarget: 'SINGLEDATA',
            valid: true,
            caption: '评论',
            counterId: 'total',
            ...
            controlLogics: [
              ...
              },
              {
                ...
                logicTag: 'toolbar',
                logicType: 'SCRIPT',
                scriptCode: '!Boolean(localStorage.getItem(context.loginname))',
                triggerType: 'ITEMVISIBLE',
                id: 'show',
              },
            ],
          ...
          },
          {
            ...
            noPrivDisplayMode: 2,
            uiactionId:
              'toolbar_model_show_view_noupdown_toolbar_deuiaction3_click@article_page',
            uiactionTarget: 'SINGLEDATA',
            valid: true,
            caption: '关闭',
            itemType: 'DEUIACTION',
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'form',
        codeName: 'model_show_view_noupdown_toolbar',
        controlType: 'TOOLBAR',
        ...
        name: 'toolbar',
        id: 'model_show_view_noupdown_toolbar',
      },
      {
        createControlAction: {
      ...
      {
        codeName: 'model_show_view_noupdown_datainfobar',
        ...
        name: 'datainfobar',
        id: 'model_show_view_noupdown_datainfobar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.PAGE',
        ...
        caption: '页面',
        codeName: 'model_show_view_noupdown_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.article_page',
        controlParam: {},
        name: 'captionbar',
        id: 'model_show_view_noupdown_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '56a9b626d5c69c350452f364416174dc',
  modelType: 'PSAPPDEVIEW',
  name: 'article_pagemodel_show_view_noupdown',
  id: 'plmweb.article_page_model_show_view_noupdown',
};
