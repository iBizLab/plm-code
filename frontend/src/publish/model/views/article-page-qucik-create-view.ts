                      ...
                      deformDetails: [
                        {
                          contentControl: {
                            ...
                            itemLayoutPanel: {
                              ...
                              codeName: 'usr0410267937',
                              controlType: 'PANEL',
                              logicName: 'stencil_org_list_列表项面板',
                              appDataEntityId: 'plmweb.stencil',
                              controlLogics: [
                                {
                                  eventNames: 'onClick',
                                  itemName: 'page_container',
                                  logicTag: 'mdctrl1_list_itempanel',
                                  logicType: 'APPDEUILOGIC',
                                  appDEUILogicId: 'get_stencil_info',
                                  appDataEntityId: 'plmweb.article_page',
                              ...
                              controlParam: {},
                              modelId: '1F757652-68AF-4FC4-A77B-0E09FE1D3BBC',
                              modelType: 'PSSYSVIEWPANEL',
                              name: 'mdctrl1_list_itempanel',
                              id: 'plmweb.stencil.usr0410267937',
                            },
                            delistDataItems: [
                              {
                                appDEFieldId: 'id',
                            ...
                            codeName: 'stencil_org_list',
                            controlType: 'LIST',
                            logicName: 'stencil_org_list',
                            appDataEntityId: 'plmweb.stencil',
                            controlParam: {},
                            modelId: 'B8A0FFE2-7F32-4DF6-BDF7-07E5BF52A191',
                            modelType: 'PSDELIST',
                            name: 'mdctrl1_list',
                            id: 'plmweb.stencil.stencil_org_list',
                          },
                          contentType: 'LIST',
                          layout: {
                            columnCount: 24,
                      ...
                      deformDetails: [
                        {
                          contentControl: {
                            ...
                            itemLayoutPanel: {
                              ...
                              codeName: 'usr0410176658',
                              controlType: 'PANEL',
                              logicName: 'stencil_space_list_列表项面板',
                              appDataEntityId: 'plmweb.stencil',
                              controlParam: {},
                              modelId: '855DDE0C-19FA-4866-866F-01C695D7B244',
                              modelType: 'PSSYSVIEWPANEL',
                              name: 'mdctrl2_list_itempanel',
                              id: 'plmweb.stencil.usr0410176658',
                            },
                            delistDataItems: [
                              {
                                appDEFieldId: 'id',
                            ...
                            autoLoad: true,
                            showBusyIndicator: true,
                            codeName: 'stencil_space_list',
                            controlType: 'LIST',
                            logicName: 'stencil_space_list',
                            appDataEntityId: 'plmweb.stencil',
                            controlParam: {},
                            modelId: 'C8C2C324-DF38-43E8-A4CC-4485EBB29386',
                            modelType: 'PSDELIST',
                            name: 'mdctrl2_list',
                            id: 'plmweb.stencil.stencil_space_list',
                          },
                          contentType: 'LIST',
                          layout: {
                            columnCount: 24,
