export default {
  ...
  caption: '页面',
  codeName: 'article_pageedit_view_document',
  height: 90,
  ...
  controls: [
    {
      ...
      xdataControlName: 'form',
      codeName: 'edit_view_documenttoolbar',
      controlType: 'TOOLBAR',
    ...
    {
      codeName: 'edit_view_documentdatainfobar',
      ...
      name: 'datainfobar',
      id: 'edit_view_documentdatainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.PAGE',
      ...
      caption: '页面',
      codeName: 'edit_view_documentcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.article_page',
      controlParam: {},
      name: 'captionbar',
      id: 'edit_view_documentcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
