export default {
  ...
  deviewCodeName: 'show_view_model',
  deviewId: '0fab20a966333e058dea3023ac1fe5fd',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.PAGE',
  },
  caption: '页面',
  codeName: 'article_pageshow_view_model',
  height: 90,
  ...
  viewLayoutPanel: {
                                ...
                                panelItems: [
                                  {
                                    editor: {
                                      editorParams: {
                                        ...
                                        USERURL:
                                          '`spaces/${context.space}/space_members/fetchdefault`',
                                        QUOTEURL:
    ...
    controls: [
      {
        detoolbarItems: [
          ...
          },
          {
            ...
            noPrivDisplayMode: 2,
            uiactionId:
              'toolbar_show_view_modeltoolbar_deuiaction2_click@article_page',
          ...
          },
          {
            ...
            noPrivDisplayMode: 2,
            uiactionId:
              'toolbar_show_view_modeltoolbar_deuiaction3_click@article_page',
            uiactionTarget: 'SINGLEDATA',
            hiddenItem: true,
            valid: true,
            caption: '关闭',
        ...
        xdataControlName: 'form',
        codeName: 'show_view_modeltoolbar',
        controlType: 'TOOLBAR',
        ...
        modelId: '9584E624-8D7D-4C95-933A-889D64AC1B73',
        modelType: 'PSDETOOLBAR',
        name: 'toolbar',
        id: 'show_view_modeltoolbar',
      },
      {
        createControlAction: {
        ...
        modelId: 'C887C32B-E039-4092-B507-0FA40C29A519',
      ...
      },
      {
        ...
        itemLayoutPanel: {
          ...
          appDataEntityId: 'plmweb.article_page',
          controlParam: {},
          modelId: 'C11ACE5A-AD7D-471F-89EE-62DA777F4891',
        ...
        modelId: '78DE8080-CA5C-4CB6-9384-37CBB1462307',
        modelType: 'PSDELIST',
        name: 'list',
        id: 'plmweb.comment.list_wiki',
      },
      {
        codeName: 'show_view_modeldatainfobar',
      ...
      },
      {
        ...
        caption: '页面',
        codeName: 'show_view_modelcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.article_page',
        controlParam: {},
        name: 'captionbar',
        id: 'show_view_modelcaptionbar',
      },
    ],
    ...
    controlParam: {},
    modelId: 'E0A38C4B-2613-4C4B-898A-34516F2B30F7',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '1d05fd27f559b7bba10552b9c36826be',
  modelType: 'PSAPPDEVIEW',
  name: 'article_pageshow_view_model',
  id: 'plmweb.article_pageshow_view_model',
};
