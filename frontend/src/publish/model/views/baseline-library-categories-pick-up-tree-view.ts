export default {
  ...
  loadDefault: true,
  deviewCodeName: 'library_categories_pick_up_tree_view',
  deviewId: 'dbf4eb821254192e24fb2370b421a03d',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '基线选择',
      codeName: 'library_categories_pick_up_tree_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.baseline',
      controlParam: {},
      name: 'captionbar',
      id: 'library_categories_pick_up_tree_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '24bd457276c58e73cada58cee1b1a92a',
  modelType: 'PSAPPDEVIEW',
  name: 'baselinelibrary_categories_pick_up_tree_view',
