export default {
  ...
  deviewId: '2e5e3b0ff4b340c1e20d4d28778fc7a5',
  accUserMode: 2,
  capLanguageRes: {
  ...
  appViewLogics: [
    {
      ...
      builtinAppUILogic: {
        ...
        newDataAppView: {
          openMode: 'POPUPMODAL',
          refAppViewId: 'plmweb.baseline_library_create_view',
        },
        appUILogicRefViews: [
          {
            openMode: 'POPUPMODAL',
    ...
    },
    {
      ...
      builtinAppUILogic: {
        openDataAppView: {
          ...
          refAppViewId: 'plmweb.baseline_library_main_view',
        },
        editMode: true,
        appUILogicRefViews: [
          {
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'library_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '新建基线',
      appDataEntityId: 'plmweb.baseline',
      controlParam: {
    ...
    },
    {
      ...
      degridColumns: [
        {
          ...
          deuiactionGroup: {
            uiactionGroupDetails: [
              {
                ...
                uiactionId: 'set_complete_library@baseline',
                tooltip: '设立完成',
                showIcon: true,
                sysImage: {
              ...
              },
              {
                ...
                caption: '编辑',
                detailType: 'DEUIACTION',
                uiactionId: 'open_library_update_view@baseline',
                showCaption: true,
                showIcon: true,
                sysImage: {
                  cssClass: 'fa fa-edit',
            ...
            appDataEntityId: 'plmweb.baseline',
            uniqueTag: 'baseline__Usr0424861247',
            name: '测试库基线表格操作列',
            id: 'usr0424861247',
          },
          valueType: 'SIMPLE',
      ...
      modelId: '9122c368ae703bb00e4872b9bf6f0b80',
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.baseline.library_baseline_grid',
    },
    {
    ...
    },
    {
      ...
      caption: '全部基线',
      codeName: 'library_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.baseline',
      controlParam: {},
      name: 'captionbar',
      id: 'library_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '0059913a33e66be43630ea0da57524da',
  modelType: 'PSAPPDEVIEW',
  name: 'baselinelibrary_grid_view',
