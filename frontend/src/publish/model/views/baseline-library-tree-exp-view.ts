export default {
  ...
  deviewId: 'ec6990e3aa5aaff8bbea3c212f245e06',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.BASELINE',
  },
  caption: '基线',
  codeName: 'baseline_library_tree_exp_view',
  ...
  controls: [
    {
      ...
      appViewRefs: [
        {
          realTitle: '测试库基线树导航表格视图',
          refAppViewId: 'plmweb.baseline_library_grid_view',
          name: 'EXPITEM:node',
          id: 'expitem:node',
        },
        {
      ...
      controls: [
        {
          ...
          detreeNodes: [
            ...
            {
              text: '全部基线',
              navAppViewId: 'plmweb.baseline_library_grid_view',
              nodeType: 'node',
              navigateParams: [
                {
                  key: 'n_owner_id_eq',
            ...
            },
            {
              ...
              decontextMenu: {
                detoolbarItems: [
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_library_tree_exp_view_node1_cm_deuiaction1_click@baseline',
                  ...
                  },
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_library_tree_exp_view_node1_cm_deuiaction2_click@baseline',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '删除',
                    itemType: 'DEUIACTION',
                ...
                name: 'node_1_cm',
                id: 'library_tree_exp_view_node1_cm',
              },
              sysImage: {
            ...
            },
            {
              ...
              decontextMenu: {
                detoolbarItems: [
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_library_tree_exp_view_node2_cm_deuiaction1_click@baseline',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '编辑',
                    itemType: 'DEUIACTION',
                  ...
                  },
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_library_tree_exp_view_node2_cm_deuiaction2_click@baseline',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '删除',
                    itemType: 'DEUIACTION',
                ...
                modelType: 'PSDETOOLBAR',
                name: 'node_2_cm',
                id: 'library_tree_exp_view_node2_cm',
              },
              navigateParams: [
                {
            ...
            },
            {
              ...
              decontextMenu: {
                detoolbarItems: [
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_library_tree_exp_view_node3_cm_deuiaction1_click@baseline',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '编辑',
                    itemType: 'DEUIACTION',
                  ...
                  },
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_library_tree_exp_view_node3_cm_deuiaction2_click@baseline',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '删除',
                    itemType: 'DEUIACTION',
                ...
                modelType: 'PSDETOOLBAR',
                name: 'node_3_cm',
                id: 'library_tree_exp_view_node3_cm',
              },
              navigateParams: [
                {
                  key: 'n_categories_like',
          ...
          modelId: 'c2b9e9d7971eb034651ce9551ad060e2',
          modelType: 'PSDETREEVIEW',
          name: 'treeexpbar_tree',
          id: 'plmweb.baseline.library_baseline_tree_view',
        },
        {
          detoolbarItems: [
            {
              ...
              detoolbarItems: [
                {
                  ...
                  noPrivDisplayMode: 2,
                  uiactionId:
                    'toolbar_library_tree_exp_view_treeexpbar_toolbar_deuiaction1_click@baseline',
                  uiactionTarget: 'SINGLEDATA',
                  valid: true,
                  caption: '新建分组',
                  itemType: 'DEUIACTION',
                ...
                },
                {
                  ...
                  noPrivDisplayMode: 2,
                  uiactionId:
                    'toolbar_library_tree_exp_view_treeexpbar_toolbar_deuiaction2_click@baseline',
                  uiactionTarget: 'SINGLEDATA',
                  valid: true,
                  caption: '新建类别',
                  itemType: 'DEUIACTION',
          ...
          toolbarStyle: 'USER',
          codeName: 'library_tree_exp_view_treeexpbar_toolbar',
          controlType: 'TOOLBAR',
          logicName: '测试库基线新建类别或分组',
          appDataEntityId: 'plmweb.baseline',
          controlParam: {
            id: 'treeexpbar_toolbar',
          },
          modelId: '1b4e034fbcd69b1f8bd747d303bfea57',
          modelType: 'PSDETOOLBAR',
          name: 'treeexpbar_toolbar',
          id: 'library_tree_exp_view_treeexpbar_toolbar',
        },
      ],
      ...
      modelId: '80cdb57563453e08e76fa6bea8ff1cd9_treeexpbar',
      modelType: 'PSEXPBAR',
      name: 'treeexpbar',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '80cdb57563453e08e76fa6bea8ff1cd9',
  modelType: 'PSAPPDEVIEW',
  name: 'baselinelibrary_tree_exp_view',
  id: 'plmweb.baseline_library_tree_exp_view',
};
