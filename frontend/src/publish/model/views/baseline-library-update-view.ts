export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'library_update_view',
  deviewId: '999fd0e90726554e05ca28e8f653ab2d',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.BASELINE',
  },
  caption: '编辑基线',
  codeName: 'baseline_library_update_view',
  height: 580,
  ...
  controls: [
    ...
    {
      codeName: 'library_update_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'library_update_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.BASELINE',
      ...
      caption: '编辑基线',
      codeName: 'library_update_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.baseline',
      controlParam: {},
      name: 'captionbar',
      id: 'library_update_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '9ef2c2b8fd8e360b1a8081036ee8d863',
  modelType: 'PSAPPDEVIEW',
  name: 'baselinelibrary_update_view',
  id: 'plmweb.baseline_library_update_view',
};
