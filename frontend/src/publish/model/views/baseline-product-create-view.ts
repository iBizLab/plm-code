export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'product_create_view',
  deviewId: '2f67b92d6c38d3451176fe23bd8e7bb1',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.BASELINE',
  },
  caption: '新建基线',
  codeName: 'baseline_product_create_view',
  height: 580,
  ...
  controls: [
    ...
    {
      codeName: 'product_create_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'product_create_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.BASELINE',
      ...
      caption: '新建基线',
      codeName: 'product_create_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.baseline',
      controlParam: {},
      name: 'captionbar',
      id: 'product_create_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '103b41ea23d730fa00faadce9e22d982',
  modelType: 'PSAPPDEVIEW',
  name: 'baselineproduct_create_view',
  id: 'plmweb.baseline_product_create_view',
};
