export default {
  ...
  deviewId: '7422ee165ae4594264f6e9228ffcf6a9',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
            ...
            uiactionGroupDetails: [
              {
                ...
                uiactionId: 'set_complete_product@baseline',
                tooltip: '设立完成',
                showIcon: true,
                sysImage: {
              ...
              },
              {
                ...
                caption: '编辑',
                detailType: 'DEUIACTION',
                uiactionId: 'open_product_update_view@baseline',
                showCaption: true,
                showIcon: true,
                sysImage: {
                  cssClass: 'fa fa-edit',
      ...
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.baseline.product_baseline_grid',
    },
    {
