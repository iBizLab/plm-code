export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'project_update_view',
  deviewId: '4E7E6385-BD55-40CF-927B-81244E5DA284',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.BASELINE',
  },
  caption: '编辑基线',
  codeName: 'baseline_project_update_view',
  height: 580,
  ...
  controls: [
    ...
    {
      codeName: 'project_update_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'project_update_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.BASELINE',
      ...
      caption: '编辑基线',
      codeName: 'project_update_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.baseline',
      controlParam: {},
      name: 'captionbar',
      id: 'project_update_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '338030e1d749f0ea95e5e809dcd98c4e',
  modelType: 'PSAPPDEVIEW',
  name: 'baselineproject_update_view',
  id: 'plmweb.baseline_project_update_view',
};
