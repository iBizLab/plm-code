export default {
  ...
  loadDefault: true,
  deviewCodeName: 'space_categories_pick_up_tree_view',
  deviewId: '33cc653088f5ae66729030a0fbbbde68',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '基线选择',
      codeName: 'space_categories_pick_up_tree_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.baseline',
      controlParam: {},
      name: 'captionbar',
      id: 'space_categories_pick_up_tree_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'b3a1892c6c79286735d84c795761c9b8',
  modelType: 'PSAPPDEVIEW',
  name: 'baselinespace_categories_pick_up_tree_view',
