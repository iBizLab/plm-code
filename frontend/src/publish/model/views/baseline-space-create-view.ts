export default {
  ...
  caption: '新建基线',
  codeName: 'baseline_space_create_view',
  height: 580,
  ...
  controls: [
    ...
    {
      codeName: 'space_create_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'space_create_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.BASELINE',
      ...
      caption: '新建基线',
      codeName: 'space_create_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.baseline',
      controlParam: {},
      name: 'captionbar',
      id: 'space_create_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
