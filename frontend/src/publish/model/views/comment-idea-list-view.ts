export default {
  ...
  loadDefault: true,
  deviewCodeName: 'idea_list_view',
  deviewId: 'a0a487df6a7b58114819287e2e6ad637',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.COMMENT',
  },
  caption: '评论',
  codeName: 'comment_idea_list_view',
  ...
  viewLayoutPanel: {
    ...
    controls: [
      ...
      },
      {
        ...
        caption: '评论',
        codeName: 'idea_list_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.comment',
        controlParam: {},
        name: 'captionbar',
        id: 'idea_list_view_captionbar',
      },
    ],
  ...
  modelId: '9fa26f24a612267d8ebcd895b9a27dd2',
  modelType: 'PSAPPDEVIEW',
  name: 'commentidea_list_view',
  id: 'plmweb.comment_idea_list_view',
};
