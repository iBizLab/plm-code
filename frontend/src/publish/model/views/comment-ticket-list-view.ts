export default {
  ...
  loadDefault: true,
  deviewCodeName: 'ticket_list_view',
  deviewId: '34802f8289d299ab813a59a9367c6ad3',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    controls: [
      ...
      },
      {
        ...
        caption: '评论',
        codeName: 'ticket_list_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.comment',
        controlParam: {},
        name: 'captionbar',
        id: 'ticket_list_view_captionbar',
      },
    ],
  ...
  modelId: '7f993863469d4be7430e2f76a3b121a8',
  modelType: 'PSAPPDEVIEW',
  name: 'commentticket_list_view',
