export default {
  ...
  controls: [
    ...
    {
      codeName: 'add_category_option_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'add_category_option_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.CUSTOMER',
      ...
      caption: '选择类别',
      codeName: 'add_category_option_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.customer',
      controlParam: {},
      name: 'captionbar',
      id: 'add_category_option_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
