export default {
  ...
  caption: '客户',
  codeName: 'customer_idea_customer_info_view',
  ...
  controls: [
    {
      ...
      xdataControlName: 'form',
      codeName: 'idea_customer_info_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '需求客户信息视图_工具栏',
      appDataEntityId: 'plmweb.customer',
      controlParam: {
        id: 'toolbar',
      },
    ...
    },
    {
      ...
      getDraftControlAction: {
        appDEMethodId: 'get_idea_customer_info',
        appDataEntityId: 'plmweb.customer',
        id: 'loaddraft',
      },
      getControlAction: {
              ...
              deformDetails: [
                {
                  ...
                  deformDetails: [
                    ...
                    },
                    {
                            ...
                            },
                            {
                              ...
                              editor: {
                                ...
                                editorParams: {
                                  ...
                                  showText: 'true',
                                  format: '0',
                                  textItem: 'very_important',
                                },
                                editorType: 'SLIDER',
                                valueType: 'SIMPLE',
                                editable: true,
                                id: 'very_important_precent',
                              },
                              allowEmpty: true,
                              caption: '非常重要',
                              codeName: 'very_important_precent',
                              detailStyle: 'DEFAULT',
                              detailType: 'FORMITEM',
                              layoutPos: {
                                grow: 1,
                          ...
                          deformDetails: [
                            ...
                            },
                            {
                              ...
                              editor: {
                                ...
                                valueType: 'SIMPLE',
                                editable: true,
                                id: 'important_precent',
                              },
                              allowEmpty: true,
                              caption: '重要',
                              codeName: 'important_precent',
                              detailStyle: 'DEFAULT',
                              detailType: 'FORMITEM',
                              layoutPos: {
                                grow: 1,
                          ...
                          deformDetails: [
                            {
                              rawItem: {
                                sysImage: {
                                  rawContent:
                                    '<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg t="1719912444933" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="12015" xmlns:xlink="http://www.w3.org/1999/xlink" width="22" height="22"><path d="M512 899.5c-213.668 0-387.5-173.832-387.5-387.5S298.332 124.5 512 124.5 899.5 298.332 899.5 512 725.668 899.5 512 899.5z" fill="#bfbfbf" p-id="12016"></path><path d="M512 137c-206.776 0-375 168.224-375 375s168.224 375 375 375 375-168.224 375-375-168.224-375-375-375m0-25c220.914 0 400 179.086 400 400S732.914 912 512 912 112 732.914 112 512s179.086-400 400-400z" fill="#bfbfbf" p-id="12017"></path><path d="M597.681 335.009c0-7.67-2.36-13.569-7.08-17.109a35.115 35.115 0 0 0-20.061-5.9c-3.54 0-6.49 1.77-10.029 4.13-3.54 2.95-6.49 5.31-8.26 7.08a75.758 75.758 0 0 0-11.211 13.569c-3.54 4.72-7.67 9.44-11.209 13.569-11.209 12.979-23.009 27.139-35.988 41.3-13.569 14.749-26.549 27.729-38.938 39.528-1.18 1.18-2.95 2.36-4.13 3.54l-4.72 2.36c-1.77 1.18-3.54 1.77-4.72 2.95l-5.31 3.54c-2.95 2.36-5.31 4.13-7.08 5.9-2.36 2.36-2.95 4.13-2.95 5.9 0 7.08 2.95 12.389 10.03 16.519 5.9 4.72 12.979 6.49 20.059 6.49a31.985 31.985 0 0 0 14.756-3.543c4.13-2.36 8.26-5.9 12.979-10.619 2.95-3.54 6.49-7.67 11.209-12.979l11.8-12.979c2.95-2.95 7.67-7.67 13.569-14.159s12.389-14.159 20.649-23.009c-1.77 9.44-3.54 20.649-4.72 33.628-2.36 12.979-4.13 25.959-5.9 40.118l-4.72 41.888c-1.18 14.159-2.36 27.729-2.95 39.528-1.18 22.419-2.36 44.838-2.95 67.257q-1.77 33.628-1.77 58.407c0 9.44 2.36 16.519 7.67 21.829 5.31 5.9 12.389 8.26 21.829 8.26a43.479 43.479 0 0 0 15.929-3.54c4.72-2.36 7.67-5.31 7.67-8.85 0-1.77-0.59-5.31-0.59-11.209a149.392 149.392 0 0 1-2.36-18.879 116.91 116.91 0 0 1-2.36-21.239 132.008 132.008 0 0 1-1.18-20.649c0-41.3 1.18-82.6 4.72-124.484 3.54-41.3 10.03-82.6 20.649-123.3a106.366 106.366 0 0 1 2.95-11.209l2.36-11.209 1.77-11.209c-0.002-3.547 0.588-7.086 0.588-11.216z" fill="#2c2c2c" p-id="12018"></path></svg>',
                                },
                                contentType: 'IMAGE',
                                id: 'rawitem5',
                              },
                          ...
                          deformDetails: [
                            {
                              rawItem: {
                                sysImage: {
                                  rawContent:
                                    '<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg t="1719912492625" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="13828" xmlns:xlink="http://www.w3.org/1999/xlink" width="22" height="22"><path d="M512 899.5c-213.668 0-387.5-173.832-387.5-387.5S298.332 124.5 512 124.5 899.5 298.332 899.5 512 725.668 899.5 512 899.5z" fill="#bfbfbf" p-id="13829"></path><path d="M512 137c-206.776 0-375 168.224-375 375s168.224 375 375 375 375-168.224 375-375-168.224-375-375-375m0-25c220.914 0 400 179.086 400 400S732.914 912 512 912 112 732.914 112 512s179.086-400 400-400z" fill="#bfbfbf" p-id="13830"></path><path d="M647.03 472.831C647.03 366.006 609.048 312 533.677 312q-71.217 0-115.727 78.338Q377 462.445 377 561.258c0 48.665 10.089 85.46 31.454 111.573C429.226 698.944 460.086 712 500.442 712c50.445 0 89.021-26.706 115.134-80.712 20.771-42.73 31.454-95.549 31.454-158.457z m-44.51 5.341c0 49.852-8.9 93.175-26.706 131.157-20.178 41.543-45.1 62.315-75.371 62.315-52.226 0-78.338-37.389-78.338-113.353q0-81.9 32.047-144.214c21.365-40.95 46.291-61.721 75.371-61.721 48.664 0 72.996 42.137 72.996 125.816z" fill="#2c2c2c" p-id="13831"></path></svg>',
                                },
                                contentType: 'IMAGE',
                                id: 'rawitem6',
                              },
                            ...
                            },
                            {
                              ...
                              editor: {
                                ...
                                editorParams: {
                                  ...
                                  showText: 'true',
                                  format: '0',
                                  textItem: 'not_important',
                                },
                                editorType: 'SLIDER',
                                valueType: 'SIMPLE',
                                editable: true,
                                id: 'not_important_precent',
                              },
                              allowEmpty: true,
                              caption: '不重要',
                              codeName: 'not_important_precent',
                              detailStyle: 'DEFAULT',
                              detailType: 'FORMITEM',
                              layoutPos: {
                                grow: 1,
                      ...
                      sysCss: {
                        cssName: 'main-info-common-view17',
                      },
                      showCaption: true,
                      id: 'grouppanel1',
                    },
    ...
    {
      codeName: 'idea_customer_info_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'idea_customer_info_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.CUSTOMER',
      ...
      caption: '客户',
      codeName: 'idea_customer_info_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.customer',
      controlParam: {},
      name: 'captionbar',
      id: 'idea_customer_info_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
