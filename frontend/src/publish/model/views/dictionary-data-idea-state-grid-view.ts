export default {
  ...
  caption: '状态管理',
  codeName: 'dictionary_data_idea_state_grid_view',
  ...
  appViewMsgGroupId: 'usrvmgroup0418749588',
  appViewNavParams: [
    {
      key: 'n_catalog_eq',
      value: 'catalog',
  ...
  controls: [
      ...
      degridColumns: [
        ...
        },
        {
          deuiactionGroup: {
            ...
            appDataEntityId: 'plmweb.dictionary_data',
            uniqueTag: 'dictionary_data__Usr0425442651',
            name: '需求配置_编辑&删除',
            id: 'usr0425442651',
          },
          aggMode: 'NONE',
    ...
    },
    {
      ...
      xdataControlName: 'grid',
      codeName: 'idea_state_grid_view_tabtoolbar',
      controlType: 'TOOLBAR',
      ...
      name: 'tabtoolbar',
      id: 'idea_state_grid_view_tabtoolbar',
    },
    {
      groupMode: 'SINGLE',
      controlType: 'SEARCHBAR',
    ...
    },
    {
      ...
      caption: '状态管理',
      codeName: 'idea_state_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.dictionary_data',
      controlParam: {},
      name: 'captionbar',
      id: 'idea_state_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
