export default {
  ...
  caption: '编辑状态',
  codeName: 'dictionary_data_state_edit_view',
  height: 320,
  ...
  controls: [
    {
      ...
      codeName: 'editor_view_form',
      controlType: 'FORM',
      logicName: '状态管理编辑视图_表单',
      appDataEntityId: 'plmweb.dictionary_data',
      controlParam: {
        id: 'form',
      },
    ...
    {
      codeName: 'state_edit_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'state_edit_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.DICTIONARY',
      ...
      caption: '编辑状态',
      codeName: 'state_edit_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.dictionary_data',
      controlParam: {},
      name: 'captionbar',
      id: 'state_edit_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
