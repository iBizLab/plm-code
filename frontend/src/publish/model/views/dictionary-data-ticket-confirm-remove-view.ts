  ...
  controls: [
    {
          ...
          deformDetails: [
            {
              ...
              deformDetails: [
                ...
                },
                {
                  ...
                  updateDV: '状态删除后，使用状态的工单会继续保留当前状态。',
                  allowEmpty: true,
                  codeName: 'remind',
                  detailStyle: 'DEFAULT',
                  detailType: 'FORMITEM',
      ...
      codeName: 'ticket_remove_view_form',
      controlType: 'FORM',
      logicName: '工单配置状态管理确认删除_表单',
      appDataEntityId: 'plmweb.dictionary_data',
      controlParam: {
        id: 'form',
      },
    ...
    {
      codeName: 'ticket_confirm_remove_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'ticket_confirm_remove_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.DICTIONARY',
      ...
      caption: '确认删除',
      codeName: 'ticket_confirm_remove_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.dictionary_data',
      controlParam: {},
      name: 'captionbar',
      id: 'ticket_confirm_remove_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
