export default {
  ...
  loadDefault: true,
  deviewCodeName: 'my_create_grid_view',
  deviewId: '8b0f4eb9f49793ca439fb484a28f3c7f',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      name: 'toolbar',
      id: 'my_create_grid_view_toolbar',
    },
    {
      aggMode: 'NONE',
    ...
    },
    {
      ...
      controlParam: {},
      name: 'captionbar',
      id: 'my_create_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '61264fe5f8ed295a3cce13de0f50b149',
