export default {
  ...
  loadDefault: true,
  deviewCodeName: 'recent_grid_view',
  deviewId: '0783B2D9-562D-49FC-AB8B-D57A2456CA13',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.DISCUSS_POST',
  },
  caption: '最新讨论',
  codeName: 'discuss_post_recent_grid_view',
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'recent_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '发起讨论',
      appDataEntityId: 'plmweb.discuss_post',
      controlParam: {
    ...
    },
    {
      ...
      caption: '最新讨论',
      codeName: 'recent_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.discuss_post',
      controlParam: {},
      name: 'captionbar',
      id: 'recent_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '0f014eb33c70a951adac40b3bd430711',
  modelType: 'PSAPPDEVIEW',
  name: 'discuss_postrecent_grid_view',
  id: 'plmweb.discuss_post_recent_grid_view',
};
