export default {
  ...
  deviewId: 'B8EA3728-CEE1-4860-AD4F-DBBB0B5E027A',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      controls: [
        {
          ...
          modelId: '411FAA63-92FE-4279-AFE1-0B601C1D27EF',
      ...
      modelId: '9b1cce8d9ae2311b19740f4c41753810_treeexpbar',
      modelType: 'PSEXPBAR',
      name: 'treeexpbar',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '9b1cce8d9ae2311b19740f4c41753810',
