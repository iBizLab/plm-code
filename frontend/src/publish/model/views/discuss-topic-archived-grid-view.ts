export default {
  ...
  deviewId: '26192e56a2cf81a708e78044938e23cd',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      navViewPos: 'NONE',
      fetchControlAction: {
        appDEMethodId: 'fetch_archived_main',
        appDataEntityId: 'plmweb.discuss_topic',
        id: 'fetch',
      },
      removeControlAction: {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'a7675c586acc237f3ab9824bda2f262e',
  modelType: 'PSAPPDEVIEW',
  name: 'discuss_topicarchived_grid_view',
