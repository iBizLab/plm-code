export default {
  ...
  deviewId: '5fa1ddb73c660580c024cd48d3273709',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.DISCUSS_TOPIC',
  },
  caption: '话题',
  codeName: 'discuss_topic_pickup_grid_view',
  ...
  title: '话题选择表格视图',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.DISCUSS_TOPIC.PICKUPGRIDVIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DEPICKUPGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: 'abee13c212ce59912d4e274bd7e34089',
  modelType: 'PSAPPDEVIEW',
  name: 'discuss_topicPickupGridView',
  id: 'plmweb.discuss_topic_pickup_grid_view',
};
