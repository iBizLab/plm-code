export default {
  ...
  deviewId: 'E061E27D-7E4F-43D9-AD88-A13D7CABA1B5',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.DISCUSS_TOPIC.TREE_EXP_VIEW',
  },
  caption: '协助空间',
  ...
  controls: [
    {
      ...
      appViewRefs: [
        {
          realTitle: '话题实体表格视图（全部话题）',
          realTitleLanguageRes: {
            lanResTag: 'PAGE.TITLE.DISCUSS_TOPIC.ALL_GRID_VIEW',
          },
          refAppViewId: 'plmweb.discuss_topic_all_grid_view',
          name: 'EXPITEM:node_10',
          id: 'expitem:node_10',
        },
        {
          realTitle: '话题实体表格视图（组织话题）',
          realTitleLanguageRes: {
            lanResTag: 'PAGE.TITLE.DISCUSS_TOPIC.ALL_GRID_VIEW',
          },
          refAppViewId: 'plmweb.discuss_topic_org_grid_view',
          name: 'EXPITEM:node_11',
          id: 'expitem:node_11',
        },
        {
          realTitle: '话题实体表格视图（团队话题）',
          realTitleLanguageRes: {
            lanResTag: 'PAGE.TITLE.DISCUSS_TOPIC.ALL_GRID_VIEW',
          },
          refAppViewId: 'plmweb.discuss_topic_group_grid_view',
          name: 'EXPITEM:node_12',
          id: 'expitem:node_12',
        },
        {
          realTitle: '话题实体表格视图（归档话题）',
          realTitleLanguageRes: {
            lanResTag: 'PAGE.TITLE.DISCUSS_TOPIC.ALL_GRID_VIEW',
          },
          refAppViewId: 'plmweb.discuss_topic_archived_grid_view',
          name: 'EXPITEM:node_3',
          id: 'expitem:node_3',
        },
        {
          realTitle: '讨论实体表格视图（最新讨论）',
          refAppViewId: 'plmweb.discuss_post_recent_grid_view',
          name: 'EXPITEM:node_5',
          id: 'expitem:node_5',
        },
        {
      ...
      controls: [
        {
          ...
          detreeNodes: [
            ...
            {
              text: '全部话题',
              navAppViewId: 'plmweb.discuss_topic_all_grid_view',
              nodeType: 'node_10',
              sysImage: {
                height: 20,
                rawContent:
            ...
            {
              text: '组织话题',
              navAppViewId: 'plmweb.discuss_topic_org_grid_view',
              nodeType: 'node_11',
              navigateContexts: [
                {
                  key: 'SCOPE_TYPE',
            ...
            {
              text: '团队话题',
              navAppViewId: 'plmweb.discuss_topic_group_grid_view',
              nodeType: 'node_12',
              navigateContexts: [
                {
                  key: 'SCOPE_TYPE',
            ...
            {
              text: '归档话题',
              navAppViewId: 'plmweb.discuss_topic_archived_grid_view',
              nodeType: 'node_3',
              sysImage: {
                rawContent:
            ...
            },
            {
              ...
              decontextMenu: {
                detoolbarItems: [
                  {
                    actionLevel: 200,
                    noPrivDisplayMode: 2,
                    uiactionId: 'open_discuss_topic_setting@discuss_topic',
                    uiactionTarget: 'NONE',
                    valid: true,
                    caption: '打开话题配置',
                    itemType: 'DEUIACTION',
                ...
                modelId: '125AB223-9AD5-49D0-BD49-FBDF5A5B30D8',
            ...
            {
              text: '最新讨论',
              navAppViewId: 'plmweb.discuss_post_recent_grid_view',
              nodeType: 'node_5',
              sysImage: {
                rawContent:
            ...
            },
            {
              ...
              decontextMenu: {
                detoolbarItems: [
                  {
                    actionLevel: 200,
                    noPrivDisplayMode: 2,
                    uiactionId: 'open_index_view@discuss_topic',
                ...
                modelId: 'CA4DB425-B441-4952-9071-9CA9A8D70423',
                modelType: 'PSDETOOLBAR',
                name: 'node_9_cm',
          ...
          modelId: '8CCB73B8-FD36-4902-B911-42D1462E2187',
          modelType: 'PSDETREEVIEW',
          name: 'treeexpbar_tree',
          id: 'plmweb.discuss_topic.tree_exp_view_tree_view',
        },
      ],
      ...
      modelId: '2a4a06406230d1948b724cada3994e01_treeexpbar',
      modelType: 'PSEXPBAR',
      name: 'treeexpbar',
  ...
  title: '话题树导航视图',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.DISCUSS_TOPIC.TREE_EXP_VIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DETREEEXPVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: '2a4a06406230d1948b724cada3994e01',
  modelType: 'PSAPPDEVIEW',
  name: 'discuss_topictree_exp_view',
