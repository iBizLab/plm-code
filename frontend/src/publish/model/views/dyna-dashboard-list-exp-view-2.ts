export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'list_exp_view2',
  deviewId: 'e8d9b13887f06da282e2d9819d733352',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.DYNADASHBOARD',
  },
  caption: '仪表盘模板列表',
  codeName: 'dyna_dashboard_list_exp_view2',
  height: 90,
    ...
    controls: [
      {
        ...
        codeName: 'list_exp_view2_listexpbar',
        controlType: 'LISTEXPBAR',
        appDataEntityId: 'plmweb.dyna_dashboard',
        controlParam: {
          id: 'listexpbar',
        },
        modelId: '211d0c82a90ab1847446491ff15f92d8_listexpbar',
        modelType: 'PSEXPBAR',
        name: 'listexpbar',
        id: 'list_exp_view2_listexpbar',
      },
      {
        groupMode: 'SINGLE',
        quickSearchMode: 1,
      ...
      },
      {
        ...
        caption: '仪表盘模板列表',
        codeName: 'list_exp_view2_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.dyna_dashboard',
        controlParam: {},
        name: 'captionbar',
        id: 'list_exp_view2_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '211d0c82a90ab1847446491ff15f92d8',
  modelType: 'PSAPPDEVIEW',
  name: 'dyna_dashboardlist_exp_view2',
  id: 'plmweb.dyna_dashboard_list_exp_view2',
};
