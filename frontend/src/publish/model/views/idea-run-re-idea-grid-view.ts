export default {
  ...
  caption: '需求',
  codeName: 'idea_run_re_idea_grid_view',
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        xdataControlName: 'grid',
        codeName: 'run_re_idea_grid_view_toolbar',
        controlType: 'TOOLBAR',
        ...
        name: 'toolbar',
        id: 'run_re_idea_grid_view_toolbar',
      },
      {
        aggMode: 'NONE',
        ...
        modelId: '1DFFC069-F85D-4EEC-B0D4-B8706791EBE6',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.idea.no_button_re_grid',
      },
      {
  ...
  id: 'plmweb.idea_run_re_idea_grid_view',
};
