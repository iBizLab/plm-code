export default {
  ...
  deviewId: '5a0621f3a0fc97b1f1ee28ba53c13147',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IDEA',
  },
  caption: '需求',
  codeName: 'idea_test_case_re_idea_grid_view',
    ...
    controls: [
      {
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'grid',
        codeName: 'test_case_re_idea_grid_view_toolbar',
        controlType: 'TOOLBAR',
        ...
        modelId: 'd611902b883cdf6246b111ab9c639ad0',
      ...
      },
      {
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetch_test_case_relation',
          appDataEntityId: 'plmweb.idea',
          id: 'fetch',
        },
      ...
      },
      {
        ...
        caption: '需求',
        codeName: 'test_case_re_idea_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.idea',
        controlParam: {},
        name: 'captionbar',
        id: 'test_case_re_idea_grid_view_captionbar',
      },
    ],
    codeName: 'test_case_re_idea_grid_view',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: '测试用例关联需求表格视图布局',
    appDataEntityId: 'plmweb.idea',
    controlLogics: [
      {
        eventNames: 'onChange',
        ...
        logicType: 'APPDEUILOGIC',
        appDEUILogicId: 'test_case_relation_idea',
        appDataEntityId: 'plmweb.idea',
  ...
  modelId: '894faa128bf0047c8ab1e2aead9dbc20',
  modelType: 'PSAPPDEVIEW',
  name: 'ideatest_case_re_idea_grid_view',
  id: 'plmweb.idea_test_case_re_idea_grid_view',
};
