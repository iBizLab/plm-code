export default {
  ...
  deviewId: '18d6542b81b9bd100fb7ef7b6a1f4e8d',
  accUserMode: 2,
  capLanguageRes: {
  ...
  title: '工作项关联需求表格视图',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.IDEA.WORK_ITEM_RE_IDEA_GRIDVIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DEGRIDVIEW',
  enableDP: true,
  showCaptionBar: false,
  modelId: 'd877b5fa8a8197e5743e61f70f114c38',
  modelType: 'PSAPPDEVIEW',
  name: 'ideawork_item_re_idea_grid_view',
