export default {
  ...
  loadDefault: true,
  deviewCodeName: 'ticket_re_idea_gridview',
  deviewId: 'EB6FF06E-2DCF-4D7E-B38A-E0EA1D9DF6BB',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IDEA',
  },
  caption: '需求',
  codeName: 'ideaticket_re_idea_gridview',
  ...
  viewLayoutPanel: {
    ...
    rootPanelItems: [
      ...
      },
      {
        editor: {
          ...
          singleSelect: true,
          pickupAppViewId: 'plmweb.ideaproduct_plan_re_idea_view2',
    ...
    controls: [
      {
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetchticket_relation_idea',
          appDataEntityId: 'plmweb.idea',
          id: 'fetch',
        },
      ...
      },
      {
        ...
        xdataControlName: 'grid',
        codeName: 'ticket_re_idea_gridviewtoolbar',
        controlType: 'TOOLBAR',
        logicName: '添加需求',
        appDataEntityId: 'plmweb.idea',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'ticket_re_idea_gridviewtoolbar',
      },
      {
        groupMode: 'SINGLE',
        quickSearchMode: 1,
      ...
      },
      {
        ...
        caption: '需求',
        codeName: 'ticket_re_idea_gridviewcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.idea',
        controlParam: {},
        name: 'captionbar',
        id: 'ticket_re_idea_gridviewcaptionbar',
      },
    ],
    codeName: 'Usr0112866957',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'ticket_re_idea_gridview表格视图布局',
    appDataEntityId: 'plmweb.idea',
    controlLogics: [
      {
        eventNames: 'onChange',
    ...
    controlParam: {},
    modelId: 'F4FD6233-3874-44AC-87FF-BF706F6315D7',
  ...
  modelId: 'dd080a9bb58032202cfcb0bdeef6cdc3',
  modelType: 'PSAPPDEVIEW',
  name: 'ideaticket_re_idea_gridview',
  id: 'plmweb.ideaticket_re_idea_gridview',
};
