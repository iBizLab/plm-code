export default {
  ...
  loadDefault: true,
  deviewCodeName: 'work_item_re_idea_gridview',
  deviewId: 'E3E2D08F-88FF-48C2-99CF-61FFB2252FC9',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.IDEA',
  },
  caption: '需求',
  codeName: 'ideawork_item_re_idea_gridview',
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        ...
        xdataControlName: 'grid',
        codeName: 'work_item_re_idea_gridviewtoolbar',
        controlType: 'TOOLBAR',
        logicName: '添加需求',
        appDataEntityId: 'plmweb.idea',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'work_item_re_idea_gridviewtoolbar',
      },
      {
        aggMode: 'NONE',
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetchwork_item_relation_idea',
          appDataEntityId: 'plmweb.idea',
          id: 'fetch',
        },
      ...
      },
      {
        ...
        caption: '需求',
        codeName: 'work_item_re_idea_gridviewcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.idea',
        controlParam: {},
        name: 'captionbar',
        id: 'work_item_re_idea_gridviewcaptionbar',
      },
    ],
    codeName: 'Usr0112657618',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'work_item_re_idea_gridview表格视图布局',
    appDataEntityId: 'plmweb.idea',
    controlLogics: [
      {
        eventNames: 'onChange',
    ...
    controlParam: {},
    modelId: 'FCB8E60C-2431-4BAF-AEC5-BED05885CF4C',
  ...
  modelId: '5bc0b56135f4409e9b86be127347d55f',
  modelType: 'PSAPPDEVIEW',
  name: 'ideawork_item_re_idea_gridview',
  id: 'plmweb.ideawork_item_re_idea_gridview',
};
