export default {
  ...
  loadDefault: true,
  deviewCodeName: 'kanban_grid_view',
  deviewId: '51356ef0827f3365bbb51e1b91260c46',
  accUserMode: 2,
  capLanguageRes: {
  ...
  appViewNavContexts: [
    {
      rawValue: true,
      key: 'PROJECT',
      value: 'e4177683-b419-8999-f325-ab689a8bcac1',
      name: 'PROJECT',
      id: 'project',
    },
  ],
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '全部报表',
      codeName: 'kanban_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.insight',
      controlParam: {},
      name: 'captionbar',
      id: 'kanban_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '9ad19884882f94134d2b481ea48bff98',
  modelType: 'PSAPPDEVIEW',
  name: 'insightkanban_grid_view',
