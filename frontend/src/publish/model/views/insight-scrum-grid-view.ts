export default {
  ...
  loadDefault: true,
  deviewCodeName: 'Scrum_grid_view',
  deviewId: '3f726555fa34518009c2d7d8db5e76d4',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '全部报表',
      codeName: 'scrum_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.insight',
      controlParam: {},
      name: 'captionbar',
      id: 'scrum_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '1617fcaddbeaa5b27584a87b8936583a',
  modelType: 'PSAPPDEVIEW',
  name: 'insightScrum_grid_view',
