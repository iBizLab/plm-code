export default {
  ...
  deviewId: '38dd754353f1631a3647a906f86a58be',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.INSIGHT_VIEW.TEAM_GRID_VIEW',
  },
  caption: '团队视图',
  codeName: 'insight_view_team_grid_view',
  ...
  controls: [
    {
      xdataControlName: 'grid',
      codeName: 'team_grid_view_toolbar',
      controlType: 'TOOLBAR',
    ...
    },
    {
      ...
      caption: '团队视图',
      codeName: 'team_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.insight_view',
      controlParam: {},
      name: 'captionbar',
      id: 'team_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '5afc10ae36a6cfe3a717421e1b2dd455',
  modelType: 'PSAPPDEVIEW',
  name: 'insight_viewteam_grid_view',
  id: 'plmweb.insight_view_team_grid_view',
};
