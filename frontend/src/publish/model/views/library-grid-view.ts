export default {
  ...
  deviewId: '0ec59277dbfba26ce5b4bd5bde6933c8',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.LIBRARY',
  },
  caption: '测试库',
  codeName: 'libraryGridView',
  ...
  appViewLogics: [
    ...
    },
    {
      ...
      builtinAppUILogic: {
        openDataAppView: {
          refAppViewId: 'plmweb.library_setting_view',
        },
        editMode: true,
        appUILogicRefViews: [
          {
  ...
  title: '测试库表格视图',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.LIBRARY.GRIDVIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DEGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: 'ced074c818a6a06a7ba048136fb3f33f',
  modelType: 'PSAPPDEVIEW',
  name: 'libraryGridView',
  id: 'plmweb.librarygridview',
};
