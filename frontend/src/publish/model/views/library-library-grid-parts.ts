export default {
  ...
  caption: '测试库列表',
  codeName: 'library_library_grid_parts',
              ...
              },
              {
                ...
                panelItems: [
                  ...
                  },
                  {
                    rawItem: {
                      content:
                        '<p><span style="color: #ced4d9;">个测试库</span></p>',
                      contentType: 'HTML',
                      predefinedType: 'STATIC_TEXT',
                      id: 'static_text',
                    },
    ...
    controls: [
      {
        ...
        xdataControlName: 'grid',
        codeName: 'library_grid_parts_toolbar',
        controlType: 'TOOLBAR',
        logicName: '测试库表格视图（仪表盘部件）_工具栏',
        appDataEntityId: 'plmweb.library',
        controlParam: {
          id: 'toolbar',
        },
      ...
      },
      {
        ...
        codeName: 'library_grid_parts_grid',
        controlType: 'GRID',
        logicName: '测试库表格视图（仪表盘部件）_表格',
        appDataEntityId: 'plmweb.library',
        controlParam: {
          id: 'grid',
        },
      ...
      },
      {
        ...
        autoLoad: true,
        showBusyIndicator: true,
        codeName: 'library_grid_parts_search_form',
        controlType: 'SEARCHFORM',
        logicName: '测试库表格视图（仪表盘部件）_搜索表单',
        appDataEntityId: 'plmweb.library',
        controlParam: {
          id: 'searchform',
        },
      ...
      },
      {
        ...
        caption: '测试库列表',
        codeName: 'library_grid_parts_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.library',
        controlParam: {},
        name: 'captionbar',
        id: 'library_grid_parts_captionbar',
      },
    ],
    codeName: 'usr1112950127',
