export default {
  ...
  deviewId: '1963162b7de472669aca1122c75f4aee',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.LIBRARY',
  },
  caption: '测试库',
  codeName: 'libraryPickupGridView',
  ...
  title: '测试库选择表格视图',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.LIBRARY.PICKUPGRIDVIEW',
  },
  viewStyle: 'DEFAULT',
  viewType: 'DEPICKUPGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: '3956f8ef3946f8339583d7977de8f43e',
  modelType: 'PSAPPDEVIEW',
  name: 'libraryPickupGridView',
  id: 'plmweb.librarypickupgridview',
};
