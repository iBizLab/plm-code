export default {
  ...
  deviewId: '418344644e29168ea03703fd9235286f',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.LIBRARY',
  },
  caption: '新建测试库',
  codeName: 'library_quick_create_view',
  ...
  controls: [
    {
      ...
      controlType: 'FORM',
      logicName: '测试库快速建立_表单',
      appDataEntityId: 'plmweb.library',
      controlParam: {
        id: 'form',
      },
      modelId: 'b21267929843ac6229be28e49d6327d6',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'plmweb.library.quick_create',
    },
    {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '56e755fd1afceaf6c7aec0c2de86b816',
  modelType: 'PSAPPDEVIEW',
  name: 'libraryquick_create_view',
  id: 'plmweb.library_quick_create_view',
};
