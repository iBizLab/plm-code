export default {
  ...
  controls: [
    {
      ...
      appViewRefs: [
        {
          realTitle: '全部测试库',
          refAppViewId: 'plmweb.librarygrid_view_all',
          name: 'EXPITEM:node_1',
          id: 'expitem:node_1',
        },
        {
          realTitle: '我负责的测试计划',
          refAppViewId: 'plmweb.test_plangrid_view_my_assignee',
          name: 'EXPITEM:node_5',
          id: 'expitem:node_5',
        },
        {
          realTitle: '我参与的测试计划',
          refAppViewId: 'plmweb.test_plangrid_view_my_part',
          name: 'EXPITEM:node_6',
          id: 'expitem:node_6',
        },
        {
          realTitle: '进行中的测试计划',
          refAppViewId: 'plmweb.test_plangrid_view_in_progress',
          name: 'EXPITEM:node_7',
          id: 'expitem:node_7',
        },
      ],
      controls: [
        {
          ...
          detreeNodes: [
            ...
            {
              text: '全部测试库',
              navAppViewId: 'plmweb.librarygrid_view_all',
              nodeType: 'node_1',
              sysImage: {
                height: 20,
                rawContent:
            ...
            },
            {
              ...
              decontextMenu: {
                ...
                codeName: 'tree_exp_viewnode_10_cm',
            ...
            {
              text: '我负责的',
              navAppViewId: 'plmweb.test_plangrid_view_my_assignee',
              nodeType: 'node_5',
              sysImage: {
                rawContent:
            ...
            {
              text: '我参与的',
              navAppViewId: 'plmweb.test_plangrid_view_my_part',
              nodeType: 'node_6',
              sysImage: {
                rawContent:
            ...
            {
              text: '进行中的',
              navAppViewId: 'plmweb.test_plangrid_view_in_progress',
              nodeType: 'node_7',
              sysImage: {
                rawContent:
            ...
            },
            {
              ...
              decontextMenu: {
                ...
                codeName: 'tree_exp_viewnode_8_cm',
                controlType: 'CONTEXTMENU',
                logicName: '测试库配置',
                appDataEntityId: 'plmweb.library',
                controlParam: {
          ...
          id: 'plmweb.library.tree_exp_view_treeview',
        },
      ],
  ...
  id: 'plmweb.librarytree_exp_view',
};
