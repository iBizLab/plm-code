export default {
  ...
  caption: '成员设置',
  codeName: 'member_all_resource_mpick_up_view',
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        embeddedAppDEViewId: 'plmweb.member_all_resource_mpick_up_grid_view',
        codeName: 'all_resource_mpick_up_view_pickupviewpanel',
        ...
        id: 'all_resource_mpick_up_view_pickupviewpanel',
      },
      {
        title: '成员管理',
        ...
        codeName: 'all_resource_mpick_up_view_treeexpbar',
      ...
      },
      {
        ...
        caption: '成员设置',
        codeName: 'all_resource_mpick_up_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.member',
        controlParam: {},
        name: 'captionbar',
        id: 'all_resource_mpick_up_view_captionbar',
      },
    ],
