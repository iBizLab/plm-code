export default {
  openMode: 'POPUPMODAL',
  deviewCodeName: 'portfolio_resource_mpick_up_view',
  deviewId: 'BCDDFBEA-E1AC-4A6F-883D-1F611CA2C3AC',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.MEMBER',
  },
  caption: '成员设置',
  codeName: 'member_portfolio_resource_mpick_up_view',
    ...
    controls: [
      {
        ...
        codeName: 'portfolio_resource_mpick_up_view_pickupviewpanel',
        ...
        id: 'portfolio_resource_mpick_up_view_pickupviewpanel',
      },
      {
        title: '成员管理',
        ...
        controls: [
          {
            ...
            autoLoad: true,
            showBusyIndicator: true,
            codeName: 'portfolio_resource_mpick_up_tree_view',
            controlStyle: 'GROUP_TREE',
            controlType: 'TREEVIEW',
            logicName: '项目集资源成员多项选择视图_树视图',
            appDataEntityId: 'plmweb.member',
            controlLogics: [
              {
            ...
            modelId: 'A11CD8C8-DF12-4987-A01A-B6FB28741AE1',
            modelType: 'PSDETREEVIEW',
            name: 'treeexpbar_tree',
            id: 'plmweb.member.portfolio_resource_mpick_up_tree_view',
          },
        ],
        codeName: 'portfolio_resource_mpick_up_view_treeexpbar',
        controlType: 'TREEEXPBAR',
        appDataEntityId: 'plmweb.member',
        controlParam: {
          id: 'treeexpbar',
        },
        modelId: 'bccb2b5b2a7f4f03decc0650a55aeca8_treeexpbar',
        modelType: 'PSEXPBAR',
        name: 'treeexpbar',
        id: 'portfolio_resource_mpick_up_view_treeexpbar',
      },
      {
        groupMode: 'NONE',
        groupStyle: 'DEFAULT',
      ...
      },
      {
        ...
        caption: '成员设置',
        codeName: 'portfolio_resource_mpick_up_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.member',
        controlParam: {},
        name: 'captionbar',
        id: 'portfolio_resource_mpick_up_view_captionbar',
      },
    ],
  ...
  modelId: 'bccb2b5b2a7f4f03decc0650a55aeca8',
  modelType: 'PSAPPDEVIEW',
  name: 'memberportfolio_resource_mpick_up_view',
  id: 'plmweb.member_portfolio_resource_mpick_up_view',
};
