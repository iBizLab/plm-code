export default {
  ...
  caption: '已删除',
  codeName: 'portfolioproject_set_delete_grid_view',
  ...
  controls: [
    {
      ...
      singleSelect: true,
      fetchControlAction: {
        appDEMethodId: 'fetchproject_set_deleted',
        appDataEntityId: 'plmweb.portfolio',
        id: 'fetch',
      },
      removeControlAction: {
      ...
      codeName: 'Project_set_deleted_grid',
      controlType: 'GRID',
      logicName: '已删除项目集_表格',
      appDataEntityId: 'plmweb.portfolio',
      controlParam: {
    ...
    },
    {
      ...
      caption: '已删除',
      codeName: 'project_set_delete_grid_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.portfolio',
      controlParam: {},
      name: 'captionbar',
      id: 'project_set_delete_grid_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
