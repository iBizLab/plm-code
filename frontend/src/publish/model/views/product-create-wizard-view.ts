  ...
  controls: [
    {
          ...
          deformPages: [
            {
              ...
              deformDetails: [
                ...
                },
                {
                  ...
                  deformDetails: [
                    {
                      appViewId: 'plmweb.product_member_assigned_grid_view',
                      parentDataJO: {
                        SRFPARENTTYPE: 'DER1N',
                        srfparentdename: 'PRODUCT',
                        srfparentmode:
                          'DER1N_PRODUCT_MEMBER_PRODUCT_PRODUCT_ID',
                        srfparentdefname: 'PRODUCT_ID',
                        SRFDER1NID: 'DER1N_PRODUCT_MEMBER_PRODUCT_PRODUCT_ID',
                      },
                      codeName: 'druipart1',
                      contentHeight: 500,
                      detailStyle: 'DEFAULT',
      ...
      dewizard: {
        ...
        wizardStyle: 'DEFAULT',
        name: '产品新建向导',
        id: 'prodmgmt.product.product_wizard',
      },
      wizardStyle: 'DEFAULT',
      showActionBar: true,
      showStepBar: true,
