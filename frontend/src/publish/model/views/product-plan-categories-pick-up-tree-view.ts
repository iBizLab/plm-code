export default {
  ...
  deviewId: '12c7d6d50f5550cba012a273d8397a84',
  accUserMode: 2,
  caption: '类别选择',
  ...
  controls: [
    {
      ...
      name: 'tree',
      id: 'plmweb.product_plan.pickup_tree',
    },
    {
      groupMode: 'SINGLE',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '4b517bfb20b41f90dc5090d3149359c4',
  modelType: 'PSAPPDEVIEW',
  name: 'product_plancategories_pick_up_tree_view',
  id: 'plmweb.product_plan_categories_pick_up_tree_view',
};
