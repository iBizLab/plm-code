export default {
  ...
  deviewId: 'EFF7A305-FB0A-49EE-BB73-B564FEAFB56A',
  accUserMode: 2,
  caption: '排期模块',
  codeName: 'product_plantree_exp_view',
  ...
  controls: [
    {
      ...
      appViewRefs: [
        {
          realTitle: '全部计划',
          refAppViewId: 'plmweb.product_plangrid_view_all',
          name: 'EXPITEM:node',
          id: 'expitem:node',
        },
        {
      ...
      controls: [
        {
          ...
          detreeNodes: [
            ...
            {
              text: '全部计划',
              navAppViewId: 'plmweb.product_plangrid_view_all',
              nodeType: 'node',
              sysImage: {
                ...
                detoolbarItems: [
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_tree_exp_viewnode_1_cm_deuiaction1_click@product_plan',
                  ...
                  },
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_tree_exp_viewnode_1_cm_deuiaction2_click@product_plan',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '删除',
                    itemType: 'DEUIACTION',
                ...
                detoolbarItems: [
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_tree_exp_viewnode_2_cm_deuiaction1_click@product_plan',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '编辑',
                    itemType: 'DEUIACTION',
                  ...
                  },
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_tree_exp_viewnode_2_cm_deuiaction2_click@product_plan',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '删除',
                    itemType: 'DEUIACTION',
                ...
                detoolbarItems: [
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_tree_exp_viewnode_3_cm_deuiaction1_click@product_plan',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '编辑',
                    itemType: 'DEUIACTION',
                  ...
                  },
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_tree_exp_viewnode_3_cm_deuiaction2_click@product_plan',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '删除',
                    itemType: 'DEUIACTION',
          ...
          modelId: 'CE5B5312-46DF-474D-A98A-5E4D92056555',
          modelType: 'PSDETREEVIEW',
          name: 'treeexpbar_tree',
          id: 'plmweb.product_plan.tree_exp_view_treeview',
        },
        {
          detoolbarItems: [
            {
              detoolbarItems: [
                {
                  ...
                  noPrivDisplayMode: 2,
                  uiactionId:
                    'toolbar_tree_exp_viewtreeexpbar_toolbar_deuiaction2_click@product_plan',
                  uiactionTarget: 'SINGLEDATA',
                  valid: true,
                  caption: '新建分组',
                  itemType: 'DEUIACTION',
                ...
                },
                {
                  ...
                  noPrivDisplayMode: 2,
                  uiactionId:
                    'toolbar_tree_exp_viewtreeexpbar_toolbar_deuiaction1_click@product_plan',
                  uiactionTarget: 'SINGLEDATA',
                  valid: true,
                  caption: '新建类别',
                  itemType: 'DEUIACTION',
          ...
          modelId: 'F98D852B-AFC1-4F04-9B9D-D1258C16344D',
          modelType: 'PSDETOOLBAR',
      ...
      modelId: '7343d261c5989dd261229cae60ed18cc_treeexpbar',
      modelType: 'PSEXPBAR',
      name: 'treeexpbar',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '7343d261c5989dd261229cae60ed18cc',
  modelType: 'PSAPPDEVIEW',
  name: 'product_plantree_exp_view',
  id: 'plmweb.product_plantree_exp_view',
};
