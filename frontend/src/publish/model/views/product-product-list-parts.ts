              ...
              },
              {
                ...
                panelItems: [
                  ...
                  },
                  {
                    rawItem: {
                      content:
                        '<p><span style="color: #ced4d9;">个产品</span></p>',
                      contentType: 'HTML',
                      predefinedType: 'STATIC_TEXT',
                      id: 'static_text',
                    },
    ...
    controls: [
      {
        ...
        xdataControlName: 'grid',
        codeName: 'product_list_parts_toolbar',
        controlType: 'TOOLBAR',
        logicName: '产品列表部件_工具栏',
        appDataEntityId: 'plmweb.product',
        controlParam: {
          id: 'toolbar',
        },
      ...
      },
      {
        ...
        codeName: 'product_list_parts_grid',
        controlType: 'GRID',
        logicName: '产品列表部件_表格',
        appDataEntityId: 'plmweb.product',
        controlParam: {
      ...
      },
      {
        ...
        autoLoad: true,
        showBusyIndicator: true,
        codeName: 'product_list_parts_search_form',
        controlType: 'SEARCHFORM',
        logicName: '产品列表部件_搜索表单',
        appDataEntityId: 'plmweb.product',
        controlParam: {
          id: 'searchform',
        },
      ...
      {
        caption: '产品列表',
        codeName: 'product_list_parts_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.product',
        controlParam: {},
        name: 'captionbar',
        id: 'product_list_parts_captionbar',
      },
    ],
    codeName: 'usr1114719630',
