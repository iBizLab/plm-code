export default {
  ...
  deviewId: '88829667e798863813a6ad281267406d',
  accUserMode: 2,
  caption: '新建产品',
  codeName: 'product_quick_create_view',
  ...
  controls: [
    {
      ...
      modelId: '43bffc968fb7069d185b5ffd91be1dab',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'plmweb.product.quick_create',
    },
    {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '23463a57863587145a0a83f5e3064e00',
  modelType: 'PSAPPDEVIEW',
  name: 'productquick_create_view',
  id: 'plmweb.product_quick_create_view',
};
