      ...
      dedrctrlItems: [
        {
          ...
          caption: '产品成员',
          appViewId: 'plmweb.product_membergrid_view_config',
          id: 'member',
        },
        {
          dedrbarGroupId: 'usrdrgroup0314526198',
          caption: '标签管理',
          appViewId: 'plmweb.product_taggrid_view_tag',
          id: 'tag',
        },
        {
          dedrbarGroupId: 'usrdrgroup0314526198',
          ...
          enableMode: 'DEOPPRIV',
          appViewId: 'plmweb.productrecover_tab_exp_view',
          id: 'recycle',
        },
        {
          ...
          dataAccessAction: 'UPDATE',
          enableMode: 'DEOPPRIV',
          appViewId: 'plmweb.productedit_view_base_information',
          id: 'base',
        },
        {
          dedrbarGroupId: 'usrdrgroup0314383150',
          ...
          dataAccessAction: 'UPDATE',
          enableMode: 'DEOPPRIV',
          appViewId: 'plmweb.productedit_view_advanced_setting',
          id: 'adv',
        },
      ],
