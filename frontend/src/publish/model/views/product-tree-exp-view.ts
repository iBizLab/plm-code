  ...
  controls: [
    {
      ...
      appViewRefs: [
        ...
        {
          realTitle: '团队产品',
          refAppViewId: 'plmweb.product_team_grid_view',
          name: 'EXPITEM:node_4',
          id: 'expitem:node_4',
        },
        {
      ...
      controls: [
        {
          ...
          detreeNodes: [
            ...
            {
              text: '全部产品',
              navAppViewId: 'plmweb.product_all_grid_view',
              nodeType: 'node_2',
              sysImage: {
                height: 20,
                rawContent:
            ...
            {
              text: '团队产品',
              navAppViewId: 'plmweb.product_team_grid_view',
              nodeType: 'node_4',
              navigateContexts: [
                {
                  key: 'SCOPE_TYPE',
          ...
          id: 'plmweb.product.tree_exp_view_tree_view',
        },
      ],
