export default {
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        ...
        dedrctrlItems: [
          {
            ...
            caption: '需求',
            appViewId: 'plmweb.ideatree_exp_view',
            id: 'idea',
          },
          {
            dedrbarGroupId: 'usrdrgroup1228149482',
            caption: '排期',
            appViewId: 'plmweb.product_plantree_exp_view',
            id: 'plan',
          },
          {
            dedrbarGroupId: 'usrdrgroup1228280909',
            caption: '工单',
            appViewId: 'plmweb.ticketgrid_view_all',
            id: 'ticket',
          },
          {
            dedrbarGroupId: 'usrdrgroup1228275731',
            caption: '客户',
            appViewId: 'plmweb.customertree_exp_view',
            id: 'customer',
          },
          {
        ...
        uniqueTag: 'productindex_view__drbar',
        autoLoad: true,
    ...
    codeName: 'DECustomIndexViewLayout_Product',
    ...
    name: 'layoutpanel',
    id: 'decustomindexviewlayout_product',
  },
  title: '产品',
  viewStyle: 'DEFAULT',
