export default {
  ...
  deviewId: '5a1fd966bf3ee5c6a095192547b67cb3',
  accUserMode: 2,
  caption: '产品管理',
  codeName: 'producttree_exp_view',
  ...
  controls: [
    {
      ...
      appViewRefs: [
        {
          realTitle: '全部产品',
          refAppViewId: 'plmweb.productgrid_view_all',
          name: 'EXPITEM:node_2',
          id: 'expitem:node_2',
        },
      ],
      controls: [
        {
          ...
          detreeNodes: [
            ...
            },
            {
              ...
              decontextMenu: {
                ...
                modelId: 'F835C1E9-4933-4FDE-A272-CEBF6131D636',
            ...
            {
              text: '全部产品',
              navAppViewId: 'plmweb.productgrid_view_all',
              nodeType: 'node_2',
              sysImage: {
                height: 20,
                rawContent:
            ...
            },
            {
              ...
              decontextMenu: {
                detoolbarItems: [
                  {
                    actionLevel: 200,
                    noPrivDisplayMode: 2,
                    uiactionId: 'open_index_view@product',
                ...
                modelId: '470519CF-D714-4385-A38B-ED4B49799FF8',
                modelType: 'PSDETOOLBAR',
                name: 'node_6_cm',
          ...
          id: 'plmweb.product.tree_exp_view_treeview',
        },
      ],
      ...
      modelId: '14a6fede1677027bc02b5df6e085e52c_treeexpbar',
      modelType: 'PSEXPBAR',
      name: 'treeexpbar',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '14a6fede1677027bc02b5df6e085e52c',
  modelType: 'PSAPPDEVIEW',
  name: 'producttree_exp_view',
  id: 'plmweb.producttree_exp_view',
};
