export default {
  loadDefault: true,
  deviewCodeName: 'hybrid_index_view',
  deviewId: '69B073D4-AD64-4E18-B04B-F336FE90FBD6',
  accUserMode: 2,
  caption: '项目',
  codeName: 'project_hybrid_index_view',
    ...
    controls: [
      {
        ...
        showTitle: true,
        dataRelationTag: 'hybrid',
        editItemCaption: '项目',
        appCounterRefId: '523b788cdaca5c955fbd487737fed2f8',
        dedrctrlItems: [
          {
          ...
          },
          {
            ...
            counterMode: 1,
            enableMode: 'COUNT_GTE_ZERO',
            appViewId: 'plmweb.work_item_dyna_hybrid_tree_grid_view',
            navigateParams: [
              {
                key: 'project_type',
                value: 'hybrid',
          ...
          },
          {
            ...
            counterMode: 1,
            enableMode: 'COUNT_GTE_ZERO',
            appViewId: 'plmweb.work_item_hybrid_kanban_view',
            navigateContexts: [
              {
                key: 'BOARD',
                value: 'project',
          ...
          {
            dedrbarGroupId: 'usrdrgroup1225643013',
            caption: '资源',
            counterId: 'resource',
            counterMode: 1,
            enableMode: 'COUNT_GTE_ZERO',
        ...
        uniqueTag: 'project_hybrid_index_view__drbar',
        autoLoad: true,
        showBusyIndicator: true,
        appCounterRefs: [
          {
            appCounter: {
              codeName: 'hybrid_project_add_on_counters',
              counterType: 'DEDR',
              getAppDEActionId: 'hybrid_index_addon_counter',
              appDataEntityId: 'plmweb.project',
              uniqueTag: 'hybrid_project_add_on_counters',
              name: 'hybrid项目组件显示隐藏计数器',
              id: 'plmweb.hybrid_project_add_on_counters',
            },
            refMode: {
              srfdeid: 'PROJECT',
            },
            tag: '523b788cdaca5c955fbd487737fed2f8',
            uniqueTag: 'hybrid_project_add_on_counters',
            id: '523b788cdaca5c955fbd487737fed2f8',
          },
        ],
        codeName: 'hybrid',
        ...
        modelId: '0D332402-1DD7-4691-8CEF-5E6F25548B0A',
        modelType: 'PSDEDRBAR',
        name: 'drbar',
        id: 'hybrid',
      },
      ...
      },
      {
        ...
        toolbarStyle: 'USER',
        codeName: 'hybrid_index_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '主视图工具栏',
        appDataEntityId: 'plmweb.project',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'hybrid_index_view_toolbar',
      },
      {
        caption: '项目',
        codeName: 'hybrid_index_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.project',
        controlParam: {},
        name: 'captionbar',
        id: 'hybrid_index_view_captionbar',
      },
    ],
    codeName: 'usr1120404616',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: '自定义实体首页视图布局面板（hybrid）',
    appDataEntityId: 'plmweb.project',
    controlParam: {},
    modelId: 'A5623324-E304-41DA-A30B-DED4BEE9DD61',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'b06800d21953cfd1b61a069d10fa2db7',
  modelType: 'PSAPPDEVIEW',
  name: 'projecthybrid_index_view',
  id: 'plmweb.project_hybrid_index_view',
};
