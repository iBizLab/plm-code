export default {
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        ...
        dedrctrlItems: [
          ...
          },
          {
            ...
            counterMode: 1,
            enableMode: 'COUNT_GTE_ZERO',
            appViewId: 'plmweb.work_item_kanban_view',
            navigateContexts: [
              {
                key: 'BOARD',
                value: 'project',
          ...
          },
          {
            ...
            counterMode: 1,
            enableMode: 'COUNT_GTE_ZERO',
            appViewId: 'plmweb.insight_kanban_tree_exp_view',
            id: 'report',
          },
        ],
        uniqueTag: 'project_kanban_index_view__drbar',
        autoLoad: true,
        showBusyIndicator: true,
        appCounterRefs: [
          {
            appCounter: {
              codeName: 'kanban_project_add_on_counters',
              counterType: 'DEDR',
              getAppDEActionId: 'kanban_index_addon_counter',
              appDataEntityId: 'plmweb.project',
              uniqueTag: 'kanban_project_add_on_counters',
              name: '看板项目组件显示隐藏计数器',
              id: 'plmweb.kanban_project_add_on_counters',
            },
            refMode: {
              srfdeid: 'PROJECT',
            },
      ...
      },
      {
        ...
        toolbarStyle: 'USER',
        codeName: 'kanban_index_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '主视图工具栏',
        appDataEntityId: 'plmweb.project',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'kanban_index_view_toolbar',
      },
      {
        caption: '项目',
        codeName: 'kanban_index_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.project',
        controlParam: {},
        name: 'captionbar',
        id: 'kanban_index_view_captionbar',
      },
    ],
    codeName: 'de_custom_index_view_layout',
    ...
    name: 'layoutpanel',
    id: 'de_custom_index_view_layout',
  },
  title: '主数据视图kanban',
  viewStyle: 'DEFAULT',
