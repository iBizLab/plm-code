export default {
  ...
  loadDefault: true,
  deviewCodeName: 'move_choose_pick_up_grid_view',
  deviewId: '650ece5a9ff254d453a2d83cd14950ff',
  accUserMode: 2,
  caption: '项目',
  ...
  controls: [
    ...
    {
      caption: '项目',
      codeName: 'move_choose_pick_up_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.project',
      controlParam: {},
      name: 'captionbar',
      id: 'move_choose_pick_up_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  title: '工作项移动时选择视图_选择数据视图',
  viewStyle: 'DEFAULT',
  viewType: 'DEPICKUPGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: '089184e234290704712e83244311cf6a',
  modelType: 'PSAPPDEVIEW',
  name: 'projectmove_choose_pick_up_grid_view',
