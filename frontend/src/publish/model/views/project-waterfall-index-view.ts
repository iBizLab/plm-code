    ...
    controls: [
      {
        ...
        dedrctrlItems: [
          ...
          },
          {
            ...
            counterMode: 1,
            enableMode: 'COUNT_GTE_ZERO',
            appViewId: 'plmweb.work_item_waterfall_tree_grid_view',
            id: 'work_item',
          },
          {
        ...
        appCounterRefs: [
          {
            appCounter: {
              codeName: 'waterfall_project_add_on_counters',
              counterType: 'DEDR',
              getAppDEActionId: 'waterfall_index_addon_counter',
              appDataEntityId: 'plmweb.project',
              uniqueTag: 'waterfall_project_add_on_counters',
              name: '瀑布项目组件显示隐藏计数器',
              id: 'plmweb.waterfall_project_add_on_counters',
            },
            refMode: {
              srfdeid: 'PROJECT',
            },
