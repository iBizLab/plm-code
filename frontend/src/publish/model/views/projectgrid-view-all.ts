export default {
  ...
  deviewId: '2de6e7b11325375a1a81bb011bbb8d02',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.PROJECT.GRID_VIEW_ALL',
  },
  caption: '全部项目',
  codeName: 'projectgrid_view_all',
  ...
  appViewLogics: [
    {
      ...
      builtinAppUILogic: {
        ...
        newDataAppView: {
          openMode: 'POPUPMODAL',
          refAppViewId: 'plmweb.projectcreate_wizard_view',
        },
        appUILogicRefViews: [
          {
            openMode: 'POPUPMODAL',
  ...
  appViewRefs: [
    {
      ...
      realTitle: '项目快速建立',
      refAppViewId: 'plmweb.projectquick_create_view',
      name: 'OPENDATA',
      id: 'opendata',
    },
    {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'a422ef310a5c9ffd2d46b1fa363e35c1',
  modelType: 'PSAPPDEVIEW',
  name: 'projectgrid_view_all',
  id: 'plmweb.projectgrid_view_all',
};
