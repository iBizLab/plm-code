export default {
  loadDefault: true,
  deviewCodeName: 'main_data_waterfall',
  deviewId: '0EDA2E62-CA6A-45DB-B6C7-9E8A3F89A739',
  accUserMode: 2,
  caption: '项目',
  codeName: 'projectmain_data_waterfall',
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        ...
        dedrctrlItems: [
          ...
          },
          {
            ...
            caption: '里程碑',
            appViewId: 'plmweb.work_itemgrid_view_milestone',
            id: 'milestone',
          },
          {
            dedrbarGroupId: 'usrdrgroup1225224021',
            caption: '交付物',
            appViewId: 'plmweb.deliverablegrid_view',
            navigateParams: [
              {
                key: 'project_id',
                value: 'project',
          ...
          },
          {
            ...
            caption: '工作项',
            appViewId: 'plmweb.work_itemgrid_view_all_waterfall',
            id: 'workitem',
          },
          {
            dedrbarGroupId: 'usrdrgroup1225507417',
            caption: '需求',
            appViewId: 'plmweb.work_itemgrid_view_story_waterfall',
            id: 'story',
          },
          {
        ...
        uniqueTag: 'projectmain_data_waterfall__drbar',
        autoLoad: true,
      ...
      },
      {
        ...
        codeName: 'main_data_waterfalltoolbar',
        controlType: 'TOOLBAR',
        logicName: '主视图工具栏',
        appDataEntityId: 'plmweb.project',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'main_data_waterfalltoolbar',
      },
      {
        caption: '项目',
        codeName: 'main_data_waterfallcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.project',
        controlParam: {},
        name: 'captionbar',
        id: 'main_data_waterfallcaptionbar',
      },
    ],
    codeName: 'DECustomIndexViewLayout_waterfall',
    ...
    name: 'layoutpanel',
    id: 'decustomindexviewlayout_waterfall',
  },
  title: '主数据视图waterfall（测试）',
  viewStyle: 'DEFAULT',
  viewType: 'DEINDEXVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: '4325c91b3c07bdd86c89c39ae58a4d39',
  modelType: 'PSAPPDEVIEW',
  name: 'projectmain_data_waterfall',
  id: 'plmweb.projectmain_data_waterfall',
};
