export default {
  ...
  loadDefault: true,
  deviewCodeName: 'move_choose_pickup_view_PickupGridView',
  deviewId: 'FFB5AE65-9A69-4FED-A48D-584CB215FC42',
  accUserMode: 2,
  caption: '项目',
  codeName: 'projectmove_choose_pickup_view_PickupGridView',
  ...
  controls: [
    ...
    },
    {
      ...
      autoLoad: true,
      showBusyIndicator: true,
      codeName: 'Usr02200129_SearchForm',
      ...
      modelId: 'C5AADA6F-59EF-44FD-A426-3FBDC86B6671',
      modelType: 'PSDEFORM_SEARCHFORM',
      name: 'searchform',
      id: 'plmweb.project.usr02200129_searchform',
    },
    {
      groupMode: 'SINGLE',
    ...
    {
      caption: '项目',
      codeName: 'move_choose_pickup_view_PickupGridViewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.project',
      controlParam: {},
      name: 'captionbar',
      id: 'move_choose_pickup_view_pickupgridviewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'd67b06ed6d5c94cbc6b22e8826836b71',
  modelType: 'PSAPPDEVIEW',
  name: 'projectmove_choose_pickup_view_PickupGridView',
  id: 'plmweb.projectmove_choose_pickup_view_pickupgridview',
};
