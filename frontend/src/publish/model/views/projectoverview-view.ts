export default {
  ...
  loadDefault: true,
  deviewCodeName: 'overview_view',
  deviewId: 'fad6f3f49bc96a07de3d81da243a5b4b',
  accUserMode: 2,
  caption: '概览',
  codeName: 'projectoverview_view',
  ...
  controls: [
      ...
      controls: [
        {
          ...
          id: 'overview_viewdashboard_container1',
        },
        {
          layout: {
            columnCount: 24,
          ...
          id: 'overview_viewdashboard_container2',
        },
      ],
      codeName: 'overview',
    ...
    {
      caption: '概览',
      codeName: 'overview_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.project',
      controlParam: {},
      name: 'captionbar',
      id: 'overview_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: '20788196eb75cfb9bbdedc21b7660f98',
  modelType: 'PSAPPDEVIEW',
  name: 'projectoverview_view',
  id: 'plmweb.projectoverview_view',
};
