export default {
      ...
      appViewRefs: [
        {
          ...
          refAppViewId: 'plmweb.projectgrid_view_all',
          name: 'EXPITEM:all',
          id: 'expitem:all',
        },
        {
          realTitle: '筛选器表格视图',
          refAppViewId: 'plmweb.work_itemfilter_grid_view',
          name: 'EXPITEM:filter',
          id: 'expitem:filter',
        },
        {
          ...
          refAppViewId: 'plmweb.portfolioproject_grid_view',
      ...
      controls: [
        {
          ...
          detreeNodes: [
            ...
            {
              text: '全部项目',
              navAppViewId: 'plmweb.projectgrid_view_all',
              nodeType: 'all',
              sysImage: {
                height: 20,
                rawContent:
            ...
            },
            {
              ...
              decontextMenu: {
                ...
                codeName: 'tree_exp_viewconfig_cm',
                ...
                modelId: 'A7164136-D10E-4920-8314-F1264FB51959',
                modelType: 'PSDETOOLBAR',
                name: 'config_cm',
                id: 'tree_exp_viewconfig_cm',
              },
              sysImage: {
                rawContent:
            ...
            {
              text: '筛选器',
              navAppViewId: 'plmweb.work_itemfilter_grid_view',
              nodeType: 'filter',
              sysImage: {
                rawContent:
            ...
            },
            {
              ...
              decontextMenu: {
                ...
                modelId: '09062165-7DBD-4CDC-A055-BB72CBF45BC3',
                modelType: 'PSDETOOLBAR',
                name: 'node_1_cm',
            ...
            },
            {
              ...
              decontextMenu: {
                ...
                codeName: 'tree_exp_viewnode_favorite_cm',
                controlType: 'CONTEXTMENU',
                logicName: '星标项目树节点菜单',
                appDataEntityId: 'plmweb.project',
                controlParam: {
                ...
                modelId: 'E9CBCE74-5910-42B9-AC90-B41AB2914A6F',
                modelType: 'PSDETOOLBAR',
                name: 'node_favorite_cm',
                id: 'tree_exp_viewnode_favorite_cm',
              },
              sysImage: {
                rawContent:
            ...
            {
              text: '项目集',
              navAppViewId: 'plmweb.portfolioproject_grid_view',
  ...
  id: 'plmweb.projecttree_exp_view',
};
