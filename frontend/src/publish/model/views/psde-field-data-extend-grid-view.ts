export default {
  ...
  appViewMsgGroupId: 'usrvmgroup1024188673',
  appViewNavParams: [
    {
      rawValue: true,
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'data_extend_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '新建属性',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {
    ...
    },
    {
      ...
      controlParam: {},
      name: 'captionbar',
      id: 'data_extend_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '3104794495e67a5c12fdcdc70c6e53f3',
  modelType: 'PSAPPDEVIEW',
  name: 'PSDEFielddata_extend_grid_view',
  id: 'plmweb.psde_field_data_extend_grid_view',
};
