export default {
  ...
  deviewId: '1ea37913f66a77fb51ce5d6fe27c5824',
  accUserMode: 2,
  caption: '实体属性',
  codeName: 'psde_field_global_idea_grid_view',
  ...
  appViewMsgGroupId: 'usrvmgroup1024293256',
  appViewNavParams: [
    {
      rawValue: true,
  ...
  controls: [
    ...
    },
    {
      ...
      xdataControlName: 'grid',
      codeName: 'global_idea_grid_view_tabtoolbar',
      controlType: 'TOOLBAR',
      logicName: '新建属性',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {
      ...
      name: 'tabtoolbar',
      id: 'global_idea_grid_view_tabtoolbar',
    },
    {
      groupMode: 'SINGLE',
      controlType: 'SEARCHBAR',
    ...
    {
      caption: '实体属性',
      codeName: 'global_idea_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {},
      name: 'captionbar',
      id: 'global_idea_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: '3d971376972b935954c03c3e43a15626',
  modelType: 'PSAPPDEVIEW',
  name: 'PSDEFieldglobal_idea_grid_view',
  id: 'plmweb.psde_field_global_idea_grid_view',
};
