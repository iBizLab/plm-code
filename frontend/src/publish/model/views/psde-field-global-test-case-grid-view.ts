export default {
  ...
  loadDefault: true,
  deviewCodeName: 'global_test_case_grid_view',
  deviewId: '809150fe0ecc543391766a93a5339437',
  accUserMode: 2,
  caption: '实体属性',
  ...
  appViewMsgGroupId: 'usrvmgroup1024813853',
  appViewNavParams: [
    {
      rawValue: true,
  ...
  controls: [
    ...
    },
    {
      ...
      xdataControlName: 'grid',
      codeName: 'global_test_case_grid_view_tabtoolbar',
      controlType: 'TOOLBAR',
      logicName: '新建属性',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {
      ...
      name: 'tabtoolbar',
      id: 'global_test_case_grid_view_tabtoolbar',
    },
    {
      groupMode: 'SINGLE',
      controlType: 'SEARCHBAR',
    ...
    {
      caption: '实体属性',
      codeName: 'global_test_case_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {},
      name: 'captionbar',
      id: 'global_test_case_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: '07fd073029c64d21fc9ef8f5967bf611',
  modelType: 'PSAPPDEVIEW',
  name: 'PSDEFieldglobal_test_case_grid_view',
