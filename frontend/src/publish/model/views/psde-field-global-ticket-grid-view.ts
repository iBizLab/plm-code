export default {
  ...
  deviewId: '4eade2b5618ba4a1a2b435ad73da9f2d',
  accUserMode: 2,
  caption: '实体属性',
  codeName: 'psde_field_global_ticket_grid_view',
  ...
  appViewMsgGroupId: 'usrvmgroup1024351941',
  appViewNavParams: [
    {
      rawValue: true,
  ...
  controls: [
    ...
    },
    {
      ...
      xdataControlName: 'grid',
      codeName: 'global_ticket_grid_view_tabtoolbar',
      controlType: 'TOOLBAR',
      logicName: '新建属性',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {
      ...
      name: 'tabtoolbar',
      id: 'global_ticket_grid_view_tabtoolbar',
    },
    {
      groupMode: 'SINGLE',
      controlType: 'SEARCHBAR',
    ...
    {
      caption: '实体属性',
      codeName: 'global_ticket_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {},
      name: 'captionbar',
      id: 'global_ticket_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: 'fd631e491c27b3f8d4fc75e2ebaee376',
  modelType: 'PSAPPDEVIEW',
  name: 'PSDEFieldglobal_ticket_grid_view',
  id: 'plmweb.psde_field_global_ticket_grid_view',
};
