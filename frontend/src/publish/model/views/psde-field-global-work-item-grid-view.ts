export default {
  ...
  loadDefault: true,
  deviewCodeName: 'global_work_item_grid_view',
  deviewId: '33998eaab76e98fd29b2fc8b1a291852',
  accUserMode: 2,
  caption: '工作项属性',
  ...
  controls: [
    ...
    },
    {
      ...
      xdataControlName: 'grid',
      codeName: 'global_work_item_grid_view_tabtoolbar',
      controlType: 'TOOLBAR',
      logicName: '新建属性',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {
      ...
      name: 'tabtoolbar',
      id: 'global_work_item_grid_view_tabtoolbar',
    },
    {
      groupMode: 'SINGLE',
      controlType: 'SEARCHBAR',
    ...
    {
      caption: '工作项属性',
      codeName: 'global_work_item_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {},
      name: 'captionbar',
      id: 'global_work_item_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: 'f65bb9e120a4560b69d0fe0e5373dc95',
  modelType: 'PSAPPDEVIEW',
  name: 'PSDEFieldglobal_work_item_grid_view',
