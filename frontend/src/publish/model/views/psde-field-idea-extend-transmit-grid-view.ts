export default {
  ...
  loadDefault: true,
  deviewCodeName: 'idea_extend_transmit_grid_view',
  deviewId: '0faf6ce6579184d8555ad957c0986bd1',
  accUserMode: 2,
  caption: '实体属性',
  ...
  appViewMsgGroupId: 'usrvmgroup1024762248',
  appViewNavParams: [
    {
      rawValue: true,
  ...
  controls: [
    {
      ...
      name: 'tabtoolbar',
      id: 'idea_extend_transmit_grid_view_tabtoolbar',
    },
    {
    ...
    },
    {
      ...
      controlParam: {},
      name: 'captionbar',
      id: 'idea_extend_transmit_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: '1fd2d0066ad4b1ceef517781ec2c2089',
