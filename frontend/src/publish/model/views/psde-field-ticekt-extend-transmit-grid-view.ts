export default {
  ...
  loadDefault: true,
  deviewCodeName: 'ticekt_extend_transmit_grid_view',
  deviewId: '8e8babbfe9b8604671f2cf3b351be107',
  accUserMode: 2,
  caption: '实体属性',
  codeName: 'psde_field_ticekt_extend_transmit_grid_view',
  ...
  appViewMsgGroupId: 'usrvmgroup1024605800',
  appViewNavParams: [
    {
      rawValue: true,
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'ticekt_extend_transmit_grid_view_tabtoolbar',
      controlType: 'TOOLBAR',
      logicName: '新建属性',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {
      ...
      name: 'tabtoolbar',
      id: 'ticekt_extend_transmit_grid_view_tabtoolbar',
    },
    {
    ...
    {
      caption: '实体属性',
      codeName: 'ticekt_extend_transmit_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {},
      name: 'captionbar',
      id: 'ticekt_extend_transmit_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: 'cd7fcb7377d7a95b5634b7f7e6a1ddda',
  modelType: 'PSAPPDEVIEW',
  name: 'PSDEFieldticekt_extend_transmit_grid_view',
  id: 'plmweb.psde_field_ticekt_extend_transmit_grid_view',
};
