export default {
  ...
  loadDefault: true,
  deviewCodeName: 'work_item_extend_transmit_grid_view',
  deviewId: '8854b6f6ab427e63e80bd1e1be015c60',
  accUserMode: 2,
  caption: '工作项属性',
  ...
  appViewMsgGroupId: 'usrvmgroup0106327135',
  appViewNavParams: [
    {
      rawValue: true,
  ...
  controls: [
    ...
    },
    {
      ...
      xdataControlName: 'grid',
      codeName: 'work_item_extend_transmit_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '新建属性',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {
      ...
      name: 'toolbar',
      id: 'work_item_extend_transmit_grid_view_toolbar',
    },
    {
      groupMode: 'SINGLE',
      quickSearchMode: 1,
    ...
    {
      caption: '工作项属性',
      codeName: 'work_item_extend_transmit_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.psdefield',
      controlParam: {},
      name: 'captionbar',
      id: 'work_item_extend_transmit_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '1e2253964e73b734f14cdbfcdbca37cf',
  modelType: 'PSAPPDEVIEW',
  name: 'PSDEFieldwork_item_extend_transmit_grid_view',
