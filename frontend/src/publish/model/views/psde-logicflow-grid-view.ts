export default {
  ...
  loadDefault: true,
  deviewCodeName: 'flow_grid_view',
  deviewId: '9DDDEDE0-FBCA-4046-827E-09D88FA6ABDD',
  accUserMode: 2,
  caption: '自动化规则',
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'flow_grid_viewtoolbar',
      controlType: 'TOOLBAR',
    ...
    {
      caption: '自动化规则',
      codeName: 'flow_grid_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.psdelogic',
      controlParam: {},
      name: 'captionbar',
      id: 'flow_grid_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'd66e4ae6d4ee7b982a11db502d64e1b2',
  modelType: 'PSAPPDEVIEW',
  name: 'PSDELogicflow_grid_view',
  id: 'plmweb.psdelogicflow_grid_view',
};
