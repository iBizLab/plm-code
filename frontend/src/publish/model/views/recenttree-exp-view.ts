  ...
  controls: [
    {
      ...
      appViewRefs: [
        {
          realTitle: '我待完成的工作项',
          refAppViewId: 'plmweb.work_itemmy_todo_gird_view',
          name: 'EXPITEM:node_3',
          id: 'expitem:node_3',
        },
        {
          realTitle: '我负责的事项',
          refAppViewId: 'plmweb.recentmy_assignee_item_tap_exp_view',
          name: 'EXPITEM:node_5',
          id: 'expitem:node_5',
        },
        {
          realTitle: '我创建的事项',
          refAppViewId: 'plmweb.recentmy_created_tab_exp_view',
          name: 'EXPITEM:node_6',
          id: 'expitem:node_6',
        },
        {
          realTitle: '我关注的事项',
          refAppViewId: 'plmweb.attentiontab_exp_view',
          name: 'EXPITEM:node_8',
          id: 'expitem:node_8',
        },
        {
          realTitle: '工作台-概览',
          refAppViewId: 'plmweb.recentdata_view',
      ...
      controls: [
        {
          ...
          detreeNodes: [
            ...
            {
              text: '待完成事项',
              navAppViewId: 'plmweb.work_itemmy_todo_gird_view',
              nodeType: 'node_3',
              sysImage: {
                rawContent:
            ...
            },
            {
              ...
              navAppViewId: 'plmweb.recentmy_assignee_item_tap_exp_view',
              nodeType: 'node_5',
              sysImage: {
                rawContent:
            ...
            {
              text: '我创建的事项',
              navAppViewId: 'plmweb.recentmy_created_tab_exp_view',
              nodeType: 'node_6',
              sysImage: {
                rawContent:
            ...
            {
              text: '我关注的事项',
              navAppViewId: 'plmweb.attentiontab_exp_view',
              nodeType: 'node_8',
              sysImage: {
                rawContent:
            ...
            {
              text: '概览',
              navAppViewId: 'plmweb.recentdata_view',
              nodeType: 'overview',
              sysImage: {
                rawContent:
