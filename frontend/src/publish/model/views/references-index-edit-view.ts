export default {
  ...
  deviewId: 'c524315de87531f58d54a81fb52c1f63',
  accUserMode: 2,
  capLanguageRes: {
      ...
      deformPages: [
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.REFERENCES_INDEX.MAIN.GROUPPANEL.GROUP1',
              },
              caption: '引用索引基本信息',
              codeName: 'group1',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag:
              'CONTROL.DEFORM.REFERENCES_INDEX.MAIN.FORMPAGE.FORMPAGE1',
          },
          caption: '基本信息',
          codeName: 'formpage1',
          detailStyle: 'DEFAULT',
        ...
        },
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.REFERENCES_INDEX.MAIN.GROUPPANEL.GROUP2',
              },
              caption: '操作信息',
              codeName: 'group2',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag:
              'CONTROL.DEFORM.REFERENCES_INDEX.MAIN.FORMPAGE.FORMPAGE2',
          },
          caption: '其它',
          codeName: 'formpage2',
          detailStyle: 'DEFAULT',
  ...
  id: 'plmweb.references_index_edit_view',
};
