export default {
  ...
  deviewId: '6d14ea6d0a62d6895f483a2b76726561',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    controls: [
      ...
      },
      {
        ...
        navViewPos: 'NONE',
        fetchControlAction: {
          appDEMethodId: 'fetch_idea_re_test_case',
          appDataEntityId: 'plmweb.relation',
          id: 'fetch',
        },
        removeControlAction: {
        ...
        codeName: 'relation_test_case_grid',
        controlType: 'GRID',
        logicName: '关联用例_表格',
        appDataEntityId: 'plmweb.relation',
        controlLogics: [
        ...
        modelId: '3102628a6fdae1d47b2e86a22480dcb7',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.relation.relation_test_case_grid',
      },
      {
    ...
    controlParam: {},
    modelId: '9d712f10ecae0166c1e7c0317dee344d',
  ...
  modelId: '0787a2a835fabb1253b550a315e0b210',
  modelType: 'PSAPPDEVIEW',
  name: 'relationidea_re_test_case_grid_view',
