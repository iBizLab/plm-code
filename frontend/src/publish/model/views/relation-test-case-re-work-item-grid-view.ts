export default {
  ...
  deviewId: 'A7AB02F5-236A-441F-ABF4-48204039C7F0',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    codeName: 'test_case_re_work_item',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: '测试用例关联工作项表格视图布局',
    appDataEntityId: 'plmweb.relation',
    controlLogics: [
      {
        eventNames: 'onChange',
  ...
  modelId: 'a9d57fc15af27c93f28e565d7246d25b',
  modelType: 'PSAPPDEVIEW',
  name: 'relationtest_case_re_work_item_grid_view',
