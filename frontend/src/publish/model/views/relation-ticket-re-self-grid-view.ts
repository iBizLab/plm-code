export default {
  ...
  loadDefault: true,
  deviewCodeName: 'ticket_re_self_grid_view',
  deviewId: '3F238481-D401-4A1E-B56E-C4EE27ACD266',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.RELATION',
  },
  caption: '关联',
  codeName: 'relation_ticket_re_self_grid_view',
    ...
    rootPanelItems: [
      ...
      },
      {
        editor: {
          ...
          singleSelect: true,
          pickupAppViewId: 'plmweb.ticket_re_self_mpick_up_view',
    ...
    controls: [
      {
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'grid',
        codeName: 'ticket_re_self_grid_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '添加关联工单',
        appDataEntityId: 'plmweb.relation',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'ticket_re_self_grid_view_toolbar',
      },
      {
        aggMode: 'NONE',
        ...
        navViewPos: 'NONE',
        fetchControlAction: {
          appDEMethodId: 'fetch_ticket_re_self',
          appDataEntityId: 'plmweb.relation',
          id: 'fetch',
        },
        removeControlAction: {
      ...
      },
      {
        ...
        caption: '关联',
        codeName: 'ticket_re_self_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.relation',
        controlParam: {},
        name: 'captionbar',
        id: 'ticket_re_self_grid_view_captionbar',
      },
    ],
  ...
  modelId: 'f2a86f4ac51a05556b4104d84506dc08',
  modelType: 'PSAPPDEVIEW',
  name: 'relationticket_re_self_grid_view',
  id: 'plmweb.relation_ticket_re_self_grid_view',
};
