export default {
  ...
  caption: '关联',
  codeName: 'relation_ticket_re_work_item_grid_view',
    ...
    controls: [
      {
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'grid',
        codeName: 'ticket_re_work_item_grid_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '添加关联工作项',
        appDataEntityId: 'plmweb.relation',
        controlParam: {
      ...
      },
      {
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetch_ticket_re_work_item',
          appDataEntityId: 'plmweb.relation',
          id: 'fetch',
        },
        removeControlAction: {
      ...
      },
      {
        ...
        caption: '关联',
        codeName: 'ticket_re_work_item_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.relation',
        controlParam: {},
        name: 'captionbar',
        id: 'ticket_re_work_item_grid_view_captionbar',
      },
    ],
    codeName: 'usr0112765952',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: '工单关联工作项表格视图布局',
    appDataEntityId: 'plmweb.relation',
    controlLogics: [
      {
        eventNames: 'onChange',
