export default {
  ...
  loadDefault: true,
  deviewCodeName: 'work_item_re_ticket_list_view',
  deviewId: 'fce3609a21fcdbe7dcf6c3d07ff4e28f',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
      ...
      controlParam: {},
      name: 'captionbar',
      id: 'work_item_re_ticket_list_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: 'beccafc3814674114bffe032421fe627',
  modelType: 'PSAPPDEVIEW',
  name: 'relationwork_item_re_ticket_list_view',
  id: 'plmweb.relation_work_item_re_ticket_list_view',
};
