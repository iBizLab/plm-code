export default {
  ...
  deviewId: '20FE5126-BE38-45C8-9998-0956C91342A6',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.RELEASE',
  },
  caption: '项目发布',
  codeName: 'release_program_pickup_grid_view',
  ...
  controls: [
    {
      ...
      codeName: 'program_pickup_grid_view_grid',
      controlType: 'GRID',
      logicName: '规划计划的发布表格视图_表格',
      appDataEntityId: 'plmweb.release',
      controlLogics: [
        {
      ...
      modelId: '56EC97B9-F9BF-4F6A-85BC-539B563C7158',
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.release.program_pickup_grid_view_grid',
    },
    {
      ...
      autoLoad: true,
      showBusyIndicator: true,
      codeName: 'usr11134031_search_form',
      controlType: 'SEARCHFORM',
      logicName: '规划计划的发布表格视图_搜索表单',
      appDataEntityId: 'plmweb.release',
      controlParam: {
        id: 'searchform',
      },
      modelId: 'E1B2EF76-1583-476F-AFE3-34BA0E302E9C',
      modelType: 'PSDEFORM_SEARCHFORM',
      name: 'searchform',
      id: 'plmweb.release.usr11134031_search_form',
    },
    {
      groupMode: 'SINGLE',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'e1c540359175dbe7817cb57b5b669cc1',
  modelType: 'PSAPPDEVIEW',
  name: 'releaseprogram_pickup_grid_view',
  id: 'plmweb.release_program_pickup_grid_view',
};
