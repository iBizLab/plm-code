export default {
  ...
  deviewId: '447979A7-0354-4887-85CA-58AD083FF5D9',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.RELEASE',
  },
  caption: '新建发布',
  codeName: 'releasequick_create_view',
  height: 580,
          ...
          deformDetails: [
            ...
            },
            {
              ...
              editor: {
                ...
                showTrigger: true,
                editorParams: {
                  'srfnavparam.n_owner_subtype_eq': 'release',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'ed56e92db3bd58f30ae882e0785ac3c7',
  modelType: 'PSAPPDEVIEW',
  name: 'releasequick_create_view',
  id: 'plmweb.releasequick_create_view',
};
