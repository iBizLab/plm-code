export default {
  ...
  loadDefault: true,
  deviewCodeName: 'baseline_grid_view',
  deviewId: '9c34b9aa9e4dd8cbe5ee7bd56946822c',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'baseline_grid_view_toolbar',
      controlType: 'TOOLBAR',
    ...
    },
    {
      ...
      caption: '基线评审',
      codeName: 'baseline_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.review',
      controlParam: {},
      name: 'captionbar',
      id: 'baseline_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '72c95e53f6dea6e72e93d327145d534f',
  modelType: 'PSAPPDEVIEW',
  name: 'reviewbaseline_grid_view',
