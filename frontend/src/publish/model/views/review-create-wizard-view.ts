export default {
  ...
  deviewId: '0E569E72-CB1B-4A94-82F2-82285E85945A',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.REVIEW.CREATE_WIZARD_VIEW',
  },
  caption: '新建评审',
  codeName: 'review_create_wizard_view',
  height: 90,
  ...
  controls: [
    {
      ...
      deeditForms: [
        {
          ...
          modelId: '51E89F70-EB07-4400-B2D6-879A64529A1D',
          modelType: 'PSDEFORM_EDITFORM',
          name: 'wizardpanel_form_fill_info',
          id: 'plmweb.review.create_form',
        },
        {
          getControlAction: {
            appDEMethodId: 'gettemp',
          ...
          id: 'plmweb.review.create_re_test_case_form',
        },
      ],
      dewizard: {
        ...
        wizardStyle: 'DEFAULT',
        name: '评审新建向导视图_向导',
        id: 'testmgmt.review.create_wizard_view_wizard',
      },
      wizardStyle: 'DEFAULT',
      showActionBar: true,
      showStepBar: true,
      ...
      modelId: 'F1F8D096-9FEC-4DF6-AB98-B82F7BAE2A06',
      modelType: 'PSDEWIZARDPANEL',
      name: 'wizardpanel',
      id: 'plmweb.review.create_wizard_view_wizard',
    },
    {
      capLanguageRes: {
        lanResTag: 'PAGE.CAPTION.REVIEW.CREATE_WIZARD_VIEW',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '95c39db941c559273270a6cffcb1e30a',
  modelType: 'PSAPPDEVIEW',
  name: 'reviewcreate_wizard_view',
  id: 'plmweb.review_create_wizard_view',
};
