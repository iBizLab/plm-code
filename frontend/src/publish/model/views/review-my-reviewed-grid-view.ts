export default {
  ...
  loadDefault: true,
  deviewCodeName: 'my_reviewed_grid_view',
  deviewId: 'd19b6c04bfcc42dfbf037925978a7217',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'my_reviewed_grid_view_toolbar',
      controlType: 'TOOLBAR',
      ...
      name: 'toolbar',
      id: 'my_reviewed_grid_view_toolbar',
    },
    {
      aggMode: 'NONE',
      ...
      singleSelect: true,
      fetchControlAction: {
        appDEMethodId: 'fetch_my_reviewed',
        appDataEntityId: 'plmweb.review',
        id: 'fetch',
      },
      removeControlAction: {
    ...
    },
    {
      ...
      caption: '我评审的',
      codeName: 'my_reviewed_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.review',
      controlParam: {},
      name: 'captionbar',
      id: 'my_reviewed_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'aa467947555b314e7f37c9e25597e5bd',
  modelType: 'PSAPPDEVIEW',
  name: 'reviewmy_reviewed_grid_view',
