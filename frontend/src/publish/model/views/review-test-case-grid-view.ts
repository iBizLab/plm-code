export default {
  ...
  deviewId: '38b5b72ba3cf91c8c1dd8ab252d3432c',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.REVIEW.ALL_GRID_VIEW',
  },
  caption: '用例评审',
  codeName: 'review_test_case_grid_view',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'a6ebd706a3e3dbab5f450c09986ede95',
  modelType: 'PSAPPDEVIEW',
  name: 'reviewtest_case_grid_view',
  id: 'plmweb.review_test_case_grid_view',
};
