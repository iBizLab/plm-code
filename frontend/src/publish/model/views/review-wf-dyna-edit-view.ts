export default {
  ...
  funcViewParam: 'TODO',
  openMode: 'POPUPMODAL',
  deviewCodeName: 'wf_dyna_edit_view',
  deviewId: 'F94E8ED0-DF7A-443C-9D93-7F2AFEBB9AA8',
  enableWF: true,
  ...
  caption: '评审',
  codeName: 'review_wf_dyna_edit_view',
  dynaSysMode: 1,
  height: 90,
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        xdataControlName: 'form',
        codeName: 'wf_dyna_edit_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '评审工作流工具栏',
        appDataEntityId: 'plmweb.review',
        controlParam: {
        ...
        modelId: '2E7794B0-47B9-4DBF-A119-24F2812851E2',
        modelType: 'PSDETOOLBAR',
        name: 'toolbar',
        id: 'wf_dyna_edit_view_toolbar',
      },
      {
        createControlAction: {
                    ...
                    deformTabPages: [
                      {
                        ...
                        capLanguageRes: {
                          lanResTag:
                            'CONTROL.DEFORM.REVIEW.MAIN_VIEW_FORM.TABPAGE.TABPAGE2',
                        },
                        caption: '评审说明',
                        codeName: 'tabpage2',
                        detailStyle: 'DEFAULT',
                      ...
                      },
                      {
                        ...
                        deformDetails: [
                          {
                            appViewId: 'plmweb.review_content_wf_grid_view',
                            parentDataJO: {
                              srfparentdename: 'REVIEW',
                              SRFPARENTTYPE: 'CUSTOM',
                            },
                            codeName: 'tabpanel1_review_content_druipart',
                            detailStyle: 'DEFAULT',
                            detailType: 'DRUIPART',
                            layoutPos: {
                              colMD: 24,
                            ...
                            showCaption: true,
                            id: 'tabpanel1_review_content_druipart',
                          },
                        ],
                        caption: '评审内容',
                        codeName: 'tabpanel1_review_content',
                        detailStyle: 'DEFAULT',
                        detailType: 'TABPAGE',
                        showCaption: true,
                        id: 'tabpanel1_review_content',
                      },
                    ],
                    codeName: 'tabpanel1',
                    detailStyle: 'DEFAULT',
        ...
        appDataEntityId: 'plmweb.review',
        controlParam: {
          id: 'wfform_main_view_form',
        },
        modelId: '04873E7D-AD13-4F72-9070-820D4145744C',
        modelType: 'PSDEFORM_EDITFORM',
        name: 'wfform_main_view_form',
      ...
      {
        codeName: 'wf_dyna_edit_view_datainfobar',
        ...
        name: 'datainfobar',
        id: 'wf_dyna_edit_view_datainfobar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.REVIEW',
        ...
        caption: '评审',
        codeName: 'wf_dyna_edit_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.review',
        controlParam: {},
        name: 'captionbar',
        id: 'wf_dyna_edit_view_captionbar',
      },
    ],
    codeName: 'usr0428330425',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'wf_dyna_edit_view实体工作流动态视图（分页关系）布局面板',
    appDataEntityId: 'plmweb.review',
    controlLogics: [
      {
        eventNames: 'onBlur',
    ...
    controlParam: {},
    modelId: '0206ACEB-2D58-4783-9D2B-197414CD5547',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '0de49defb0961a19534d72577abd89ac',
  modelType: 'PSAPPDEVIEW',
  name: 'reviewwf_dyna_edit_view',
  id: 'plmweb.review_wf_dyna_edit_view',
};
