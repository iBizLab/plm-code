  ...
  controls: [
    {
      ...
      codeName: 'usr04261930_form',
      controlType: 'FORM',
      logicName: '每日执行结果统计选项操作视图（测试）_表单',
      appDataEntityId: 'plmweb.run',
      controlParam: {
        id: 'form',
      },
    ...
    {
      codeName: 'daily_tendencies_option_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'daily_tendencies_option_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.RUN',
      ...
      caption: '编辑部件',
      codeName: 'daily_tendencies_option_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.run',
      controlParam: {},
      name: 'captionbar',
      id: 'daily_tendencies_option_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
