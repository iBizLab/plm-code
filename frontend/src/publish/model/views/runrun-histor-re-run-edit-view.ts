export default {
  ...
  loadDefault: true,
  deviewCodeName: 'run_histor_re_run_edit_view',
  deviewId: '752EADA8-3B33-4775-A299-756A50981A7A',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.RUN',
  },
  caption: '执行用例',
  codeName: 'runrun_histor_re_run_edit_view',
  ...
  controls: [
    {
      ...
      modelId: '2C69767B-81A2-45CE-A7D5-0B0695E9A5A4',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'plmweb.run.show_run_history_form',
    },
    {
      codeName: 'run_histor_re_run_edit_viewdatainfobar',
      ...
      name: 'datainfobar',
      id: 'run_histor_re_run_edit_viewdatainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.RUN',
      ...
      caption: '执行用例',
      codeName: 'run_histor_re_run_edit_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.run',
      controlParam: {},
      name: 'captionbar',
      id: 'run_histor_re_run_edit_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: 'ef608ed6bb8255192a1a62565d4c44c7',
  modelType: 'PSAPPDEVIEW',
  name: 'runrun_histor_re_run_edit_view',
  id: 'plmweb.runrun_histor_re_run_edit_view',
};
