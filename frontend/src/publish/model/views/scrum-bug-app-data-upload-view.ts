export default {
  codeName: 'scrum_bug_app_data_upload_view',
  sysCss: {
  ...
  viewLayoutPanel: {
          ...
          },
          {
            ...
            panelItems: [
              ...
              },
              {
                rawItem: {
                  content:
                    '<p>上传文件</p>\n<p>上传需要导入的 Excel 文件，上传文件的表头字段名必须与对应缺陷属性一致，仅支持 xls 、 xlsx 。</p>',
                  contentType: 'HTML',
                  predefinedType: 'STATIC_TEXT',
    ...
    codeName: 'usr0423815737',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'ScrumBugAppDataUploadView',
    controlLogics: [
      {
        eventNames: 'onClick',
    ...
    controlParam: {},
    modelId: '25650227-E014-47C3-9A0B-F8373970CA33',
  ...
  showCaptionBar: true,
  modelId: '6A8237EB-F07F-410F-81D2-28FAE050D4D7',
  modelType: 'PSAPPUTILVIEW',
  name: 'ScrumBugAppDataUploadView',
  id: 'plmweb.scrum_bug_app_data_upload_view',
};
