export default {
  codeName: 'scrum_work_item_app_data_upload_view',
  sysCss: {
  ...
  viewLayoutPanel: {
    ...
    codeName: 'usr0521744516',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'ScrumWorkItemAppDataUploadView',
    controlLogics: [
      {
        eventNames: 'onClick',
    ...
    controlParam: {},
    modelId: '56B480CF-4F60-4288-B85F-0BAEE36EA4F9',
  ...
  showCaptionBar: true,
  modelId: 'E01082BE-AFAA-4156-B184-6D0593F839E9',
  modelType: 'PSAPPUTILVIEW',
  name: 'ScrumWorkItemAppDataUploadView',
  id: 'plmweb.scrum_work_item_app_data_upload_view',
};
