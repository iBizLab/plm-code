export default {
  ...
  controls: [
    {
      xdataControlName: 'form',
      codeName: 'advanced_setting_view_toolbar',
      controlType: 'TOOLBAR',
      ...
      name: 'toolbar',
      id: 'advanced_setting_view_toolbar',
    },
    {
      createControlAction: {
    ...
    {
      codeName: 'advanced_setting_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'advanced_setting_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.SPACE',
      ...
      caption: '高级设置',
      codeName: 'advanced_setting_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.space',
      controlParam: {},
      name: 'captionbar',
      id: 'advanced_setting_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
