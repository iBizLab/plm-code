export default {
  ...
  loadDefault: true,
  deviewCodeName: 'category_grid_view',
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'category_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '新建空间',
      appDataEntityId: 'plmweb.space',
      controlParam: {
    ...
    },
    {
      ...
      fetchControlAction: {
        appDEMethodId: 'fetch_category_space',
        appDataEntityId: 'plmweb.space',
        id: 'fetch',
      },
      removeControlAction: {
      ...
      controls: [
        {
          ...
          id: 'category_grid_view_grid_batchtoolbar',
        },
      ],
    ...
    },
    {
      ...
      caption: '全部空间',
      codeName: 'category_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.space',
      controlParam: {},
      name: 'captionbar',
      id: 'category_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
