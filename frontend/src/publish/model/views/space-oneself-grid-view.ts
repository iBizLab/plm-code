export default {
  ...
  loadDefault: true,
  deviewCodeName: 'oneself_grid_view',
  deviewId: '3422076455dffc62955e61e0a8d5eaf0',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.SPACE.GRID_VIEW_ONESELF',
  },
  caption: '个人空间',
  codeName: 'space_oneself_grid_view',
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'oneself_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '新建空间',
      appDataEntityId: 'plmweb.space',
      controlParam: {
    ...
    },
    {
      ...
      caption: '个人空间',
      codeName: 'oneself_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.space',
      controlParam: {},
      name: 'captionbar',
      id: 'oneself_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '48dfbbdbd266cfc7646fd4d8166bdb9f',
  modelType: 'PSAPPDEVIEW',
  name: 'spaceoneself_grid_view',
  id: 'plmweb.space_oneself_grid_view',
};
