export default {
  ...
  loadDefault: true,
  deviewCodeName: 'project_re_tree_exp_view',
  deviewId: '766c843bae369f512d62db05ecd0506d',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.SPACE',
  },
  caption: '空间',
  codeName: 'space_project_re_tree_exp_view',
  ...
  controls: [
    {
      ...
      appViewRefs: [
        ...
        {
          realTitle: '附件',
          refAppViewId: 'plmweb.search_attachment_cur_project_grid_view',
          name: 'EXPITEM:node_6',
          id: 'expitem:node_6',
        },
      ],
      controls: [
        {
          ...
          detreeNodes: [
            ...
            },
            {
              ...
              decontextMenu: {
                ...
                codeName: 'project_re_tree_exp_view_node_cm',
                ...
                name: 'node_cm',
                id: 'project_re_tree_exp_view_node_cm',
              },
              sysImage: {
                rawContent:
            ...
            {
              text: '全部附件',
              navAppViewId: 'plmweb.search_attachment_cur_project_grid_view',
              nodeType: 'node_6',
              navigateParams: [
                {
                  key: 'project_id',
          ...
          codeName: 'project_relation_tree_view',
          controlStyle: 'GROUP_TREE',
          controlType: 'TREEVIEW',
          logicName: '项目关联空间树导航视图_树视图',
          appDataEntityId: 'plmweb.space',
          controlLogics: [
            {
          ...
          modelId: '34092a1073fb13ccc82fff8c3e4b9614',
          modelType: 'PSDETREEVIEW',
          name: 'treeexpbar_tree',
          id: 'plmweb.space.project_relation_tree_view',
        },
        {
          detoolbarItems: [
            {
          ...
          toolbarStyle: 'USER',
          codeName: 'project_re_tree_exp_view_treeexpbar_toolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'project_re_tree_exp_view_treeexpbar_toolbar',
        },
      ],
      codeName: 'project_re_tree_exp_view_treeexpbar',
      controlType: 'TREEEXPBAR',
      appDataEntityId: 'plmweb.space',
      controlParam: {
        id: 'treeexpbar',
      },
      modelId: '7355a1076e3479a0bd9c4233a8cfa7c3_treeexpbar',
      modelType: 'PSEXPBAR',
      name: 'treeexpbar',
      id: 'project_re_tree_exp_view_treeexpbar',
    },
    {
      groupMode: 'SINGLE',
      quickSearchMode: 1,
    ...
    },
    {
      ...
      caption: '空间',
      codeName: 'project_re_tree_exp_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.space',
      controlParam: {},
      name: 'captionbar',
      id: 'project_re_tree_exp_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '7355a1076e3479a0bd9c4233a8cfa7c3',
  modelType: 'PSAPPDEVIEW',
  name: 'spaceproject_re_tree_exp_view',
  id: 'plmweb.space_project_re_tree_exp_view',
};
