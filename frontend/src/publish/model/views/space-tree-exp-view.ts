export default {
  ...
  controls: [
    {
      ...
      appViewRefs: [
        {
          realTitle: '页面筛选器',
          refAppViewId: 'plmweb.article_page_filter_grid_view',
          name: 'EXPITEM:filter',
          id: 'expitem:filter',
        },
        {
        ...
        {
          realTitle: '归档空间表格',
          refAppViewId: 'plmweb.space_is_archived_grid_view',
        ...
        },
        {
          ...
          refAppViewId: 'plmweb.space_all_grid_view',
          name: 'EXPITEM:node_3',
          id: 'expitem:node_3',
        },
        {
        ...
        },
        {
          realTitle: '团队空间',
          realTitleLanguageRes: {
            lanResTag: 'PAGE.TITLE.SPACE.GRID_VIEW_TEAM',
          },
          refAppViewId: 'plmweb.space_team_grid_view',
          name: 'EXPITEM:node_5',
          id: 'expitem:node_5',
        },
        {
        ...
        {
          realTitle: '最近访问页面表格',
          refAppViewId: 'plmweb.recent_recent_page_grid_view',
          name: 'EXPITEM:node_7',
          id: 'expitem:node_7',
        },
        {
          realTitle: '与我共享',
          refAppViewId: 'plmweb.article_page_shared_with_me_grid_view',
          name: 'EXPITEM:node_8',
          id: 'expitem:node_8',
        },
        {
          realTitle: '我收藏的页面',
          refAppViewId: 'plmweb.article_page_my_favorite_page_grid_view',
          name: 'EXPITEM:node_9',
          id: 'expitem:node_9',
        },
      ],
      controls: [
        {
          ...
          detreeNodes: [
            ...
            {
              text: '筛选器',
              navAppViewId: 'plmweb.article_page_filter_grid_view',
              nodeType: 'filter',
              sysImage: {
                rawContent:
            ...
            },
            {
              ...
              decontextMenu: {
                ...
                codeName: 'tree_exp_view_node11_cm',
            ...
            {
              text: '归档空间',
              navAppViewId: 'plmweb.space_is_archived_grid_view',
              nodeType: 'node_15',
              sysImage: {
                rawContent:
            ...
            {
              text: '全部空间',
              navAppViewId: 'plmweb.space_all_grid_view',
              nodeType: 'node_3',
              sysImage: {
                height: 20,
                rawContent:
            ...
            {
              text: '团队空间',
              navAppViewId: 'plmweb.space_team_grid_view',
              nodeType: 'node_5',
              navigateContexts: [
                {
                  key: 'SCOPE_TYPE',
            ...
            {
              text: '最近访问',
              navAppViewId: 'plmweb.recent_recent_page_grid_view',
              nodeType: 'node_7',
              sysImage: {
                rawContent:
            ...
            {
              text: '与我共享',
              navAppViewId: 'plmweb.article_page_shared_with_me_grid_view',
              nodeType: 'node_8',
              sysImage: {
                rawContent:
            ...
            {
              text: '我的收藏',
              navAppViewId: 'plmweb.article_page_my_favorite_page_grid_view',
              nodeType: 'node_9',
              sysImage: {
                rawContent:
          ...
          id: 'plmweb.space.tree_exp_view_tree_view',
        },
      ],
  ...
  title: '知识管理',
  titleLanguageRes: {
    lanResTag: 'PAGE.TITLE.SPACE.TREE_EXP_VIEW',
  },
  viewStyle: 'DEFAULT',
