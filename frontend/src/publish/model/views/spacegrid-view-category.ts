export default {
  ...
  loadDefault: true,
  deviewCodeName: 'grid_view_category',
  deviewId: 'db1065606ff6fd0de1224fc4186daa9d',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.SPACE.GRID_VIEW_ALL',
  },
  caption: '全部空间',
  codeName: 'spacegrid_view_category',
  ...
  appViewLogics: [
    {
      ...
      builtinAppUILogic: {
        ...
        newDataAppView: {
          openMode: 'POPUPMODAL',
          refAppViewId: 'plmweb.spacecreate_wizard_view',
        },
        appUILogicRefViews: [
          {
            openMode: 'POPUPMODAL',
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'grid_view_categorytoolbar',
      controlType: 'TOOLBAR',
      logicName: '新建空间',
      appDataEntityId: 'plmweb.space',
      controlParam: {
      ...
      modelId: '1467591C-9D94-435B-91C9-A5732FC6136C',
      modelType: 'PSDETOOLBAR',
      name: 'toolbar',
      id: 'grid_view_categorytoolbar',
    },
    {
      aggMode: 'NONE',
      ...
      fetchControlAction: {
        appDEMethodId: 'fetchcategory_space',
        appDataEntityId: 'plmweb.space',
        id: 'fetch',
      },
      removeControlAction: {
      ...
      controls: [
        {
          ...
          codeName: 'grid_view_categorygrid_batchtoolbar',
          controlType: 'TOOLBAR',
          logicName: '分类下空间工具栏',
          appDataEntityId: 'plmweb.space',
          controlParam: {
          ...
          modelId: 'E9BC1977-D5CD-4066-8694-2A9E6C035869',
          modelType: 'PSDETOOLBAR',
          name: 'grid_batchtoolbar',
          id: 'grid_view_categorygrid_batchtoolbar',
        },
      ],
      ...
      modelId: '44D8F7F1-85D8-45D1-BE51-CB40C94C7188',
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.space.under_category_space',
    },
    {
    ...
    },
    {
      ...
      caption: '全部空间',
      codeName: 'grid_view_categorycaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.space',
      controlParam: {},
      name: 'captionbar',
      id: 'grid_view_categorycaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '778eedf84d4cf0f515ab4dfa3cc1e950',
  modelType: 'PSAPPDEVIEW',
  name: 'spacegrid_view_category',
  id: 'plmweb.spacegrid_view_category',
};
