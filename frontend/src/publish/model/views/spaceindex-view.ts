export default {
  ...
  viewLayoutPanel: {
        ...
        dedrctrlItems: [
          {
            ...
            caption: '页面',
            appViewId: 'plmweb.article_pagetree_exp_view',
            id: 'page',
          },
        ],
        uniqueTag: 'spaceindex_view__drbar',
        autoLoad: true,
        showBusyIndicator: true,
    ...
    codeName: 'DECustomIndexViewLayout_Space',
    ...
    name: 'layoutpanel',
    id: 'decustomindexviewlayout_space',
  },
  title: '空间',
  titleLanguageRes: {
