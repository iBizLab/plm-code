export default {
  ...
  caption: '空间管理',
  codeName: 'spaceis_running_grid_view',
  ...
  controls: [
    {
      xdataControlName: 'grid',
      codeName: 'is_running_grid_viewtoolbar',
      controlType: 'TOOLBAR',
    ...
    },
    {
      ...
      codeName: 'Is_running_grid_view_Grid',
      controlType: 'GRID',
      logicName: '空间管理表格视图_进行中_表格',
      appDataEntityId: 'plmweb.space',
      controlParam: {
        id: 'grid',
      },
    ...
    },
    {
      ...
      autoLoad: true,
      showBusyIndicator: true,
      codeName: 'Usr02274660_SearchForm',
    ...
    },
    {
      ...
      caption: '空间管理',
      codeName: 'is_running_grid_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.space',
      controlParam: {},
      name: 'captionbar',
      id: 'is_running_grid_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
