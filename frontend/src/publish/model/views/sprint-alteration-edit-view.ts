export default {
  ...
  deviewId: '816cf481318ebd622fb6c635f71a053e',
  accUserMode: 2,
  capLanguageRes: {
      ...
      deformPages: [
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.SPRINT_ALTERATION.MAIN.GROUPPANEL.GROUP1',
              },
              caption: '迭代变更基本信息',
              codeName: 'group1',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag:
              'CONTROL.DEFORM.SPRINT_ALTERATION.MAIN.FORMPAGE.FORMPAGE1',
          },
          caption: '基本信息',
          codeName: 'formpage1',
          detailStyle: 'DEFAULT',
        ...
        },
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.SPRINT_ALTERATION.MAIN.GROUPPANEL.GROUP2',
              },
              caption: '操作信息',
              codeName: 'group2',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag:
              'CONTROL.DEFORM.SPRINT_ALTERATION.MAIN.FORMPAGE.FORMPAGE2',
          },
          caption: '其它',
          codeName: 'formpage2',
          detailStyle: 'DEFAULT',
  ...
  id: 'plmweb.sprint_alteration_edit_view',
};
