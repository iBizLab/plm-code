export default {
  ...
  deviewId: 'd1a6af4bc377d8e2389bd577ce42ded2',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.SPRINT',
  },
  caption: '迭代',
  codeName: 'sprint_edit_view',
      ...
      deformPages: [
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag: 'CONTROL.DEFORM.SPRINT.MAIN.GROUPPANEL.GROUP1',
              },
              caption: '迭代基本信息',
              codeName: 'group1',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag: 'CONTROL.DEFORM.SPRINT.MAIN.FORMPAGE.FORMPAGE1',
          },
          caption: '基本信息',
          codeName: 'formpage1',
          detailStyle: 'DEFAULT',
        ...
        },
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag: 'CONTROL.DEFORM.SPRINT.MAIN.GROUPPANEL.GROUP2',
              },
              caption: '操作信息',
              codeName: 'group2',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag: 'CONTROL.DEFORM.SPRINT.MAIN.FORMPAGE.FORMPAGE2',
          },
          caption: '其它',
          codeName: 'formpage2',
          detailStyle: 'DEFAULT',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '37482b7e4593760b9ec3465463aaa339',
  modelType: 'PSAPPDEVIEW',
  name: 'sprintEditView',
  id: 'plmweb.sprint_edit_view',
};
