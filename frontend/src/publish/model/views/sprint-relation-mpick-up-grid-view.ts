export default {
  ...
  deviewId: 'CA8AB8B4-0FB5-4D4F-A5C4-C0605697E849',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.SPRINT',
  },
  caption: '迭代',
  codeName: 'sprint_relation_mpick_up_grid_view',
  ...
  controls: [
    {
      ...
      singleSelect: true,
      fetchControlAction: {
        appDEMethodId: 'fetch_choose_sprint_relation',
        appDataEntityId: 'plmweb.sprint',
        id: 'fetch',
      },
      removeControlAction: {
  ...
  title: '关联迭代多项选择视图_选择数据视图',
  viewStyle: 'DEFAULT',
  viewType: 'DEPICKUPGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: '8a198c3b7fc86b994c0218aab1ba67f0',
  modelType: 'PSAPPDEVIEW',
  name: 'sprintrelation_mpick_up_grid_view',
  id: 'plmweb.sprint_relation_mpick_up_grid_view',
};
