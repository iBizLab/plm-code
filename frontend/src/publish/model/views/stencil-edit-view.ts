export default {
  ...
  deviewId: 'd40f6684112754cd58e5272ba76c12bb',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      modelId: '178c59ab1c6cb116bed7e3cb80ef0132',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'plmweb.stencil.main',
    },
    {
      detoolbarItems: [
        {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'dff5ff9fe7346126342fac0d6e4c6766',
  modelType: 'PSAPPDEVIEW',
  name: 'stencilEditView',
