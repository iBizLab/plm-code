  ...
  viewLayoutPanel: {
    ...
    controls: [
      ...
      },
      {
        ...
        dechartSerieses: [
          {
            ...
            catalogCodeListId: 'plmweb.testmgmt__test_case_state',
            echartsType: 'pie',
        ...
        chartDataSetGroups: [
          {
            appDEDataSetId: 'fetch_assessment_result',
            appDataEntityId: 'plmweb.test_case',
        ...
        chartDataSets: [
          {
            chartDataSetFields: [
              {
                codeListId: 'plmweb.testmgmt__test_case_state',
                groupField: true,
                name: 'filter_type',
                id: '0',
              },
            ...
            name: 'pie_0-assessmentResult',
            id: '0',
          },
        ],
        navViewPos: 'NONE',
        fetchControlAction: {
          appDEMethodId: 'fetch_assessment_result',
          appDataEntityId: 'plmweb.test_case',
          id: 'fetch',
        },
        readOnly: true,
        autoLoad: true,
        showBusyIndicator: true,
        codeName: 'assessment_result',
        controlStyle: 'CHART_GRID',
        controlType: 'CHART',
        logicName: 'assessment_result',
        appDataEntityId: 'plmweb.test_case',
        controlParam: {
          id: 'chart',
        },
        sysPFPluginId: 'chart_grid',
        modelId: 'be2c237d51c1e32ba08113650522846a',
        modelType: 'PSDECHART',
        userParam: {
          'EC.gridHeaders':
            '[{"id":"filter_type","name":"评审状态"},{"id":"count","name":"用例数量"},{"id":"srfpercent","name":"百分比"}]',
          'EC.color':
            '["#5470c6","#91cc75","#fac858","#ee6666","#73c0de","#3ba272","#fc8452","#9a60b4","#ea7ccc","#5470c6","#91cc75"]',
        },
        name: 'chart',
        id: 'plmweb.test_case.assessment_result',
      },
      {
        groupMode: 'SINGLE',
      ...
      },
      {
        ...
        caption: '测试用例评审结果分布',
        codeName: 'assessment_result_report_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.test_case',
        controlParam: {},
        name: 'captionbar',
        id: 'assessment_result_report_view_captionbar',
      },
    ],
