export default {
  ...
  controls: [
              ...
              deformDetails: [
                ...
                },
                {
                  ...
                  editor: {
                    ...
                    appDEDataSetId: 'fetch_un_join_plan',
    ...
    {
      codeName: 'case_move_plan_option_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'case_move_plan_option_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.TEST_CASE',
      ...
      controlParam: {},
      name: 'captionbar',
      id: 'case_move_plan_option_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
