export default {
  enableSearch: true,
  loadDefault: true,
  deviewCodeName: 'case_type_report_view',
  deviewId: '504383723c9bca7aec66419327f1b9c8',
  accUserMode: 2,
  capLanguageRes: {
    ...
    controls: [
      {
        ...
        codeName: 'case_type_search_form',
        controlType: 'SEARCHFORM',
        logicName: '测试用例类型分布_搜索表单',
        appDataEntityId: 'plmweb.test_case',
        controlParam: {
          id: 'searchform',
        },
        modelId: '2542e6eaf292fe33a8ea813a3b52cf76',
        modelType: 'PSDEFORM_SEARCHFORM',
        name: 'searchform',
        id: 'plmweb.test_case.case_type_search_form',
      },
      {
        ...
        dechartSerieses: [
          {
            ...
            catalogCodeListId: 'plmweb.testmgmt__test_case_type',
            echartsType: 'pie',
        ...
        chartDataSetGroups: [
          {
            appDEDataSetId: 'fetch_case_type',
            appDataEntityId: 'plmweb.test_case',
            name: 'caseType',
            id: '0',
          },
        ...
        modelId: '504383723c9bca7aec66419327f1b9c8',
        modelType: 'PSDECHART',
        userParam: {
          'EC.gridHeaders':
            '[{"id":"filter_type","name":"类型"},{"id":"count","name":"用例数"},{"id":"srfpercent","name":"百分比"}]',
          'EC.color':
            '["#5470c6","#91cc75","#fac858","#ee6666","#73c0de","#3ba272","#fc8452","#9a60b4","#ea7ccc","#5470c6","#91cc75"]',
        },
        name: 'chart',
        id: 'plmweb.test_case.case_type',
      },
      {
        groupMode: 'SINGLE',
      ...
      },
      {
        ...
        caption: '测试用例类型分布',
        codeName: 'case_type_report_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.test_case',
        controlParam: {},
        name: 'captionbar',
        id: 'case_type_report_view_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '241cb6ef28f84a0da7458bdc25870306',
  modelType: 'PSAPPDEVIEW',
  name: 'test_casecase_type_report_view',
