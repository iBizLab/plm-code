export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'move_test_case_view',
  deviewId: '0fd8d0d4645048acf6a68ed09ac05846',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.TEST_CASE',
  },
  caption: '移动用例',
  codeName: 'test_case_move_test_case_view',
  height: 340,
  ...
  controls: [
    ...
    {
      codeName: 'move_test_case_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'move_test_case_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.TEST_CASE',
      ...
      caption: '移动用例',
      codeName: 'move_test_case_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.test_case',
      controlParam: {},
      name: 'captionbar',
      id: 'move_test_case_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '4d973f457130989eebed4003da1b590a',
  modelType: 'PSAPPDEVIEW',
  name: 'test_casemove_test_case_view',
  id: 'plmweb.test_case_move_test_case_view',
};
