export default {
  ...
  caption: '选择用例',
  codeName: 'test_case_mpick_up_view2_review',
    ...
    controls: [
      {
        ...
        codeName: 'mpick_up_view2_review_pickupviewpanel',
        ...
        id: 'mpick_up_view2_review_pickupviewpanel',
      },
      {
        title: '选择用例',
        ...
        codeName: 'mpick_up_view2_review_treeexpbar',
      ...
      },
      {
        ...
        caption: '选择用例',
        codeName: 'mpick_up_view2_review_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.test_case',
        controlParam: {},
        name: 'captionbar',
        id: 'mpick_up_view2_review_captionbar',
      },
    ],
