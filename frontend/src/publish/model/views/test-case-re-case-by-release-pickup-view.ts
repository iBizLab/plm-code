export default {
  openMode: 'POPUPMODAL',
  deviewCodeName: 're_case_by_release_pickup_view',
  deviewId: '2C407B0C-3BA8-4B4C-B852-CCD9FF974281',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.TEST_CASE',
  },
  caption: '用例',
  codeName: 'test_case_re_case_by_release_pickup_view',
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        embeddedAppDEViewId: 'plmweb.release_program_pickup_grid_view',
        codeName: 're_case_by_release_pickup_view_pickupviewpanel',
        ...
        id: 're_case_by_release_pickup_view_pickupviewpanel',
      },
      {
        title: '选择发布',
        ...
        controls: [
          {
            detreeNodeRSs: [
              ...
              },
              {
                ...
                parentDER1N: {
                  ...
                  id: 'projmgmt.release.der1n_release_project_project_id',
                },
            ...
            id: 'plmweb.test_case.choose_release_tree_exp_view',
          },
        ],
        codeName: 're_case_by_release_pickup_view_treeexpbar',
        controlType: 'TREEEXPBAR',
        appDataEntityId: 'plmweb.test_case',
        controlParam: {
          id: 'treeexpbar',
        },
        modelId: '8a0fd6693a8a24f94cc0b214a720b752_treeexpbar',
        modelType: 'PSEXPBAR',
        name: 'treeexpbar',
        id: 're_case_by_release_pickup_view_treeexpbar',
      },
      {
        groupMode: 'NONE',
        groupStyle: 'DEFAULT',
      ...
      },
      {
        ...
        caption: '用例',
        codeName: 're_case_by_release_pickup_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.test_case',
        controlParam: {},
        name: 'captionbar',
        id: 're_case_by_release_pickup_view_captionbar',
      },
    ],
  ...
  title: '通过发布关联用例多项选择视图',
  viewStyle: 'DEFAULT',
  viewType: 'DEMPICKUPVIEW2',
  enableDP: true,
  showCaptionBar: false,
  modelId: '8a0fd6693a8a24f94cc0b214a720b752',
  modelType: 'PSAPPDEVIEW',
  name: 'test_casere_case_by_release_pickup_view',
  id: 'plmweb.test_case_re_case_by_release_pickup_view',
};
