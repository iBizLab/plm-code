  ...
  controls: [
    {
      ...
      xdataControlName: 'form',
      codeName: 'new_edit_view_toolbar',
      controlType: 'TOOLBAR',
    ...
    {
      codeName: 'new_edit_view_datainfobar',
    ...
    },
    {
      ...
      caption: '新建',
      codeName: 'new_edit_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.test_case_template',
      controlParam: {},
      name: 'captionbar',
      id: 'new_edit_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
