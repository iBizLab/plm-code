export default {
  ...
  deviewId: '7DAA0765-2964-4DE5-8972-943B4D6F2744',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.TEST_CASE_TEMPLATE',
  },
  caption: '用例模板',
  codeName: 'test_case_template_show_edit_view',
  ...
  controls: [
    {
      ...
      controlType: 'TOOLBAR',
      logicName: '用例模板展示编辑视图_工具栏',
      appDataEntityId: 'plmweb.test_case_template',
      controlParam: {
        id: 'toolbar',
      },
      modelId: '95CCA8F7-CD0A-46DB-8A62-05B4255CE95A',
    ...
    },
    {
      ...
      controlType: 'FORM',
      logicName: '用例模板展示编辑视图_表单',
      appDataEntityId: 'plmweb.test_case_template',
      controlParam: {
        id: 'form',
      },
      modelId: 'E4D3F725-1058-4A76-81CE-D80DC415772D',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'plmweb.test_case_template.show_edit_view_form',
    },
    {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'b0d26b5e9a50fefd5c20be82b950d811',
  modelType: 'PSAPPDEVIEW',
  name: 'test_case_templateshow_edit_view',
  id: 'plmweb.test_case_template_show_edit_view',
};
