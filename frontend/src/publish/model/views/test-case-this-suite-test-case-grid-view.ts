export default {
  ...
  loadDefault: true,
  deviewCodeName: 'this_suite_test_case_grid_view',
  deviewId: '1ac5d1a8b1bbe399390dfc940360e17a',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'this_suite_test_case_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '新建用例',
      appDataEntityId: 'plmweb.test_case',
      controlParam: {
      ...
      name: 'toolbar',
      id: 'this_suite_test_case_grid_view_toolbar',
    },
    {
      aggMode: 'NONE',
      ...
      fetchControlAction: {
        appDEMethodId: 'fetch_suites_test_case',
        appDataEntityId: 'plmweb.test_case',
        id: 'fetch',
      },
      ...
      controls: [
        {
          ...
          codeName: 'this_suite_test_case_grid_view_grid_batchtoolbar',
          controlType: 'TOOLBAR',
          logicName: '批操作工具栏',
          appDataEntityId: 'plmweb.test_case',
          controlParam: {
          ...
          id: 'this_suite_test_case_grid_view_grid_batchtoolbar',
        },
      ],
      codeName: 'main',
    ...
    },
    {
      ...
      caption: '用例',
      codeName: 'this_suite_test_case_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.test_case',
      controlParam: {},
      name: 'captionbar',
      id: 'this_suite_test_case_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'a6d90925ec0080bde719c50b3119a1d6',
  modelType: 'PSAPPDEVIEW',
  name: 'test_casethis_suite_test_case_grid_view',
