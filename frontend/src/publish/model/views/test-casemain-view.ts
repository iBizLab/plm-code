export default {
  ...
  viewLayoutPanel: {
                  ...
                  },
                  {
                    deformTabPages: [
                      ...
                      },
                      {
                        ...
                        deformDetails: [
                          {
                            appViewId: 'plmweb.ideatest_case_re_idea_grid_view',
                            navigateContexts: [
                              {
                                key: 'PRODUCT',
                                rawValue: true,
                      ...
                      },
                      {
                        ...
                        deformDetails: [
                          {
                            appViewId: 'plmweb.rungrid_view_history',
                            parentDataJO: {
                              SRFPARENTTYPE: 'DER1N',
                              srfparentdename: 'TEST_CASE',
                              srfparentmode: 'DER1N_RUN_TEST_CASE_CASE_ID',
                              srfparentdefname: 'CASE_ID',
                              SRFDER1NID: 'DER1N_RUN_TEST_CASE_CASE_ID',
                            },
                            codeName: 'tabpanel1_run_history_druipart',
                            detailStyle: 'DEFAULT',
                            detailType: 'DRUIPART',
                            layoutPos: {
                              colMD: 24,
                            ...
                            showCaption: true,
                            id: 'tabpanel1_run_history_druipart',
                          },
                        ],
                        caption: '执行历史',
                        codeName: 'tabpanel1_run_history',
                        detailStyle: 'DEFAULT',
                        detailType: 'TABPAGE',
                        showCaption: true,
                        id: 'tabpanel1_run_history',
                      },
                    ],
                    codeName: 'tabpanel1',
                    detailStyle: 'DEFAULT',
                        ...
                        deformDetails: [
                          ...
                          },
                          {
                            ...
                            editor: {
                              ...
                              editorParams: {
                                URL: '`/libraries/${data.test_library_id}/test_suites/fetchdefault`',
                                ...
                                METHOD: 'post',
                                PICKUPVIEW: 'TRUE',
                                'srfnavparam.n_test_library_id_eq':
                                  '%test_library_id%',
                              },
        ...
        appCounterRefs: [
          {
            ...
            tag: '02b9636f5fe0d0523a721343c9200ce6',
            id: '02b9636f5fe0d0523a721343c9200ce6',
          },
        ],
        codeName: 'Main',
        controlType: 'FORM',
    ...
    codeName: 'Usr0116223693',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'main_view编辑视图布局面板（用例）',
    appDataEntityId: 'plmweb.test_case',
    controlLogics: [
      {
        eventNames: 'onChange',
