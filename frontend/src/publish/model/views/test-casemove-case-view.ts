export default {
  ...
  caption: '移动用例',
  codeName: 'test_casemove_case_view',
  height: 340,
  ...
  controls: [
    ...
    {
      codeName: 'move_case_viewdatainfobar',
    ...
    },
    {
      ...
      caption: '移动用例',
      codeName: 'move_case_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.test_case',
      controlParam: {},
      name: 'captionbar',
      id: 'move_case_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
