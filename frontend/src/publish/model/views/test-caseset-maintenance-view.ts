export default {
  ...
  loadDefault: true,
  openMode: 'POPOVER',
  deviewCodeName: 'set_maintenance_view',
  deviewId: 'E09355B5-8403-4902-9319-349E86754F36',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.TEST_CASE',
  },
  caption: '用例',
  codeName: 'test_caseset_maintenance_view',
  ...
  controls: [
    ...
    {
      codeName: 'set_maintenance_viewdatainfobar',
      ...
      name: 'datainfobar',
      id: 'set_maintenance_viewdatainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.TEST_CASE',
      ...
      caption: '用例',
      codeName: 'set_maintenance_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.test_case',
      controlParam: {},
      name: 'captionbar',
      id: 'set_maintenance_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: 'a0254edc5fd31e5f63132a7b2eb1e406',
  modelType: 'PSAPPDEVIEW',
  name: 'test_caseset_maintenance_view',
  id: 'plmweb.test_caseset_maintenance_view',
};
