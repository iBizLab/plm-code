export default {
  ...
  loadDefault: true,
  deviewCodeName: 'work_item_re_case_gridview',
  ...
  caption: '用例',
  codeName: 'test_casework_item_re_case_gridview',
    ...
    controls: [
      {
        ...
        xdataControlName: 'grid',
        codeName: 'work_item_re_case_gridviewtoolbar',
        controlType: 'TOOLBAR',
        logicName: '添加用例',
        appDataEntityId: 'plmweb.test_case',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'work_item_re_case_gridviewtoolbar',
      },
      {
        aggMode: 'NONE',
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetchwork_item_relation_test_case',
          appDataEntityId: 'plmweb.test_case',
          id: 'fetch',
        },
      ...
      },
      {
        ...
        caption: '用例',
        codeName: 'work_item_re_case_gridviewcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.test_case',
        controlParam: {},
        name: 'captionbar',
        id: 'work_item_re_case_gridviewcaptionbar',
      },
    ],
  ...
  name: 'test_casework_item_re_case_gridview',
  id: 'plmweb.test_casework_item_re_case_gridview',
};
