export default {
  ...
  loadDefault: true,
  deviewCodeName: 'my_part_grid_view',
  deviewId: '88d746bd5de58895062bf1753dd63ff0',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
      ...
      controlParam: {},
      name: 'captionbar',
      id: 'my_part_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '8ae1139b8ea0c0c2f3e1b96961e2e21d',
  modelType: 'PSAPPDEVIEW',
  name: 'test_planmy_part_grid_view',
