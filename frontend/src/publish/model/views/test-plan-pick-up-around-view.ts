export default {
  ...
  caption: '选择计划',
  codeName: 'test_plan_pick_up_around_view',
  ...
  controls: [
    {
      embeddedAppDEViewId: 'plmweb.test_plan_pick_up_around_gird_view',
    ...
    },
    {
      ...
      controls: [
        {
          ...
          logicName: '测试计划实体数据选择视图（左右关系）_树视图',
          appDataEntityId: 'plmweb.test_plan',
          controlLogics: [
            {
          ...
          modelId: 'f3de3fc2c9bbba9d15ea4d7968195699',
          modelType: 'PSDETREEVIEW',
          name: 'treeexpbar_tree',
          id: 'plmweb.test_plan.pick_up_view_tree_view',
        },
      ],
      ...
      modelId: '6ba85a7fe943a42f5aadd8bae15dc42b_treeexpbar',
      modelType: 'PSEXPBAR',
      name: 'treeexpbar',
  ...
  viewLayoutPanel: {
        ...
        panelItems: [
          {
            ...
            uiactionId:
              'panel_ex_test_plan_pickup_view2_layout_button_okaction_click@test_plan',
            renderMode: 'BUTTON',
            tooltip: '确定',
    ...
    layoutPanel: true,
    codeName: 'ex_test_plan_pickup_view2_layout',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: '选择视图(左右关系)布局面板(测试计划实体扩展)',
    appDataEntityId: 'plmweb.test_plan',
    controlParam: {},
    modelId: '37ec6a76b52050a5edc9e65481d30497',
    modelType: 'PSSYSVIEWLAYOUTPANEL',
    name: 'layoutpanel',
    id: 'ex_test_plan_pickup_view2_layout',
  },
  title: '测试计划实体数据选择视图（左右关系）',
  viewStyle: 'DEFAULT',
  ...
  name: 'test_planpick_up_around_view',
  id: 'plmweb.test_plan_pick_up_around_view',
};
