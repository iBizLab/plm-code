export default {
  ...
  deviewId: '3CF7EDAF-5613-4EBF-88DE-09A705D6244A',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.TEST_PLAN',
  },
  caption: '测试计划',
  codeName: 'test_plangrid_view_in_progress',
  ...
  controls: [
    {
      ...
      singleSelect: true,
      fetchControlAction: {
        appDEMethodId: 'fetchmy_in_progress',
        appDataEntityId: 'plmweb.test_plan',
        id: 'fetch',
      },
      removeControlAction: {
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '49df5e8870fcd2bd5664c090dee8e623',
  modelType: 'PSAPPDEVIEW',
  name: 'test_plangrid_view_in_progress',
  id: 'plmweb.test_plangrid_view_in_progress',
};
