export default {
  ...
  loadDefault: true,
  deviewCodeName: 'grid_view_my_assignee',
  deviewId: 'AC73D409-E63A-4497-A7BD-27A71B8DBFA2',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.TEST_PLAN',
  },
  caption: '测试计划',
  codeName: 'test_plangrid_view_my_assignee',
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '测试计划',
      codeName: 'grid_view_my_assigneecaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.test_plan',
      controlParam: {},
      name: 'captionbar',
      id: 'grid_view_my_assigneecaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'bef5897101eed95c897864bab699b290',
  modelType: 'PSAPPDEVIEW',
  name: 'test_plangrid_view_my_assignee',
  id: 'plmweb.test_plangrid_view_my_assignee',
};
