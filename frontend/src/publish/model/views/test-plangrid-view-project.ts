export default {
  ...
  loadDefault: true,
  deviewCodeName: 'grid_view_project',
  deviewId: '468014EE-F9E9-4447-8C32-E31914ED5ABA',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.TEST_PLAN',
  },
  caption: '全部计划',
  codeName: 'test_plangrid_view_project',
  ...
  appViewLogics: [
    {
      ...
      builtinAppUILogic: {
        ...
        newDataAppView: {
          openMode: 'POPUPMODAL',
          refAppViewId: 'plmweb.test_planupdate_view',
        },
        appUILogicRefViews: [
          {
            openMode: 'POPUPMODAL',
  ...
  controls: [
    {
      ...
      modelId: '3BA924FB-BC66-4C40-8552-A8B97BDA2803',
      modelType: 'PSDEGRID',
      name: 'grid',
    ...
    },
    {
      ...
      caption: '全部计划',
      codeName: 'grid_view_projectcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.test_plan',
      controlParam: {},
      name: 'captionbar',
      id: 'grid_view_projectcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '7fc26c1160d5f188c6c661514fb93ff8',
  modelType: 'PSAPPDEVIEW',
  name: 'test_plangrid_view_project',
  id: 'plmweb.test_plangrid_view_project',
};
