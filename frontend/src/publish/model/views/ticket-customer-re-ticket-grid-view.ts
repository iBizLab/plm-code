    ...
    rootPanelItems: [
      ...
      },
      {
        editor: {
          ...
          singleSelect: true,
          pickupAppViewId: 'plmweb.ticket_customer_re_ticket_pick_up_view',
          appDEACModeId: 'customer_create_ticket',
          appDEDataSetId: 'fetch_recent_curproduct_ticket',
    ...
    controls: [
      {
        ...
        name: 'toolbar',
        id: 'customer_re_ticket_grid_view_toolbar',
      },
      {
        aggMode: 'NONE',
      ...
      },
      {
        ...
        controlParam: {},
        name: 'captionbar',
        id: 'customer_re_ticket_grid_view_captionbar',
      },
    ],
