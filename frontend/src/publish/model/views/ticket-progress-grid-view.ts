  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'progress_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '新建工单',
      appDataEntityId: 'plmweb.ticket',
      controlParam: {
      ...
      controls: [
        {
          ...
          codeName: 'progress_grid_view_grid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'progress_grid_view_grid_batchtoolbar',
        },
      ],
      codeName: 'main',
    ...
    },
    {
      ...
      caption: '进行中的工单',
      codeName: 'progress_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.ticket',
      controlParam: {},
      name: 'captionbar',
      id: 'progress_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
