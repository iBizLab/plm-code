export default {
  ...
  controls: [
      ...
      controls: [
        {
          ...
          codeName: 'tags_tciket_grid_view_grid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'tags_tciket_grid_view_grid_batchtoolbar',
        },
      ],
      codeName: 'main',
    ...
    },
    {
      ...
      caption: '本标签-工单',
      codeName: 'tags_tciket_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.ticket',
      controlParam: {},
      name: 'captionbar',
      id: 'tags_tciket_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
