export default {
  ...
  loadDefault: true,
  deviewCodeName: 'ticket_re_ticket_grid_view',
    ...
    appViewLogics: [
      ...
      },
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            openMode: 'POPUPMODAL',
            refAppViewId: 'plmweb.ticket_create_re_ticket_view',
          },
          appUILogicRefViews: [
            {
              openMode: 'POPUPMODAL',
    ...
    controls: [
      {
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetch_ticket_relation_ticket',
          appDataEntityId: 'plmweb.ticket',
          id: 'fetch',
        },
        ...
        controls: [
          {
            ...
            id: 'ticket_re_ticket_grid_view_grid_batchtoolbar',
          },
        ],
      ...
      },
      {
        ...
        modelType: 'PSDETOOLBAR',
        name: 'toolbar',
        id: 'ticket_re_ticket_grid_view_toolbar',
      },
      {
        groupMode: 'SINGLE',
        quickSearchMode: 1,
      ...
      },
      {
        ...
        controlParam: {},
        name: 'captionbar',
        id: 'ticket_re_ticket_grid_view_captionbar',
      },
    ],
