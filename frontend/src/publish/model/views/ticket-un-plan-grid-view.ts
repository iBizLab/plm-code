export default {
  ...
  loadDefault: true,
  deviewCodeName: 'un_plan_grid_view',
  deviewId: 'ae312507ce32c9dd5519c7d9f2241772',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'un_plan_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '新建工单',
      appDataEntityId: 'plmweb.ticket',
      controlParam: {
      ...
      controls: [
        {
          ...
          codeName: 'un_plan_grid_view_grid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'un_plan_grid_view_grid_batchtoolbar',
        },
      ],
      codeName: 'main',
    ...
    },
    {
      ...
      caption: '待计划的工单',
      codeName: 'un_plan_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.ticket',
      controlParam: {},
      name: 'captionbar',
      id: 'un_plan_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'a15365be89e6f0b8a299dc4a4457ad83',
  modelType: 'PSAPPDEVIEW',
  name: 'ticketun_plan_grid_view',
