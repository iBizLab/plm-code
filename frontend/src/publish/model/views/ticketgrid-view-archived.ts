export default {
  ...
  deviewId: '98689e56afc4261dad617b3083479ab2',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.TICKET',
  },
  caption: '已归档的工单',
  codeName: 'ticketgrid_view_archived',
  ...
  appViewLogics: [
    ...
    },
    {
      ...
      builtinAppUILogic: {
        openDataAppView: {
          refAppViewId: 'plmweb.ticketredirectview',
        },
        editMode: true,
        appUILogicRefViews: [
          {
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'grid_view_archivedtoolbar',
      controlType: 'TOOLBAR',
      logicName: '新建工单',
      appDataEntityId: 'plmweb.ticket',
      controlParam: {
      ...
      controls: [
        {
          ...
          codeName: 'grid_view_archivedgrid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'grid_view_archivedgrid_batchtoolbar',
        },
      ],
      codeName: 'Main',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '090e95305e654d90721aa3eb7ba74d47',
  modelType: 'PSAPPDEVIEW',
  name: 'ticketgrid_view_archived',
  id: 'plmweb.ticketgrid_view_archived',
};
