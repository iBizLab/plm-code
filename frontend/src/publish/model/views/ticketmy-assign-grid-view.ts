export default {
  ...
  deviewId: 'ED9BC4A0-2220-4677-B8A9-1E93400F0877',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.TICKET',
  },
  caption: '工单',
  codeName: 'ticketmy_assign_grid_view',
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '工单',
      codeName: 'my_assign_grid_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.ticket',
      controlParam: {},
      name: 'captionbar',
      id: 'my_assign_grid_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: '71ba03375f867141fea08e4b58845cdb',
  modelType: 'PSAPPDEVIEW',
  name: 'ticketmy_assign_grid_view',
  id: 'plmweb.ticketmy_assign_grid_view',
};
