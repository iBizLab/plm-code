export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'tags_tciket_grid_view',
  deviewId: 'f8012b74742c112bf82a7f35c93d5ab5',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.TICKET',
  },
  caption: '本标签-工单',
  codeName: 'tickettags_tciket_grid_view',
  ...
  controls: [
    {
      ...
      fetchControlAction: {
        appDEMethodId: 'fetchticket_re_product_tag',
        appDataEntityId: 'plmweb.ticket',
        id: 'fetch',
      },
      ...
      controls: [
        {
          ...
          codeName: 'tags_tciket_grid_viewgrid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'tags_tciket_grid_viewgrid_batchtoolbar',
        },
      ],
      codeName: 'Main',
    ...
    },
    {
      ...
      caption: '本标签-工单',
      codeName: 'tags_tciket_grid_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.ticket',
      controlParam: {},
      name: 'captionbar',
      id: 'tags_tciket_grid_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '63723aadd03d3be59c18d35fc2077e95',
  modelType: 'PSAPPDEVIEW',
  name: 'tickettags_tciket_grid_view',
  id: 'plmweb.tickettags_tciket_grid_view',
};
