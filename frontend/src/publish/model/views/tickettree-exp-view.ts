  ...
  controls: [
    {
      ...
      appViewRefs: [
        {
          realTitle: '全部工单',
          refAppViewId: 'plmweb.ticketgrid_view_all',
          name: 'EXPITEM:node',
          id: 'expitem:node',
        },
        {
          realTitle: '待计划的工单',
          refAppViewId: 'plmweb.ticketgrid_view_plan',
          name: 'EXPITEM:node_1',
          id: 'expitem:node_1',
        },
        {
          realTitle: '进行中的工单',
          refAppViewId: 'plmweb.ticketgrid_view_progress',
          name: 'EXPITEM:node_2',
          id: 'expitem:node_2',
        },
        {
          realTitle: '我负责的工单',
          refAppViewId: 'plmweb.ticketgrid_view_assignee',
          name: 'EXPITEM:node_3',
          id: 'expitem:node_3',
        },
        {
          realTitle: '我提交的工单',
          refAppViewId: 'plmweb.ticketgrid_view_submit',
          name: 'EXPITEM:node_4',
          id: 'expitem:node_4',
        },
        {
          realTitle: '已归档的工单',
          refAppViewId: 'plmweb.ticketgrid_view_archived',
          name: 'EXPITEM:node_5',
          id: 'expitem:node_5',
        },
      ],
      controls: [
        {
          ...
          detreeNodes: [
            ...
            {
              text: '全部工单',
              navAppViewId: 'plmweb.ticketgrid_view_all',
              nodeType: 'node',
              navigateParams: [
                {
                  key: 'target_type',
            ...
            {
              text: '待计划的工单',
              navAppViewId: 'plmweb.ticketgrid_view_plan',
              nodeType: 'node_1',
              navigateParams: [
                {
                  key: 'target_type',
            ...
            {
              text: '进行中的工单',
              navAppViewId: 'plmweb.ticketgrid_view_progress',
              nodeType: 'node_2',
              sysImage: {
                cssClass: 'fa fa-list-ul',
                glyph: 'xf0ca@FontAwesome',
            ...
            {
              text: '我负责的工单',
              navAppViewId: 'plmweb.ticketgrid_view_assignee',
              nodeType: 'node_3',
              sysImage: {
                cssClass: 'fa fa-list-ul',
                glyph: 'xf0ca@FontAwesome',
            ...
            {
              text: '我提交的工单',
              navAppViewId: 'plmweb.ticketgrid_view_submit',
              nodeType: 'node_4',
              sysImage: {
                cssClass: 'fa fa-list-ul',
                glyph: 'xf0ca@FontAwesome',
            ...
            {
              text: '已归档的工单',
              navAppViewId: 'plmweb.ticketgrid_view_archived',
              nodeType: 'node_5',
              sysImage: {
                cssClass: 'fa fa-list-ul',
                glyph: 'xf0ca@FontAwesome',
          ...
          id: 'plmweb.ticket.tree_exp_view_treeview',
        },
      ],
