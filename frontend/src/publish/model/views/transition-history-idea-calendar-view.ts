export default {
  ...
  loadDefault: true,
  deviewCodeName: 'idea_calendar_view',
  deviewId: '14eda9c067907d6238446cdb452b0e4f',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      sysCalendarItems: [
        {
          ...
          layoutPanel: {
            ...
            id: 'plmweb.transition_history.idea_transition_history',
          },
      ...
      name: 'calendar',
      id: 'plmweb.transition_history.idea_transition_timeline',
    },
    {
      groupMode: 'SINGLE',
    ...
    },
    {
      ...
      controlParam: {},
      name: 'captionbar',
      id: 'idea_calendar_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  id: 'plmweb.transition_history_idea_calendar_view',
};
