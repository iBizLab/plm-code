  ...
  controls: [
    {
      detoolbarItems: [
        ...
        },
        {
          actionLevel: 100,
          noPrivDisplayMode: 2,
          uiactionId: 'cancel_workload@user',
          uiactionTarget: 'MULTIKEY',
          valid: true,
          caption: '取消工时统计',
          itemType: 'DEUIACTION',
      ...
      controls: [
        {
          ...
          codeName: 'unassigned_dept_grid_view_grid_batchtoolbar',
          controlType: 'TOOLBAR',
          logicName: '企业用户管理表格视图_工具栏',
          appDataEntityId: 'plmweb.user',
          controlParam: {
          ...
          id: 'unassigned_dept_grid_view_grid_batchtoolbar',
        },
      ],
      codeName: 'main_grid',
      controlType: 'GRID',
