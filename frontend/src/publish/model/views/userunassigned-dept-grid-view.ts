export default {
  ...
  caption: '成员管理',
  codeName: 'userunassigned_dept_grid_view',
  ...
  controls: [
    {
      xdataControlName: 'grid',
      codeName: 'unassigned_dept_grid_viewtoolbar',
      controlType: 'TOOLBAR',
    ...
    },
    {
      ...
      fetchControlAction: {
        appDEMethodId: 'fetchunassigned_dept',
        appDataEntityId: 'plmweb.user',
        id: 'fetch',
      },
      removeControlAction: {
    ...
    },
    {
      ...
      caption: '成员管理',
      codeName: 'unassigned_dept_grid_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.user',
      controlParam: {},
      name: 'captionbar',
      id: 'unassigned_dept_grid_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  id: 'plmweb.userunassigned_dept_grid_view',
};
