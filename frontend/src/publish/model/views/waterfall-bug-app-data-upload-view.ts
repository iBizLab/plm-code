export default {
  codeName: 'waterfall_bug_app_data_upload_view',
  sysCss: {
  ...
  viewLayoutPanel: {
    ...
    codeName: 'usr0521644051',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'WaterfallBugAppDataUploadView',
    controlLogics: [
      {
        eventNames: 'onClick',
    ...
    controlParam: {},
    modelId: '9F0C18CE-E666-4E5D-99DA-CC9BED54A263',
  ...
  showCaptionBar: true,
  modelId: '41E7DC8F-CA5E-4693-9B2D-FE1CB1C8A5C7',
  modelType: 'PSAPPUTILVIEW',
  name: 'WaterfallBugAppDataUploadView',
  id: 'plmweb.waterfall_bug_app_data_upload_view',
};
