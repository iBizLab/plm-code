export default {
  ...
  loadDefault: true,
  deviewCodeName: 'all_kanban_grid_view',
  deviewId: '3f7a403ec49d39c8605c66c65351d858',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'all_kanban_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '新建工作项（看板）',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
      ...
      name: 'toolbar',
      id: 'all_kanban_grid_view_toolbar',
    },
    {
      aggMode: 'NONE',
      ...
      degridColumns: [
        ...
        },
        {
          ...
          deuiactionGroup: {
            ...
            appDataEntityId: 'plmweb.work_item',
            uniqueTag: 'work_item__Usr0326201009',
            name: '看板项目工作项操作列',
            id: 'usr0326201009',
          },
          valueType: 'SIMPLE',
      ...
      controls: [
        {
          ...
          codeName: 'all_kanban_grid_view_grid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'all_kanban_grid_view_grid_batchtoolbar',
        },
      ],
      codeName: 'kanban_grid',
      controlStyle: 'NUMBER_GRID',
      controlType: 'GRID',
      logicName: '工作项表格（kanban）',
      appDataEntityId: 'plmweb.work_item',
      controlLogics: [
        {
      ...
      modelId: '725f36ed1746667390bcd4dd1572da61',
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.work_item.kanban_grid',
    },
    {
      groupMode: 'SINGLE',
      groupMoreText: '更多',
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'all_kanban_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'all_kanban_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'bc1d44f107f417f0733b8ba6d6f3be7e',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemall_kanban_grid_view',
