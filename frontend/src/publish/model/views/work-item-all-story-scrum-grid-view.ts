export default {
  ...
  loadDefault: true,
  deviewCodeName: 'all_story_scrum_grid_view',
  deviewId: '0fff281ecef7188b9331ea8a217cb181',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'all_story_scrum_grid_view_toolbar',
      controlType: 'TOOLBAR',
      ...
      name: 'toolbar',
      id: 'all_story_scrum_grid_view_toolbar',
    },
    {
      aggMode: 'NONE',
      ...
      fetchControlAction: {
        appDEMethodId: 'fetch_requirement',
        appDataEntityId: 'plmweb.work_item',
        id: 'fetch',
      },
      ...
      controls: [
        {
          ...
          codeName: 'all_story_scrum_grid_view_grid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'all_story_scrum_grid_view_grid_batchtoolbar',
        },
      ],
      codeName: 'story_grid',
      ...
      modelId: 'd9fc06fb81a20f720a9ed77722be46f5',
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.work_item.story_grid',
    },
    {
      groupMode: 'SINGLE',
      groupMoreText: '更多',
    ...
    },
    {
      ...
      caption: '全部需求',
      codeName: 'all_story_scrum_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'all_story_scrum_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'd7b4de4b4db1d4fa8a996d075eab7bbc',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemall_story_scrum_grid_view',
