export default {
  ...
  loadDefault: true,
  deviewCodeName: 'all_waterfall_grid_view',
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'all_waterfall_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '新建工作项（瀑布）',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
      ...
      name: 'toolbar',
      id: 'all_waterfall_grid_view_toolbar',
    },
    {
      aggMode: 'NONE',
      ...
      controls: [
        {
          ...
          codeName: 'all_waterfall_grid_view_grid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'all_waterfall_grid_view_grid_batchtoolbar',
        },
      ],
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'all_waterfall_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'all_waterfall_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  name: 'work_itemall_waterfall_grid_view',
