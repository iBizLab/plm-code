export default {
  ...
  loadDefault: true,
  deviewCodeName: 'backlog_age_report_report_view',
  deviewId: '569a44e9d70381577b170a7c1923d467',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    controls: [
        ...
        deformPages: [
          {
            ...
            deformDetails: [
              ...
              },
              {
                ...
                editor: {
                  singleSelect: true,
                  appCodeListId: 'plmweb.base__contains_delete',
                  editorType: 'DROPDOWNLIST_100',
                  valueType: 'SIMPLES',
                  editable: true,
                  id: 'n_is_deleted_in',
      ...
      },
      {
        ...
        caption: '需求年龄报告',
        codeName: 'backlog_age_report_report_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {},
        name: 'captionbar',
        id: 'backlog_age_report_report_view_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '3d21238cd75f17c9ff355532f1d73792',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itembacklog_age_report_report_view',
