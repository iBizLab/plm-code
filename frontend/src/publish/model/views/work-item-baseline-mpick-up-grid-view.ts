export default {
  ...
  deviewId: '9CA4DAF0-526E-462C-856E-DD12A7A9C766',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      fetchControlAction: {
        appDEMethodId: 'fetch_baseline_plan_work_item',
        appDataEntityId: 'plmweb.work_item',
        id: 'fetch',
      },
      ...
      controlType: 'GRID',
      logicName: '基线规划工作项多项选择视图_选择数据视图_表格',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
        id: 'grid',
      },
      modelId: '087F3B83-3C19-4A0D-83C7-E2DA4D5E5DBC',
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.work_item.baseline_mpick_up_view_pickup_grid_view_grid',
    },
    {
  ...
  title: '基线规划工作项多项选择视图_选择数据视图',
  viewStyle: 'DEFAULT',
  viewType: 'DEPICKUPGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: 'c7024e9133a5c2e05e3dd21df3f36da2',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itembaseline_mpick_up_grid_view',
