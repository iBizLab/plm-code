export default {
  ...
  loadDefault: true,
  deviewCodeName: 'case_re_bug_mpick_up_grid_view',
  ...
  controls: [
    {
      ...
      fetchControlAction: {
        appDEMethodId: 'fetch_not_exsists_bug_relation',
        appDataEntityId: 'plmweb.work_item',
        id: 'fetch',
      },
      ...
      codeName: 'case_re_bug_mpick_up_grid',
      ...
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.work_item.case_re_bug_mpick_up_grid',
    },
    {
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'case_re_bug_mpick_up_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'case_re_bug_mpick_up_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  name: 'work_itemcase_re_bug_mpick_up_grid_view',
