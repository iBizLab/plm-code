export default {
  openMode: 'POPUPMODAL',
  deviewCodeName: 'case_re_bug_mpick_up_view',
  ...
  caption: '选择缺陷',
  codeName: 'work_item_case_re_bug_mpick_up_view',
  ...
  controls: [
    {
      embeddedAppDEViewId: 'plmweb.work_item_case_re_bug_mpick_up_grid_view',
      codeName: 'case_re_bug_mpick_up_view_pickupviewpanel',
      ...
      id: 'case_re_bug_mpick_up_view_pickupviewpanel',
    },
    {
      ...
      controls: [
        {
          ...
          autoLoad: true,
          showBusyIndicator: true,
          codeName: 'case_re_bug_mpickup_view_tree_view',
          ...
          id: 'plmweb.work_item.case_re_bug_mpickup_view_tree_view',
        },
      ],
      codeName: 'case_re_bug_mpick_up_view_treeexpbar',
      ...
      modelType: 'PSEXPBAR',
      name: 'treeexpbar',
      id: 'case_re_bug_mpick_up_view_treeexpbar',
    },
    {
      groupMode: 'NONE',
      itemLayoutPanel: {
    ...
    },
    {
      ...
      caption: '选择缺陷',
      codeName: 'case_re_bug_mpick_up_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'case_re_bug_mpick_up_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutMode: 'Flex',
  ...
  name: 'work_itemcase_re_bug_mpick_up_view',
  id: 'plmweb.work_item_case_re_bug_mpick_up_view',
};
