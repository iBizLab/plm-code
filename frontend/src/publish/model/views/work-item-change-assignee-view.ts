export default {
  ...
  controls: [
    ...
    {
      codeName: 'change_assignee_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'change_assignee_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.WORK_ITEM',
      ...
      caption: '工作项',
      codeName: 'change_assignee_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'change_assignee_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
