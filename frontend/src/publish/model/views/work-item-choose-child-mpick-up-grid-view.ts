export default {
  ...
  loadDefault: true,
  deviewCodeName: 'choose_child_mpick_up_grid_view',
  deviewId: 'e93305cb43ae7f96aa6f2bbbb7c0c8fb',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '工作项',
  codeName: 'work_item_choose_child_mpick_up_grid_view',
  ...
  controls: [
    {
      ...
      fetchControlAction: {
        appDEMethodId: 'fetch_choose_child',
        appDataEntityId: 'plmweb.work_item',
        id: 'fetch',
      },
      ...
      codeName: 'choose_child_view_pickup_grid_view_grid',
      controlStyle: 'CHECKBOX_GRID',
      controlType: 'GRID',
      logicName: '子工作项多项选择视图_选择数据视图_表格',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
        id: 'grid',
      },
      sysPFPluginId: 'checkbox_grid',
      modelId: '945f27402faebe7c1d3eb6bfb0b909ed',
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.work_item.choose_child_view_pickup_grid_view_grid',
    },
    {
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'choose_child_mpick_up_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'choose_child_mpick_up_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  title: '子工作项多项选择视图_选择数据视图',
  viewStyle: 'DEFAULT',
  viewType: 'DEPICKUPGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: '7e1dcf8efa1e4619cf2b0eba8a314314',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemchoose_child_mpick_up_grid_view',
  id: 'plmweb.work_item_choose_child_mpick_up_grid_view',
};
