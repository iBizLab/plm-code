export default {
  ...
  loadDefault: true,
  deviewCodeName: 'depend_mpick_up_grid_view',
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'depend_mpick_up_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'depend_mpick_up_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  name: 'work_itemdepend_mpick_up_grid_view',
