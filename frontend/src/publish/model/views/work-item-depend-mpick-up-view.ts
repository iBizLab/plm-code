export default {
  openMode: 'POPUPMODAL',
  deviewCodeName: 'depend_mpick_up_view',
  deviewId: 'F1DBDDDE-F294-4ABE-9A5A-F831803FF58C',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      id: 'depend_mpick_up_view_pickupviewpanel',
    },
    {
      title: '选择工作项',
      ...
      controls: [
        {
          ...
          autoLoad: true,
          showBusyIndicator: true,
          codeName: 'depend_mpick_up_view_tree_view',
          controlType: 'TREEVIEW',
          logicName: '工作项选择依赖多项选择视图_树视图',
          appDataEntityId: 'plmweb.work_item',
          controlLogics: [
            {
          ...
          modelId: '510EF810-3EB6-49B1-ABF0-978110099235',
          modelType: 'PSDETREEVIEW',
          name: 'treeexpbar_tree',
          id: 'plmweb.work_item.depend_mpick_up_view_tree_view',
        },
      ],
      codeName: 'depend_mpick_up_view_treeexpbar',
      controlType: 'TREEEXPBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
        id: 'treeexpbar',
      },
      modelId: '1f467593ad591f797885470903eb9725_treeexpbar',
      modelType: 'PSEXPBAR',
      name: 'treeexpbar',
      id: 'depend_mpick_up_view_treeexpbar',
    },
    {
      groupMode: 'NONE',
      groupStyle: 'DEFAULT',
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'depend_mpick_up_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'depend_mpick_up_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutMode: 'Flex',
  ...
  modelId: '1f467593ad591f797885470903eb9725',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemdepend_mpick_up_view',
