export default {
  ...
  loadDefault: true,
  deviewCodeName: 'dyna_kanban_grid_view',
  deviewId: '9928948F-AB5C-4DD3-8236-92E84F4D33D4',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'dyna_kanban_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '新建工作项（看板）',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
      ...
      name: 'toolbar',
      id: 'dyna_kanban_grid_view_toolbar',
    },
    {
      aggMode: 'NONE',
      ...
      controls: [
        {
          ...
          codeName: 'dyna_kanban_grid_view_grid_quicktoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'dyna_kanban_grid_view_grid_quicktoolbar',
        },
      ],
      codeName: 'dyna_kanban_grid',
      controlType: 'GRID',
      logicName: '工作项表格（动态kanban）',
      appDataEntityId: 'plmweb.work_item',
      controlLogics: [
        {
      ...
      modelId: '8EC2DF85-1ABD-45B6-AC4D-0EA20B96E59F',
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.work_item.dyna_kanban_grid',
    },
    {
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'dyna_kanban_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'dyna_kanban_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'c1e56fe8f5caa34b2b6881e7206a19a4',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemdyna_kanban_grid_view',
