export default {
  ...
  controls: [
    ...
    {
      codeName: 'dyna_kanban_quick_create_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'dyna_kanban_quick_create_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.WORK_ITEM',
      ...
      caption: '工作项',
      codeName: 'dyna_kanban_quick_create_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'dyna_kanban_quick_create_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
