export default {
  ...
  loadDefault: true,
  deviewCodeName: 'dyna_scrum_grid_view',
  deviewId: '59ac276de479ac725c9a7ea6daede93e',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'dyna_scrum_grid_view_toolbar',
      controlType: 'TOOLBAR',
      logicName: '新建工作项（看板）',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
      ...
      name: 'toolbar',
      id: 'dyna_scrum_grid_view_toolbar',
    },
    {
      aggMode: 'NONE',
      ...
      controls: [
        {
          ...
          codeName: 'dyna_scrum_grid_view_grid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'dyna_scrum_grid_view_grid_batchtoolbar',
        },
      ],
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'dyna_scrum_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'dyna_scrum_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '19195ec31086c84bdb3c50617cb5ce05',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemdyna_scrum_grid_view',
