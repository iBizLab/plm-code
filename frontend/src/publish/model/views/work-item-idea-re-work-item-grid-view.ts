export default {
  ...
  loadDefault: true,
  deviewCodeName: 'idea_re_work_item_grid_view',
  deviewId: 'bcb9918d6145829b64270e165dc33aba',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
        ...
        panelItems: [
          ...
          },
          {
            editor: {
              ...
              singleSelect: true,
              pickupAppViewId: 'plmweb.work_item_others_re_view',
    ...
    controls: [
      {
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetch_idea_relation_work_item',
          appDataEntityId: 'plmweb.work_item',
          id: 'fetch',
        },
        ...
        codeName: 'idea_relation_work_item_grid',
        controlType: 'GRID',
        logicName: '产品需求关联工作项_表格',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {
          id: 'grid',
        },
        modelId: 'a46297cb62fd095d035e18d5d0580b38',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.work_item.idea_relation_work_item_grid',
      },
      {
        detoolbarItems: [
          {
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'grid',
        codeName: 'idea_re_work_item_grid_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '添加工作项',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'idea_re_work_item_grid_view_toolbar',
      },
      {
        groupMode: 'SINGLE',
        quickSearchMode: 1,
      ...
      },
      {
        ...
        caption: '工作项',
        codeName: 'idea_re_work_item_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {},
        name: 'captionbar',
        id: 'idea_re_work_item_grid_view_captionbar',
      },
    ],
    codeName: 'idea_re_work_item_grid_view',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: '需求关联工作项表格视图布局',
    appDataEntityId: 'plmweb.work_item',
    controlLogics: [
      {
        eventNames: 'onChange',
        ...
        logicType: 'APPDEUILOGIC',
        appDEUILogicId: 'idea_relation_work_item',
        appDataEntityId: 'plmweb.work_item',
    ...
    controlParam: {},
    modelId: 'bd9c8adf86503d975e6d4fd2643248d7',
    modelType: 'PSSYSVIEWLAYOUTPANEL',
    name: 'layoutpanel',
    id: 'idea_re_work_item_grid_view',
  },
  title: '产品需求关联工作项表格',
  viewStyle: 'DEFAULT',
  viewType: 'DEGRIDVIEW',
  ...
  modelId: 'e96cb22fa5897305ff39aaf47624674d',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemidea_re_work_item_grid_view',
