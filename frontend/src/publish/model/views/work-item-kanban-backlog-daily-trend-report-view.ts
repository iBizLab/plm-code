export default {
  enableSearch: true,
  loadDefault: true,
  deviewCodeName: 'kanban_backlog_daily_trend_report_view',
  deviewId: 'bae578253af17a12b97e9e4278f627c7',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    controls: [
      ...
      },
      {
        ...
        caption: '需求每日趋势',
        codeName: 'kanban_backlog_daily_trend_report_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {},
        name: 'captionbar',
        id: 'kanban_backlog_daily_trend_report_view_captionbar',
      },
    ],
  ...
  title: 'kanban需求每日趋势报表',
  viewStyle: 'DEFAULT',
  viewType: 'DECHARTVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: '1112ffb15308cab04e284bdbdfbbc7a8',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemkanban_backlog_daily_trend_report_view',
