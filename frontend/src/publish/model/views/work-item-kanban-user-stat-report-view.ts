    ...
    controls: [
      {
        ...
        name: 'searchform',
        id: 'plmweb.work_item.kanban_user_stat_search_form',
      },
      {
        coordinateSystem: 'XY',
        ...
        dechartTitle: {
          title: 'kanban成员负荷报告_图表',
          id: '0',
        },
        chartDataSetGroups: [
          {
            appDEDataSetId: 'fetch_kanban_user_stat',
            appDataEntityId: 'plmweb.work_item',
        ...
        autoLoad: true,
        showBusyIndicator: true,
        codeName: 'kanban_user_stat_chart',
        ...
        modelId: 'ef846a65485cba904e00cf9243fba7e2',
        modelType: 'PSDECHART',
        userParam: {
          'EC.dataZoom':
        ...
        name: 'chart',
        id: 'plmweb.work_item.kanban_user_stat_chart',
      },
      {
        groupMode: 'SINGLE',
      ...
      },
      {
        ...
        caption: '成员负荷报告',
        codeName: 'kanban_user_stat_report_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {},
        name: 'captionbar',
        id: 'kanban_user_stat_report_view_captionbar',
      },
    ],
