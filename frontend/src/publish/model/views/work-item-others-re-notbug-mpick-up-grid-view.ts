export default {
  ...
  loadDefault: true,
  deviewCodeName: 'others_re_notbug_mpick_up_grid_view',
  deviewId: '145b40310dda7906428e1a79ad0f570a',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '工作项',
  codeName: 'work_item_others_re_notbug_mpick_up_grid_view',
  ...
  controls: [
    {
      ...
      fetchControlAction: {
        appDEMethodId: 'fetch_notbug_exsists_relation',
        appDataEntityId: 'plmweb.work_item',
        id: 'fetch',
      },
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'others_re_notbug_mpick_up_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'others_re_notbug_mpick_up_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  title: '用例关联工作项多项选择视图_选择数据视图',
  viewStyle: 'DEFAULT',
  viewType: 'DEPICKUPGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: 'f4a36c58c314a9ee0c1a46c2552dc167',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemothers_re_notbug_mpick_up_grid_view',
  id: 'plmweb.work_item_others_re_notbug_mpick_up_grid_view',
};
