export default {
  openMode: 'POPUPMODAL',
  deviewCodeName: 'others_re_notbug_view',
  deviewId: '86dc2cf3c90b7ea2d9062a0cbf684b37',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '选择工作项',
  codeName: 'work_item_others_re_notbug_view',
  ...
  controls: [
    {
      ...
      codeName: 'others_re_notbug_view_pickupviewpanel',
      ...
      id: 'others_re_notbug_view_pickupviewpanel',
    },
    {
      ...
      controls: [
        {
          ...
          modelId: '734a2e1d97df03f361a90c9c56ea1f99',
          modelType: 'PSDETREEVIEW',
          name: 'treeexpbar_tree',
          id: 'plmweb.work_item.others_relation_view_tree_view',
        },
      ],
      codeName: 'others_re_notbug_view_treeexpbar',
      controlType: 'TREEEXPBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
        id: 'treeexpbar',
      },
      modelId: '66cfe4515e4ebca83c728cb9c46da77d_treeexpbar',
      modelType: 'PSEXPBAR',
      name: 'treeexpbar',
      id: 'others_re_notbug_view_treeexpbar',
    },
    {
      groupMode: 'NONE',
      groupStyle: 'DEFAULT',
    ...
    },
    {
      ...
      caption: '选择工作项',
      codeName: 'others_re_notbug_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'others_re_notbug_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutMode: 'Flex',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '66cfe4515e4ebca83c728cb9c46da77d',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemothers_re_notbug_view',
  id: 'plmweb.work_item_others_re_notbug_view',
};
