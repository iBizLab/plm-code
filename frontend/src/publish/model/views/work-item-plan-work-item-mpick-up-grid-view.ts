  ...
  controls: [
    {
      ...
      codeName: 'plan_work_item_pickview_pickup_grid_view_grid',
      controlType: 'GRID',
      ...
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.work_item.plan_work_item_pickview_pickup_grid_view_grid',
    },
    {
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'plan_work_item_mpick_up_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'plan_work_item_mpick_up_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
