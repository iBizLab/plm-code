export default {
  ...
  caption: '资源分配',
  codeName: 'work_item_project_set_resource_gantt_view',
  ...
  controls: [
    {
      ...
      detreeNodes: [
            ...
            detoolbarItems: [
              {
                actionLevel: 100,
                noPrivDisplayMode: 2,
                uiactionId: 'portfolio_capacity@portfolio',
                uiactionTarget: 'NONE',
                valid: true,
                caption: '容量设置',
                itemType: 'DEUIACTION',
              ...
              },
              {
                actionLevel: 100,
                noPrivDisplayMode: 2,
                uiactionId: 'project_set_resource_member_pre@portfolio',
                uiactionTarget: 'NONE',
                valid: true,
                caption: '成员管理',
                itemType: 'DEUIACTION',
        ...
        },
        {
          ...
          appDEDataSetId: 'fetch_cur_portfolio_resource',
          textAppDEFieldId: 'name',
        ...
        {
          idAppDEFieldId: 'id',
          appDEDataSetId: 'fetch_under_work_resource',
    ...
    },
    {
      ...
      caption: '资源分配',
      codeName: 'project_set_resource_gantt_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'project_set_resource_gantt_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutMode: 'Flex',
    ...
    layoutPanel: true,
    codeName: 'usr0529691587',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: '项目集资源甘特布局',
    appDataEntityId: 'plmweb.work_item',
    controlParam: {},
    modelId: '49abf50140efa705d096aa33c824066c',
