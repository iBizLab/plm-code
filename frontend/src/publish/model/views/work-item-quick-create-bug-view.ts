export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'quick_create_bug_view',
  ...
  controls: [
    ...
    {
      codeName: 'quick_create_bug_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'quick_create_bug_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.WORK_ITEM',
      ...
      caption: '新建缺陷',
      codeName: 'quick_create_bug_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'quick_create_bug_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  name: 'work_itemquick_create_bug_view',
