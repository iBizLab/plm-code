export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'quick_create_milestone_view',
  deviewId: 'd1eae147a855c11c685ac01b513ea416',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '新建里程碑',
  codeName: 'work_item_quick_create_milestone_view',
  ...
  controls: [
    {
              ...
              deformDetails: [
                ...
                },
                {
                  ...
                  deformDetails: [
                    ...
                    {
                      createDV: 'N_WORK_ITEM_TYPE_ID_EQ',
                      createDVT: 'CONTEXT',
                      dataType: 25,
                      enableCond: 3,
                      ignoreInput: 3,
      ...
      autoLoad: true,
      showBusyIndicator: true,
      codeName: 'quick_create_milestone',
      controlType: 'FORM',
      logicName: '快速建立（里程碑）',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
      ...
      modelId: '5935e0296a7b30278d02bac582be4555',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'plmweb.work_item.quick_create_milestone',
    },
    {
      codeName: 'quick_create_milestone_view_datainfobar',
      ...
      name: 'datainfobar',
      id: 'quick_create_milestone_view_datainfobar',
    },
    {
      capLanguageRes: {
        lanResTag: 'DE.LNAME.WORK_ITEM',
      ...
      caption: '新建里程碑',
      codeName: 'quick_create_milestone_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'quick_create_milestone_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '3aa350f2141771b2c477de33ddaeed36',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemquick_create_milestone_view',
  id: 'plmweb.work_item_quick_create_milestone_view',
};
