export default {
  ...
  loadDefault: true,
  deviewCodeName: 're_mpick_up_grid_view',
  deviewId: 'b03112a4344cc8f72695c2d2940ad2b1',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      fetchControlAction: {
        appDEMethodId: 'fetch_no_bug_work_item',
        appDataEntityId: 'plmweb.work_item',
        id: 'fetch',
      },
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 're_mpick_up_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 're_mpick_up_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  title: '关联工作项多项选择视图_选择数据视图（测试用例关联）',
  viewStyle: 'DEFAULT',
  viewType: 'DEPICKUPGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: '98ecc4267831954943c4f1c87b7be22d',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemre_mpick_up_grid_view',
