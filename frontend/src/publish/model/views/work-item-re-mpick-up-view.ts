export default {
  ...
  deviewId: '2e75aafea3e099cab0258cab1aeae312',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '选择工作项',
  codeName: 'work_item_re_mpick_up_view',
  ...
  controls: [
    {
      embeddedAppDEViewId: 'plmweb.work_item_re_mpick_up_grid_view',
    ...
    },
    {
      ...
      appViewRefs: [
        {
          realTitle: '关联工作项多项选择视图_选择数据视图（测试用例关联）',
          refAppViewId: 'plmweb.work_item_re_mpick_up_grid_view',
          name: 'EXPITEM:node',
          id: 'expitem:node',
        },
      ],
      controls: [
        {
          ...
          detreeNodes: [
            ...
            },
            {
              ...
              navAppViewId: 'plmweb.work_item_re_mpick_up_grid_view',
              nodeType: 'node',
          ...
          logicName: '关联工作项多项选择视图_树视图（测试用例关联）',
          appDataEntityId: 'plmweb.work_item',
          controlLogics: [
            {
          ...
          modelId: 'a00d1babde8f4cf82d1f61a498ade8f7',
          modelType: 'PSDETREEVIEW',
          name: 'treeexpbar_tree',
          id: 'plmweb.work_item.relation_mpick_up_view_tree_view',
        },
      ],
      ...
      modelId: 'c7cc999fcd4127b97a1b4f4100250345_treeexpbar',
      modelType: 'PSEXPBAR',
      name: 'treeexpbar',
  ...
  modelId: 'c7cc999fcd4127b97a1b4f4100250345',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemre_mpick_up_view',
  id: 'plmweb.work_item_re_mpick_up_view',
};
