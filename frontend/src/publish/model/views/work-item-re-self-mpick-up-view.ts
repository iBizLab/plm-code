export default {
  ...
  controls: [
    {
      embeddedAppDEViewId: 'plmweb.work_item_re_self_mpick_up_grid_view',
      ...
      controls: [
        {
          ...
          autoLoad: true,
          showBusyIndicator: true,
          codeName: 're_self_mpickup_view_tree_view',
          ...
          id: 'plmweb.work_item.re_self_mpickup_view_tree_view',
        },
      ],
