  ...
  controls: [
    {
      ...
      degridColumns: [
        ...
        },
        {
          ...
          deuiactionGroup: {
            uiactionGroupDetails: [
              {
                ...
                uiactionId: 'shift_out_release@work_item',
                showCaption: true,
                showIcon: true,
                sysImage: {
            ...
            appDataEntityId: 'plmweb.work_item',
            uniqueTag: 'work_item__Usr0527711207',
            name: '发布下工作项操作列',
            id: 'usr0527711207',
          },
          valueType: 'SIMPLE',
      ...
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.work_item.release_work_item_grid',
    },
    {
      detoolbarItems: [
        {
      ...
      xdataControlName: 'grid',
      codeName: 'release_grid_view_tabtoolbar',
      controlType: 'TOOLBAR',
      logicName: '发布_规划工作项',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
      ...
      modelType: 'PSDETOOLBAR',
      name: 'tabtoolbar',
      id: 'release_grid_view_tabtoolbar',
    },
    {
      groupMode: 'SINGLE',
      quickSearchMode: 1,
