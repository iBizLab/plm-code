export default {
  ...
  loadDefault: true,
  deviewCodeName: 'resource_gantt_view',
  deviewId: '766797F5-11A1-4AB0-9F0A-14994D3F64D4',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      detreeNodes: [
        {
          ...
          decontextMenu: {
            detoolbarItems: [
              {
                actionLevel: 100,
                noPrivDisplayMode: 2,
                uiactionId: 'open_capacity@addon_resource',
                uiactionTarget: 'NONE',
                valid: true,
                caption: '容量设置',
                itemType: 'DEUIACTION',
              ...
              },
              {
                actionLevel: 100,
                noPrivDisplayMode: 2,
                uiactionId: 'resource_member_pre@work_item',
                uiactionTarget: 'NONE',
                valid: true,
                caption: '成员管理',
                itemType: 'DEUIACTION',
            ...
            codeName: 'resource_gantt_view_root_cm',
            controlType: 'CONTEXTMENU',
            logicName: '资源甘特图头部上下文菜单',
            appDataEntityId: 'plmweb.addon_resource',
            controlParam: {
              id: 'root_cm',
            },
            modelId: '44378E2F-7F1D-4389-A588-078E95CCD7AC',
            modelType: 'PSDETOOLBAR',
            name: 'root_cm',
            id: 'resource_gantt_view_root_cm',
          },
          treeNodeType: 'DE',
        ...
        },
        {
          ...
          appDEDataSetId: 'fetch_resource_member',
          textAppDEFieldId: 'name',
      ...
      modelId: 'B4D12564-7E8A-47E1-AF41-B1BCCECF991D',
      modelType: 'PSDEGANTT',
      name: 'gantt',
      id: 'plmweb.work_item.resource_gantt',
    },
    {
    ...
    },
    {
      ...
      caption: '资源分配',
      codeName: 'resource_gantt_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'resource_gantt_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutMode: 'Flex',
    ...
    layoutPanel: true,
    codeName: 'usr0529691589',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: '资源甘特布局',
    appDataEntityId: 'plmweb.work_item',
    controlParam: {},
    modelId: '358a7fe5326a656948449e2bff1aa853',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'e85ce57213746d70811513688599e74a',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemresource_gantt_view',
