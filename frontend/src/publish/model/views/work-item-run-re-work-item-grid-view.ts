export default {
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        xdataControlName: 'grid',
        codeName: 'run_re_work_item_grid_view_toolbar',
        controlType: 'TOOLBAR',
        ...
        name: 'toolbar',
        id: 'run_re_work_item_grid_view_toolbar',
      },
      {
        aggMode: 'NONE',
        ...
        modelId: 'F2439024-FC1B-4053-B842-91060DDDF46D',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.work_item.no_button_re_grid',
      },
      {
