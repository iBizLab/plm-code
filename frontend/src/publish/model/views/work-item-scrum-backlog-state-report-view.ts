    ...
    controls: [
      {
        ...
        name: 'searchform',
        id: 'plmweb.work_item.usr03193185_search_form',
      },
      {
        ...
        chartDataSetGroups: [
          {
            appDEDataSetId: 'fetch_backlog_state_distribution',
            appDataEntityId: 'plmweb.work_item',
        ...
        chartDataSets: [
          {
            ...
            name: 'pie_0-backlog_state_distribution',
            id: '0',
          },
        ],
        navViewPos: 'NONE',
        ...
        autoLoad: true,
        showBusyIndicator: true,
        codeName: 'backlog_state_distribution_report_view_chart',
        ...
        modelId: '1a629a0f4abea38a255daff078bc916e',
        modelType: 'PSDECHART',
        userParam: {
          'EC.gridHeaders':
            '[{"id":"filter_type","name":"状态"},{"id":"count","name":"需求数"},{"id":"srfpercent","name":"百分比"}]',
          'EC.color':
            '["#5470c6","#91cc75","#fac858","#ee6666","#73c0de","#3ba272","#fc8452","#9a60b4","#ea7ccc","#5470c6","#91cc75"]',
        },
        name: 'chart',
        id: 'plmweb.work_item.backlog_state_distribution_report_view_chart',
      },
      {
        groupMode: 'SINGLE',
      ...
      },
      {
        ...
        caption: '需求状态分布',
        codeName: 'scrum_backlog_state_report_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {},
        name: 'captionbar',
        id: 'scrum_backlog_state_report_view_captionbar',
      },
    ],
