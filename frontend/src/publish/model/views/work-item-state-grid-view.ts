export default {
  ...
  caption: '工作项全局状态',
  codeName: 'work_item_stateGridView',
  ...
  viewLayoutPanel: {
    ...
    appViewLogics: [
      ...
      },
      {
        ...
        builtinAppUILogic: {
          ...
          newDataAppView: {
            openMode: 'POPUPMODAL',
            refAppViewId: 'plmweb.work_item_statequick_edit_view',
          },
          appUILogicRefViews: [
            {
              openMode: 'POPUPMODAL',
      ...
      },
      {
        ...
        builtinAppUILogic: {
          openDataAppView: {
            openMode: 'POPUPMODAL',
            refAppViewId: 'plmweb.work_item_stateedit_view',
          },
          editMode: true,
          appUILogicRefViews: [
            {
    ...
    controls: [
      ...
      },
      {
        ...
        modelId: '6431DAF0-C4FE-4182-B72F-D93F940BDF24',
    ...
    appDataEntityId: 'plmweb.work_item_state',
    controlParam: {},
    modelId: 'FDE81B4F-312D-449B-9D8C-F0E1D9CFADDF',
  ...
  id: 'plmweb.work_item_stategridview',
};
