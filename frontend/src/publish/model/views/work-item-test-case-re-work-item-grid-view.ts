export default {
  ...
  deviewId: '3d9d1643ba355476de59829ec7535f50',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    rootPanelItems: [
      ...
      },
      {
        editor: {
          ...
          singleSelect: true,
          pickupAppViewId: 'plmweb.work_item_others_re_notbug_view',
          appDEACModeId: 'test_case_create_new_work_item',
          appDEDataSetId: 'fetch_recent_work_item_and_nobug',
    ...
    controls: [
      {
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'grid',
        codeName: 'test_case_re_work_item_grid_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '添加工作项',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'test_case_re_work_item_grid_view_toolbar',
      },
      {
        aggMode: 'NONE',
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetch_test_case_relation_work_item',
          appDataEntityId: 'plmweb.work_item',
          id: 'fetch',
        },
        ...
        modelId: '08be33647e70b71858f10c072a982848',
        modelType: 'PSDEGRID',
        name: 'grid',
      ...
      },
      {
        ...
        caption: '工作项',
        codeName: 'test_case_re_work_item_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {},
        name: 'captionbar',
        id: 'test_case_re_work_item_grid_view_captionbar',
      },
    ],
    ...
    controlParam: {},
    modelId: 'db1b8b85ab45a0924345a224f9bc3ca9',
  ...
  modelId: 'ddf61e836c0f9c9b3b898d94afc5f84d',
