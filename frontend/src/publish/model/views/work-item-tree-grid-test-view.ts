export default {
  ...
  caption: '工作项树表测试',
  codeName: 'work_itemTreeGridTestView',
    ...
    appViewLogics: [
      ...
      },
      {
        ...
        builtinAppUILogic: {
          openDataAppView: {
            openMode: 'POPUPMODAL',
            refAppViewId: 'plmweb.work_itemtest_follow_edit_view',
          },
          editMode: true,
          appUILogicRefViews: [
            {
    ...
    controls: [
      {
            ...
            detoolbarItems: [
              {
                actionLevel: 100,
                noPrivDisplayMode: 2,
                uiactionId: 'change_tree_mode@work_item',
                uiactionTarget: 'NONE',
                valid: true,
                caption: '树状',
                itemType: 'DEUIACTION',
              ...
              },
              {
                actionLevel: 100,
                noPrivDisplayMode: 2,
                uiactionId: 'change_grid_mode@work_item',
                uiactionTarget: 'NONE',
                valid: true,
                caption: '表格',
                itemType: 'DEUIACTION',
        ...
        codeName: 'TreeGridTestViewtoolbar',
        controlType: 'TOOLBAR',
        logicName: '工作项树表测试_工具栏',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '9c4a135387933c7350ba138a6bf2b899',
        modelType: 'PSDETOOLBAR',
        name: 'toolbar',
        id: 'treegridtestviewtoolbar',
      },
      {
        aggMode: 'NONE',
        ...
        degridEditItems: [
          {
            ...
            editor: {
              maxLength: 500,
              editorType: 'TEXTBOX',
              placeHolder: '添加任务，按回车键（Enter）保存',
              valueType: 'SIMPLE',
              editable: true,
              id: 'title',
            },
        ...
        fetchControlAction: {
          appDEMethodId: 'fetchtree_tile_grid_query',
          appDataEntityId: 'plmweb.work_item',
          id: 'fetch',
        },
        ...
        controls: [
          {
            ...
            codeName: 'TreeGridTestViewtreegrid_batchtoolbar',
            controlType: 'TOOLBAR',
            ...
            id: 'treegridtestviewtreegrid_batchtoolbar',
          },
        ],
        codeName: 'Tree_grid_waterfall',
        controlStyle: 'NUMBER_GRID',
        controlType: 'TREEGRID',
        logicName: '工作项树表格（waterfall）',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {
          ctrlParams: {
            GRIDROWACTIVEMODE: '2',
        ...
        modelType: 'PSDEGRID',
        name: 'treegrid',
        id: 'plmweb.work_item.tree_grid_waterfall',
      },
      {
        groupMode: 'SINGLE',
        groupMoreText: '更多',
      ...
      },
      {
        ...
        caption: '工作项树表测试',
        codeName: 'TreeGridTestViewcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {},
        name: 'captionbar',
        id: 'treegridtestviewcaptionbar',
      },
    ],
    codeName: 'Usr0123588524',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'TreeGridTestView树表格视图布局面板',
    appDataEntityId: 'plmweb.work_item',
    controlParam: {},
    modelId: '95b0492ff92a8e9bfd554cfeb771e7a3',
  ...
  name: 'work_itemTreeGridTestView',
  id: 'plmweb.work_itemtreegridtestview',
};
