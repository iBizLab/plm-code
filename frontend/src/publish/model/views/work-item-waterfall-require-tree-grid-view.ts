export default {
  gridRowActiveMode: 1,
  loadDefault: true,
  deviewCodeName: 'waterfall_require_tree_grid_view',
  deviewId: 'bfd9914cdf036283799573a4b7933ad5',
  accUserMode: 2,
  capLanguageRes: {
    ...
    controls: [
      {
            ...
            detoolbarItems: [
              {
                actionLevel: 100,
                noPrivDisplayMode: 2,
                uiactionId: 'waterfall_upload_back@work_item',
                uiactionTarget: 'NONE',
                valid: true,
                caption: '导入需求',
                itemType: 'DEUIACTION',
        ...
        codeName: 'waterfall_require_tree_grid_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '新建需求（waterfall）',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {
          id: 'toolbar',
        },
        modelId: '12c7c8049f7307563473fc4e0ae982f8',
        modelType: 'PSDETOOLBAR',
        name: 'toolbar',
        id: 'waterfall_require_tree_grid_view_toolbar',
      },
      {
        aggMode: 'NONE',
        ...
        controls: [
          {
            ...
            codeName: 'waterfall_require_tree_grid_view_treegrid_batchtoolbar',
            controlType: 'TOOLBAR',
            ...
            id: 'waterfall_require_tree_grid_view_treegrid_batchtoolbar',
          },
        ],
      ...
      },
      {
        ...
        caption: '全部需求',
        codeName: 'waterfall_require_tree_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {},
        name: 'captionbar',
        id: 'waterfall_require_tree_grid_view_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '78d9c2874224fdd7a8af05dd5d262b1c',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemwaterfall_require_tree_grid_view',
