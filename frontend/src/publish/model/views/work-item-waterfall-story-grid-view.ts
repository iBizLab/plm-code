export default {
  ...
  loadDefault: true,
  deviewCodeName: 'waterfall_story_grid_view',
  deviewId: '26c197110c79f1c4077d1a2186ba7c1e',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'waterfall_story_grid_view_toolbar',
      controlType: 'TOOLBAR',
      ...
      name: 'toolbar',
      id: 'waterfall_story_grid_view_toolbar',
    },
    {
      aggMode: 'NONE',
      ...
      controls: [
        {
          ...
          codeName: 'waterfall_story_grid_view_grid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'waterfall_story_grid_view_grid_batchtoolbar',
        },
      ],
      codeName: 'story_grid',
    ...
    },
    {
      ...
      caption: '全部需求',
      codeName: 'waterfall_story_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'waterfall_story_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '498b8ed5e07f6db7b93ce3444022647f',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemwaterfall_story_grid_view',
