export default {
  ...
  caption: '工作项操作向导明细',
  codeName: 'work_item_wizard_detail_edit_view',
      ...
      deformPages: [
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.WORK_ITEM_WIZARD_DETAIL.MAIN.GROUPPANEL.GROUP1',
              },
              caption: '工作项操作向导成员基本信息',
              codeName: 'group1',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag:
              'CONTROL.DEFORM.WORK_ITEM_WIZARD_DETAIL.MAIN.FORMPAGE.FORMPAGE1',
          },
          caption: '基本信息',
          codeName: 'formpage1',
          detailStyle: 'DEFAULT',
        ...
        },
        {
          ...
          deformDetails: [
            {
              ...
              capLanguageRes: {
                lanResTag:
                  'CONTROL.DEFORM.WORK_ITEM_WIZARD_DETAIL.MAIN.GROUPPANEL.GROUP2',
              },
              caption: '操作信息',
              codeName: 'group2',
              detailStyle: 'DEFAULT',
          ...
          capLanguageRes: {
            lanResTag:
              'CONTROL.DEFORM.WORK_ITEM_WIZARD_DETAIL.MAIN.FORMPAGE.FORMPAGE2',
          },
          caption: '其它',
          codeName: 'formpage2',
          detailStyle: 'DEFAULT',
