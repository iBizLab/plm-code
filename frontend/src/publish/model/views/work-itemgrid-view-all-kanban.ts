export default {
  ...
  loadDefault: true,
  deviewCodeName: 'grid_view_all_kanban',
  ...
  caption: '工作项',
  codeName: 'work_itemgrid_view_all_kanban',
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'grid_view_all_kanbantoolbar',
      controlType: 'TOOLBAR',
      logicName: '新建工作项（看板）',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
      ...
      name: 'toolbar',
      id: 'grid_view_all_kanbantoolbar',
    },
    {
      aggMode: 'NONE',
      ...
      controls: [
        {
          ...
          codeName: 'grid_view_all_kanbangrid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'grid_view_all_kanbangrid_batchtoolbar',
        },
      ],
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'grid_view_all_kanbancaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'grid_view_all_kanbancaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  name: 'work_itemgrid_view_all_kanban',
  id: 'plmweb.work_itemgrid_view_all_kanban',
};
