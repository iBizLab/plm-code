  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'grid_view_all_waterfalltoolbar',
      controlType: 'TOOLBAR',
      logicName: '新建工作项（瀑布）',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
      ...
      name: 'toolbar',
      id: 'grid_view_all_waterfalltoolbar',
    },
    {
      aggMode: 'NONE',
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'grid_view_all_waterfallcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'grid_view_all_waterfallcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
