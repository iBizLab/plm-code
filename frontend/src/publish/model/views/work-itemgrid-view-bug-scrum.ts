export default {
  ...
  caption: '全部缺陷',
  codeName: 'work_itemgrid_view_bug_scrum',
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'grid_view_bug_scrumtoolbar',
      controlType: 'TOOLBAR',
      ...
      controls: [
        {
          ...
          codeName: 'grid_view_bug_scrumgrid_batchtoolbar',
          controlType: 'TOOLBAR',
    ...
    },
    {
      ...
      caption: '全部缺陷',
      codeName: 'grid_view_bug_scrumcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'grid_view_bug_scrumcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
