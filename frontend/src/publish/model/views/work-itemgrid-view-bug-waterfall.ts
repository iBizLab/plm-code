export default {
  ...
  loadDefault: true,
  deviewCodeName: 'grid_view_bug_waterfall',
  ...
  caption: '全部缺陷',
  codeName: 'work_itemgrid_view_bug_waterfall',
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'grid_view_bug_waterfalltoolbar',
      controlType: 'TOOLBAR',
      ...
      modelId: '7AF875CD-3BB1-4F2D-A118-3C4BBB5F8542',
      modelType: 'PSDETOOLBAR',
      name: 'toolbar',
      id: 'grid_view_bug_waterfalltoolbar',
    },
    {
      aggMode: 'NONE',
      ...
      controls: [
        {
          ...
          codeName: 'grid_view_bug_waterfallgrid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'grid_view_bug_waterfallgrid_batchtoolbar',
        },
      ],
      codeName: 'Bug_grid',
    ...
    },
    {
      ...
      caption: '全部缺陷',
      codeName: 'grid_view_bug_waterfallcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'grid_view_bug_waterfallcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  name: 'work_itemgrid_view_bug_waterfall',
  id: 'plmweb.work_itemgrid_view_bug_waterfall',
};
