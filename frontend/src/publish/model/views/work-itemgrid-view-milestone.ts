export default {
  ...
  caption: '里程碑',
  codeName: 'work_itemgrid_view_milestone',
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'grid_view_milestonetoolbar',
      controlType: 'TOOLBAR',
    ...
    },
    {
      ...
      caption: '里程碑',
      codeName: 'grid_view_milestonecaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'grid_view_milestonecaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
