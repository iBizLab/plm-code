export default {
  ...
  loadDefault: true,
  deviewCodeName: 'grid_view_story_waterfall',
  ...
  caption: '全部需求',
  codeName: 'work_itemgrid_view_story_waterfall',
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'grid_view_story_waterfalltoolbar',
      controlType: 'TOOLBAR',
      ...
      modelId: '94EF0BAC-B830-4F23-96A0-E6B0F9217DAD',
      modelType: 'PSDETOOLBAR',
      name: 'toolbar',
      id: 'grid_view_story_waterfalltoolbar',
    },
    {
      aggMode: 'NONE',
      ...
      fetchControlAction: {
        appDEMethodId: 'fetchrequirement',
        appDataEntityId: 'plmweb.work_item',
        id: 'fetch',
      },
      ...
      controls: [
        {
          ...
          codeName: 'grid_view_story_waterfallgrid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'grid_view_story_waterfallgrid_batchtoolbar',
        },
      ],
      codeName: 'Story_grid',
    ...
    },
    {
      ...
      caption: '全部需求',
      codeName: 'grid_view_story_waterfallcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'grid_view_story_waterfallcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  name: 'work_itemgrid_view_story_waterfall',
  id: 'plmweb.work_itemgrid_view_story_waterfall',
};
