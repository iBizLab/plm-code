export default {
  ...
  loadDefault: true,
  deviewCodeName: 'grid_view_version',
  deviewId: '45dc83b03464cc35682cc1be4486e6fc',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '全部工作项',
  codeName: 'work_itemgrid_view_version',
  ...
  controls: [
    {
      detoolbarItems: [
        {
          actionLevel: 100,
          noPrivDisplayMode: 2,
          uiactionId: 'plan_work_item@work_item',
          uiactionTarget: 'NONE',
          valid: true,
          caption: '规划工作项',
          itemType: 'DEUIACTION',
      ...
      xdataControlName: 'grid',
      codeName: 'grid_view_versiontoolbar',
      controlType: 'TOOLBAR',
      logicName: '发布_规划工作项',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
      ...
      modelId: '29F9FC1C-AC3E-4918-89EF-3189484EC488',
      modelType: 'PSDETOOLBAR',
      name: 'toolbar',
      id: 'grid_view_versiontoolbar',
    },
    {
      aggMode: 'NONE',
      ...
      controls: [
        {
          ...
          codeName: 'grid_view_versiongrid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'grid_view_versiongrid_batchtoolbar',
        },
      ],
      codeName: 'Scrum_grid',
    ...
    },
    {
      ...
      caption: '全部工作项',
      codeName: 'grid_view_versioncaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'grid_view_versioncaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'cc6c28fc3a02fd6e4cb54d7851397a90',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemgrid_view_version',
  id: 'plmweb.work_itemgrid_view_version',
};
