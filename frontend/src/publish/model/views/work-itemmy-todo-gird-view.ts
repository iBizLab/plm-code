export default {
  ...
  loadDefault: true,
  deviewCodeName: 'my_todo_gird_view',
  deviewId: '23288ec989b6b94bd4ce417ab0b24b0b',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '工作项',
  codeName: 'work_itemmy_todo_gird_view',
  ...
  controls: [
    {
      ...
      codeName: 'My_todo_item_grid',
      controlType: 'GRID',
      logicName: '我的待完成工作项表格',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
        id: 'grid',
      },
      modelId: 'c6bb581b6ffce3bc23351b0b45ebe3df',
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.work_item.my_todo_item_grid',
    },
    {
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'my_todo_gird_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'my_todo_gird_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '9c1e2210f3725e675c17b1154dae0702',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemmy_todo_gird_view',
  id: 'plmweb.work_itemmy_todo_gird_view',
};
