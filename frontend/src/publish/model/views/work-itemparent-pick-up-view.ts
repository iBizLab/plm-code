export default {
  ...
  caption: '选择工作项',
  codeName: 'work_itemparent_pick_up_view',
  ...
  controls: [
    {
      embeddedAppDEViewId: 'plmweb.work_itemparent_pick_up_view_pickupgridview',
      codeName: 'parent_pick_up_viewpickupviewpanel',
      ...
      id: 'parent_pick_up_viewpickupviewpanel',
    },
    {
      title: '选择工作项',
      ...
      controls: [
        {
          ...
          autoLoad: true,
          showBusyIndicator: true,
          codeName: 'Parent_pick_up_view_TreeView',
      ...
      codeName: 'parent_pick_up_viewtreeexpbar',
    ...
    },
    {
      ...
      caption: '选择工作项',
      codeName: 'parent_pick_up_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'parent_pick_up_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutMode: 'FLEX',
    ...
    layoutPanel: true,
    codeName: 'ExWorkItemPickupView2Layout',
