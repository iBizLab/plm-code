export default {
  ...
  loadDefault: true,
  deviewCodeName: 'plan_work_item_pickview_PickupGridView',
  deviewId: '7C07D2E8-DADB-4386-BA5A-86667EDCDAA5',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '工作项',
  codeName: 'work_itemplan_work_item_pickview_PickupGridView',
  ...
  controls: [
    {
      ...
      codeName: 'Plan_work_item_pickview_PickupGridView_Grid',
      controlType: 'GRID',
      logicName: '规划工作项多项选择视图_选择数据视图_表格',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
        id: 'grid',
      },
      modelId: '8AC9E390-C118-4774-9ADA-9C48ADEE11C4',
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.work_item.plan_work_item_pickview_pickupgridview_grid',
    },
    {
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 'plan_work_item_pickview_PickupGridViewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'plan_work_item_pickview_pickupgridviewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  title: '规划工作项多项选择视图_选择数据视图',
  viewStyle: 'DEFAULT',
  viewType: 'DEPICKUPGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: '2efbf793096d68a613fef70a99930007',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemplan_work_item_pickview_PickupGridView',
  id: 'plmweb.work_itemplan_work_item_pickview_pickupgridview',
};
