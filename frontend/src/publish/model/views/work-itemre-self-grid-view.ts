export default {
  ...
  deviewId: 'EC21A4E1-FAE3-49D7-91FE-65B496C22DF0',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    rootPanelItems: [
      ...
      },
      {
        editor: {
          ...
          singleSelect: true,
          pickupAppViewId: 'plmweb.work_itemre_self_mpickup_view',
    ...
    controls: [
      ...
      },
      {
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetchwork_item_relation_work_item',
          appDataEntityId: 'plmweb.work_item',
          id: 'fetch',
        },
        ...
        modelId: 'E5A939BA-DC8D-4998-BA94-1C7C4AEFAF73',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.work_item.relation_self_grid',
      },
      {
        groupMode: 'SINGLE',
        quickSearchMode: 1,
    ...
    controlParam: {},
    modelId: 'D307DC36-D9BE-4450-A092-5D6D9033DDE8',
  ...
  modelId: '11486da76d4cebffa999c0a4732ca812',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemre_self_grid_view',
