export default {
  ...
  loadDefault: true,
  deviewCodeName: 're_self_mpickup_view_PickupGridView',
  deviewId: '911F0609-768E-4CB3-A206-522E80C4BDF5',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '工作项',
  codeName: 'work_itemre_self_mpickup_view_PickupGridView',
  ...
  controls: [
    {
      ...
      codeName: 'Re_self_mpickup_view_PickupGridView_Grid',
      ...
      modelId: '885BFF7A-E07E-49B7-8F97-4BE93F4A214A',
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.work_item.re_self_mpickup_view_pickupgridview_grid',
    },
    {
    ...
    },
    {
      ...
      caption: '工作项',
      codeName: 're_self_mpickup_view_PickupGridViewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 're_self_mpickup_view_pickupgridviewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'e395eeafa205df48b6103f3f93ae2d36',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemre_self_mpickup_view_PickupGridView',
  id: 'plmweb.work_itemre_self_mpickup_view_pickupgridview',
};
