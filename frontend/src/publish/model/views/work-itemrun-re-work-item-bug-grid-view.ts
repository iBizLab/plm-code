export default {
  ...
  deviewId: '7CD29D89-F5A4-474F-B38E-1823F9C016AE',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '工作项',
  codeName: 'work_itemrun_re_work_item_bug_grid_view',
  ...
  viewLayoutPanel: {
        ...
        panelItems: [
          ...
          },
          {
            editor: {
              ...
              singleSelect: true,
              pickupAppViewId: 'plmweb.work_itemcase_re_bug_mpickup_view',
              appDEACModeId: 'run_create_new_work_item_bug',
              appDEDataSetId: 'fetchrecent_work_item_bug',
      ...
      },
      {
        ...
        builtinAppUILogic: {
          openDataAppView: {
            ...
            refAppViewId: 'plmweb.work_itemmain_view_bug',
          },
          editMode: true,
          appUILogicRefViews: [
            {
    ...
    controls: [
      {
        ...
        xdataControlName: 'grid',
        codeName: 'run_re_work_item_bug_grid_viewtoolbar',
        controlType: 'TOOLBAR',
        logicName: '测试用例关联缺陷',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {
        ...
        modelId: 'A5612BB6-0871-4883-B160-3690FE17D43F',
        modelType: 'PSDETOOLBAR',
        name: 'toolbar',
        id: 'run_re_work_item_bug_grid_viewtoolbar',
      },
      {
        aggMode: 'NONE',
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetchrun_relation_work_item',
          appDataEntityId: 'plmweb.work_item',
          id: 'fetch',
        },
        ...
        modelId: '4B982FED-3ECA-40D4-AD85-651AC769FE6E',
        modelType: 'PSDEGRID',
        name: 'grid',
      ...
      },
      {
        ...
        caption: '工作项',
        codeName: 'run_re_work_item_bug_grid_viewcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {},
        name: 'captionbar',
        id: 'run_re_work_item_bug_grid_viewcaptionbar',
      },
    ],
    ...
    controlParam: {},
    modelId: '3A17D4BF-B8C0-42ED-A1CC-3A0D726FCC5D',
  ...
  modelId: '32c9d94403329fbc4c4b2a9c0f03757d',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemrun_re_work_item_bug_grid_view',
  id: 'plmweb.work_itemrun_re_work_item_bug_grid_view',
};
