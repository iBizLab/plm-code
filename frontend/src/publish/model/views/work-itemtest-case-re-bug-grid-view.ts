export default {
  ...
  deviewId: '9C921E61-EA13-45DF-8C0D-B3D20105A760',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '工作项',
  codeName: 'work_itemtest_case_re_bug_grid_view',
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        ...
        xdataControlName: 'grid',
        codeName: 'test_case_re_bug_grid_viewtoolbar',
        controlType: 'TOOLBAR',
        logicName: '测试用例关联缺陷',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'test_case_re_bug_grid_viewtoolbar',
      },
      {
        aggMode: 'NONE',
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetchtest_case_relation_bug',
          appDataEntityId: 'plmweb.work_item',
          id: 'fetch',
        },
      ...
      },
      {
        ...
        caption: '工作项',
        codeName: 'test_case_re_bug_grid_viewcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {},
        name: 'captionbar',
        id: 'test_case_re_bug_grid_viewcaptionbar',
      },
    ],
    codeName: 'Usr0112685160',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'test_case_relation_bug_grid_view表格视图布局',
    appDataEntityId: 'plmweb.work_item',
    controlLogics: [
      {
        eventNames: 'onChange',
    ...
    controlParam: {},
    modelId: '4514358D-5A07-4012-92C1-857A43554C34',
  ...
  modelId: 'f9126d93c36619cfe67838cf7459e946',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemtest_case_re_bug_grid_view',
  id: 'plmweb.work_itemtest_case_re_bug_grid_view',
};
