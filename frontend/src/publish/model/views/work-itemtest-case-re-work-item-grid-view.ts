export default {
  ...
  loadDefault: true,
  deviewCodeName: 'test_case_re_work_item_grid_view',
  deviewId: '89991F0F-D600-44D0-9B48-D26CABA95733',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '工作项',
  codeName: 'work_itemtest_case_re_work_item_grid_view',
  ...
  viewLayoutPanel: {
    ...
    rootPanelItems: [
      ...
      },
      {
        editor: {
          ...
          singleSelect: true,
          pickupAppViewId: 'plmweb.work_itemothers_re_notbug_view',
          appDEACModeId: 'test_case_create_new_work_item',
          appDEDataSetId: 'fetchrecent_work_item_and_nobug',
    ...
    controls: [
      {
        ...
        xdataControlName: 'grid',
        codeName: 'test_case_re_work_item_grid_viewtoolbar',
        controlType: 'TOOLBAR',
        logicName: '添加工作项',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {
        ...
        modelId: 'C6CC5A64-9189-4A6A-9870-A68F26670513',
        modelType: 'PSDETOOLBAR',
        name: 'toolbar',
        id: 'test_case_re_work_item_grid_viewtoolbar',
      },
      {
        aggMode: 'NONE',
        ...
        codeName: 'Case_relation_work_item_grid',
        controlType: 'GRID',
        logicName: '测试用例关联工作项_表格',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {
          id: 'grid',
        },
        modelId: 'F8F37F11-A031-43F5-83EB-1EE63287A585',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.work_item.case_relation_work_item_grid',
      },
      {
        groupMode: 'SINGLE',
      ...
      },
      {
        ...
        caption: '工作项',
        codeName: 'test_case_re_work_item_grid_viewcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {},
        name: 'captionbar',
        id: 'test_case_re_work_item_grid_viewcaptionbar',
      },
    ],
    codeName: 'Usr0112455197',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'test_case_relation_work_item_grid_view表格视图布局',
    appDataEntityId: 'plmweb.work_item',
    controlLogics: [
      {
        eventNames: 'onChange',
        ...
        logicType: 'APPDEUILOGIC',
        appDEUILogicId: 'relation_work_item_change',
        appDataEntityId: 'plmweb.work_item',
    ...
    controlParam: {},
    modelId: '85EAB4E1-299F-44DA-9439-B24D423F9E74',
  ...
  modelId: 'ee13084a7b639e3584d0256684e3168c',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemtest_case_re_work_item_grid_view',
  id: 'plmweb.work_itemtest_case_re_work_item_grid_view',
};
