export default {
  ...
  caption: '动态视图测试',
  codeName: 'work_itemwork_item_testdyna',
    ...
    },
    {
      ...
      builtinAppUILogic: {
        openDataAppView: {
          ...
          refAppViewId: 'plmweb.work_itemmain_view_dyna',
        },
        editMode: true,
        appUILogicRefViews: [
          {
  ...
  controls: [
    {
      ...
      xdataControlName: 'grid',
      codeName: 'work_item_testdynatoolbar',
      controlType: 'TOOLBAR',
      logicName: '新建工作项（看板）',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
      ...
      controls: [
        {
          ...
          codeName: 'work_item_testdynagrid_batchtoolbar',
          controlType: 'TOOLBAR',
          ...
          id: 'work_item_testdynagrid_batchtoolbar',
        },
      ],
    ...
    },
    {
      ...
      caption: '动态视图测试',
      codeName: 'work_item_testdynacaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {},
      name: 'captionbar',
      id: 'work_item_testdynacaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  id: 'plmweb.work_itemwork_item_testdyna',
};
