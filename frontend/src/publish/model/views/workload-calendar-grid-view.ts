export default {
  ...
  deviewId: '35ced94a9121d2dc58e08de9a554d239',
  accUserMode: 2,
  capLanguageRes: {
    ...
    controls: [
      {
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetch_my_calendar',
          appDataEntityId: 'plmweb.workload',
          id: 'fetch',
        },
        removeControlAction: {
      ...
      },
      {
        ...
        caption: '工时',
        codeName: 'calendar_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'calendar_grid_view_captionbar',
      },
    ],
    codeName: 'usr0322332286',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'calendar_grid_view表格视图布局',
    appDataEntityId: 'plmweb.workload',
    controlParam: {},
    modelId: 'da477d12eba2195bfc788d5249d7add0',
  ...
  modelId: '3e9e99fcc96bc4104f74ce308b213e13',
