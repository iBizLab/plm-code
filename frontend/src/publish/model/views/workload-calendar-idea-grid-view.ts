export default {
  ...
  loadDefault: true,
  deviewCodeName: 'calendar_idea_grid_view',
  deviewId: 'bb141272dfdd3c8857d9ecd0a1b081d9',
  accUserMode: 2,
  capLanguageRes: {
    ...
    controls: [
      {
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetch_idea_dimension',
          appDataEntityId: 'plmweb.workload',
          id: 'fetch',
        },
        controlNavParams: [
        ...
        modelId: 'f64a6f840e75e202fdceb2a92bba497f',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.workload.calendar_idea_grid',
      },
      {
      ...
      },
      {
        ...
        name: 'searchbar',
        id: 'plmweb.workload.idea_calendar_searchbar',
      },
      {
        detoolbarItems: [
          {
        ...
        xdataControlName: 'grid',
        codeName: 'calendar_idea_grid_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '工时日历_工具栏',
        appDataEntityId: 'plmweb.workload',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'calendar_idea_grid_view_toolbar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.WORKLOAD',
        ...
        caption: '工时',
        codeName: 'calendar_idea_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'calendar_idea_grid_view_captionbar',
      },
    ],
    codeName: 'usr0326498718',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'calendar_idea_grid_view表格视图布局',
    appDataEntityId: 'plmweb.workload',
    controlParam: {},
    modelId: '0A12EA1C-EEC5-4754-9F66-D199F8E35C26',
  ...
  modelId: 'd94ec1ffba127f7397455d57f3a934a9',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadcalendar_idea_grid_view',
