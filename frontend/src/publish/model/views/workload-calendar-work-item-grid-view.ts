  ...
  viewLayoutPanel: {
    ...
    controls: [
        ...
        searchBarFilters: [
          ...
          },
          {
            ...
            defsearchMode: {
              ...
              id: 'n_work_item_exists__n_identifier_like',
            },
            editor: {
              editorType: 'TEXTBOX',
              valueType: 'SIMPLE',
      ...
      },
      {
        ...
        xdataControlName: 'grid',
        codeName: 'calendar_work_item_grid_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '工时日历_工具栏',
        appDataEntityId: 'plmweb.workload',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'calendar_work_item_grid_view_toolbar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.WORKLOAD',
        ...
        caption: '工时',
        codeName: 'calendar_work_item_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'calendar_work_item_grid_view_captionbar',
      },
    ],
