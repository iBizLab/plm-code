export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'day_link_grid_view',
  deviewId: '95614dad699a9fc3a56e65f1511dfec5',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '工时日志',
      codeName: 'day_link_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.workload',
      controlParam: {},
      name: 'captionbar',
      id: 'day_link_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'ba204777f535d571f9e42b75e2d10292',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadday_link_grid_view',
