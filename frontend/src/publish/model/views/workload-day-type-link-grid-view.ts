export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'day_type_link_grid_view',
  deviewId: 'e198cd29ba418ec664a4738a01ea85d4',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORKLOAD',
  },
  caption: '工时日志',
  codeName: 'workload_day_type_link_grid_view',
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '工时日志',
      codeName: 'day_type_link_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.workload',
      controlParam: {},
      name: 'captionbar',
      id: 'day_type_link_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '5f9fff29c2c6f070146163839af5f7bb',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadday_type_link_grid_view',
  id: 'plmweb.workload_day_type_link_grid_view',
};
