export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'group_duration_link_grid_view',
  deviewId: '7F03E2EF-B3F8-4262-9F00-9AEEC987D206',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    controls: [
      ...
      },
      {
        ...
        caption: '工时日志',
        codeName: 'group_duration_link_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'group_duration_link_grid_view_captionbar',
      },
    ],
    codeName: 'usr0619764143',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'group_duration_link_grid_view表格视图布局',
    appDataEntityId: 'plmweb.workload',
    controlParam: {},
    modelId: '6523EEFD-2C1E-4CF1-A614-EA21FB6D1126',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '70271d690a4510f8442dda6f13ed14de',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadgroup_duration_link_grid_view',
