export default {
  ...
  loadDefault: true,
  deviewCodeName: 'library_gird_view',
  deviewId: '82f7b2cfec4dc2ece1debc450e8b48ad',
  accUserMode: 2,
  capLanguageRes: {
    ...
    controls: [
      {
        ...
        codeName: 'library_grid',
        controlStyle: 'WORKLOAD_TABLE',
        controlType: 'GRID',
        logicName: '工时日历_测试库表格',
        appDataEntityId: 'plmweb.workload',
        controlParam: {
          ctrlParams: {
        ...
        modelId: '477ce3be825f501bab3f87eef6b06ab9',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.workload.library_grid',
      },
      {
      ...
      },
      {
        ...
        xdataControlName: 'grid',
        codeName: 'library_gird_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '工时日历_工具栏',
        appDataEntityId: 'plmweb.workload',
        controlParam: {
      ...
      },
      {
        ...
        caption: '工时',
        codeName: 'library_gird_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'library_gird_view_captionbar',
      },
    ],
    codeName: 'usr0322436809',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'library_gird_view表格视图布局',
    appDataEntityId: 'plmweb.workload',
    controlParam: {},
    modelId: '5860891df3f3b07fd24530a797bb881c',
  ...
  modelId: '6a96474a998c18459f940d0b3220d7f1',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadlibrary_gird_view',
