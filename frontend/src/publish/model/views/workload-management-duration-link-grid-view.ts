export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'management_duration_link_grid_view',
  deviewId: '69565d1b2d837bd8419fb9829caa4da5',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    controls: [
      ...
      },
      {
        ...
        controlParam: {},
        name: 'captionbar',
        id: 'management_duration_link_grid_view_captionbar',
      },
    ],
    codeName: 'usr0419148816',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'management_duration_link_grid_view表格视图布局',
    appDataEntityId: 'plmweb.workload',
    controlParam: {},
    modelId: 'B7385895-E900-4CA6-A4E4-D8B98C0D7BF7',
  ...
  id: 'plmweb.workload_management_duration_link_grid_view',
};
