export default {
  ...
  loadDefault: true,
  deviewCodeName: 'management_product_grid_view',
  deviewId: 'e9c482058491fceff7abfec5eace8777',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    appViewLogics: [
      ...
      },
      {
        ...
        appDEUILogicId: 'open_product_main_view',
        appDataEntityId: 'plmweb.workload',
        ctrlName: 'grid',
        builtinLogic: true,
        name: 'OPENDATA',
    ...
    controls: [
      {
        ...
        codeName: 'management_product_grid',
        controlStyle: 'WORKLOAD_TABLE',
        controlType: 'GRID',
        logicName: '工时日历_产品管理表格',
        appDataEntityId: 'plmweb.workload',
        controlParam: {
          ctrlParams: {
        ...
        modelId: '472551359b39e5e534ca6e5dcab8aa93',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.workload.management_product_grid',
      },
      {
      ...
      },
      {
        ...
        codeName: 'product_calendar_searchbar',
        controlType: 'SEARCHBAR',
        logicName: '产品工时日历_搜索栏',
        appDataEntityId: 'plmweb.workload',
        controlParam: {
          id: 'searchbar',
        },
        modelId: '1965cdf2bd469e75c224d0234fa04075',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'plmweb.workload.product_calendar_searchbar',
      },
      {
        detoolbarItems: [
          {
        ...
        xdataControlName: 'grid',
        codeName: 'management_product_grid_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '工时日历_工具栏',
        appDataEntityId: 'plmweb.workload',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'management_product_grid_view_toolbar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.WORKLOAD',
        ...
        caption: '工时',
        codeName: 'management_product_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'management_product_grid_view_captionbar',
      },
    ],
    codeName: 'usr0322264064',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'management_product_grid_view表格视图布局',
    appDataEntityId: 'plmweb.workload',
    controlParam: {},
    modelId: 'a5f9fac1b53815bea89a2d2db29f5f6f',
    modelType: 'PSSYSVIEWLAYOUTPANEL',
    name: 'layoutpanel',
    id: 'usr0322264064',
  },
  title: '工时日历项目维度表格视图（管理）',
  viewStyle: 'DEFAULT',
  viewType: 'DEGRIDVIEW',
  enableDP: true,
  showCaptionBar: false,
  modelId: '1b19ec812171b43555a168e95fbfd489',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadmanagement_product_grid_view',
