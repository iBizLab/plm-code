export default {
  ...
  loadDefault: true,
  deviewCodeName: 'management_project_grid_view',
  deviewId: '738efe9b6127ad9066a87a48991c53d3',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    appViewLogics: [
      ...
      },
      {
        ...
        appDEUILogicId: 'open_project_main_view',
        appDataEntityId: 'plmweb.workload',
        ctrlName: 'grid',
        builtinLogic: true,
        name: 'OPENDATA',
    ...
    controls: [
      {
        ...
        degridColumns: [
          ...
          },
          {
            ...
            deuiactionId: 'management_project_duration_link@workload',
            valueFormat: '#0.0',
            valueType: 'SIMPLE',
            aggMode: 'NONE',
            align: 'RIGHT',
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetch_work_item_workload',
          appDataEntityId: 'plmweb.workload',
          id: 'fetch',
        },
        removeControlAction: {
        ...
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.workload.management_project_grid',
      },
      {
      ...
      },
      {
        ...
        codeName: 'project_calendar_searchbar',
        controlType: 'SEARCHBAR',
        logicName: '项目工时日历_搜索栏',
        appDataEntityId: 'plmweb.workload',
        controlParam: {
          id: 'searchbar',
        },
        modelId: '14a43774bf67bda90ac2cd9ce79a6179',
        modelType: 'PSSYSSEARCHBAR',
        name: 'searchbar',
        id: 'plmweb.workload.project_calendar_searchbar',
      },
      {
        detoolbarItems: [
          {
        ...
        xdataControlName: 'grid',
        codeName: 'management_project_grid_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '工时日历_工具栏',
        appDataEntityId: 'plmweb.workload',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'management_project_grid_view_toolbar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.WORKLOAD',
        ...
        caption: '工时',
        codeName: 'management_project_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'management_project_grid_view_captionbar',
      },
    ],
    codeName: 'usr0322319855',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'management_project_grid_view表格视图布局',
    appDataEntityId: 'plmweb.workload',
    controlParam: {},
    modelId: '78f1709d06e9cd5d7a861a91b0c191f3',
  ...
  modelId: '08ea75fba2447a8adab1361375ef8091',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadmanagement_project_grid_view',
