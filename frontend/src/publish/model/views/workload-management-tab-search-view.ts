export default {
  ...
  caption: '工时',
  codeName: 'workload_management_tab_search_view',
    ...
    controls: [
      {
        ...
        tabLayout: 'TOP',
        uniqueTag: 'workload_management_tab_search_view__tabexppanel',
        appViewRefs: [
          {
          ...
          },
          {
            ...
            refAppViewId: 'plmweb.workload_management_project_grid_view',
            name: 'EXPITEM:project',
            id: 'expitem:project',
          },
          {
            realTitle: '工时日历需求维度表格视图（管理）',
            refAppViewId: 'plmweb.workload_calendar_idea_management_grid_view',
            name: 'EXPITEM:idea',
            id: 'expitem:idea',
          },
          {
            realTitle: '工时日历项目维度表格视图（管理）',
            refAppViewId: 'plmweb.workload_management_product_grid_view',
          ...
          },
          {
            ...
            refAppViewId: 'plmweb.workload_management_library_grid_view',
            name: 'EXPITEM:library',
            id: 'expitem:library',
          },
          {
            realTitle: '工时日历工作类别维度表格视图（管理）',
            refAppViewId: 'plmweb.workload_management_work_type_grid_view',
        ...
        controls: [
          {
            ...
            embeddedAppDEViewId:
              'plmweb.workload_management_member_calendar_grid_view',
            codeName: 'management_tab_search_view_member',
            ...
            name: 'member',
            id: 'management_tab_search_view_member',
          },
          {
            sysImage: {
              rawContent:
            ...
            embeddedAppDEViewId:
              'plmweb.workload_calendar_work_item_management_grid_view',
            codeName: 'management_tab_search_view_work_item',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'work_item',
            ...
            modelType: 'PSVIEWPANEL',
            name: 'work_item',
            id: 'management_tab_search_view_work_item',
          },
          {
            sysImage: {
              rawContent:
            ...
            caption: '项目',
            embeddedAppDEViewId: 'plmweb.workload_management_project_grid_view',
            codeName: 'management_tab_search_view_project',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'project',
            ...
            modelType: 'PSVIEWPANEL',
            name: 'project',
            id: 'management_tab_search_view_project',
          },
          {
            sysImage: {
              rawContent:
            ...
            codeName: 'management_tab_search_view_idea',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'idea',
            ...
            modelType: 'PSVIEWPANEL',
            name: 'idea',
            id: 'management_tab_search_view_idea',
          },
          {
            sysImage: {
              rawContent:
            ...
            caption: '产品',
            embeddedAppDEViewId: 'plmweb.workload_management_product_grid_view',
            codeName: 'management_tab_search_view_product',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'product',
            ...
            modelType: 'PSVIEWPANEL',
            name: 'product',
            id: 'management_tab_search_view_product',
          },
          {
            sysImage: {
              rawContent:
            ...
            embeddedAppDEViewId:
              'plmweb.workload_calendar_test_case_management_grid_view',
            codeName: 'management_tab_search_view_test_case',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'test_case',
            ...
            modelType: 'PSVIEWPANEL',
            name: 'test_case',
            id: 'management_tab_search_view_test_case',
          },
          {
            sysImage: {
              rawContent:
            ...
            caption: '测试库',
            embeddedAppDEViewId: 'plmweb.workload_management_library_grid_view',
            codeName: 'management_tab_search_view_library',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'library',
            ...
            modelType: 'PSVIEWPANEL',
            name: 'library',
            id: 'management_tab_search_view_library',
          },
          {
            sysImage: {
              rawContent:
            ...
            codeName: 'management_tab_search_view_work_type',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'work_type',
            ...
            modelType: 'PSVIEWPANEL',
            name: 'work_type',
            id: 'management_tab_search_view_work_type',
          },
        ],
        codeName: 'management_tab_search_view_tabexppanel',
        ...
        name: 'tabexppanel',
        id: 'management_tab_search_view_tabexppanel',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.WORKLOAD',
        ...
        caption: '工时',
        codeName: 'management_tab_search_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'management_tab_search_view_captionbar',
      },
    ],
  ...
  id: 'plmweb.workload_management_tab_search_view',
};
