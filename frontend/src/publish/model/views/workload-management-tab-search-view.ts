    ...
    controls: [
      {
        dedrtabPages: [
          {
            caption: '人员',
            itemTag: '成员',
            appViewId: 'plmweb.workload_management_member_calendar_grid_view',
            sysImage: {
              rawContent:
          ...
          },
          {
            caption: '团队',
            itemTag: '成员',
            appViewId: 'plmweb.workload_user_group_grid_view',
            sysImage: {
              rawContent:
          ...
          },
          {
            caption: '项目',
            itemTag: '项目管理',
            appViewId: 'plmweb.workload_management_project_grid_view',
            sysImage: {
              rawContent:
          ...
          },
          {
            caption: '产品需求',
            itemTag: '产品管理',
            appViewId: 'plmweb.workload_calendar_idea_management_grid_view',
            sysImage: {
              rawContent:
          ...
          },
          {
            caption: '产品',
            itemTag: '产品管理',
            appViewId: 'plmweb.workload_management_product_grid_view',
            sysImage: {
              rawContent:
          ...
          },
          {
            caption: '测试库',
            itemTag: '测试管理',
            appViewId: 'plmweb.workload_management_library_grid_view',
            sysImage: {
              rawContent:
          ...
          },
          {
            caption: '工作类别',
            itemTag: '项目管理',
            appViewId: 'plmweb.workload_management_work_type_grid_view',
            sysImage: {
              rawContent:
        ...
        dataRelationTag: 'management_tab_search_view_DR',
        ...
        codeName: 'management_tab_search_view_dr',
        ...
        modelId: '26d7e6813ec37a2384d82d4fb119c665',
        modelType: 'PSDEDRTAB',
        name: 'tabexppanel',
        id: 'management_tab_search_view_dr',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.WORKLOAD',
