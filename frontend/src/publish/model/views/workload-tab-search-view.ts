export default {
  ...
  deviewId: '83e56e03e0059f8bad360f71cecab4ea',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORKLOAD',
  },
  caption: '工时',
  codeName: 'workload_tab_search_view',
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        ...
        tabLayout: 'TOP',
        uniqueTag: 'workload_tab_search_view__tabexppanel',
        appViewRefs: [
          {
            realTitle: '工时日历工作项维度表格视图',
            refAppViewId: 'plmweb.workload_calendar_work_item_grid_view',
            name: 'EXPITEM:work_item',
            id: 'expitem:work_item',
          },
          {
            realTitle: '工时日历项目维度表格视图',
            refAppViewId: 'plmweb.workload_project_grid_view',
            name: 'EXPITEM:project',
            id: 'expitem:project',
          },
          {
            realTitle: '工时日历需求维度表格视图',
            refAppViewId: 'plmweb.workload_calendar_idea_grid_view',
            name: 'EXPITEM:idea',
            id: 'expitem:idea',
          },
          {
            realTitle: '工时日历产品维度表格视图',
            refAppViewId: 'plmweb.workload_product_grid_view',
            name: 'EXPITEM:product',
            id: 'expitem:product',
          },
          {
            realTitle: '工时日历用例维度表格视图',
            refAppViewId: 'plmweb.workload_calendar_test_case_grid_view',
            name: 'EXPITEM:test_case',
            id: 'expitem:test_case',
          },
          {
            realTitle: '工时日历测试库维度表格视图',
            refAppViewId: 'plmweb.workload_library_gird_view',
            name: 'EXPITEM:library',
            id: 'expitem:library',
          },
          {
            realTitle: '工时日历工作类别维度表格视图',
            refAppViewId: 'plmweb.workload_work_type_grid_view',
        ...
        controls: [
          {
            ...
            caption: '工作项',
            embeddedAppDEViewId: 'plmweb.workload_calendar_work_item_grid_view',
            ...
            modelId: 'cf5c065b59a0a7239565b42e58139518_work_item',
          ...
          },
          {
            ...
            caption: '项目',
            embeddedAppDEViewId: 'plmweb.workload_project_grid_view',
            codeName: 'tab_search_view_project',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'project',
            },
            modelId: 'cf5c065b59a0a7239565b42e58139518_project',
            modelType: 'PSVIEWPANEL',
            name: 'project',
            id: 'tab_search_view_project',
          },
          {
            sysImage: {
              rawContent:
            ...
            caption: '产品需求',
            embeddedAppDEViewId: 'plmweb.workload_calendar_idea_grid_view',
            ...
            modelId: 'cf5c065b59a0a7239565b42e58139518_idea',
            modelType: 'PSVIEWPANEL',
            name: 'idea',
          ...
          },
          {
            ...
            caption: '产品',
            embeddedAppDEViewId: 'plmweb.workload_product_grid_view',
            codeName: 'tab_search_view_product',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'product',
            },
            modelId: 'cf5c065b59a0a7239565b42e58139518_product',
            modelType: 'PSVIEWPANEL',
            name: 'product',
            id: 'tab_search_view_product',
          },
          {
            sysImage: {
              rawContent:
            ...
            caption: '测试用例',
            embeddedAppDEViewId: 'plmweb.workload_calendar_test_case_grid_view',
            ...
            modelId: 'cf5c065b59a0a7239565b42e58139518_test_case',
            modelType: 'PSVIEWPANEL',
            name: 'test_case',
          ...
          },
          {
            ...
            caption: '测试库',
            embeddedAppDEViewId: 'plmweb.workload_library_gird_view',
            codeName: 'tab_search_view_library',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'library',
            },
            modelId: 'cf5c065b59a0a7239565b42e58139518_library',
            modelType: 'PSVIEWPANEL',
            name: 'library',
            id: 'tab_search_view_library',
          },
          {
            sysImage: {
              rawContent:
            ...
            caption: '工作类别',
            embeddedAppDEViewId: 'plmweb.workload_work_type_grid_view',
            codeName: 'tab_search_view_work_type',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'work_type',
            },
            modelId: 'cf5c065b59a0a7239565b42e58139518_work_type',
            modelType: 'PSVIEWPANEL',
            name: 'work_type',
            id: 'tab_search_view_work_type',
          },
        ],
        ...
        modelId: 'cf5c065b59a0a7239565b42e58139518_tabexppanel',
    ...
    codeName: 'usr0322938012',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'tab_search_view分页搜索视图布局面板',
    appDataEntityId: 'plmweb.workload',
    controlParam: {},
    modelId: '3029138f3ee2b0a6572b24e1c8a7a05c',
  ...
  modelId: 'cf5c065b59a0a7239565b42e58139518',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadtab_search_view',
  id: 'plmweb.workload_tab_search_view',
};
