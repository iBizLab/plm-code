    ...
    controls: [
      {
        dedrtabPages: [
          {
            caption: '工作项',
            itemTag: '项目管理',
            appViewId: 'plmweb.workload_calendar_work_item_grid_view',
            sysImage: {
              rawContent:
          ...
          },
          {
            caption: '项目',
            itemTag: '项目管理',
            appViewId: 'plmweb.workload_project_grid_view',
            sysImage: {
              rawContent:
          ...
          },
          {
            caption: '产品需求',
            itemTag: '产品管理',
            appViewId: 'plmweb.workload_calendar_idea_grid_view',
            sysImage: {
              rawContent:
          ...
          },
          {
            caption: '产品',
            itemTag: '产品管理',
            appViewId: 'plmweb.workload_product_grid_view',
            sysImage: {
              rawContent:
          ...
          },
          {
            caption: '测试用例',
            itemTag: '测试管理',
            appViewId: 'plmweb.workload_calendar_test_case_grid_view',
            sysImage: {
              rawContent:
          ...
          },
          {
            caption: '测试库',
            itemTag: '测试管理',
            appViewId: 'plmweb.workload_library_gird_view',
            sysImage: {
              rawContent:
          ...
          },
          {
            caption: '工作类别',
            itemTag: '项目管理',
            appViewId: 'plmweb.workload_work_type_grid_view',
            sysImage: {
              rawContent:
        ...
        dataRelationTag: 'tab_search_view_DR',
        ...
        modelId: '778d36cca3c7638385df56a6e2131c5b',
        modelType: 'PSDEDRTAB',
        name: 'tabexppanel',
        id: 'tab_search_view_dr',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.WORKLOAD',
