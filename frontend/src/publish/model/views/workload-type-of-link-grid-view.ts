export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'type_of_link_grid_view',
  deviewId: 'D53B97AB-A7BA-4FB1-8F78-65DBF93A36E3',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORKLOAD',
  },
  caption: '工时日志',
  codeName: 'workload_type_of_link_grid_view',
  ...
  controls: [
    {
      ...
      singleSelect: true,
      fetchControlAction: {
        appDEMethodId: 'fetch_my_type_of',
        appDataEntityId: 'plmweb.workload',
        id: 'fetch',
      },
      removeControlAction: {
    ...
    },
    {
      ...
      caption: '工时日志',
      codeName: 'type_of_link_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.workload',
      controlParam: {},
      name: 'captionbar',
      id: 'type_of_link_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  title: '工时日历工作类别链接表格视图',
  viewStyle: 'DEFAULT',
  viewType: 'DEGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: 'c48fda80dd4c1b04546da0d62677e572',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadtype_of_link_grid_view',
  id: 'plmweb.workload_type_of_link_grid_view',
};
