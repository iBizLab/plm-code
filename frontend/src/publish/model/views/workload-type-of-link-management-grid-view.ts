export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'type_of_link_management_grid_view',
  deviewId: '9f88e9d25b363f39486a2361e8c3577a',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
      ...
      caption: '工时日志',
      codeName: 'type_of_link_management_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.workload',
      controlParam: {},
      name: 'captionbar',
      id: 'type_of_link_management_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  title: '工时日历工作类别管理链接表格视图',
  viewStyle: 'DEFAULT',
  viewType: 'DEGRIDVIEW',
  enableDP: true,
  showCaptionBar: true,
  modelId: 'b73d3e014a9d19c0d43fef122ba7dc50',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadtype_of_link_management_grid_view',
