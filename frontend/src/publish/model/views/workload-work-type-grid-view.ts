export default {
  ...
  loadDefault: true,
  deviewCodeName: 'work_type_grid_view',
  deviewId: '83758e5fef951f29a976d4bb53ffdcf6',
  accUserMode: 2,
  capLanguageRes: {
    ...
    controls: [
      {
        ...
        degridColumns: [
          ...
          },
          {
            ...
            deuiactionId: 'workload_type_duration_link@workload',
            valueFormat: '#0.0',
            valueType: 'SIMPLE',
            aggMode: 'NONE',
            align: 'RIGHT',
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetch_type_of_dimension',
          appDataEntityId: 'plmweb.workload',
          id: 'fetch',
        },
        controlNavParams: [
        ...
        codeName: 'workload_type_grid',
        controlStyle: 'WORKLOAD_TABLE',
        controlType: 'GRID',
        logicName: '工时日历_工作类别表格',
        appDataEntityId: 'plmweb.workload',
        controlParam: {
          ctrlParams: {
            ...
            OPENVIEW: 'workload_day_type_link_grid_view',
          },
          id: 'grid',
        },
        sysPFPluginId: 'workload_table',
        modelId: 'fc8d19e9a4c99604011280a79e6c2895',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.workload.workload_type_grid',
      },
      {
      ...
      },
      {
        ...
        xdataControlName: 'grid',
        codeName: 'work_type_grid_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '工时日历_工具栏',
        appDataEntityId: 'plmweb.workload',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'work_type_grid_view_toolbar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.WORKLOAD',
        ...
        caption: '工时',
        codeName: 'work_type_grid_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'work_type_grid_view_captionbar',
      },
    ],
    codeName: 'usr0322684174',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'work_type_grid_view表格视图布局',
    appDataEntityId: 'plmweb.workload',
    controlParam: {},
    modelId: 'dfdc914ff6460193b4f93b7b0ee16b7f',
    modelType: 'PSSYSVIEWLAYOUTPANEL',
    name: 'layoutpanel',
    id: 'usr0322684174',
  },
  title: '工时日历工作类别维度表格视图',
  viewStyle: 'DEFAULT',
  viewType: 'DEGRIDVIEW',
  enableDP: true,
  showCaptionBar: false,
  modelId: '92ed16ea262905812efaadaa293deb44',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadwork_type_grid_view',
