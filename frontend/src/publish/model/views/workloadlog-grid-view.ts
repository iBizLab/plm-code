export default {
  ...
  deviewId: '7424cb3f499db1757d5a72e3a7885235',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORKLOAD',
  },
  caption: '工时',
  codeName: 'workloadlog_grid_view',
  ...
  controls: [
    ...
    },
    {
      ...
      autoLoad: true,
      showBusyIndicator: true,
      codeName: 'Log_management_search_form',
    ...
    },
    {
      ...
      caption: '工时',
      codeName: 'log_grid_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.workload',
      controlParam: {},
      name: 'captionbar',
      id: 'log_grid_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  modelId: '510b2d4c2687209fff70e98be1927a22',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadlog_grid_view',
  id: 'plmweb.workloadlog_grid_view',
};
