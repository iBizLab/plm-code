export default {
  ...
  caption: '工时',
  codeName: 'workloadmanagement_library_grid_view',
    ...
    controls: [
      {
        ...
        degridColumns: [
          ...
          },
          {
            ...
            deuiactionId: 'management_library_duration_link@workload',
            valueFormat: '#.0',
            valueType: 'SIMPLE',
            aggMode: 'NONE',
            align: 'RIGHT',
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetchtest_case_workload',
          appDataEntityId: 'plmweb.workload',
          id: 'fetch',
        },
        removeControlAction: {
      ...
      },
      {
        ...
        caption: '工时',
        codeName: 'management_library_grid_viewcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'management_library_grid_viewcaptionbar',
      },
    ],
  ...
  id: 'plmweb.workloadmanagement_library_grid_view',
};
