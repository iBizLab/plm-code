    ...
    controls: [
      {
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetchmember_dimension',
          appDataEntityId: 'plmweb.workload',
          id: 'fetch',
        },
        removeControlAction: {
      ...
      },
      {
        ...
        xdataControlName: 'grid',
        codeName: 'management_member_calendar_grid_viewtoolbar',
        controlType: 'TOOLBAR',
        logicName: '工时日历_工具栏',
        appDataEntityId: 'plmweb.workload',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'management_member_calendar_grid_viewtoolbar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.WORKLOAD',
        ...
        caption: '工时',
        codeName: 'management_member_calendar_grid_viewcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'management_member_calendar_grid_viewcaptionbar',
      },
    ],
