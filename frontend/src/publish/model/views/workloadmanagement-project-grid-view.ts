export default {
  ...
  caption: '工时',
  codeName: 'workloadmanagement_project_grid_view',
    ...
    controls: [
      {
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetchwork_item_workload',
          appDataEntityId: 'plmweb.workload',
          id: 'fetch',
        },
        removeControlAction: {
      ...
      },
      {
        ...
        caption: '工时',
        codeName: 'management_project_grid_viewcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'management_project_grid_viewcaptionbar',
      },
    ],
  ...
  id: 'plmweb.workloadmanagement_project_grid_view',
};
