export default {
  ...
  loadDefault: true,
  deviewCodeName: 'product_grid_view',
  deviewId: '2598cfc778ca35ca85e18e72a99fce2a',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORKLOAD',
  },
  caption: '工时',
  codeName: 'workloadproduct_grid_view',
    ...
    controls: [
      {
        ...
        degridColumns: [
          ...
          },
          {
            ...
            deuiactionId: 'product_duration_link@workload',
            valueFormat: '#.0',
            valueType: 'SIMPLE',
            aggMode: 'NONE',
            align: 'RIGHT',
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetchmy_idea_workload',
          appDataEntityId: 'plmweb.workload',
          id: 'fetch',
        },
        removeControlAction: {
        ...
        modelId: 'dab54031cb1b98cb731d53349d31a286',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.workload.product_grid',
      },
      {
      ...
      },
      {
        ...
        caption: '工时',
        codeName: 'product_grid_viewcaptionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.workload',
        controlParam: {},
        name: 'captionbar',
        id: 'product_grid_viewcaptionbar',
      },
    ],
    codeName: 'Usr0322849293',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'product_grid_view表格视图布局',
    appDataEntityId: 'plmweb.workload',
    controlParam: {},
    modelId: '3b89668a924eb45b493a5bcd3e40d17f',
  ...
  modelId: '256b6972cc2d323413ca21b641e5d4b9',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadproduct_grid_view',
  id: 'plmweb.workloadproduct_grid_view',
};
