export default {
  ...
  deviewId: '1a8ab5a19e91eaaf3245d60b567cb82f',
  accUserMode: 2,
  capLanguageRes: {
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        ...
        degridColumns: [
          ...
          },
          {
            ...
            deuiactionId: 'project_duration_link@workload',
            valueFormat: '#.0',
            valueType: 'SIMPLE',
            aggMode: 'NONE',
            align: 'RIGHT',
        ...
        singleSelect: true,
        fetchControlAction: {
          appDEMethodId: 'fetchmy_work_item_workload',
          appDataEntityId: 'plmweb.workload',
          id: 'fetch',
        },
        removeControlAction: {
    ...
    codeName: 'Usr0322575743',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'project_grid_view表格视图布局',
    appDataEntityId: 'plmweb.workload',
    controlParam: {},
    modelId: '93803fdc056e478d57cd79f14ce66b72',
  ...
  modelId: '395dde042530f8eb53379f05a67b7395',
