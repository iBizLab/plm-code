        ...
        appViewRefs: [
          {
            ...
            refAppViewId: 'plmweb.workloadcalendar_work_item_grid_view',
          ...
          },
          {
            ...
            refAppViewId: 'plmweb.workloadcalendar_idea_grid_view',
            name: 'EXPITEM:idea',
            id: 'expitem:idea',
          },
          {
            realTitle: '工时日历产品维度表格视图',
            refAppViewId: 'plmweb.workloadproduct_grid_view',
            name: 'EXPITEM:product',
            id: 'expitem:product',
          },
          {
            realTitle: '工时日历用例维度表格视图',
            refAppViewId: 'plmweb.workloadcalendar_test_case_grid_view',
            name: 'EXPITEM:test_case',
            id: 'expitem:test_case',
          },
          {
            realTitle: '工时日历测试库维度表格视图',
            refAppViewId: 'plmweb.workloadlibrary_gird_view',
            name: 'EXPITEM:library',
            id: 'expitem:library',
          },
          {
            realTitle: '工时日历工作类别维度表格视图',
            refAppViewId: 'plmweb.workloadwork_type_grid_view',
        ...
        controls: [
          {
            ...
            caption: '工作项',
            embeddedAppDEViewId: 'plmweb.workloadcalendar_work_item_grid_view',
          ...
          },
          {
            ...
            caption: '产品需求',
            embeddedAppDEViewId: 'plmweb.workloadcalendar_idea_grid_view',
            codeName: 'tab_search_viewidea',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'idea',
          ...
          },
          {
            ...
            caption: '产品',
            embeddedAppDEViewId: 'plmweb.workloadproduct_grid_view',
            codeName: 'tab_search_viewproduct',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'product',
          ...
          },
          {
            ...
            caption: '测试用例',
            embeddedAppDEViewId: 'plmweb.workloadcalendar_test_case_grid_view',
            codeName: 'tab_search_viewtest_case',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'test_case',
          ...
          },
          {
            ...
            caption: '测试库',
            embeddedAppDEViewId: 'plmweb.workloadlibrary_gird_view',
            codeName: 'tab_search_viewlibrary',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'library',
          ...
          },
          {
            ...
            caption: '工作类别',
            embeddedAppDEViewId: 'plmweb.workloadwork_type_grid_view',
            codeName: 'tab_search_viewwork_type',
            controlType: 'TABVIEWPANEL',
            appDataEntityId: 'plmweb.workload',
            controlParam: {
              id: 'work_type',
