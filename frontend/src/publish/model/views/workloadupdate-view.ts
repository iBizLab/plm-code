export default {
  ...
  deviewId: '6C47B1DE-E2AC-4B53-B63B-397B9901D0EF',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORKLOAD',
  },
  caption: '修改实际工时',
  codeName: 'workloadupdate_view',
  height: 850,
  ...
  controls: [
    {
              ...
              deformDetails: [
                ...
                },
                {
                  ...
                  editor: {
                    ...
                    singleSelect: true,
                    pickupAppViewId: 'plmweb.workload_typepickupview',
      ...
      modelId: '8326F249-DDCB-43D5-979F-062C0F30FDD1',
      modelType: 'PSDEFORM_EDITFORM',
      name: 'form',
      id: 'plmweb.workload.update_form',
    },
    {
      codeName: 'update_viewdatainfobar',
    ...
    },
    {
      ...
      caption: '修改实际工时',
      codeName: 'update_viewcaptionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.workload',
      controlParam: {},
      name: 'captionbar',
      id: 'update_viewcaptionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'b32f7b57839ed2ecb27cbca2b863ba83',
  modelType: 'PSAPPDEVIEW',
  name: 'workloadupdate_view',
  id: 'plmweb.workloadupdate_view',
};
