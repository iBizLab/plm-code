  ...
  switch (_name) {
    ...
    case 'psde_field_work_item_extend_transmit_grid_view':
      return defineAsyncComponent(
        () =>
          import(
            './psde-field/psde-field-work-item-extend-transmit-grid-view/psde-field-work-item-extend-transmit-grid-view.vue'
          ),
      );
    ...
    case 'role_member_edit_view':
      return defineAsyncComponent(
        () =>
          import(
            './role-member/role-member-edit-view/role-member-edit-view.vue'
          ),
      );
    ...
    case 'ps_core_prd_func_api_show_html_view':
      return defineAsyncComponent(
        () =>
          import(
            './ps-core-prd-func/ps-core-prd-func-api-show-html-view/ps-core-prd-func-api-show-html-view.vue'
          ),
      );
    ...
    case 'ps_core_prd_func_second_dev_tav_exp_view':
      return defineAsyncComponent(
        () =>
          import(
            './ps-core-prd-func/ps-core-prd-func-second-dev-tav-exp-view/ps-core-prd-func-second-dev-tav-exp-view.vue'
          ),
      );
    ...
    case 'role_edit_view2':
      return defineAsyncComponent(
        () => import('./role/role-edit-view-2/role-edit-view-2.vue'),
      );
    ...
    case 'role_edit_view':
      return defineAsyncComponent(
        () => import('./role/role-edit-view/role-edit-view.vue'),
      );
    ...
    case 'recent_modeling_custome_view':
      return defineAsyncComponent(
        () =>
          import(
            './recent/recent-modeling-custome-view/recent-modeling-custome-view.vue'
          ),
      );
    ...
    case 'role_grid_view':
      return defineAsyncComponent(
        () => import('./role/role-grid-view/role-grid-view.vue'),
      );
    ...
    case 'comment_ticket_list_view':
      return defineAsyncComponent(
        () =>
          import(
            './comment/comment-ticket-list-view/comment-ticket-list-view.vue'
          ),
      );
    ...
    case 'role_member_grid_view':
      return defineAsyncComponent(
        () =>
          import(
            './role-member/role-member-grid-view/role-member-grid-view.vue'
          ),
      );
    ...
    case 'test_plan_cur_project_grid_view':
      return defineAsyncComponent(
        () =>
          import(
            './test-plan/test-plan-cur-project-grid-view/test-plan-cur-project-grid-view.vue'
          ),
      );
    ...
    case 'comment_idea_list_view':
      return defineAsyncComponent(
        () =>
          import('./comment/comment-idea-list-view/comment-idea-list-view.vue'),
      );
    ...
    case 'ps_core_prd_func_data_model_html_view':
      return defineAsyncComponent(
        () =>
          import(
            './ps-core-prd-func/ps-core-prd-func-data-model-html-view/ps-core-prd-func-data-model-html-view.vue'
          ),
      );
    ...
    case 'user_main_view':
      return defineAsyncComponent(
        () => import('./user/user-main-view/user-main-view.vue'),
      );
    ...
    case 'release_modal_main_view':
      return defineAsyncComponent(
        () =>
          import(
            './release/release-modal-main-view/release-modal-main-view.vue'
          ),
      );
    ...
    case 'ps_core_prd_func_modeling_ide_html_view':
      return defineAsyncComponent(
        () =>
          import(
            './ps-core-prd-func/ps-core-prd-func-modeling-ide-html-view/ps-core-prd-func-modeling-ide-html-view.vue'
          ),
      );
    ...
    case 'user_quick_create_view':
      return defineAsyncComponent(
        () =>
          import('./user/user-quick-create-view/user-quick-create-view.vue'),
      );
    ...
    case 'psde_field_global_work_item_grid_view':
      return defineAsyncComponent(
        () =>
          import(
            './psde-field/psde-field-global-work-item-grid-view/psde-field-global-work-item-grid-view.vue'
          ),
      );
