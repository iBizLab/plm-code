...
@TableName(value = "ACTIVITIY", resultMap = "ActivitiyResultMap")
@ApiModel(value = "ACTIVITIY", description = "活动")
public class Activitiy extends EntityMP implements Serializable
{
     ...
     * 设置 [名称]
     */
    public Activitiy setName(String name) {
        this.name = name;
     ...
     * 设置 [审计信息]
     */
    public Activitiy setAuditInfo(String auditInfo) {
     ...
     * 设置 [对象标识]
     */
    public Activitiy setObjectId(String objectId) {
     ...
     * 设置 [操作人]
     */
    public Activitiy setOpPersonId(String opPersonId) {
     ...
     * 设置 [操作人]
     */
    public Activitiy setOpPersonName(String opPersonName) {
     ...
     * 设置 [访问地址]
     */
    public Activitiy setIpAddress(String ipAddress) {
     ...
     * 设置 [审计类型]
     */
    public Activitiy setAuditType(String auditType) {
     ...
     * 设置 [对象类型]
     */
    public Activitiy setObjectType(String objectType) {
