...
@ApiModel(value = "ROLE_MEMBER", description = "系统角色成员")
public class RoleMember extends EntityBase implements Serializable
{
    /**
     * 用户组/人员标识
     */
    ...
    * 设置 [系统角色标识]
    */
    public RoleMember setRoleId(String roleId) {
        this.roleId = roleId;
