...
@ApiModel("活动查询条件对象")
public class ActivitiySearchContext extends QueryWrapperContext<Activitiy> {
    ...
    @Transient
    @Override
    public QueryWrapper<Activitiy> getSelectCond() {
        QueryWrapper<Activitiy> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}