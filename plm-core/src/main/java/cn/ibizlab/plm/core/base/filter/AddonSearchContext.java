...
@ApiModel("组件查询条件对象")
public class AddonSearchContext extends QueryWrapperContext<Addon> {
    ...
    @Transient
    @Override
    public QueryWrapper<Addon> getSelectCond() {
        QueryWrapper<Addon> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}