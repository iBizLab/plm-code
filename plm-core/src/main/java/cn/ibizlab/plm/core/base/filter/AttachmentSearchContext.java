...
@ApiModel("附件查询条件对象")
public class AttachmentSearchContext extends QueryWrapperContext<Attachment> {
    ...
    public void setContextParentKey(Serializable contextParentKey) {
        ...
        if(Entities.STENCIL.equals(this.getContextParentEntity())&&contextParentKey!=null)
    ...
    @Transient
    @Override
    public QueryWrapper<Attachment> getSelectCond() {
        QueryWrapper<Attachment> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}