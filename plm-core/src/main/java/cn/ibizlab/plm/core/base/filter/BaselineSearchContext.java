...
@ApiModel("基线查询条件对象")
public class BaselineSearchContext extends QueryWrapperContext<Baseline> {
    ...
    @Transient
    @Override
    public QueryWrapper<Baseline> getSelectCond() {
        QueryWrapper<Baseline> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}