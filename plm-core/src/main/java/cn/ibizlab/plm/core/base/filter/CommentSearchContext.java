...
@ApiModel("评论查询条件对象")
public class CommentSearchContext extends QueryWrapperContext<Comment> {
    ...
    public void setContextParentKey(Serializable contextParentKey) {
        ...
        if(Entities.COMMENT.equals(this.getContextParentEntity())&&contextParentKey!=null)
    ...
    @Transient
    @Override
    public QueryWrapper<Comment> getSelectCond() {
        QueryWrapper<Comment> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}