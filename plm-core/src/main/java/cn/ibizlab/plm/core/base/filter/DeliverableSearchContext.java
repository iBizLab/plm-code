...
@ApiModel("交付物查询条件对象")
public class DeliverableSearchContext extends QueryWrapperContext<Deliverable> {
    ...
    @Transient
    @Override
    public QueryWrapper<Deliverable> getSelectCond() {
        QueryWrapper<Deliverable> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}