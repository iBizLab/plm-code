...
@ApiModel("数据字典查询条件对象")
public class DictionaryDataSearchContext extends QueryWrapperContext<DictionaryData> {
    ...
    @Transient
    @Override
    public QueryWrapper<DictionaryData> getSelectCond() {
        QueryWrapper<DictionaryData> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}