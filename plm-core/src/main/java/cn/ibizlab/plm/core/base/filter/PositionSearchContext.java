...
@ApiModel("职位查询条件对象")
public class PositionSearchContext extends QueryWrapperContext<Position> {
    ...
    @Transient
    @Override
    public QueryWrapper<Position> getSelectCond() {
        QueryWrapper<Position> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}