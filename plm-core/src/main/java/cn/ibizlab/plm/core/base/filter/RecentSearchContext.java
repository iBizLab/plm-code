...
@ApiModel("最近访问查询条件对象")
public class RecentSearchContext extends QueryWrapperContext<Recent> {
    ...
    @Transient
    @Override
    public QueryWrapper<Recent> getSelectCond() {
        QueryWrapper<Recent> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}