...
@ApiModel("分组查询条件对象")
public class SectionSearchContext extends QueryWrapperContext<Section> {
    ...
    @Transient
    @Override
    public QueryWrapper<Section> getSelectCond() {
        QueryWrapper<Section> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}