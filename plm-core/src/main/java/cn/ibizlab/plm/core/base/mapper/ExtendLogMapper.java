...
public interface ExtendLogMapper extends BaseMapper<ExtendLog> {
     ...
     * @return
     */
    Page<Map> searchExecutionStatistics(IPage<ExtendLog> page, @Param("ctx") ExtendLogSearchContext context, @Param("ew") Wrapper<ExtendLog> wrapper);
    
    /**
     * 数据集合execution_statistics查询
     * 
     * @param context
     * @param wrapper
     * @return
