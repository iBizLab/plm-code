...
public interface InsightService extends IService<Insight> {
     ...
     * @return
     */
    default List<Insight> getByIds(Collection<String> ids) {
        List<Insight> entities =new ArrayList<>();
        ids.forEach(key -> entities.add(new Insight().setId(key)));
     ...
     * @return
     */
    List<Insight> getByEntities(List<Insight> entities);
     ...
     * @return
     */
    boolean createBatch(List<Insight> list);
     ...
     * @return
     */
    boolean updateBatch(List<Insight> list);
     ...
     * @return
     */
    boolean saveBatch(List<Insight> list);
     ...
     * @return
     */
    boolean removeByEntities(List<Insight> entities);
     ...
     * @return
     */
    Page<Insight> searchDefault(InsightSearchContext context);
    /**
     * listDefault
     * 
     * @param context
