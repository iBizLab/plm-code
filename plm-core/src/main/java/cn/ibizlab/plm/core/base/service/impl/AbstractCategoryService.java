...
public abstract class AbstractCategoryService extends ServiceImpl<CategoryMapper,Category> implements CategoryService {
    ...
    public boolean saveBatch(List<Category> list) {
        if(ObjectUtils.isEmpty(list))
            return true;
        Map<String,Category> before = getByEntities(list).stream().collect(Collectors.toMap(Category::getId,e->e));
    ...
    public boolean remove(Category et) {
        String key = et.getId();
        categoryService.removeByPid(key);
    ...
    @Transactional
    public boolean removeByEntities(List<Category> entities) {
    ...
    public Page<Category> searchNoSection(CategorySearchContext context) {
    ...
    public Page<Category> searchProductIdeaCategory(CategorySearchContext context) {
    ...
    public Page<Category> searchProductPlan(CategorySearchContext context) {
    ...
    public Page<Category> searchSpaceCategory(CategorySearchContext context) {
    ...
    public Page<Category> searchSpaceCategoryTop(CategorySearchContext context) {
