...
public abstract class AbstractPortfolioMemberService extends ServiceImpl<PortfolioMemberMapper,PortfolioMember> implements PortfolioMemberService {
    ...
    public List<PortfolioMember> getByEntities(List<PortfolioMember> entities) {
        entities.forEach(et->{
    ...
    @Transactional
    public boolean createBatch(List<PortfolioMember> list) {
    ...
    @Transactional
    public boolean updateBatch(List<PortfolioMember> list) {
        list.forEach(this::fillParentData);
    ...
    @Transactional
    public boolean saveBatch(List<PortfolioMember> list) {
        if(ObjectUtils.isEmpty(list))
            return true;
        Map<String,PortfolioMember> before = getByEntities(list).stream().collect(Collectors.toMap(PortfolioMember::getId,e->e));
    ...
    @Transactional
    public boolean removeByEntities(List<PortfolioMember> entities) {
        this.baseMapper.deleteEntities(entities);
        return true;
    }

    public Page<PortfolioMember> searchDefault(PortfolioMemberSearchContext context) {
