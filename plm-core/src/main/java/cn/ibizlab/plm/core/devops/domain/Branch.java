...
@TableName(value = "BRANCH", resultMap = "BranchResultMap")
@ApiModel(value = "BRANCH", description = "代码分支")
public class Branch extends EntityMP implements Serializable
{
    ...
    */
    ...
    @ApiModelProperty(value = "repository", notes = "代码仓库-分支")
    ...
    * 设置 [仓库标识]
    */
    public Branch setRepositoryId(String repositoryId) {
