...
@ApiModel("拉取提交查询条件对象")
public class PullRequestSearchContext extends QueryWrapperContext<PullRequest> {
    ...
    @Transient
    @Override
    public QueryWrapper<PullRequest> getSelectCond() {
        QueryWrapper<PullRequest> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}