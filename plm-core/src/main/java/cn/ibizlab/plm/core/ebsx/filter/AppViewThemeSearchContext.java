...
@ApiModel("应用视图主题查询条件对象")
public class AppViewThemeSearchContext extends QueryWrapperContext<AppViewTheme> {
    ...
    @Transient
    @Override
    public QueryWrapper<AppViewTheme> getSelectCond() {
        QueryWrapper<AppViewTheme> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}