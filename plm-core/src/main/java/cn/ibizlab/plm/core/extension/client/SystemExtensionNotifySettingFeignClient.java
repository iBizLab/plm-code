...
public interface SystemExtensionNotifySettingFeignClient  {
    ...
    @PostMapping("system_extension_notify_settings/fetch_view")
    Page<SystemExtensionNotifySetting> fetchView(@Validated @RequestBody SystemExtensionNotifySettingSearchContext dto) ;
