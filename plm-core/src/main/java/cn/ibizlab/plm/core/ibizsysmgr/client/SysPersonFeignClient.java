...
public interface SysPersonFeignClient  {
    ...
    CheckKeyStatus checkKey(@Validated @RequestBody SysPerson dto) ;
    ...
    @PostMapping("sys_people/fetchuser")
    Page<SysPerson> fetchUser(@Validated @RequestBody SysPersonSearchContext dto) ;
