...
@ApiModel("效能视图查询条件对象")
public class InsightViewSearchContext extends QueryWrapperContext<InsightView> {
    ...
    @Transient
    @Override
    public QueryWrapper<InsightView> getSelectCond() {
        QueryWrapper<InsightView> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}