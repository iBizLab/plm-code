...
@TableName(value = "PRODUCT_TAG", resultMap = "ProductTagResultMap")
@ApiModel(value = "PRODUCT_TAG", description = "产品标签")
public class ProductTag extends EntityMP implements Serializable
{
    ...
    */
    ...
    @DEField(name = "name" , dupCheck = DupCheck.ALL , dupCheckField = "productId")
    @JSONField(name = "name")
    @JsonProperty("name")
    ...
    */
    ...
    @ApiModelProperty(value = "product", notes = "产品标签")
    ...
    * 设置 [产品标识]
    */
    public ProductTag setProductId(String productId) {
    ...
    * 设置 [产品名称]
    */
    public ProductTag setProductName(String productName) {
