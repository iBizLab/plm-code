...
@ApiModel("工单渠道查询条件对象")
public class ChannelSearchContext extends QueryWrapperContext<Channel> {
    ...
    @Transient
    @Override
    public QueryWrapper<Channel> getSelectCond() {
        QueryWrapper<Channel> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}