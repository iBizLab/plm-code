...
public abstract class AbstractTicketTypeService extends ServiceImpl<TicketTypeMapper,TicketType> implements TicketTypeService {
    ...
    public List<TicketType> getByEntities(List<TicketType> entities) {
    ...
    @Transactional
    public boolean createBatch(List<TicketType> list) {
    ...
    @Transactional
    public boolean updateBatch(List<TicketType> list) {
    ...
    @Transactional
    public boolean saveBatch(List<TicketType> list) {
        if(ObjectUtils.isEmpty(list))
            return true;
        Map<String,TicketType> before = getByEntities(list).stream().collect(Collectors.toMap(TicketType::getId,e->e));
    ...
    public Page<TicketType> searchDefault(TicketTypeSearchContext context) {
