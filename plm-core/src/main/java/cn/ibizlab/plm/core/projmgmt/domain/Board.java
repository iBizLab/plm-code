...
@TableName(value = "BOARD", resultMap = "BoardResultMap")
@ApiModel(value = "BOARD", description = "看板")
public class Board extends EntityMP implements Serializable
{
    ...
    */
    ...
    @ApiModelProperty(value = "project", notes = "项目-看板")
    ...
    * 设置 [产品标识]
    */
    public Board setProjectId(String projectId) {
