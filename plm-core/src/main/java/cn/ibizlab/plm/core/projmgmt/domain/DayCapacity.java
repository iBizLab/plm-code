...
public class DayCapacity extends EntityBase implements Serializable
{
     ...
     * 项目成员
     */
    @JSONField(name = "dercustom_day_capacity_project_member")
    @JsonProperty("dercustom_day_capacity_project_member")
    @ApiModelProperty(value = "dercustom_day_capacity_project_member", notes = "名称")
    private ProjectMember dercustomDayCapacityProjectMember;
