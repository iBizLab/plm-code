...
@ApiModel("看板查询条件对象")
public class BoardSearchContext extends QueryWrapperContext<Board> {
    ...
    @Transient
    @Override
    public QueryWrapper<Board> getSelectCond() {
        QueryWrapper<Board> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}