...
@ApiModel("项目进度查询条件对象")
public class ProgressSearchContext extends QueryWrapperContext<Progress> {
    ...
    @Transient
    @Override
    public QueryWrapper<Progress> getSelectCond() {
        QueryWrapper<Progress> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}