...
@ApiModel("迭代类别查询条件对象")
public class SprintCategorySearchContext extends QueryWrapperContext<SprintCategory> {
    ...
    public void setContextParentKey(Serializable contextParentKey) {
        ...
        if(Entities.SPRINT_SECTION.equals(this.getContextParentEntity())&&contextParentKey!=null)
            this.getFilter().eq("sprint_section_id",contextParentKey);
    }
    ...
    @Transient
    @Override
    public QueryWrapper<SprintCategory> getSelectCond() {
        QueryWrapper<SprintCategory> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}