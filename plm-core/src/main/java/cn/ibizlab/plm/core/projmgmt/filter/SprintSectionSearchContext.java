...
@ApiModel("迭代分组查询条件对象")
public class SprintSectionSearchContext extends QueryWrapperContext<SprintSection> {
    ...
    @Transient
    @Override
    public QueryWrapper<SprintSection> getSelectCond() {
        QueryWrapper<SprintSection> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}