...
@ApiModel("泳道查询条件对象")
public class SwimlaneSearchContext extends QueryWrapperContext<Swimlane> {
    ...
    @Transient
    @Override
    public QueryWrapper<Swimlane> getSelectCond() {
        QueryWrapper<Swimlane> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}