...
/**
 * 关系型数据实体[TransitionHistory] 查询条件对象
 *
 * @author generator
 */
@Slf4j
...
@ApiModel("流转记录查询条件对象")
public class TransitionHistorySearchContext extends QueryWrapperContext<TransitionHistory> {
    ...
    @Transient
    @Override
    public QueryWrapper<TransitionHistory> getSelectCond() {
        QueryWrapper<TransitionHistory> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}