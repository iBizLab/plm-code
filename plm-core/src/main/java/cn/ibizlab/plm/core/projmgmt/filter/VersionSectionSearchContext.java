...
@ApiModel("发布分组查询条件对象")
public class VersionSectionSearchContext extends QueryWrapperContext<VersionSection> {
    ...
    @Transient
    @Override
    public QueryWrapper<VersionSection> getSelectCond() {
        QueryWrapper<VersionSection> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}