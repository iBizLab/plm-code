...
@TableName(value = "MEMBER", resultMap = "DiscussMemberResultMap")
@ApiModel(value = "DISCUSS_MEMBER", description = "协作成员")
public class DiscussMember extends EntityMP implements Serializable
{
    ...
    */
    ...
    @ApiModelProperty(value = "owner_id", notes = "话题标识")
    ...
    */
    ...
    @DEField(name = "owner_type" , defaultValue = "DISCUSS")
    ...
    */
    ...
    @DEField(name = "owner_subtype" , defaultValue = "DISCUSS")
    ...
    */
    ...
    @ApiModelProperty(value = "discuss_topic", notes = "话题")
    ...
    * 设置 [话题标识]
    */
    public DiscussMember setOwnerId(String ownerId) {
    ...
    * 设置 [所属数据对象]
    */
    public DiscussMember setOwnerType(String ownerType) {
    ...
    * 设置 [所属对象子类型]
    */
    public DiscussMember setOwnerSubtype(String ownerSubtype) {
    ...
    * 设置 [名称]
    */
    public DiscussMember setName(String name) {
        this.name = name;
    ...
    * 设置 [登录名]
    */
    public DiscussMember setUserId(String userId) {
        this.userId = userId;
    ...
    public Serializable getDefaultKey(boolean gen) {
        //Assert.notNull(getOwnerId(),"未设置话题标识");
