...
public class DiscussReplySearchContext extends QueryWrapperContext<DiscussReply> {
    ...
    public void setContextParentKey(Serializable contextParentKey) {
        ...
        if(Entities.DISCUSS_POST.equals(this.getContextParentEntity())&&contextParentKey!=null)
            this.getFilter().eq("post_id",contextParentKey);
    }
    ...
    @Transient
    @Override
    public QueryWrapper<DiscussReply> getSelectCond() {
        QueryWrapper<DiscussReply> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}