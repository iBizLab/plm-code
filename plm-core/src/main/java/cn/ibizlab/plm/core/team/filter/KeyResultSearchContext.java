...
@ApiModel("关键结果查询条件对象")
public class KeyResultSearchContext extends QueryWrapperContext<KeyResult> {
    ...
    @Transient
    @Override
    public QueryWrapper<KeyResult> getSelectCond() {
        QueryWrapper<KeyResult> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}