...
@TableName(value = "CASE_HISTORY", resultMap = "CaseHistoryResultMap")
@ApiModel(value = "CASE_HISTORY", description = "用例执行历史")
public class CaseHistory extends EntityMP implements Serializable
{
    ...
    */
    ...
    @ApiModelProperty(value = "test_case", notes = "测试用例-执行历史")
    ...
    * 设置 [测试用例标识]
    */
    public CaseHistory setCaseId(String caseId) {
        this.caseId = caseId;
