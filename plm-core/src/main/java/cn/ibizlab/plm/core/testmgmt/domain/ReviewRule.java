...
@ApiModel(value = "REVIEW_RULE", description = "评审规则")
public class ReviewRule extends EntityBase implements Serializable
{
    /**
     * 标识
     */
    ...
    @ApiModelProperty(value = "guideline", notes = "准则-规则")
    private Guideline guideline;

    /**
    * 设置 [名称]
    */
    public ReviewRule setName(String name) {
        this.name = name;
    ...
    * 设置 [准则标识]
    */
    public ReviewRule setGuidelineId(String guidelineId) {
