...
/**
 * 关系型数据实体[ReviewContentExtend] 查询条件对象
 *
 * @author generator
 */
@Slf4j
...
public class ReviewContentExtendSearchContext extends QueryWrapperContext<ReviewContentExtend> {
    ...
    @Transient
    @Override
    public QueryWrapper<ReviewContentExtend> getSelectCond() {
        QueryWrapper<ReviewContentExtend> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}