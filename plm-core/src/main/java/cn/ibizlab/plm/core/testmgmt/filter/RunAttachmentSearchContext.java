...
@ApiModel("执行用例结果附件查询条件对象")
public class RunAttachmentSearchContext extends QueryWrapperContext<RunAttachment> {
    ...
    @Transient
    @Override
    public QueryWrapper<RunAttachment> getSelectCond() {
        QueryWrapper<RunAttachment> queryWrapper = super.getSelectCond();
        return queryWrapper;
    }
}