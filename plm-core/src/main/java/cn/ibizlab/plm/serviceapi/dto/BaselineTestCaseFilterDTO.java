...
/**
 * 基线用例过滤[BaselineTestCaseFilterDTO]
 *
 * @author generator
 */
@Getter
...
@ApiModel("基线用例过滤DTO")
public class BaselineTestCaseFilterDTO extends FilterBase implements Serializable {
    ...
    @ApiModelProperty(value = "测试类型EQ", position = 180)
