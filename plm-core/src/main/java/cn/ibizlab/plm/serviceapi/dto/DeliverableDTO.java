...
@ApiModel("交付物DTO")
public class DeliverableDTO extends DTOBase implements Serializable {
     ...
     * 设置 [文件标识]
     */
    public DeliverableDTO setFileId(String fileId) {
        this.fileId = fileId;
     ...
     * 设置 [工作项编号]
     */
    public DeliverableDTO setWorkItemIdentifier(String workItemIdentifier) {
     ...
     * 设置 [工作项标题]
     */
    public DeliverableDTO setWorkItemTitle(String workItemTitle) {
     ...
     * 设置 [工作项类型]
     */
    public DeliverableDTO setWorkItemTypeId(String workItemTypeId) {
     ...
     * 设置 [标题]
     */
    public DeliverableDTO setTitle(String title) {
        this.title = title;
     ...
     * 设置 [名称]
     */
    public DeliverableDTO setName(String name) {
        this.name = name;
