...
@ApiModel("协作成员DTO")
public class DiscussMemberDTO extends DTOBase implements Serializable {
     ...
     * 设置 [话题标识]
     */
    public DiscussMemberDTO setOwnerId(String ownerId) {
     ...
     * 设置 [所属数据对象]
     */
    public DiscussMemberDTO setOwnerType(String ownerType) {
     ...
     * 设置 [所属对象子类型]
     */
    public DiscussMemberDTO setOwnerSubtype(String ownerSubtype) {
     ...
     * 设置 [名称]
     */
    public DiscussMemberDTO setName(String name) {
        this.name = name;
     ...
     * 设置 [登录名]
     */
    public DiscussMemberDTO setUserId(String userId) {
        this.userId = userId;
