...
public class PSDENotifyDTO extends DTOBase implements Serializable {
    ...
    @ApiModelProperty(value = "自定义条件", position = 6)
    ...
    @ApiModelProperty(value = "结束时间属性", position = 8)
    ...
    @ApiModelProperty(value = "监控事件集", position = 9)
    ...
    @ApiModelProperty(value = "监控变化属性集", position = 10)
    ...
    @ApiModelProperty(value = "通知消息类型", position = 11)
    ...
    @ApiModelProperty(value = "延后通知间隔", position = 12)
    ...
    @ApiModelProperty(value = "提前通知间隔", position = 13)
    ...
    @ApiModelProperty(value = "通知子类", position = 14)
    ...
    @ApiModelProperty(value = "通知标记", position = 15)
    ...
    @ApiModelProperty(value = "通知标记2", position = 16)
    ...
    @ApiModelProperty(value = "实体数据集", position = 18)
    ...
    @ApiModelProperty(value = "实体", position = 20)
    ...
    @ApiModelProperty(value = "实体通知标识", position = 21)
    ...
    @ApiModelProperty(value = "实体通知名称", position = 22)
    ...
    @ApiModelProperty(value = "系统消息队列", position = 24)
    ...
    @ApiModelProperty(value = "系统消息模板", position = 26)
    ...
    @ApiModelProperty(value = "附加任务模式", position = 27)
    ...
    @ApiModelProperty(value = "定时触发模式", position = 28)
    ...
    @ApiModelProperty(value = "用户标识", position = 31)
    ...
    @ApiModelProperty(value = "用户标识2", position = 32)
    ...
    @ApiModelProperty(value = "用户标识3", position = 33)
    ...
    @ApiModelProperty(value = "用户标识4", position = 34)
    ...
    @ApiModelProperty(value = "启用", position = 35)
