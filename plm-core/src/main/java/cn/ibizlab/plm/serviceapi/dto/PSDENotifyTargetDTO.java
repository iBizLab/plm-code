...
public class PSDENotifyTargetDTO extends DTOBase implements Serializable {
    ...
    @JsonProperty("data")
    @JSONField(name = "data")
    @ApiModelProperty(value = "目标数据", position = 0)
    private String data;
    ...
    @ApiModelProperty(value = "过滤项", position = 1)
    ...
    @ApiModelProperty(value = "实体通知", position = 2)
    ...
    @ApiModelProperty(value = "实体通知", position = 3)
    ...
    @ApiModelProperty(value = "实体通知目标标识", position = 4)
    ...
    @ApiModelProperty(value = "实体通知目标名称", position = 5)
    ...
    @ApiModelProperty(value = "目标类型", position = 6)
