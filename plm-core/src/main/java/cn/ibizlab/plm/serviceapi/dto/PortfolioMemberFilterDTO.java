...
/**
 * 文件夹成员过滤[PortfolioMemberFilterDTO]
 *
 * @author generator
 */
@Getter
...
@ApiModel("文件夹成员过滤DTO")
public class PortfolioMemberFilterDTO extends FilterBase implements Serializable {
    ...
    @ApiModelProperty(value = "文件夹名称EQ", position = 20)
    ...
    @ApiModelProperty(value = "文件夹名称LIKE", position = 21)
    ...
    @ApiModelProperty(value = "文件夹标识EQ", position = 100)
