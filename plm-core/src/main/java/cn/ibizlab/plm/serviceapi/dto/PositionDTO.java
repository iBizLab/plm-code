...
@ApiModel("职位DTO")
public class PositionDTO extends DTOBase implements Serializable {
    ...
    @ApiModelProperty(value = "分组标识", position = 1)
     ...
     * 设置 [分组标识]
     */
    public PositionDTO setCategoryId(String categoryId) {
