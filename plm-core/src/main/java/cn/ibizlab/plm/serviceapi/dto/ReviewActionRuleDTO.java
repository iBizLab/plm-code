...
@ApiModel("评审后置动作DTO")
public class ReviewActionRuleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [准则标识]
     */
    public ReviewActionRuleDTO setGuidelineId(String guidelineId) {
     ...
     * 设置 [名称]
     */
    public ReviewActionRuleDTO setName(String name) {
        this.name = name;
