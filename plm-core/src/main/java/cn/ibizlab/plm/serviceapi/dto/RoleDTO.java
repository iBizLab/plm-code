...
@ApiModel("角色DTO")
public class RoleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [租户系统标识]
     */
    public RoleDTO setDcSystemId(String dcSystemId) {
        this.dcSystemId = dcSystemId;
        this.modify("dc_system_id", dcSystemId);
        return this;
    }
     ...
     * 设置 [全局标记]
     */
    public RoleDTO setGlobalFlag(Integer globalFlag) {
        this.globalFlag = globalFlag;
        this.modify("global_flag", globalFlag);
        return this;
    }
