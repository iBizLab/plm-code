...
@ApiModel("迭代分组DTO")
public class SprintSectionDTO extends DTOBase implements Serializable {
     ...
     * 设置 [名称]
     */
    public SprintSectionDTO setName(String name) {
        this.name = name;
     ...
     * 设置 [产品标识]
     */
    public SprintSectionDTO setProjectId(String projectId) {
