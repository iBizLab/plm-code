...
/**
 * 通知设置[SystemExtensionNotifySettingDTO]
 *
 * @author generator
 */
@Getter
...
@ApiModel("通知设置DTO")
public class SystemExtensionNotifySettingDTO extends DTOBase implements Serializable {
     ...
     * 设置 [所有者类型]
     */
    public SystemExtensionNotifySettingDTO setOwnerType(String ownerType) {
     ...
     * 设置 [所有者标识]
     */
    public SystemExtensionNotifySettingDTO setOwnerId(String ownerId) {
     ...
     * 设置 [名称]
     */
    public SystemExtensionNotifySettingDTO setName(String name) {
        this.name = name;
     ...
     * 设置 [系统标记]
     */
    public SystemExtensionNotifySettingDTO setSystemTag(String systemTag) {
     ...
     * 设置 [设置模型]
     */
    public SystemExtensionNotifySettingDTO setSettingModel(List<NotifyEventDTO> settingModel) {
