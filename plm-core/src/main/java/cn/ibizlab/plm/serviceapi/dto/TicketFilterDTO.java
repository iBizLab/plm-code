...
public class TicketFilterDTO extends FilterBase implements Serializable {
    ...
    @ApiModelProperty(value = "最近创建日期LTANDEQ", position = 280)
    ...
    @ApiModelProperty(value = "标识NOTEQ", position = 290)
    ...
    @ApiModelProperty(value = "标识EQ", position = 291)
	private String idEQ;
    ...
    @ApiModelProperty(value = "更新时间GTANDEQ", position = 330)
    ...
    @ApiModelProperty(value = "更新时间LTANDEQ", position = 331)
    ...
    @ApiModelProperty(value = "产品标识EQ", position = 350)
    ...
    @ApiModelProperty(value = "产品标识ISNULL", position = 351)
    ...
    @ApiModelProperty(value = "客户标识EQ", position = 360)
    ...
    @ApiModelProperty(value = "客户EQ", position = 370)
    ...
    @ApiModelProperty(value = "客户LIKE", position = 371)
    ...
    @ApiModelProperty(value = "所属产品EQ", position = 380)
    ...
    @ApiModelProperty(value = "所属产品LIKE", position = 381)
