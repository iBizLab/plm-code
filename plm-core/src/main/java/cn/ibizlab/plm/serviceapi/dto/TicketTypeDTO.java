...
@ApiModel("工单类型DTO")
public class TicketTypeDTO extends DTOBase implements Serializable {
    ...
    @ApiModelProperty(value = "是否系统默认", position = 1)
     ...
     * 设置 [描述]
     */
    public TicketTypeDTO setDescription(String description) {
     ...
     * 设置 [是否系统默认]
     */
    public TicketTypeDTO setIsSystem(Integer isSystem) {
     ...
     * 设置 [名称]
     */
    public TicketTypeDTO setName(String name) {
        this.name = name;
