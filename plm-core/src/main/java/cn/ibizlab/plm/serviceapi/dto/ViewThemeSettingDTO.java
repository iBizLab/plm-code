...
@ApiModel("视图主题设置DTO")
public class ViewThemeSettingDTO extends DTOBase implements Serializable {
    ...
    @ApiModelProperty(value = "过滤条件", position = 4)
    ...
    @ApiModelProperty(value = "系统标记", position = 11)
    ...
    @ApiModelProperty(value = "应用标记", position = 12)
    ...
    @ApiModelProperty(value = "应用视图标记", position = 13)
     ...
     * 设置 [启用标记]
     */
    public ViewThemeSettingDTO setValidFlag(Integer validFlag) {
     ...
     * 设置 [主题模型]
     */
    public ViewThemeSettingDTO setThemeModel(String themeModel) {
     ...
     * 设置 [所有者类型]
     */
    public ViewThemeSettingDTO setOwnerType(String ownerType) {
     ...
     * 设置 [标题]
     */
    public ViewThemeSettingDTO setCaption(String caption) {
     ...
     * 设置 [过滤条件]
     */
    public ViewThemeSettingDTO setSearchConds(List<Map> searchConds) {
     ...
     * 设置 [名称]
     */
    public ViewThemeSettingDTO setName(String name) {
        this.name = name;
     ...
     * 设置 [系统标记]
     */
    public ViewThemeSettingDTO setSystemTag(String systemTag) {
     ...
     * 设置 [应用标记]
     */
    public ViewThemeSettingDTO setAppTag(String appTag) {
        this.appTag = appTag;
     ...
     * 设置 [应用视图标记]
     */
    public ViewThemeSettingDTO setAppViewTag(String appViewTag) {
     ...
     * 设置 [排序值]
     */
    public ViewThemeSettingDTO setOrderValue(Integer orderValue) {
