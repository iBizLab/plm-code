...
@ApiModel("工作项DTO")
public class WorkItemAdvancedSearchDTO extends DTOBase implements Serializable {
     ...
     * 设置 [所属项目]
     */
    public WorkItemAdvancedSearchDTO setProjectName(String projectName) {
     ...
     * 设置 [状态]
     */
    public WorkItemAdvancedSearchDTO setState(String state) {
        this.state = state;
     ...
     * 设置 [标题]
     */
    public WorkItemAdvancedSearchDTO setTitle(String title) {
        this.title = title;
     ...
     * 设置 [项目]
     */
    public WorkItemAdvancedSearchDTO setProjectId(String projectId) {
     ...
     * 设置 [编号]
     */
    public WorkItemAdvancedSearchDTO setShowIdentifier(String showIdentifier) {
     ...
     * 设置 [项目标识]
     */
    public WorkItemAdvancedSearchDTO setProjectIdentifier(String projectIdentifier) {
