...
public class WorkItemFilterDTO extends FilterBase implements Serializable {
    ...
    @ApiModelProperty(value = "严重程度EQ", position = 150)
    ...
    @ApiModelProperty(value = "风险EQ", position = 160)
    ...
    @ApiModelProperty(value = "工作项类型分组EQ", position = 180)
    ...
    @ApiModelProperty(value = "任务类别EQ", position = 270)
    ...
    @ApiModelProperty(value = "编号LIKE", position = 330)
    ...
    @ApiModelProperty(value = "关注EXISTS所属数据标识EQ", position = 350)
    ...
    @ApiModelProperty(value = "关注EXISTS关注类型EQ", position = 351)
    ...
    @ApiModelProperty(value = "关注EXISTS关注人EQ", position = 352)
    ...
    @ApiModelProperty(value = "关注NOTEXISTS关注类型EQ", position = 353)
    ...
    @ApiModelProperty(value = "关注NOTEXISTS关注人EQ", position = 354)
    ...
    @ApiModelProperty(value = "标识EQ", position = 420)
	private String idEQ;
    ...
    @ApiModelProperty(value = "标识EXISTS标识EQ", position = 421)
    ...
    @ApiModelProperty(value = "标识IN", position = 422)
	private String idIN;
    ...
    @ApiModelProperty(value = "标识NOTEQ", position = 423)
    ...
    @ApiModelProperty(value = "建立时间EQ", position = 430)
    ...
    @ApiModelProperty(value = "建立时间GTANDEQ", position = 431)
    ...
    @ApiModelProperty(value = "建立时间LTANDEQ", position = 432)
    ...
    @ApiModelProperty(value = "项目EQ", position = 460)
    ...
    @ApiModelProperty(value = "工作项类型EQ", position = 470)
    ...
    @ApiModelProperty(value = "工作项类型IN", position = 471)
    ...
    @ApiModelProperty(value = "工作项类型LIKE", position = 472)
    ...
    @ApiModelProperty(value = "所属项目EQ", position = 480)
    ...
    @ApiModelProperty(value = "所属项目LIKE", position = 481)
    ...
    @ApiModelProperty(value = "工作项类型EQ", position = 490)
    ...
    @ApiModelProperty(value = "工作项类型LIKE", position = 491)
    ...
    @ApiModelProperty(value = "父标识EQ", position = 500)
    ...
    @ApiModelProperty(value = "父工作项EQ", position = 510)
    ...
    @ApiModelProperty(value = "父工作项LIKE", position = 511)
    ...
    @ApiModelProperty(value = "迭代标识EQ", position = 520)
    ...
    @ApiModelProperty(value = "迭代标识ISNULL", position = 521)
    ...
    @ApiModelProperty(value = "看板标识EQ", position = 530)
    ...
    @ApiModelProperty(value = "看板栏标识EQ", position = 540)
    ...
    @ApiModelProperty(value = "泳道标识EQ", position = 550)
    ...
    @ApiModelProperty(value = "看板栏名称EQ", position = 560)
    ...
    @ApiModelProperty(value = "看板栏名称LIKE", position = 561)
    ...
    @ApiModelProperty(value = "看板名称EQ", position = 570)
    ...
    @ApiModelProperty(value = "看板名称LIKE", position = 571)
    ...
    @ApiModelProperty(value = "顶级工作项标识EQ", position = 580)
    ...
    @ApiModelProperty(value = "顶级工作项标识IN", position = 581)
    ...
    @ApiModelProperty(value = "顶级工作项标题EQ", position = 590)
    ...
    @ApiModelProperty(value = "顶级工作项标题LIKE", position = 591)
    ...
    @ApiModelProperty(value = "迭代名称EQ", position = 600)
    ...
    @ApiModelProperty(value = "迭代名称LIKE", position = 601)
    ...
    @ApiModelProperty(value = "项目发布标识EQ", position = 610)
