...
public abstract class AbstractAddonResourceResource {
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<AddonResourceDTO>> create
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<AddonResourceDTO>> updateById
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<AddonResourceDTO>> checkResourceIsDeletedById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<AddonResourceDTO> dto) {
        ResponseWrapper<AddonResourceDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<AddonResourceDTO>> save
            (@Validated @RequestBody RequestWrapper<AddonResourceDTO> dto) {
        ResponseWrapper<AddonResourceDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<AddonResourceDTO>> createByOwnerId
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<AddonResourceDTO>> updateByOwnerIdAndId
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<AddonResourceDTO>> checkResourceIsDeletedByOwnerIdAndId
            (@PathVariable("ownerId") String ownerId, @PathVariable("id") String id, @Validated @RequestBody RequestWrapper<AddonResourceDTO> dto) {
        ResponseWrapper<AddonResourceDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<AddonResourceDTO>> saveByOwnerId
            (@PathVariable("ownerId") String ownerId, @Validated @RequestBody RequestWrapper<AddonResourceDTO> dto) {
        ResponseWrapper<AddonResourceDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-AddonResource-Get-all')  or hasPermission(this.addonResourceDtoMapping.toDomain(returnObject.body),'ibizplm-AddonResource-Get')")
    @GetMapping("addon_resources/{id}")
    public ResponseEntity<AddonResourceDTO> getById
            (@PathVariable("id") String id) {
        AddonResource rt = addonResourceService.get(id);
        return ResponseEntity.status(HttpStatus.OK).body(addonResourceDtoMapping.toDto(rt));
    }
    ...
    */
    ...
    public ResponseEntity<Integer> checkKey
        ...
        AddonResource domain = addonResourceDtoMapping.toDomain(dto);
        Integer rt = addonResourceService.checkKey(domain);
        return ResponseEntity.status(HttpStatus.OK).body(rt);
    }
    ...
    */
    ...
    public ResponseEntity<AddonResourceDTO> getDraft
    ...
    *
    * @param dto dto
    * @return ResponseEntity<List<AddonResourceDTO>>
    */
    ...
    public ResponseEntity<List<AddonResourceDTO>> fetchAll
    ...
    */
    ...
    public ResponseEntity<List<AddonResourceDTO>> fetchDefault
            (@Validated @RequestBody AddonResourceFilterDTO dto) {
        AddonResourceSearchContext context = addonResourceFilterDtoMapping.toDomain(dto);
    ...
    */
    @ApiOperation(value = "获取Get", tags = {"资源组件" },  notes = "AddonResource-Get ")
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-AddonResource-Get-all')  or hasPermission('project',#ownerId,this.addonResourceDtoMapping.toDomain(returnObject.body),'ibizplm-AddonResource-Get')")
    @GetMapping("projects/{ownerId}/addon_resources/{id}")
    public ResponseEntity<AddonResourceDTO> getByOwnerIdAndId
    ...
    */
    ...
    public ResponseEntity<AddonResourceDTO> getDraftByOwnerId
    ...
    */
    ...
    public ResponseEntity<List<AddonResourceDTO>> fetchAllByOwnerId
    ...
    */
    ...
    public ResponseEntity<List<AddonResourceDTO>> fetchDefaultByOwnerId
            (@PathVariable("ownerId") String ownerId, @Validated @RequestBody AddonResourceFilterDTO dto) {
        dto.setOwnerIdEQ(ownerId);
        AddonResourceSearchContext context = addonResourceFilterDtoMapping.toDomain(dto);
        Page<AddonResource> domains = addonResourceService.fetchDefault(context) ;
    ...
    */
    ...
    public ResponseEntity<Boolean> createBatch(@RequestBody List<AddonResourceDTO> dtos) {
    ...
    */
    ...
    public ResponseEntity<Boolean> updateBatch(@RequestBody List<AddonResourceDTO> dtos) {
    ...
    */
    ...
    public ResponseEntity<Boolean> saveBatch(@RequestBody List<AddonResourceDTO> dtos) {
    ...
    */
    ...
    public ResponseEntity<ImportResult> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<AddonResourceDTO> dtos) {
        return  ResponseEntity.status(HttpStatus.OK).body(addonResourceService.importData(config,ignoreError,addonResourceDtoMapping.toDomain(dtos)));
    }
