...
public abstract class AbstractBaselinePageResource {
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<BaselinePageDTO>>>create
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<BaselinePageDTO>>>updateById
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<BaselinePageDTO>>>save
            (@Validated @RequestBody RequestWrapper<BaselinePageDTO> dto) {
        ResponseWrapper<BaselinePageDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<BaselinePageDTO>>>createByOwnerIdAndPrincipalId
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<BaselinePageDTO>>>updateByOwnerIdAndPrincipalIdAndId
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<BaselinePageDTO>>>saveByOwnerIdAndPrincipalId
            (@PathVariable("ownerId") String ownerId, @PathVariable("principalId") String principalId, @Validated @RequestBody RequestWrapper<BaselinePageDTO> dto) {
        ResponseWrapper<BaselinePageDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-BaselinePage-Get-all')  or hasPermission(this.baselinePageDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-BaselinePage-Get')")
    @GetMapping("baseline_pages/{id}")
    public Mono<ResponseEntity<BaselinePageDTO>> getById
            (@PathVariable("id") String id) {
        BaselinePage rt = baselinePageService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(baselinePageDtoMapping.toDto(rt)));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<CheckKeyStatus>> checkKey
        ...
        BaselinePage domain = baselinePageDtoMapping.toDomain(dto);
        CheckKeyStatus rt = baselinePageService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<BaselinePageDTO>> getDraft
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<List<BaselinePageDTO>>>
    */
    ...
    public Mono<ResponseEntity<List<BaselinePageDTO>>> fetchDefault
    ...
    */
    ...
    public Mono<ResponseEntity<List<BaselinePageDTO>>> fetchFillVersionData
            (@Validated @RequestBody BaselinePageFilterDTO dto) {
        BaselinePageSearchContext context = baselinePageFilterDtoMapping.toDomain(dto);
    ...
    */
    @ApiOperation(value = "获取Get", tags = {"基线页面" },  notes = "BaselinePage-Get ")
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-BaselinePage-Get-all')  or hasPermission('library',#ownerId,this.baselinePageDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-BaselinePage-Get')")
    @GetMapping("libraries/{ownerId}/baselines/{principalId}/baseline_pages/{id}")
    public Mono<ResponseEntity<BaselinePageDTO>> getByOwnerIdAndPrincipalIdAndId
    ...
    */
    ...
    public Mono<ResponseEntity<BaselinePageDTO>> getDraftByOwnerIdAndPrincipalId
    ...
    */
    ...
    public Mono<ResponseEntity<List<BaselinePageDTO>>> fetchDefaultByOwnerIdAndPrincipalId
    ...
    */
    ...
    public Mono<ResponseEntity<List<BaselinePageDTO>>> fetchFillVersionDataByOwnerIdAndPrincipalId
            (@PathVariable("ownerId") String ownerId, @PathVariable("principalId") String principalId, @Validated @RequestBody BaselinePageFilterDTO dto) {
        dto.setPrincipalIdEQ(principalId);
        BaselinePageSearchContext context = baselinePageFilterDtoMapping.toDomain(dto);
        Page<BaselinePage> domains = baselinePageService.fetchFillVersionData(context) ;
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> createBatch(@RequestBody List<BaselinePageDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> updateBatch(@RequestBody List<BaselinePageDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> saveBatch(@RequestBody List<BaselinePageDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<ImportResult>> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<BaselinePageDTO> dtos) {
        return  Mono.just(ResponseEntity.status(HttpStatus.OK).body(baselinePageService.importData(config,ignoreError,baselinePageDtoMapping.toDomain(dtos))));
    }
