...
public abstract class AbstractBaselineWorkItemResource {
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<BaselineWorkItemDTO>>>create
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<BaselineWorkItemDTO>>>updateById
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<BaselineWorkItemDTO>>>save
            (@Validated @RequestBody RequestWrapper<BaselineWorkItemDTO> dto) {
        ResponseWrapper<BaselineWorkItemDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<BaselineWorkItemDTO>>>createByOwnerIdAndPrincipalId
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<BaselineWorkItemDTO>>>updateByOwnerIdAndPrincipalIdAndId
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<BaselineWorkItemDTO>>>saveByOwnerIdAndPrincipalId
            (@PathVariable("ownerId") String ownerId, @PathVariable("principalId") String principalId, @Validated @RequestBody RequestWrapper<BaselineWorkItemDTO> dto) {
        ResponseWrapper<BaselineWorkItemDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-BaselineWorkItem-Get-all')  or hasPermission(this.baselineWorkItemDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-BaselineWorkItem-Get')")
    @GetMapping("baseline_work_items/{id}")
    public Mono<ResponseEntity<BaselineWorkItemDTO>> getById
            (@PathVariable("id") String id) {
        BaselineWorkItem rt = baselineWorkItemService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(baselineWorkItemDtoMapping.toDto(rt)));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<CheckKeyStatus>> checkKey
        ...
        BaselineWorkItem domain = baselineWorkItemDtoMapping.toDomain(dto);
        CheckKeyStatus rt = baselineWorkItemService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<BaselineWorkItemDTO>> getDraft
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<List<BaselineWorkItemDTO>>>
    */
    ...
    public Mono<ResponseEntity<List<BaselineWorkItemDTO>>> fetchBaselineRelationVersion
    ...
    */
    ...
    public Mono<ResponseEntity<List<BaselineWorkItemDTO>>> fetchDefault
            (@Validated @RequestBody BaselineWorkItemFilterDTO dto) {
        BaselineWorkItemSearchContext context = baselineWorkItemFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<List<BaselineWorkItemDTO>>> fetchFillVersionData
            (@Validated @RequestBody BaselineWorkItemFilterDTO dto) {
        BaselineWorkItemSearchContext context = baselineWorkItemFilterDtoMapping.toDomain(dto);
    ...
    */
    @ApiOperation(value = "获取Get", tags = {"基线工作项" },  notes = "BaselineWorkItem-Get ")
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-BaselineWorkItem-Get-all')  or hasPermission('library',#ownerId,this.baselineWorkItemDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-BaselineWorkItem-Get')")
    @GetMapping("libraries/{ownerId}/baselines/{principalId}/baseline_work_items/{id}")
    public Mono<ResponseEntity<BaselineWorkItemDTO>> getByOwnerIdAndPrincipalIdAndId
    ...
    */
    ...
    public Mono<ResponseEntity<BaselineWorkItemDTO>> getDraftByOwnerIdAndPrincipalId
    ...
    */
    ...
    public Mono<ResponseEntity<List<BaselineWorkItemDTO>>> fetchBaselineRelationVersionByOwnerIdAndPrincipalId
    ...
    */
    ...
    public Mono<ResponseEntity<List<BaselineWorkItemDTO>>> fetchDefaultByOwnerIdAndPrincipalId
            (@PathVariable("ownerId") String ownerId, @PathVariable("principalId") String principalId, @Validated @RequestBody BaselineWorkItemFilterDTO dto) {
        dto.setPrincipalIdEQ(principalId);
        BaselineWorkItemSearchContext context = baselineWorkItemFilterDtoMapping.toDomain(dto);
        Page<BaselineWorkItem> domains = baselineWorkItemService.fetchDefault(context) ;
    ...
    */
    ...
    public Mono<ResponseEntity<List<BaselineWorkItemDTO>>> fetchFillVersionDataByOwnerIdAndPrincipalId
            (@PathVariable("ownerId") String ownerId, @PathVariable("principalId") String principalId, @Validated @RequestBody BaselineWorkItemFilterDTO dto) {
        dto.setPrincipalIdEQ(principalId);
        BaselineWorkItemSearchContext context = baselineWorkItemFilterDtoMapping.toDomain(dto);
        Page<BaselineWorkItem> domains = baselineWorkItemService.fetchFillVersionData(context) ;
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> createBatch(@RequestBody List<BaselineWorkItemDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> updateBatch(@RequestBody List<BaselineWorkItemDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> saveBatch(@RequestBody List<BaselineWorkItemDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<ImportResult>> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<BaselineWorkItemDTO> dtos) {
        return  Mono.just(ResponseEntity.status(HttpStatus.OK).body(baselineWorkItemService.importData(config,ignoreError,baselineWorkItemDtoMapping.toDomain(dtos))));
    }
