...
public abstract class AbstractBoardResource {
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"看板" },  notes = "Board-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Board-FetchDefault-all') or hasPermission(#dto,'ibizplm-Board-FetchDefault')")
    @PostMapping("boards/fetchdefault")
    ...
    */
    @ApiOperation(value = "校验CheckKey", tags = {"看板" },  notes = "Board-CheckKey ")
    @PostMapping("projects/{projectId}/boards/checkkey")
    ...
    */
    @ApiOperation(value = "草稿GetDraft", tags = {"看板" },  notes = "Board-GetDraft ")
    @GetMapping("projects/{projectId}/boards/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"看板" },  notes = "Board-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Board-FetchDefault-all') or hasPermission('Project',#projectId,#dto,'ibizplm-Board-FetchDefault')")
    @PostMapping("projects/{projectId}/boards/fetchdefault")
