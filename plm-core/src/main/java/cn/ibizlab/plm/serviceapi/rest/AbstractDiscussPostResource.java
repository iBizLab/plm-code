...
public abstract class AbstractDiscussPostResource {
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> create
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> updateById
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> closeById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> delCommentById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> deleteById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> fillAdditionById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> moveById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> openById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> recoverById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> save
            (@Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> sendCommentById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> createByTopicId
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> updateByTopicIdAndId
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> closeByTopicIdAndId
            (@PathVariable("topicId") String topicId, @PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> delCommentByTopicIdAndId
            (@PathVariable("topicId") String topicId, @PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> deleteByTopicIdAndId
            (@PathVariable("topicId") String topicId, @PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> fillAdditionByTopicIdAndId
            (@PathVariable("topicId") String topicId, @PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> moveByTopicIdAndId
            (@PathVariable("topicId") String topicId, @PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> openByTopicIdAndId
            (@PathVariable("topicId") String topicId, @PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> recoverByTopicIdAndId
            (@PathVariable("topicId") String topicId, @PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> saveByTopicId
            (@PathVariable("topicId") String topicId, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussPostDTO>> sendCommentByTopicIdAndId
            (@PathVariable("topicId") String topicId, @PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussPostDTO> dto) {
        ResponseWrapper<DiscussPostDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-DiscussPost-Get-all')  or hasPermission(this.discussPostDtoMapping.toDomain(returnObject.body),'ibizplm-DiscussPost-Get')")
    @GetMapping("discuss_posts/{id}")
    public ResponseEntity<DiscussPostDTO> getById
            (@PathVariable("id") String id) {
        DiscussPost rt = discussPostService.get(id);
        return ResponseEntity.status(HttpStatus.OK).body(discussPostDtoMapping.toDto(rt));
    }
    ...
    */
    ...
    public ResponseEntity<Integer> checkKey
        ...
        DiscussPost domain = discussPostDtoMapping.toDomain(dto);
        Integer rt = discussPostService.checkKey(domain);
        return ResponseEntity.status(HttpStatus.OK).body(rt);
    }
    ...
    */
    ...
    public ResponseEntity<DiscussPostDTO> getAttentionById
            (@PathVariable("id") String id) {
    ...
    */
    ...
    public ResponseEntity<DiscussPostDTO> getDraft
    ...
    *
    * @param dto dto
    * @return ResponseEntity<List<DiscussPostDTO>>
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchDefault
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchDeleted
            (@Validated @RequestBody DiscussPostFilterDTO dto) {
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchMyAttention
            (@Validated @RequestBody DiscussPostFilterDTO dto) {
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchMyCreate
            (@Validated @RequestBody DiscussPostFilterDTO dto) {
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchMyReply
            (@Validated @RequestBody DiscussPostFilterDTO dto) {
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchNormal
            (@Validated @RequestBody DiscussPostFilterDTO dto) {
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchReader
            (@Validated @RequestBody DiscussPostFilterDTO dto) {
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchRecent
            (@Validated @RequestBody DiscussPostFilterDTO dto) {
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
    ...
    */
    @ApiOperation(value = "获取Get", tags = {"讨论" },  notes = "DiscussPost-Get ")
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-DiscussPost-Get-all')  or hasPermission('discuss_topic',#topicId,this.discussPostDtoMapping.toDomain(returnObject.body),'ibizplm-DiscussPost-Get')")
    @GetMapping("discuss_topics/{topicId}/discuss_posts/{id}")
    public ResponseEntity<DiscussPostDTO> getByTopicIdAndId
    ...
    */
    ...
    public ResponseEntity<Boolean> removeByTopicIdAndId
            (@PathVariable("topicId") String topicId, @PathVariable("id") String id) {
        Boolean rt = discussPostService.remove(id);
        return ResponseEntity.status(HttpStatus.OK).body(rt);
    }
    ...
    */
    ...
    public ResponseEntity<Integer> checkKeyByTopicId
    ...
    */
    ...
    public ResponseEntity<DiscussPostDTO> getAttentionByTopicIdAndId
            (@PathVariable("topicId") String topicId, @PathVariable("id") String id) {
        DiscussPost rt = discussPostService.getAttention(id);
        return ResponseEntity.status(HttpStatus.OK).body(discussPostDtoMapping.toDto(rt));
    }
    ...
    */
    ...
    public ResponseEntity<DiscussPostDTO> getDraftByTopicId
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchDefaultByTopicId
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchDeletedByTopicId
            (@PathVariable("topicId") String topicId, @Validated @RequestBody DiscussPostFilterDTO dto) {
        dto.setTopicIdEQ(topicId);
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
        Page<DiscussPost> domains = discussPostService.fetchDeleted(context) ;
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchMyAttentionByTopicId
            (@PathVariable("topicId") String topicId, @Validated @RequestBody DiscussPostFilterDTO dto) {
        dto.setTopicIdEQ(topicId);
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
        Page<DiscussPost> domains = discussPostService.fetchMyAttention(context) ;
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchMyCreateByTopicId
            (@PathVariable("topicId") String topicId, @Validated @RequestBody DiscussPostFilterDTO dto) {
        dto.setTopicIdEQ(topicId);
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
        Page<DiscussPost> domains = discussPostService.fetchMyCreate(context) ;
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchMyReplyByTopicId
            (@PathVariable("topicId") String topicId, @Validated @RequestBody DiscussPostFilterDTO dto) {
        dto.setTopicIdEQ(topicId);
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
        Page<DiscussPost> domains = discussPostService.fetchMyReply(context) ;
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchNormalByTopicId
            (@PathVariable("topicId") String topicId, @Validated @RequestBody DiscussPostFilterDTO dto) {
        dto.setTopicIdEQ(topicId);
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
        Page<DiscussPost> domains = discussPostService.fetchNormal(context) ;
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchReaderByTopicId
            (@PathVariable("topicId") String topicId, @Validated @RequestBody DiscussPostFilterDTO dto) {
        dto.setTopicIdEQ(topicId);
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
        Page<DiscussPost> domains = discussPostService.fetchReader(context) ;
    ...
    */
    ...
    public ResponseEntity<List<DiscussPostDTO>> fetchRecentByTopicId
            (@PathVariable("topicId") String topicId, @Validated @RequestBody DiscussPostFilterDTO dto) {
        dto.setTopicIdEQ(topicId);
        DiscussPostSearchContext context = discussPostFilterDtoMapping.toDomain(dto);
        Page<DiscussPost> domains = discussPostService.fetchRecent(context) ;
    ...
    */
    ...
    public ResponseEntity<Boolean> createBatch(@RequestBody List<DiscussPostDTO> dtos) {
    ...
    */
    ...
    public ResponseEntity<Boolean> updateBatch(@RequestBody List<DiscussPostDTO> dtos) {
    ...
    */
    ...
    public ResponseEntity<Boolean> saveBatch(@RequestBody List<DiscussPostDTO> dtos) {
    ...
    */
    ...
    public ResponseEntity<ImportResult> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<DiscussPostDTO> dtos) {
        return  ResponseEntity.status(HttpStatus.OK).body(discussPostService.importData(config,ignoreError,discussPostDtoMapping.toDomain(dtos)));
    }
