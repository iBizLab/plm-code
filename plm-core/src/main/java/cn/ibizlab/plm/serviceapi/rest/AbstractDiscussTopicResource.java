...
public abstract class AbstractDiscussTopicResource {
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussTopicDTO>> create
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussTopicDTO>> updateById
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussTopicDTO>> activateById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussTopicDTO> dto) {
        ResponseWrapper<DiscussTopicDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussTopicDTO>> archiveById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussTopicDTO> dto) {
        ResponseWrapper<DiscussTopicDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussTopicDTO>> changeAdminRoleById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussTopicDTO> dto) {
        ResponseWrapper<DiscussTopicDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussTopicDTO>> deleteById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussTopicDTO> dto) {
        ResponseWrapper<DiscussTopicDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussTopicDTO>> favoriteById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussTopicDTO> dto) {
        ResponseWrapper<DiscussTopicDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussTopicDTO>> moveDiscussTopicById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussTopicDTO> dto) {
        ResponseWrapper<DiscussTopicDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussTopicDTO>> recoverById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussTopicDTO> dto) {
        ResponseWrapper<DiscussTopicDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussTopicDTO>> save
            (@Validated @RequestBody RequestWrapper<DiscussTopicDTO> dto) {
        ResponseWrapper<DiscussTopicDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    public ResponseEntity<ResponseWrapper<DiscussTopicDTO>> unFavoriteById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<DiscussTopicDTO> dto) {
        ResponseWrapper<DiscussTopicDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-DiscussTopic-Get-all')  or hasPermission(this.discussTopicDtoMapping.toDomain(returnObject.body),'ibizplm-DiscussTopic-Get')")
    @GetMapping("discuss_topics/{id}")
    public ResponseEntity<DiscussTopicDTO> getById
            (@PathVariable("id") String id) {
        DiscussTopic rt = discussTopicService.get(id);
        return ResponseEntity.status(HttpStatus.OK).body(discussTopicDtoMapping.toDto(rt));
    }
    ...
    */
    ...
    public ResponseEntity<Integer> checkKey
        ...
        DiscussTopic domain = discussTopicDtoMapping.toDomain(dto);
        Integer rt = discussTopicService.checkKey(domain);
        return ResponseEntity.status(HttpStatus.OK).body(rt);
    }
    ...
    */
    ...
    public ResponseEntity<DiscussTopicDTO> getDraft
    ...
    *
    * @param dto dto
    * @return ResponseEntity<List<DiscussTopicDTO>>
    */
    ...
    public ResponseEntity<List<DiscussTopicDTO>> fetchAdmin
    ...
    */
    ...
    public ResponseEntity<List<DiscussTopicDTO>> fetchArchived
            (@Validated @RequestBody DiscussTopicFilterDTO dto) {
        DiscussTopicSearchContext context = discussTopicFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussTopicDTO>> fetchArchivedMain
            (@Validated @RequestBody DiscussTopicFilterDTO dto) {
        DiscussTopicSearchContext context = discussTopicFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussTopicDTO>> fetchDefault
            (@Validated @RequestBody DiscussTopicFilterDTO dto) {
        DiscussTopicSearchContext context = discussTopicFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussTopicDTO>> fetchDeleted
            (@Validated @RequestBody DiscussTopicFilterDTO dto) {
        DiscussTopicSearchContext context = discussTopicFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussTopicDTO>> fetchFavorite
            (@Validated @RequestBody DiscussTopicFilterDTO dto) {
        DiscussTopicSearchContext context = discussTopicFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussTopicDTO>> fetchGroup
            (@Validated @RequestBody DiscussTopicFilterDTO dto) {
        DiscussTopicSearchContext context = discussTopicFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussTopicDTO>> fetchMain
            (@Validated @RequestBody DiscussTopicFilterDTO dto) {
        DiscussTopicSearchContext context = discussTopicFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussTopicDTO>> fetchNormal
            (@Validated @RequestBody DiscussTopicFilterDTO dto) {
        DiscussTopicSearchContext context = discussTopicFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussTopicDTO>> fetchQuickUser
            (@Validated @RequestBody DiscussTopicFilterDTO dto) {
        DiscussTopicSearchContext context = discussTopicFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussTopicDTO>> fetchReader
            (@Validated @RequestBody DiscussTopicFilterDTO dto) {
        DiscussTopicSearchContext context = discussTopicFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<List<DiscussTopicDTO>> fetchUser
            (@Validated @RequestBody DiscussTopicFilterDTO dto) {
        DiscussTopicSearchContext context = discussTopicFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public ResponseEntity<Boolean> createBatch(@RequestBody List<DiscussTopicDTO> dtos) {
    ...
    */
    ...
    public ResponseEntity<Boolean> updateBatch(@RequestBody List<DiscussTopicDTO> dtos) {
    ...
    */
    ...
    public ResponseEntity<Boolean> saveBatch(@RequestBody List<DiscussTopicDTO> dtos) {
    ...
    */
    ...
    public ResponseEntity<ImportResult> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<DiscussTopicDTO> dtos) {
        return  ResponseEntity.status(HttpStatus.OK).body(discussTopicService.importData(config,ignoreError,discussTopicDtoMapping.toDomain(dtos)));
    }
