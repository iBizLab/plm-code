...
public abstract class AbstractDynaAppmenuResource {
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<DynaAppmenuDTO>>
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<DynaAppmenuDTO>>>create
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<DynaAppmenuDTO>>>updateById
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<DynaAppmenuDTO>>>save
            (@Validated @RequestBody RequestWrapper<DynaAppmenuDTO> dto) {
        ResponseWrapper<DynaAppmenuDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-DynaAppmenu-Get-all')  or hasPermission(this.dynaAppmenuDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-DynaAppmenu-Get')")
    @GetMapping("dyna_appmenus/{id}")
    public Mono<ResponseEntity<DynaAppmenuDTO>> getById
            (@PathVariable("id") String id) {
        DynaAppmenu rt = dynaAppmenuService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(dynaAppmenuDtoMapping.toDto(rt)));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<CheckKeyStatus>> checkKey
        ...
        DynaAppmenu domain = dynaAppmenuDtoMapping.toDomain(dto);
        CheckKeyStatus rt = dynaAppmenuService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<DynaAppmenuDTO>> getDraft
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<List<DynaAppmenuDTO>>>
    */
    ...
    public Mono<ResponseEntity<List<DynaAppmenuDTO>>> fetchDefault
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> createBatch(@RequestBody List<DynaAppmenuDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> updateBatch(@RequestBody List<DynaAppmenuDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> saveBatch(@RequestBody List<DynaAppmenuDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<ImportResult>> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<DynaAppmenuDTO> dtos) {
        return  Mono.just(ResponseEntity.status(HttpStatus.OK).body(dynaAppmenuService.importData(config,ignoreError,dynaAppmenuDtoMapping.toDomain(dtos))));
    }
