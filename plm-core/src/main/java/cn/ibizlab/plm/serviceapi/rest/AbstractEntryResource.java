...
public abstract class AbstractEntryResource {
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"看板栏" },  notes = "Entry-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Entry-FetchDefault-all') or hasPermission(#dto,'ibizplm-Entry-FetchDefault')")
    @PostMapping("entries/fetchdefault")
    ...
    */
    @ApiOperation(value = "校验CheckKey", tags = {"看板栏" },  notes = "Entry-CheckKey ")
    @PostMapping("projects/{projectId}/entries/checkkey")
    ...
    */
    @ApiOperation(value = "草稿GetDraft", tags = {"看板栏" },  notes = "Entry-GetDraft ")
    @GetMapping("projects/{projectId}/entries/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"看板栏" },  notes = "Entry-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Entry-FetchDefault-all') or hasPermission('Project',#projectId,#dto,'ibizplm-Entry-FetchDefault')")
    @PostMapping("projects/{projectId}/entries/fetchdefault")
