...
public abstract class AbstractExtendLogResource {
    ...
    */
    ...
    @PostMapping("extend_logs/checkkey")
    ...
    */
    ...
    @GetMapping("extend_logs/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"扩展日志" },  notes = "ExtendLog-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-ExtendLog-FetchDefault-all') or hasPermission(#dto,'ibizplm-ExtendLog-FetchDefault')")
    @PostMapping("extend_logs/fetchdefault")
