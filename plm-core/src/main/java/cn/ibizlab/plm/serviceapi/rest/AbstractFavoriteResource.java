...
public abstract class AbstractFavoriteResource {
    ...
    */
    ...
    @PostMapping("favorites/checkkey")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"收藏" },  notes = "Favorite-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Favorite-FetchDefault-all') or hasPermission(#dto,'ibizplm-Favorite-FetchDefault')")
    @PostMapping("favorites/fetchdefault")
