...
public abstract class AbstractInsightResource {
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"洞察力" },  notes = "Insight-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Insight-FetchDefault-all') or hasPermission(#dto,'ibizplm-Insight-FetchDefault')")
    @PostMapping("insights/fetchdefault")
