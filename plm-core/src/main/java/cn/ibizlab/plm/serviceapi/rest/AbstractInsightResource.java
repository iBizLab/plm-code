...
public abstract class AbstractInsightResource {
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<InsightDTO>>
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<InsightDTO>>>create
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<InsightDTO>>>updateById
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<InsightDTO>>>save
            (@Validated @RequestBody RequestWrapper<InsightDTO> dto) {
        ResponseWrapper<InsightDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Insight-Get-all')  or hasPermission(this.insightDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-Insight-Get')")
    @GetMapping("insights/{id}")
    public Mono<ResponseEntity<InsightDTO>> getById
            (@PathVariable("id") String id) {
        Insight rt = insightService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(insightDtoMapping.toDto(rt)));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<CheckKeyStatus>> checkKey
        ...
        Insight domain = insightDtoMapping.toDomain(dto);
        CheckKeyStatus rt = insightService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<InsightDTO>> getDraft
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<List<InsightDTO>>>
    */
    ...
    public Mono<ResponseEntity<List<InsightDTO>>> fetchDefault
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> createBatch(@RequestBody List<InsightDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> updateBatch(@RequestBody List<InsightDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> saveBatch(@RequestBody List<InsightDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<ImportResult>> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<InsightDTO> dtos) {
        return  Mono.just(ResponseEntity.status(HttpStatus.OK).body(insightService.importData(config,ignoreError,insightDtoMapping.toDomain(dtos))));
    }
