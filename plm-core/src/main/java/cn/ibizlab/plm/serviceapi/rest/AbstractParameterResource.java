...
public abstract class AbstractParameterResource {
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<ParameterDTO>>
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ParameterDTO>>>create
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ParameterDTO>>>updateById
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ParameterDTO>>>save
            (@Validated @RequestBody RequestWrapper<ParameterDTO> dto) {
        ResponseWrapper<ParameterDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Parameter-Get-all')  or hasPermission(this.parameterDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-Parameter-Get')")
    @GetMapping("parameters/{id}")
    public Mono<ResponseEntity<ParameterDTO>> getById
            (@PathVariable("id") String id) {
        Parameter rt = parameterService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(parameterDtoMapping.toDto(rt)));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<CheckKeyStatus>> checkKey
        ...
        Parameter domain = parameterDtoMapping.toDomain(dto);
        CheckKeyStatus rt = parameterService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<ParameterDTO>> getDraft
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<List<ParameterDTO>>>
    */
    ...
    public Mono<ResponseEntity<List<ParameterDTO>>> fetchDefault
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> createBatch(@RequestBody List<ParameterDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> updateBatch(@RequestBody List<ParameterDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> saveBatch(@RequestBody List<ParameterDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<ImportResult>> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<ParameterDTO> dtos) {
        return  Mono.just(ResponseEntity.status(HttpStatus.OK).body(parameterService.importData(config,ignoreError,parameterDtoMapping.toDomain(dtos))));
    }
