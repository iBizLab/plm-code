...
public abstract class AbstractPortfolioMemberResource {
    ...
    */
    ...
    @PostMapping("portfolio_members/checkkey")
    ...
    */
    ...
    @GetMapping("portfolio_members/getdraft")
    ...
    /**
    * 查询FetchDefault 文件夹成员
    * 
    *
    * @param dto dto
    * @return ResponseEntity<List<PortfolioMemberDTO>>
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"文件夹成员" },  notes = "PortfolioMember-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-PortfolioMember-FetchDefault-all') or hasPermission(#dto,'ibizplm-PortfolioMember-FetchDefault')")
    @PostMapping("portfolio_members/fetchdefault")
    ...
    */
    @ApiOperation(value = "校验CheckKey", tags = {"文件夹成员" },  notes = "PortfolioMember-CheckKey ")
    @PostMapping("portfolios/{portfolioId}/portfolio_members/checkkey")
    ...
    */
    @ApiOperation(value = "草稿GetDraft", tags = {"文件夹成员" },  notes = "PortfolioMember-GetDraft ")
    @GetMapping("portfolios/{portfolioId}/portfolio_members/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"文件夹成员" },  notes = "PortfolioMember-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-PortfolioMember-FetchDefault-all') or hasPermission('Portfolio',#portfolioId,#dto,'ibizplm-PortfolioMember-FetchDefault')")
    @PostMapping("portfolios/{portfolioId}/portfolio_members/fetchdefault")
    ...
    */
    @ApiOperation(value = "校验CheckKey", tags = {"文件夹成员" },  notes = "PortfolioMember-CheckKey ")
    @PostMapping("users/{userId}/portfolio_members/checkkey")
    ...
    */
    @ApiOperation(value = "草稿GetDraft", tags = {"文件夹成员" },  notes = "PortfolioMember-GetDraft ")
    @GetMapping("users/{userId}/portfolio_members/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"文件夹成员" },  notes = "PortfolioMember-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-PortfolioMember-FetchDefault-all') or hasPermission('User',#userId,#dto,'ibizplm-PortfolioMember-FetchDefault')")
    @PostMapping("users/{userId}/portfolio_members/fetchdefault")
