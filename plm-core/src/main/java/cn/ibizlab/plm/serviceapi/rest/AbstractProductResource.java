...
public abstract class AbstractProductResource {
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>create
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>updateById
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>activateById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<ProductDTO> dto) {
        ResponseWrapper<ProductDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>archiveById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<ProductDTO> dto) {
        ResponseWrapper<ProductDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>deleteById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<ProductDTO> dto) {
        ResponseWrapper<ProductDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>favoriteById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<ProductDTO> dto) {
        ResponseWrapper<ProductDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>otherReSpaceById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<ProductDTO> dto) {
        ResponseWrapper<ProductDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>productIndexAddonCounterById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<ProductDTO> dto) {
        ResponseWrapper<ProductDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>productMoveById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<ProductDTO> dto) {
        ResponseWrapper<ProductDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>productReadonlyRecognizeById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<ProductDTO> dto) {
        ResponseWrapper<ProductDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>recoverById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<ProductDTO> dto) {
        ResponseWrapper<ProductDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>save
            (@Validated @RequestBody RequestWrapper<ProductDTO> dto) {
        ResponseWrapper<ProductDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductDTO>>>unFavoriteById
            (@PathVariable("id") String id, @Validated @RequestBody RequestWrapper<ProductDTO> dto) {
        ResponseWrapper<ProductDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Product-Get-all')  or hasPermission(this.productDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-Product-Get')")
    @GetMapping("products/{id}")
    public Mono<ResponseEntity<ProductDTO>> getById
            (@PathVariable("id") String id) {
        Product rt = productService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(productDtoMapping.toDto(rt)));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<CheckKeyStatus>> checkKey
        ...
        Product domain = productDtoMapping.toDomain(dto);
        CheckKeyStatus rt = productService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<ProductDTO>> getDraft
    ...
    */
    ...
    public Mono<ResponseEntity<List<ProductDTO>>> fetchAdmin
    ...
    */
    ...
    public Mono<ResponseEntity<List<ProductDTO>>> fetchArchived
            (@Validated @RequestBody ProductFilterDTO dto) {
        ProductSearchContext context = productFilterDtoMapping.toDomain(dto);
    ...
    /**
    * 查询fetch_cur_product 产品
    * 
    *
    * @param dto dto
    * @return Mono<ResponseEntity<List<ProductDTO>>>
    */
    @ApiOperation(value = "查询fetch_cur_product", tags = {"产品" },  notes = "Product-fetch_cur_product ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Product-fetch_cur_product-all') or hasPermission(#dto,'ibizplm-Product-fetch_cur_product')")
    @PostMapping("products/fetch_cur_product")
    public Mono<ResponseEntity<List<ProductDTO>>> fetchCurProduct
            (@Validated @RequestBody ProductFilterDTO dto) {
        ProductSearchContext context = productFilterDtoMapping.toDomain(dto);
        Page<Product> domains = productService.fetchCurProduct(context) ;
        List<ProductDTO> list = productDtoMapping.toDto(domains.getContent());
            return Mono.just(ResponseEntity.status(HttpStatus.OK)
            .header("x-page", String.valueOf(context.getPageable().getPageNumber()))
            .header("x-per-page", String.valueOf(context.getPageable().getPageSize()))
    ...
    */
    ...
    public Mono<ResponseEntity<List<ProductDTO>>> fetchDefault
            (@Validated @RequestBody ProductFilterDTO dto) {
        ProductSearchContext context = productFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<List<ProductDTO>>> fetchDeleted
            (@Validated @RequestBody ProductFilterDTO dto) {
        ProductSearchContext context = productFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<List<ProductDTO>>> fetchFavorite
            (@Validated @RequestBody ProductFilterDTO dto) {
        ProductSearchContext context = productFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<List<ProductDTO>>> fetchMain
            (@Validated @RequestBody ProductFilterDTO dto) {
        ProductSearchContext context = productFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<List<ProductDTO>>> fetchNormal
            (@Validated @RequestBody ProductFilterDTO dto) {
        ProductSearchContext context = productFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<List<ProductDTO>>> fetchQuickUser
            (@Validated @RequestBody ProductFilterDTO dto) {
        ProductSearchContext context = productFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<List<ProductDTO>>> fetchReader
            (@Validated @RequestBody ProductFilterDTO dto) {
        ProductSearchContext context = productFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<List<ProductDTO>>> fetchUser
            (@Validated @RequestBody ProductFilterDTO dto) {
        ProductSearchContext context = productFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> createBatch(@RequestBody List<ProductDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> updateBatch(@RequestBody List<ProductDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> saveBatch(@RequestBody List<ProductDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<ImportResult>> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<ProductDTO> dtos) {
        return  Mono.just(ResponseEntity.status(HttpStatus.OK).body(productService.importData(config,ignoreError,productDtoMapping.toDomain(dtos))));
    }
