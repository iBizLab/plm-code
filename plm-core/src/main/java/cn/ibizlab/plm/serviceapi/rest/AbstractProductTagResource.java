...
public abstract class AbstractProductTagResource {
    ...
    */
    ...
    @PostMapping("product_tags/checkkey")
    ...
    */
    ...
    @GetMapping("product_tags/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"产品标签" },  notes = "ProductTag-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-ProductTag-FetchDefault-all') or hasPermission(#dto,'ibizplm-ProductTag-FetchDefault')")
    @PostMapping("product_tags/fetchdefault")
    ...
    */
    @ApiOperation(value = "校验CheckKey", tags = {"产品标签" },  notes = "ProductTag-CheckKey ")
    @PostMapping("products/{productId}/product_tags/checkkey")
    ...
    */
    @ApiOperation(value = "草稿GetDraft", tags = {"产品标签" },  notes = "ProductTag-GetDraft ")
    @GetMapping("products/{productId}/product_tags/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"产品标签" },  notes = "ProductTag-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-ProductTag-FetchDefault-all') or hasPermission('Product',#productId,#dto,'ibizplm-ProductTag-FetchDefault')")
    @PostMapping("products/{productId}/product_tags/fetchdefault")
