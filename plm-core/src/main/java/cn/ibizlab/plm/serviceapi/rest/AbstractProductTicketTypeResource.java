...
public abstract class AbstractProductTicketTypeResource {
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<ProductTicketTypeDTO>>
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductTicketTypeDTO>>>create
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductTicketTypeDTO>>>updateById
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductTicketTypeDTO>>>save
            (@Validated @RequestBody RequestWrapper<ProductTicketTypeDTO> dto) {
        ResponseWrapper<ProductTicketTypeDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductTicketTypeDTO>>>createByProductId
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductTicketTypeDTO>>>updateByProductIdAndId
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ProductTicketTypeDTO>>>saveByProductId
            (@PathVariable("productId") String productId, @Validated @RequestBody RequestWrapper<ProductTicketTypeDTO> dto) {
        ResponseWrapper<ProductTicketTypeDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-ProductTicketType-Get-all')  or hasPermission(this.productTicketTypeDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-ProductTicketType-Get')")
    @GetMapping("product_ticket_types/{id}")
    public Mono<ResponseEntity<ProductTicketTypeDTO>> getById
            (@PathVariable("id") String id) {
        ProductTicketType rt = productTicketTypeService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(productTicketTypeDtoMapping.toDto(rt)));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<CheckKeyStatus>> checkKey
        ...
        ProductTicketType domain = productTicketTypeDtoMapping.toDomain(dto);
        CheckKeyStatus rt = productTicketTypeService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<ProductTicketTypeDTO>> getDraft
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<List<ProductTicketTypeDTO>>>
    */
    ...
    public Mono<ResponseEntity<List<ProductTicketTypeDTO>>> fetchDefault
    ...
    */
    @ApiOperation(value = "获取Get", tags = {"产品工单类型" },  notes = "ProductTicketType-Get ")
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-ProductTicketType-Get-all')  or hasPermission('product',#productId,this.productTicketTypeDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-ProductTicketType-Get')")
    @GetMapping("products/{productId}/product_ticket_types/{id}")
    public Mono<ResponseEntity<ProductTicketTypeDTO>> getByProductIdAndId
    ...
    */
    ...
    public Mono<ResponseEntity<ProductTicketTypeDTO>> getDraftByProductId
    ...
    */
    ...
    public Mono<ResponseEntity<List<ProductTicketTypeDTO>>> fetchDefaultByProductId
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> createBatch(@RequestBody List<ProductTicketTypeDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> updateBatch(@RequestBody List<ProductTicketTypeDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> saveBatch(@RequestBody List<ProductTicketTypeDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<ImportResult>> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<ProductTicketTypeDTO> dtos) {
        return  Mono.just(ResponseEntity.status(HttpStatus.OK).body(productTicketTypeService.importData(config,ignoreError,productTicketTypeDtoMapping.toDomain(dtos))));
    }
