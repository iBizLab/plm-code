...
public abstract class AbstractProductTicketTypeResource {
    ...
    */
    ...
    @PostMapping("product_ticket_types/checkkey")
    ...
    */
    ...
    @GetMapping("product_ticket_types/getdraft")
    ...
    /**
    * 查询FetchDefault 产品工单类型
    * 
    *
    * @param dto dto
    * @return ResponseEntity<List<ProductTicketTypeDTO>>
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"产品工单类型" },  notes = "ProductTicketType-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-ProductTicketType-FetchDefault-all') or hasPermission(#dto,'ibizplm-ProductTicketType-FetchDefault')")
    @PostMapping("product_ticket_types/fetchdefault")
