...
public abstract class AbstractReferencesIndexResource {
    ...
    */
    ...
    @PostMapping("references_indices/checkkey")
    ...
    */
    ...
    @GetMapping("references_indices/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"引用索引" },  notes = "ReferencesIndex-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-ReferencesIndex-FetchDefault-all')")
    @PostMapping("references_indices/fetchdefault")
