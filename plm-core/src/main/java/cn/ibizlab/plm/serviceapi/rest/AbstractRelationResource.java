...
public abstract class AbstractRelationResource {
    ...
    */
    ...
    @PostMapping("relations/checkkey")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"关联" },  notes = "Relation-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Relation-FetchDefault-all') or hasPermission(#dto,'ibizplm-Relation-FetchDefault')")
    @PostMapping("relations/fetchdefault")
