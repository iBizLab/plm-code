...
public abstract class AbstractReviewWizardResource {
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<ReviewWizardDTO>>
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ReviewWizardDTO>>>create
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ReviewWizardDTO>>>updateById
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ReviewWizardDTO>>>fillGuideline
            (@Validated @RequestBody RequestWrapper<ReviewWizardDTO> dto) {
        ResponseWrapper<ReviewWizardDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ReviewWizardDTO>>>save
            (@Validated @RequestBody RequestWrapper<ReviewWizardDTO> dto) {
        ResponseWrapper<ReviewWizardDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ReviewWizardDTO>>>createByLibraryId
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ReviewWizardDTO>>>updateByLibraryIdAndId
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ReviewWizardDTO>>>fillGuidelineByLibraryId
            (@PathVariable("libraryId") String libraryId, @Validated @RequestBody RequestWrapper<ReviewWizardDTO> dto) {
        ResponseWrapper<ReviewWizardDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<ReviewWizardDTO>>>saveByLibraryId
            (@PathVariable("libraryId") String libraryId, @Validated @RequestBody RequestWrapper<ReviewWizardDTO> dto) {
        ResponseWrapper<ReviewWizardDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-ReviewWizard-Get-all')  or hasPermission(this.reviewWizardDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-ReviewWizard-Get')")
    @GetMapping("review_wizards/{id}")
    public Mono<ResponseEntity<ReviewWizardDTO>> getById
            (@PathVariable("id") String id) {
        ReviewWizard rt = reviewWizardService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(reviewWizardDtoMapping.toDto(rt)));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<CheckKeyStatus>> checkKey
        ...
        ReviewWizard domain = reviewWizardDtoMapping.toDomain(dto);
        CheckKeyStatus rt = reviewWizardService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<ReviewWizardDTO>> getDraft
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<List<ReviewWizardDTO>>>
    */
    ...
    public Mono<ResponseEntity<List<ReviewWizardDTO>>> fetchDefault
    ...
    */
    @ApiOperation(value = "获取Get", tags = {"评审向导" },  notes = "ReviewWizard-Get ")
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-ReviewWizard-Get-all')  or hasPermission('library',#libraryId,this.reviewWizardDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-ReviewWizard-Get')")
    @GetMapping("libraries/{libraryId}/review_wizards/{id}")
    public Mono<ResponseEntity<ReviewWizardDTO>> getByLibraryIdAndId
    ...
    */
    ...
    public Mono<ResponseEntity<ReviewWizardDTO>> getDraftByLibraryId
    ...
    */
    ...
    public Mono<ResponseEntity<List<ReviewWizardDTO>>> fetchDefaultByLibraryId
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> createBatch(@RequestBody List<ReviewWizardDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> updateBatch(@RequestBody List<ReviewWizardDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> saveBatch(@RequestBody List<ReviewWizardDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<ImportResult>> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<ReviewWizardDTO> dtos) {
        return  Mono.just(ResponseEntity.status(HttpStatus.OK).body(reviewWizardService.importData(config,ignoreError,reviewWizardDtoMapping.toDomain(dtos))));
    }
