...
public abstract class AbstractSpaceMemberResource {
    ...
    */
    ...
    @PostMapping("space_members/checkkey")
    ...
    */
    ...
    @GetMapping("space_members/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"空间成员" },  notes = "SpaceMember-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SpaceMember-FetchDefault-all') or hasPermission(#dto,'ibizplm-SpaceMember-FetchDefault')")
    @PostMapping("space_members/fetchdefault")
    ...
    */
    @ApiOperation(value = "校验CheckKey", tags = {"空间成员" },  notes = "SpaceMember-CheckKey ")
    @PostMapping("spaces/{spaceId}/space_members/checkkey")
    ...
    */
    @ApiOperation(value = "草稿GetDraft", tags = {"空间成员" },  notes = "SpaceMember-GetDraft ")
    @GetMapping("spaces/{spaceId}/space_members/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"空间成员" },  notes = "SpaceMember-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SpaceMember-FetchDefault-all') or hasPermission('Space',#spaceId,#dto,'ibizplm-SpaceMember-FetchDefault')")
    @PostMapping("spaces/{spaceId}/space_members/fetchdefault")
    ...
    */
    @ApiOperation(value = "校验CheckKey", tags = {"空间成员" },  notes = "SpaceMember-CheckKey ")
    @PostMapping("users/{userId}/space_members/checkkey")
    ...
    */
    @ApiOperation(value = "草稿GetDraft", tags = {"空间成员" },  notes = "SpaceMember-GetDraft ")
    @GetMapping("users/{userId}/space_members/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"空间成员" },  notes = "SpaceMember-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SpaceMember-FetchDefault-all') or hasPermission('User',#userId,#dto,'ibizplm-SpaceMember-FetchDefault')")
    @PostMapping("users/{userId}/space_members/fetchdefault")
