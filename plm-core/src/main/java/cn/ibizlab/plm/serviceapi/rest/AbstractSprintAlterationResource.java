...
public abstract class AbstractSprintAlterationResource {
    ...
    */
    @ApiOperation(value = "创建Create", tags = {"迭代变更" },  notes = "SprintAlteration-Create ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-Create-all') or hasPermission('release',#releaseId,this.sprintAlterationDtoMapping.toDomain(#dto),'ibizplm-SprintAlteration-Create')")
    @PostMapping("releases/{releaseId}/work_items/{workItemId}/sprint_alterations")
    public Mono<ResponseEntity<ResponseWrapper<SprintAlterationDTO>>>createByReleaseIdAndWorkItemId
            (@PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @Validated @RequestBody RequestWrapper<SprintAlterationDTO> dto) {
        ResponseWrapper<SprintAlterationDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
            dto.getList().forEach(item -> rt.add(createByReleaseIdAndWorkItemId(releaseId, workItemId, item)));
        else
            rt.set(createByReleaseIdAndWorkItemId(releaseId, workItemId, dto.getDto()));
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    * @return ResponseEntity<SprintAlterationDTO>
    */   
    public SprintAlterationDTO createByReleaseIdAndWorkItemId
            (String releaseId, String workItemId, SprintAlterationDTO dto) {
        SprintAlteration domain = sprintAlterationDtoMapping.toDomain(dto);
        domain.setWorkItemId(workItemId);
        sprintAlterationService.create(domain);
        SprintAlteration rt = domain;
    ...
    */
    @ApiOperation(value = "更新Update", tags = {"迭代变更" },  notes = "SprintAlteration-Update ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-Update-all') or hasPermission('release',#releaseId,this.sprintAlterationService.get(#id),'ibizplm-SprintAlteration-Update')")
    @VersionCheck(entity = "sprintalteration" , versionfield = "updateTime")
    @PutMapping("releases/{releaseId}/work_items/{workItemId}/sprint_alterations/{id}")
    public Mono<ResponseEntity<ResponseWrapper<SprintAlterationDTO>>>updateByReleaseIdAndWorkItemIdAndId
            (@PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @PathVariable("id") String id, @Validated @RequestBody RequestWrapper<SprintAlterationDTO> dto) {
        ResponseWrapper<SprintAlterationDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
            IntStream.range(0, ids.length).forEach(i -> rt.add(updateByReleaseIdAndWorkItemIdAndId(releaseId, workItemId, ids[i], dto.getList().get(i))));
        }
        else
            rt.set(updateByReleaseIdAndWorkItemIdAndId(releaseId, workItemId, id, dto.getDto()));
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    * @return ResponseEntity<SprintAlterationDTO>
    */   
    public SprintAlterationDTO updateByReleaseIdAndWorkItemIdAndId
            (String releaseId, String workItemId, String id, SprintAlterationDTO dto) {
        SprintAlteration domain = sprintAlterationDtoMapping.toDomain(dto);
        domain.setId(id);
        sprintAlterationService.update(domain);
        SprintAlteration rt = domain;
    ...
    */
    @ApiOperation(value = "rep_change", tags = {"迭代变更" },  notes = "SprintAlteration-rep_change ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-rep_change-all') or hasPermission('release',#releaseId,this.sprintAlterationDtoMapping.toDomain(#dto),'ibizplm-SprintAlteration-rep_change')")
    @PostMapping("releases/{releaseId}/work_items/{workItemId}/sprint_alterations/rep_change")
    public Mono<ResponseEntity<ResponseWrapper<SprintAlterationDTO>>>repChangeByReleaseIdAndWorkItemId
            (@PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @Validated @RequestBody RequestWrapper<SprintAlterationDTO> dto) {
        ResponseWrapper<SprintAlterationDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
            dto.getList().forEach(item -> rt.add(repChangeByReleaseIdAndWorkItemId(releaseId, workItemId, item)));
        else
            rt.set(repChangeByReleaseIdAndWorkItemId(releaseId, workItemId, dto.getDto()));
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    * @return ResponseEntity<SprintAlterationDTO>
    */   
    public SprintAlterationDTO repChangeByReleaseIdAndWorkItemId
            (String releaseId, String workItemId, SprintAlterationDTO dto) {
        SprintAlteration domain = sprintAlterationDtoMapping.toDomain(dto);
        domain.setWorkItemId(workItemId);
        SprintAlteration rt = sprintAlterationService.repChange(domain);
    ...
    */
    @ApiOperation(value = "保存Save", tags = {"迭代变更" },  notes = "SprintAlteration-Save ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-Save-all') or hasPermission('release',#releaseId,this.sprintAlterationDtoMapping.toDomain(#dto),'ibizplm-SprintAlteration-Save')")
    @PostMapping("releases/{releaseId}/work_items/{workItemId}/sprint_alterations/save")
    public Mono<ResponseEntity<ResponseWrapper<SprintAlterationDTO>>>saveByReleaseIdAndWorkItemId
            (@PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @Validated @RequestBody RequestWrapper<SprintAlterationDTO> dto) {
        ResponseWrapper<SprintAlterationDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
            dto.getList().forEach(item -> rt.add(saveByReleaseIdAndWorkItemId(releaseId, workItemId, item)));
        else
            rt.set(saveByReleaseIdAndWorkItemId(releaseId, workItemId, dto.getDto()));
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    * @return ResponseEntity<SprintAlterationDTO>
    */   
    public SprintAlterationDTO saveByReleaseIdAndWorkItemId
            (String releaseId, String workItemId, SprintAlterationDTO dto) {
        SprintAlteration domain = sprintAlterationDtoMapping.toDomain(dto);
        domain.setWorkItemId(workItemId);
        sprintAlterationService.save(domain);
    ...
    */
    @ApiOperation(value = "创建Create", tags = {"迭代变更" },  notes = "SprintAlteration-Create ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-Create-all') or hasPermission('project',#projectId,this.sprintAlterationDtoMapping.toDomain(#dto),'ibizplm-SprintAlteration-Create')")
    @PostMapping("projects/{projectId}/releases/{releaseId}/work_items/{workItemId}/sprint_alterations")
    public Mono<ResponseEntity<ResponseWrapper<SprintAlterationDTO>>>createByProjectIdAndReleaseIdAndWorkItemId
            (@PathVariable("projectId") String projectId, @PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @Validated @RequestBody RequestWrapper<SprintAlterationDTO> dto) {
        ResponseWrapper<SprintAlterationDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
            dto.getList().forEach(item -> rt.add(createByProjectIdAndReleaseIdAndWorkItemId(projectId, releaseId, workItemId, item)));
        else
            rt.set(createByProjectIdAndReleaseIdAndWorkItemId(projectId, releaseId, workItemId, dto.getDto()));
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    * @return ResponseEntity<SprintAlterationDTO>
    */   
    public SprintAlterationDTO createByProjectIdAndReleaseIdAndWorkItemId
            (String projectId, String releaseId, String workItemId, SprintAlterationDTO dto) {
        SprintAlteration domain = sprintAlterationDtoMapping.toDomain(dto);
        domain.setWorkItemId(workItemId);
        sprintAlterationService.create(domain);
        SprintAlteration rt = domain;
    ...
    */
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-Update-all') or hasPermission('project',#projectId,this.sprintAlterationService.get(#id),'ibizplm-SprintAlteration-Update')")
    @VersionCheck(entity = "sprintalteration" , versionfield = "updateTime")
    @PutMapping("projects/{projectId}/releases/{releaseId}/work_items/{workItemId}/sprint_alterations/{id}")
    public Mono<ResponseEntity<ResponseWrapper<SprintAlterationDTO>>>updateByProjectIdAndReleaseIdAndWorkItemIdAndId
            (@PathVariable("projectId") String projectId, @PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @PathVariable("id") String id, @Validated @RequestBody RequestWrapper<SprintAlterationDTO> dto) {
        ResponseWrapper<SprintAlterationDTO> rt = new ResponseWrapper<>();
        if (dto.isArray()) {
            String [] ids = id.split(";");
            IntStream.range(0, ids.length).forEach(i -> rt.add(updateByProjectIdAndReleaseIdAndWorkItemIdAndId(projectId, releaseId, workItemId, ids[i], dto.getList().get(i))));
        }
        else
            rt.set(updateByProjectIdAndReleaseIdAndWorkItemIdAndId(projectId, releaseId, workItemId, id, dto.getDto()));
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    * @return ResponseEntity<SprintAlterationDTO>
    */   
    public SprintAlterationDTO updateByProjectIdAndReleaseIdAndWorkItemIdAndId
            (String projectId, String releaseId, String workItemId, String id, SprintAlterationDTO dto) {
        SprintAlteration domain = sprintAlterationDtoMapping.toDomain(dto);
        domain.setId(id);
        sprintAlterationService.update(domain);
        SprintAlteration rt = domain;
    ...
    */
    @ApiOperation(value = "rep_change", tags = {"迭代变更" },  notes = "SprintAlteration-rep_change ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-rep_change-all') or hasPermission('project',#projectId,this.sprintAlterationDtoMapping.toDomain(#dto),'ibizplm-SprintAlteration-rep_change')")
    @PostMapping("projects/{projectId}/releases/{releaseId}/work_items/{workItemId}/sprint_alterations/rep_change")
    public Mono<ResponseEntity<ResponseWrapper<SprintAlterationDTO>>>repChangeByProjectIdAndReleaseIdAndWorkItemId
            (@PathVariable("projectId") String projectId, @PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @Validated @RequestBody RequestWrapper<SprintAlterationDTO> dto) {
        ResponseWrapper<SprintAlterationDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
            dto.getList().forEach(item -> rt.add(repChangeByProjectIdAndReleaseIdAndWorkItemId(projectId, releaseId, workItemId, item)));
        else
            rt.set(repChangeByProjectIdAndReleaseIdAndWorkItemId(projectId, releaseId, workItemId, dto.getDto()));
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    * @return ResponseEntity<SprintAlterationDTO>
    */   
    public SprintAlterationDTO repChangeByProjectIdAndReleaseIdAndWorkItemId
            (String projectId, String releaseId, String workItemId, SprintAlterationDTO dto) {
        SprintAlteration domain = sprintAlterationDtoMapping.toDomain(dto);
        domain.setWorkItemId(workItemId);
        SprintAlteration rt = sprintAlterationService.repChange(domain);
    ...
    */
    @ApiOperation(value = "保存Save", tags = {"迭代变更" },  notes = "SprintAlteration-Save ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-Save-all') or hasPermission('project',#projectId,this.sprintAlterationDtoMapping.toDomain(#dto),'ibizplm-SprintAlteration-Save')")
    @PostMapping("projects/{projectId}/releases/{releaseId}/work_items/{workItemId}/sprint_alterations/save")
    public Mono<ResponseEntity<ResponseWrapper<SprintAlterationDTO>>>saveByProjectIdAndReleaseIdAndWorkItemId
            (@PathVariable("projectId") String projectId, @PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @Validated @RequestBody RequestWrapper<SprintAlterationDTO> dto) {
        ResponseWrapper<SprintAlterationDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
            dto.getList().forEach(item -> rt.add(saveByProjectIdAndReleaseIdAndWorkItemId(projectId, releaseId, workItemId, item)));
        else
            rt.set(saveByProjectIdAndReleaseIdAndWorkItemId(projectId, releaseId, workItemId, dto.getDto()));
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    * @return ResponseEntity<SprintAlterationDTO>
    */   
    public SprintAlterationDTO saveByProjectIdAndReleaseIdAndWorkItemId
            (String projectId, String releaseId, String workItemId, SprintAlterationDTO dto) {
        SprintAlteration domain = sprintAlterationDtoMapping.toDomain(dto);
        domain.setWorkItemId(workItemId);
        sprintAlterationService.save(domain);
    ...
    */
    @ApiOperation(value = "获取Get", tags = {"迭代变更" },  notes = "SprintAlteration-Get ")
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-Get-all')  or hasPermission('release',#releaseId,this.sprintAlterationDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-SprintAlteration-Get')")
    @GetMapping("releases/{releaseId}/work_items/{workItemId}/sprint_alterations/{id}")
    public Mono<ResponseEntity<SprintAlterationDTO>> getByReleaseIdAndWorkItemIdAndId
            (@PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @PathVariable("id") String id) {
        SprintAlteration rt = sprintAlterationService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(sprintAlterationDtoMapping.toDto(rt)));
    }
    ...
    */
    @ApiOperation(value = "删除Remove", tags = {"迭代变更" },  notes = "SprintAlteration-Remove ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-Remove-all') or hasPermission('release',#releaseId,this.sprintAlterationService.get(#id),'ibizplm-SprintAlteration-Remove')")
    @DeleteMapping("releases/{releaseId}/work_items/{workItemId}/sprint_alterations/{id}")
    public Mono<ResponseEntity<Boolean>> removeByReleaseIdAndWorkItemIdAndId
            (@PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @PathVariable("id") String id) {
        Boolean rt = sprintAlterationService.remove(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    @ApiOperation(value = "校验CheckKey", tags = {"迭代变更" },  notes = "SprintAlteration-CheckKey ")
    @PostMapping("releases/{releaseId}/work_items/{workItemId}/sprint_alterations/check_key")
    public Mono<ResponseEntity<CheckKeyStatus>> checkKeyByReleaseIdAndWorkItemId
            (@PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @Validated @RequestBody SprintAlterationDTO dto) {
        SprintAlteration domain = sprintAlterationDtoMapping.toDomain(dto);
        domain.setWorkItemId(workItemId);
        CheckKeyStatus rt = sprintAlterationService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    ...
    */
    @ApiOperation(value = "草稿GetDraft", tags = {"迭代变更" },  notes = "SprintAlteration-GetDraft ")
    @GetMapping("releases/{releaseId}/work_items/{workItemId}/sprint_alterations/get_draft")
    public Mono<ResponseEntity<SprintAlterationDTO>> getDraftByReleaseIdAndWorkItemId
            (@PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @SpringQueryMap SprintAlterationDTO dto) {
        SprintAlteration domain = sprintAlterationDtoMapping.toDomain(dto);
        domain.setWorkItemId(workItemId);
        SprintAlteration rt = sprintAlterationService.getDraft(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(sprintAlterationDtoMapping.toDto(rt)));
    ...
    */
    @ApiOperation(value = "查询fetch_change", tags = {"迭代变更" },  notes = "SprintAlteration-fetch_change ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-fetch_change-all') or hasPermission('release',#releaseId,#dto,'ibizplm-SprintAlteration-fetch_change')")
    @PostMapping("releases/{releaseId}/work_items/{workItemId}/sprint_alterations/fetch_change")
    public Mono<ResponseEntity<List<SprintAlterationDTO>>> fetchChangeByReleaseIdAndWorkItemId
            (@PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @Validated @RequestBody SprintAlterationFilterDTO dto) {
        dto.setWorkItemIdEQ(workItemId);
        SprintAlterationSearchContext context = sprintAlterationFilterDtoMapping.toDomain(dto);
        Page<SprintAlteration> domains = sprintAlterationService.fetchChange(context) ;
        List<SprintAlterationDTO> list = sprintAlterationDtoMapping.toDto(domains.getContent());
    ...
    */
    @ApiOperation(value = "查询fetch_default", tags = {"迭代变更" },  notes = "SprintAlteration-fetch_default ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-fetch_default-all') or hasPermission('release',#releaseId,#dto,'ibizplm-SprintAlteration-fetch_default')")
    @PostMapping("releases/{releaseId}/work_items/{workItemId}/sprint_alterations/fetch_default")
    public Mono<ResponseEntity<List<SprintAlterationDTO>>> fetchDefaultByReleaseIdAndWorkItemId
            (@PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @Validated @RequestBody SprintAlterationFilterDTO dto) {
        dto.setWorkItemIdEQ(workItemId);
        SprintAlterationSearchContext context = sprintAlterationFilterDtoMapping.toDomain(dto);
        Page<SprintAlteration> domains = sprintAlterationService.fetchDefault(context) ;
    ...
    */
    @ApiOperation(value = "获取Get", tags = {"迭代变更" },  notes = "SprintAlteration-Get ")
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-Get-all')  or hasPermission('project',#projectId,this.sprintAlterationDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-SprintAlteration-Get')")
    @GetMapping("projects/{projectId}/releases/{releaseId}/work_items/{workItemId}/sprint_alterations/{id}")
    public Mono<ResponseEntity<SprintAlterationDTO>> getByProjectIdAndReleaseIdAndWorkItemIdAndId
            (@PathVariable("projectId") String projectId, @PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @PathVariable("id") String id) {
        SprintAlteration rt = sprintAlterationService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(sprintAlterationDtoMapping.toDto(rt)));
    }
    ...
    */
    @ApiOperation(value = "删除Remove", tags = {"迭代变更" },  notes = "SprintAlteration-Remove ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-Remove-all') or hasPermission('project',#projectId,this.sprintAlterationService.get(#id),'ibizplm-SprintAlteration-Remove')")
    @DeleteMapping("projects/{projectId}/releases/{releaseId}/work_items/{workItemId}/sprint_alterations/{id}")
    public Mono<ResponseEntity<Boolean>> removeByProjectIdAndReleaseIdAndWorkItemIdAndId
            (@PathVariable("projectId") String projectId, @PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @PathVariable("id") String id) {
        Boolean rt = sprintAlterationService.remove(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    @ApiOperation(value = "校验CheckKey", tags = {"迭代变更" },  notes = "SprintAlteration-CheckKey ")
    @PostMapping("projects/{projectId}/releases/{releaseId}/work_items/{workItemId}/sprint_alterations/check_key")
    public Mono<ResponseEntity<CheckKeyStatus>> checkKeyByProjectIdAndReleaseIdAndWorkItemId
            (@PathVariable("projectId") String projectId, @PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @Validated @RequestBody SprintAlterationDTO dto) {
        SprintAlteration domain = sprintAlterationDtoMapping.toDomain(dto);
        domain.setWorkItemId(workItemId);
        CheckKeyStatus rt = sprintAlterationService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    ...
    */
    @ApiOperation(value = "草稿GetDraft", tags = {"迭代变更" },  notes = "SprintAlteration-GetDraft ")
    @GetMapping("projects/{projectId}/releases/{releaseId}/work_items/{workItemId}/sprint_alterations/get_draft")
    public Mono<ResponseEntity<SprintAlterationDTO>> getDraftByProjectIdAndReleaseIdAndWorkItemId
            (@PathVariable("projectId") String projectId, @PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @SpringQueryMap SprintAlterationDTO dto) {
        SprintAlteration domain = sprintAlterationDtoMapping.toDomain(dto);
        domain.setWorkItemId(workItemId);
        SprintAlteration rt = sprintAlterationService.getDraft(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(sprintAlterationDtoMapping.toDto(rt)));
    ...
    */
    @ApiOperation(value = "查询fetch_change", tags = {"迭代变更" },  notes = "SprintAlteration-fetch_change ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-fetch_change-all') or hasPermission('project',#projectId,#dto,'ibizplm-SprintAlteration-fetch_change')")
    @PostMapping("projects/{projectId}/releases/{releaseId}/work_items/{workItemId}/sprint_alterations/fetch_change")
    public Mono<ResponseEntity<List<SprintAlterationDTO>>> fetchChangeByProjectIdAndReleaseIdAndWorkItemId
            (@PathVariable("projectId") String projectId, @PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @Validated @RequestBody SprintAlterationFilterDTO dto) {
        dto.setWorkItemIdEQ(workItemId);
        SprintAlterationSearchContext context = sprintAlterationFilterDtoMapping.toDomain(dto);
        Page<SprintAlteration> domains = sprintAlterationService.fetchChange(context) ;
        List<SprintAlterationDTO> list = sprintAlterationDtoMapping.toDto(domains.getContent());
    ...
    */
    @ApiOperation(value = "查询fetch_default", tags = {"迭代变更" },  notes = "SprintAlteration-fetch_default ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SprintAlteration-fetch_default-all') or hasPermission('project',#projectId,#dto,'ibizplm-SprintAlteration-fetch_default')")
    @PostMapping("projects/{projectId}/releases/{releaseId}/work_items/{workItemId}/sprint_alterations/fetch_default")
    public Mono<ResponseEntity<List<SprintAlterationDTO>>> fetchDefaultByProjectIdAndReleaseIdAndWorkItemId
            (@PathVariable("projectId") String projectId, @PathVariable("releaseId") String releaseId, @PathVariable("workItemId") String workItemId, @Validated @RequestBody SprintAlterationFilterDTO dto) {
        dto.setWorkItemIdEQ(workItemId);
        SprintAlterationSearchContext context = sprintAlterationFilterDtoMapping.toDomain(dto);
        Page<SprintAlteration> domains = sprintAlterationService.fetchDefault(context) ;
