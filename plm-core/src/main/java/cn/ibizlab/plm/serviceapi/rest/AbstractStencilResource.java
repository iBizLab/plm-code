...
public abstract class AbstractStencilResource {
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<StencilDTO>>>create
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<StencilDTO>>>updateById
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<StencilDTO>>>save
            (@Validated @RequestBody RequestWrapper<StencilDTO> dto) {
        ResponseWrapper<StencilDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<StencilDTO>>>createBySpaceId
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<StencilDTO>>>updateBySpaceIdAndId
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<StencilDTO>>>saveBySpaceId
            (@PathVariable("spaceId") String spaceId, @Validated @RequestBody RequestWrapper<StencilDTO> dto) {
        ResponseWrapper<StencilDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Stencil-Get-all')  or hasPermission(this.stencilDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-Stencil-Get')")
    @GetMapping("stencils/{id}")
    public Mono<ResponseEntity<StencilDTO>> getById
            (@PathVariable("id") String id) {
        Stencil rt = stencilService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(stencilDtoMapping.toDto(rt)));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<CheckKeyStatus>> checkKey
        ...
        Stencil domain = stencilDtoMapping.toDomain(dto);
        CheckKeyStatus rt = stencilService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<StencilDTO>> getDraft
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<List<StencilDTO>>>
    */
    ...
    public Mono<ResponseEntity<List<StencilDTO>>> fetchDefault
    ...
    */
    ...
    public Mono<ResponseEntity<List<StencilDTO>>> fetchNoSpaceStencil
            (@Validated @RequestBody StencilFilterDTO dto) {
        StencilSearchContext context = stencilFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<List<StencilDTO>>> fetchReader
            (@Validated @RequestBody StencilFilterDTO dto) {
        StencilSearchContext context = stencilFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<List<StencilDTO>>> fetchSpaceStencil
            (@Validated @RequestBody StencilFilterDTO dto) {
        StencilSearchContext context = stencilFilterDtoMapping.toDomain(dto);
    ...
    */
    @ApiOperation(value = "获取Get", tags = {"页面模板" },  notes = "Stencil-Get ")
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-Stencil-Get-all')  or hasPermission('space',#spaceId,this.stencilDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-Stencil-Get')")
    @GetMapping("spaces/{spaceId}/stencils/{id}")
    public Mono<ResponseEntity<StencilDTO>> getBySpaceIdAndId
    ...
    */
    ...
    public Mono<ResponseEntity<StencilDTO>> getDraftBySpaceId
    ...
    */
    ...
    public Mono<ResponseEntity<List<StencilDTO>>> fetchDefaultBySpaceId
    ...
    */
    ...
    public Mono<ResponseEntity<List<StencilDTO>>> fetchNoSpaceStencilBySpaceId
            (@PathVariable("spaceId") String spaceId, @Validated @RequestBody StencilFilterDTO dto) {
        dto.setSpaceIdEQ(spaceId);
        StencilSearchContext context = stencilFilterDtoMapping.toDomain(dto);
        Page<Stencil> domains = stencilService.fetchNoSpaceStencil(context) ;
    ...
    */
    ...
    public Mono<ResponseEntity<List<StencilDTO>>> fetchReaderBySpaceId
            (@PathVariable("spaceId") String spaceId, @Validated @RequestBody StencilFilterDTO dto) {
        dto.setSpaceIdEQ(spaceId);
        StencilSearchContext context = stencilFilterDtoMapping.toDomain(dto);
        Page<Stencil> domains = stencilService.fetchReader(context) ;
    ...
    */
    ...
    public Mono<ResponseEntity<List<StencilDTO>>> fetchSpaceStencilBySpaceId
            (@PathVariable("spaceId") String spaceId, @Validated @RequestBody StencilFilterDTO dto) {
        dto.setSpaceIdEQ(spaceId);
        StencilSearchContext context = stencilFilterDtoMapping.toDomain(dto);
        Page<Stencil> domains = stencilService.fetchSpaceStencil(context) ;
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> createBatch(@RequestBody List<StencilDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> updateBatch(@RequestBody List<StencilDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> saveBatch(@RequestBody List<StencilDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<ImportResult>> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<StencilDTO> dtos) {
        return  Mono.just(ResponseEntity.status(HttpStatus.OK).body(stencilService.importData(config,ignoreError,stencilDtoMapping.toDomain(dtos))));
    }
