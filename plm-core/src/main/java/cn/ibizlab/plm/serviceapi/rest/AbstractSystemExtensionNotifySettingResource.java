...
public abstract class AbstractSystemExtensionNotifySettingResource {
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<SystemExtensionNotifySettingDTO>>
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<SystemExtensionNotifySettingDTO>>>create
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<SystemExtensionNotifySettingDTO>>>updateById
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<SystemExtensionNotifySettingDTO>>>save
            (@Validated @RequestBody RequestWrapper<SystemExtensionNotifySettingDTO> dto) {
        ResponseWrapper<SystemExtensionNotifySettingDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SystemExtensionNotifySetting-Get-all')  or hasPermission(this.systemExtensionNotifySettingDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-SystemExtensionNotifySetting-Get')")
    @GetMapping("system_extension_notify_settings/{id}")
    public Mono<ResponseEntity<SystemExtensionNotifySettingDTO>> getById
            (@PathVariable("id") String id) {
        SystemExtensionNotifySetting rt = systemExtensionNotifySettingService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(systemExtensionNotifySettingDtoMapping.toDto(rt)));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<CheckKeyStatus>> checkKey
        ...
        SystemExtensionNotifySetting domain = systemExtensionNotifySettingDtoMapping.toDomain(dto);
        CheckKeyStatus rt = systemExtensionNotifySettingService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<SystemExtensionNotifySettingDTO>> getDraft
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<List<SystemExtensionNotifySettingDTO>>>
    */
    ...
    public Mono<ResponseEntity<List<SystemExtensionNotifySettingDTO>>> fetchDefault
    ...
    * @return Mono<ResponseEntity<List<SystemExtensionNotifySettingDTO>>>
    */
    @ApiOperation(value = "查询FetchView", tags = {"通知设置" },  notes = "SystemExtensionNotifySetting-FetchView ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-SystemExtensionNotifySetting-FetchView-all') or hasPermission(#dto,'ibizplm-SystemExtensionNotifySetting-FetchView')")
    @PostMapping("system_extension_notify_settings/fetchview")
    public Mono<ResponseEntity<List<SystemExtensionNotifySettingDTO>>> fetchView
            (@Validated @RequestBody SystemExtensionNotifySettingFilterDTO dto) {
        SystemExtensionNotifySettingSearchContext context = systemExtensionNotifySettingFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> createBatch(@RequestBody List<SystemExtensionNotifySettingDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> updateBatch(@RequestBody List<SystemExtensionNotifySettingDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> saveBatch(@RequestBody List<SystemExtensionNotifySettingDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<ImportResult>> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<SystemExtensionNotifySettingDTO> dtos) {
        return  Mono.just(ResponseEntity.status(HttpStatus.OK).body(systemExtensionNotifySettingService.importData(config,ignoreError,systemExtensionNotifySettingDtoMapping.toDomain(dtos))));
    }
