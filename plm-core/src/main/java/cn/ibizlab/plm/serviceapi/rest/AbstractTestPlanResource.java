...
public abstract class AbstractTestPlanResource {
    ...
    */
    ...
    @PostMapping("test_plans/checkkey")
    ...
    */
    ...
    @GetMapping("test_plans/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"测试计划" },  notes = "TestPlan-FetchDefault ")
    @PostMapping("test_plans/fetchdefault")
    ...
    /**
    * 查询FetchMy_assignee 测试计划
    * 
    *
    * @param dto dto
    * @return ResponseEntity<List<TestPlanDTO>>
    */
    @ApiOperation(value = "查询FetchMy_assignee", tags = {"测试计划" },  notes = "TestPlan-FetchMy_assignee ")
    @PostMapping("test_plans/fetchmy_assignee")
    ...
    /**
    * 查询FetchMy_in_progress 测试计划
    * 
    *
    * @param dto dto
    * @return ResponseEntity<List<TestPlanDTO>>
    */
    @ApiOperation(value = "查询FetchMy_in_progress", tags = {"测试计划" },  notes = "TestPlan-FetchMy_in_progress ")
    @PostMapping("test_plans/fetchmy_in_progress")
    ...
    /**
    * 查询FetchMy_participate 测试计划
    * 
    *
    * @param dto dto
    * @return ResponseEntity<List<TestPlanDTO>>
    */
    @ApiOperation(value = "查询FetchMy_participate", tags = {"测试计划" },  notes = "TestPlan-FetchMy_participate ")
    @PostMapping("test_plans/fetchmy_participate")
    ...
    /**
    * 查询FetchPending_and_in_progress 测试计划
    * 
    *
    * @param dto dto
    * @return ResponseEntity<List<TestPlanDTO>>
    */
    @ApiOperation(value = "查询FetchPending_and_in_progress", tags = {"测试计划" },  notes = "TestPlan-FetchPending_and_in_progress ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-TestPlan-FetchPending_and_in_progress-all') or hasPermission(#dto,'ibizplm-TestPlan-FetchPending_and_in_progress')")
    @PostMapping("test_plans/fetchpending_and_in_progress")
    ...
    /**
    * 查询FetchQuery_no_shift_in 测试计划
    * 
    *
    * @param dto dto
    * @return ResponseEntity<List<TestPlanDTO>>
    */
    @ApiOperation(value = "查询FetchQuery_no_shift_in", tags = {"测试计划" },  notes = "TestPlan-FetchQuery_no_shift_in ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-TestPlan-FetchQuery_no_shift_in-all') or hasPermission(#dto,'ibizplm-TestPlan-FetchQuery_no_shift_in')")
    @PostMapping("test_plans/fetchquery_no_shift_in")
    ...
    /**
    * 查询FetchUn_join_plan 测试计划
    * 
    *
    * @param dto dto
    * @return ResponseEntity<List<TestPlanDTO>>
    */
    @ApiOperation(value = "查询FetchUn_join_plan", tags = {"测试计划" },  notes = "TestPlan-FetchUn_join_plan ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-TestPlan-FetchUn_join_plan-all') or hasPermission(#dto,'ibizplm-TestPlan-FetchUn_join_plan')")
    @PostMapping("test_plans/fetchun_join_plan")
    ...
    */
    @ApiOperation(value = "校验CheckKey", tags = {"测试计划" },  notes = "TestPlan-CheckKey ")
    @PostMapping("libraries/{libraryId}/test_plans/checkkey")
    ...
    */
    @ApiOperation(value = "草稿GetDraft", tags = {"测试计划" },  notes = "TestPlan-GetDraft ")
    @GetMapping("libraries/{libraryId}/test_plans/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"测试计划" },  notes = "TestPlan-FetchDefault ")
    @PostMapping("libraries/{libraryId}/test_plans/fetchdefault")
    ...
    */
    @ApiOperation(value = "查询FetchMy_assignee", tags = {"测试计划" },  notes = "TestPlan-FetchMy_assignee ")
    @PostMapping("libraries/{libraryId}/test_plans/fetchmy_assignee")
    ...
    */
    @ApiOperation(value = "查询FetchMy_in_progress", tags = {"测试计划" },  notes = "TestPlan-FetchMy_in_progress ")
    @PostMapping("libraries/{libraryId}/test_plans/fetchmy_in_progress")
    ...
    */
    @ApiOperation(value = "查询FetchMy_participate", tags = {"测试计划" },  notes = "TestPlan-FetchMy_participate ")
    @PostMapping("libraries/{libraryId}/test_plans/fetchmy_participate")
    ...
    */
    @ApiOperation(value = "查询FetchPending_and_in_progress", tags = {"测试计划" },  notes = "TestPlan-FetchPending_and_in_progress ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-TestPlan-FetchPending_and_in_progress-all') or hasPermission('Library',#libraryId,#dto,'ibizplm-TestPlan-FetchPending_and_in_progress')")
    @PostMapping("libraries/{libraryId}/test_plans/fetchpending_and_in_progress")
    ...
    */
    @ApiOperation(value = "查询FetchQuery_no_shift_in", tags = {"测试计划" },  notes = "TestPlan-FetchQuery_no_shift_in ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-TestPlan-FetchQuery_no_shift_in-all') or hasPermission('Library',#libraryId,#dto,'ibizplm-TestPlan-FetchQuery_no_shift_in')")
    @PostMapping("libraries/{libraryId}/test_plans/fetchquery_no_shift_in")
    ...
    */
    @ApiOperation(value = "查询FetchUn_join_plan", tags = {"测试计划" },  notes = "TestPlan-FetchUn_join_plan ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-TestPlan-FetchUn_join_plan-all') or hasPermission('Library',#libraryId,#dto,'ibizplm-TestPlan-FetchUn_join_plan')")
    @PostMapping("libraries/{libraryId}/test_plans/fetchun_join_plan")
