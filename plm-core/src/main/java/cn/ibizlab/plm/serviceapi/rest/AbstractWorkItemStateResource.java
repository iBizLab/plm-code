...
public abstract class AbstractWorkItemStateResource {
    ...
    */
    ...
    @PostMapping("work_item_states/checkkey")
    ...
    */
    ...
    @GetMapping("work_item_states/getdraft")
    ...
    /**
    * 查询FetchDefault 工作项状态
    * 
    *
    * @param dto dto
    * @return ResponseEntity<List<WorkItemStateDTO>>
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"工作项状态" },  notes = "WorkItemState-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-WorkItemState-FetchDefault-all') or hasPermission(#dto,'ibizplm-WorkItemState-FetchDefault')")
    @PostMapping("work_item_states/fetchdefault")
