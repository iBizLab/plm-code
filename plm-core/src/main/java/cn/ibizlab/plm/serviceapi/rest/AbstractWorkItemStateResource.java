...
public abstract class AbstractWorkItemStateResource {
    ...
    *
    * @param dto dto
    * @return Mono<ResponseEntity<WorkItemStateDTO>>
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<WorkItemStateDTO>>>create
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<WorkItemStateDTO>>>updateById
    ...
    */
    ...
    public Mono<ResponseEntity<ResponseWrapper<WorkItemStateDTO>>>save
            (@Validated @RequestBody RequestWrapper<WorkItemStateDTO> dto) {
        ResponseWrapper<WorkItemStateDTO> rt = new ResponseWrapper<>();
        if (dto.isArray())
    ...
    */
    ...
    @PostAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-WorkItemState-Get-all')  or hasPermission(this.workItemStateDtoMapping.toDomain(returnObject.block().getBody()),'ibizplm-WorkItemState-Get')")
    @GetMapping("work_item_states/{id}")
    public Mono<ResponseEntity<WorkItemStateDTO>> getById
            (@PathVariable("id") String id) {
        WorkItemState rt = workItemStateService.get(id);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(workItemStateDtoMapping.toDto(rt)));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<CheckKeyStatus>> checkKey
        ...
        WorkItemState domain = workItemStateDtoMapping.toDomain(dto);
        CheckKeyStatus rt = workItemStateService.checkKey(domain);
        return Mono.just(ResponseEntity.status(HttpStatus.OK).body(rt));
    }
    ...
    */
    ...
    public Mono<ResponseEntity<WorkItemStateDTO>> getDraft
    ...
    */
    ...
    public Mono<ResponseEntity<List<WorkItemStateDTO>>> fetchDefault
            (@Validated @RequestBody WorkItemStateFilterDTO dto) {
        WorkItemStateSearchContext context = workItemStateFilterDtoMapping.toDomain(dto);
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> createBatch(@RequestBody List<WorkItemStateDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> updateBatch(@RequestBody List<WorkItemStateDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<Boolean>> saveBatch(@RequestBody List<WorkItemStateDTO> dtos) {
    ...
    */
    ...
    public Mono<ResponseEntity<ImportResult>> importData(@RequestParam(value = "config" , required = false) String config ,@RequestParam(value = "ignoreerror", required = false, defaultValue = "true") Boolean ignoreError ,@RequestBody List<WorkItemStateDTO> dtos) {
        return  Mono.just(ResponseEntity.status(HttpStatus.OK).body(workItemStateService.importData(config,ignoreError,workItemStateDtoMapping.toDomain(dtos))));
    }
