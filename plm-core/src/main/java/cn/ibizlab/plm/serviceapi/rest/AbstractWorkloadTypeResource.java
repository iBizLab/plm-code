...
public abstract class AbstractWorkloadTypeResource {
    ...
    */
    ...
    @PostMapping("workload_types/checkkey")
    ...
    */
    ...
    @GetMapping("workload_types/getdraft")
    ...
    */
    @ApiOperation(value = "查询FetchDefault", tags = {"工时类别" },  notes = "WorkloadType-FetchDefault ")
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibizplm-WorkloadType-FetchDefault-all') or hasPermission(#dto,'ibizplm-WorkloadType-FetchDefault')")
    @PostMapping("workload_types/fetchdefault")
