...
public enum Entities {
    ...
    ACTIVITIY ("Activitiy","活动",cn.ibizlab.plm.core.base.domain.Activitiy.class,cn.ibizlab.plm.core.base.filter.ActivitiySearchContext.class,cn.ibizlab.plm.core.base.service.ActivitiyService.class),
    ...
    DYNADASHBOARD ("Dynadashboard","动态数据看板",cn.ibizlab.plm.core.base.domain.Dynadashboard.class,cn.ibizlab.plm.core.base.filter.DynadashboardSearchContext.class,cn.ibizlab.plm.core.base.service.DynadashboardService.class),
    ...
    SPRINT_CATEGORY ("SprintCategory","迭代类别",cn.ibizlab.plm.core.projmgmt.domain.SprintCategory.class,cn.ibizlab.plm.core.projmgmt.filter.SprintCategorySearchContext.class,cn.ibizlab.plm.core.projmgmt.service.SprintCategoryService.class),
    SPRINT_SECTION ("SprintSection","迭代分组",cn.ibizlab.plm.core.projmgmt.domain.SprintSection.class,cn.ibizlab.plm.core.projmgmt.filter.SprintSectionSearchContext.class,cn.ibizlab.plm.core.projmgmt.service.SprintSectionService.class),
    ...
    VERSION ("Version","版本（temp）",cn.ibizlab.plm.core.projmgmt.domain.Version.class,cn.ibizlab.plm.core.projmgmt.filter.VersionSearchContext.class,cn.ibizlab.plm.core.projmgmt.service.VersionService.class),
    VERSION_CATEGORY ("VersionCategory","发布类别",cn.ibizlab.plm.core.projmgmt.domain.VersionCategory.class,cn.ibizlab.plm.core.projmgmt.filter.VersionCategorySearchContext.class,cn.ibizlab.plm.core.projmgmt.service.VersionCategoryService.class),
    VERSION_SECTION ("VersionSection","发布分组",cn.ibizlab.plm.core.projmgmt.domain.VersionSection.class,cn.ibizlab.plm.core.projmgmt.filter.VersionSectionSearchContext.class,cn.ibizlab.plm.core.projmgmt.service.VersionSectionService.class),
