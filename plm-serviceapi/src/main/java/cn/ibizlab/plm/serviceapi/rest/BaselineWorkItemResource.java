 ...
 */
@Slf4j
@io.swagger.annotations.Api(tags = {"基线工作项" })
@RestController("serviceapi-baselineworkitem")
@RequestMapping("${ibiz.rest.basePath.serviceapi:/}")
public class BaselineWorkItemResource extends BaselineWorkItemResourceImpl{
